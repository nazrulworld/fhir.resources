...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ClaimResponse) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, coding, domainresource, fhirdate,
               fhirreference, identifier, quantity)
...
class ClaimResponseAddItemAdjudication(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ClaimResponseAddItemAdjudication, self).__init__(
...
class ClaimResponseAddItemDetailAdjudication(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ClaimResponseAddItemDetailAdjudication, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ClaimResponseItemDetailAdjudication(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ClaimResponseItemDetailAdjudication, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ClaimResponseItemDetailSubDetailAdjudication(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ClaimResponseItemDetailSubDetailAdjudication, self).__init__(
            jsondict=jsondict, strict=strict
        )

    def elementProperties(self):
        js = super(
            ClaimResponseItemDetailSubDetailAdjudication, self
        ).elementProperties()
        js.extend(
            [
                ("amount", "amount", quantity.Quantity, False, None, False),
