...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ClinicalImpression) on 2019-05-14.
...
class ClinicalImpressionInvestigations(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ClinicalImpressionInvestigations, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ClinicalImpressionRuledOut(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ClinicalImpressionRuledOut, self).__init__(
            jsondict=jsondict, strict=strict
        )
