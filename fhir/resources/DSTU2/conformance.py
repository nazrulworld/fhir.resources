...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Conformance) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, codeableconcept, coding, contactpoint,
               domainresource, fhirdate, fhirreference)
...
class ConformanceImplementation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ConformanceImplementation, self).__init__(
...
class ConformanceMessagingEndpoint(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ConformanceMessagingEndpoint, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ConformanceMessagingEvent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ConformanceMessagingEvent, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ConformanceRestInteraction(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ConformanceRestInteraction, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ConformanceRestResourceInteraction(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ConformanceRestResourceInteraction, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ConformanceRestResourceSearchParam(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ConformanceRestResourceSearchParam, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ConformanceRestSecurityCertificate(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ConformanceRestSecurityCertificate, self).__init__(
            jsondict=jsondict, strict=strict
        )
