...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ImagingObjectSelection) on 2019-05-14.
...
class ImagingObjectSelectionStudy(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ImagingObjectSelectionStudy, self).__init__(
...
class ImagingObjectSelectionStudySeries(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ImagingObjectSelectionStudySeries, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ImagingObjectSelectionStudySeriesInstance(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ImagingObjectSelectionStudySeriesInstance, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class ImagingObjectSelectionStudySeriesInstanceFrames(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ImagingObjectSelectionStudySeriesInstanceFrames, self).__init__(
            jsondict=jsondict, strict=strict
        )

    def elementProperties(self):
        js = super(
            ImagingObjectSelectionStudySeriesInstanceFrames, self
        ).elementProperties()
        js.extend(
            [
