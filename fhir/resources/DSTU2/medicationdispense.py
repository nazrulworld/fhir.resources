...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/MedicationDispense) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, codeableconcept, domainresource, fhirdate,
               fhirreference, identifier, quantity, range, ratio, timing)
...
class MedicationDispenseDosageInstruction(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(MedicationDispenseDosageInstruction, self).__init__(
...
class MedicationDispenseSubstitution(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(MedicationDispenseSubstitution, self).__init__(
            jsondict=jsondict, strict=strict
        )
