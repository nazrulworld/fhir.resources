...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/MedicationOrder) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, codeableconcept, domainresource, fhirdate,
               fhirreference, identifier, period, quantity, range, ratio,
               timing)
...
class MedicationOrderDispenseRequest(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(MedicationOrderDispenseRequest, self).__init__(
...
class MedicationOrderDosageInstruction(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(MedicationOrderDosageInstruction, self).__init__(
            jsondict=jsondict, strict=strict
        )
...
class MedicationOrderSubstitution(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(MedicationOrderSubstitution, self).__init__(
            jsondict=jsondict, strict=strict
        )
