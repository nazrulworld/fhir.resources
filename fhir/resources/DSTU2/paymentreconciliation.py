...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/PaymentReconciliation) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, coding, domainresource, fhirdate,
               fhirreference, identifier, period, quantity)
...
class PaymentReconciliationNote(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(PaymentReconciliationNote, self).__init__(
            jsondict=jsondict, strict=strict
        )
