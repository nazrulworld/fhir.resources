...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Practitioner) on 2019-05-14.
#  2019, SMART Health IT.


from . import (address, attachment, backboneelement, codeableconcept,
               contactpoint, domainresource, fhirdate, fhirreference,
...
class PractitionerPractitionerRole(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(PractitionerPractitionerRole, self).__init__(
