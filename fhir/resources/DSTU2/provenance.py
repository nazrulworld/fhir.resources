...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Provenance) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, codeableconcept, coding, domainresource,
               fhirdate, fhirreference, identifier, period, signature)
...
class ProvenanceAgentRelatedAgent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ProvenanceAgentRelatedAgent, self).__init__(
