...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Questionnaire) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, coding, contactpoint, domainresource, fhirdate,
...
class QuestionnaireGroupQuestion(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(QuestionnaireGroupQuestion, self).__init__(
