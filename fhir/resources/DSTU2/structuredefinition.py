...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/StructureDefinition) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, codeableconcept, coding, contactpoint,
               domainresource, elementdefinition, fhirdate, identifier)
...
class StructureDefinitionContact(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(StructureDefinitionContact, self).__init__(
