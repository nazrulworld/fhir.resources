...
class BasicTests(unittest.TestCase):
    ...
    def implBasic1(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].system, "http://hl7.org/fhir/basic-resource-type"
        )
        ...
        self.assertEqual(
            inst.modifierExtension[0].valueCodeableConcept.coding[0].code, "11429006"
        )
        self.assertEqual(
    ...
    def implBasic2(self, inst):
        ...
        self.assertEqual(
            inst.extension[0].extension[1].extension[0].valueString, "attribute1"
        )
        ...
        self.assertEqual(
            inst.extension[0].extension[2].extension[0].valueString, "attribute2"
        )
