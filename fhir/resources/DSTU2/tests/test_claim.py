...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim1(self, inst):
        ...
        self.assertEqual(
            inst.item[0].service.system, "http://hl7.org/fhir/oralservicecodes"
        )
        ...
        self.assertEqual(
            inst.item[1].bodySite.system, "http://fdi.org/fhir/oraltoothcodes"
        )
        ...
        self.assertEqual(
            inst.item[1].service.system, "http://hl7.org/fhir/oralservicecodes"
        )
        ...
        self.assertEqual(
            inst.item[1].subSite[0].system, "http://fdi.org/fhir/oralsurfacecodes"
        )
        ...
        self.assertEqual(
            inst.item[2].bodySite.system, "http://fdi.org/fhir/oraltoothcodes"
        )
        ...
        self.assertEqual(
            inst.item[2].detail[0].service.system,
            "http://hl7.org/fhir/oralservicecodes",
        )
        self.assertEqual(inst.item[2].detail[0].type.code, "service")
        self.assertEqual(inst.item[2].detail[0].unitPrice.code, "USD")
        self.assertEqual(
            inst.item[2].detail[0].unitPrice.system, "urn:iso:std:iso:4217"
        )
        ...
        self.assertEqual(
            inst.item[2].service.system, "http://hl7.org/fhir/oralservicecodes"
        )
        ...
        self.assertEqual(
            inst.text.div,
            "<div>A human-readable rendering of the Oral Health Claim</div>",
        )
    ...
    def implClaim3(self, inst):
        ...
        self.assertEqual(
            inst.item[0].service.system, "http://hl7.org/fhir/ex-pharmaservice"
        )
        self.assertEqual(inst.item[0].serviceDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].serviceDate.as_json(), "2014-08-16")
        self.assertEqual(inst.item[0].type.code, "service")
        ...
        self.assertEqual(
            inst.text.div, "<div>A human-readable rendering of the Pharmacy Claim</div>"
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implClaim4(self, inst):
        ...
        self.assertEqual(
            inst.item[0].service.system, "http://hl7.org/fhir/ex-visionservice"
        )
        self.assertEqual(inst.item[0].serviceDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].serviceDate.as_json(), "2014-08-16")
        self.assertEqual(inst.item[0].type.code, "service")
        ...
        self.assertEqual(inst.priority.code, "normal")
        self.assertEqual(
            inst.text.div, "<div>A human-readable rendering of the Vision Claim</div>"
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implClaim5(self, inst):
        ...
        self.assertEqual(inst.item[0].service.code, "exam")
        self.assertEqual(
            inst.item[0].service.system, "http://hl7.org/fhir/ex-serviceproduct"
        )
        self.assertEqual(inst.item[0].serviceDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].serviceDate.as_json(), "2014-08-16")
        self.assertEqual(inst.item[0].type.code, "service")
        ...
        self.assertEqual(inst.priority.code, "normal")
        self.assertEqual(
            inst.text.div, "<div>A human-readable rendering of the Claim</div>"
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implClaim7(self, inst):
        ...
        self.assertEqual(
            inst.item[0].detail[0].service.system,
        ...
        self.assertEqual(
            inst.item[0].detail[0].unitPrice.system, "urn:iso:std:iso:4217"
        )
        ...
        self.assertEqual(
            inst.text.div,
            "<div>A human-readable rendering of the Vision Claim for Glasses</div>",
        )
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(inst.type, "vision")
        self.assertEqual(inst.use, "complete")
    ...
    def implClaim9(self, inst):
        ...
        self.assertEqual(
            inst.diagnosis[0].diagnosis.system, "http://hl7.org/fhir/sid/icd-10"
        )
        self.assertEqual(inst.diagnosis[0].sequence, 1)
        ...
        self.assertEqual(
            inst.item[0].detail[3].service.system,
            "http://hl7.org/fhir/oralservicecodes",
        )
        ...
        self.assertEqual(
            inst.item[0].detail[4].service.system,
            "http://hl7.org/fhir/oralservicecodes",
        )
        ...
        self.assertEqual(
            inst.item[0].detail[4].unitPrice.system, "urn:iso:std:iso:4217"
        )
