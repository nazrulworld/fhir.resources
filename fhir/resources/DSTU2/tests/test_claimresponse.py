...
class ClaimResponseTests(unittest.TestCase):
    ...
    def implClaimResponse1(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://www.BenefitsInc.com/fhir/remittance"
        )
        self.assertEqual(inst.identifier[0].value, "R3500")
        self.assertEqual(inst.item[0].adjudication[0].amount.code, "USD")
        self.assertEqual(
            inst.item[0].adjudication[0].amount.system, "urn:iso:std:iso:4217"
        )
        ...
        self.assertEqual(
            inst.item[0].adjudication[1].amount.system, "urn:iso:std:iso:4217"
        )
        ...
        self.assertEqual(
            inst.item[0].adjudication[3].amount.system, "urn:iso:std:iso:4217"
        )
        ...
        self.assertEqual(
            inst.paymentRef.system, "http://www.BenefitsInc.com/fhir/paymentRef"
        )
        self.assertEqual(inst.paymentRef.value, "201408-2-1569478")
        self.assertEqual(
            inst.text.div, "<div>A human-readable rendering of the ClaimResponse</div>"
        )
