...
class CompositionTests(unittest.TestCase):
    ...
    def implComposition1(self, inst):
        ...
        self.assertEqual(
            inst.event[0].code[0].coding[0].system, "http://hl7.org/fhir/v3/ActCode"
        )
        ...
        self.assertEqual(
            inst.identifier.system, "http://healthintersections.com.au/test"
        )
        self.assertEqual(inst.identifier.value, "1")
        self.assertEqual(inst.section[0].code.coding[0].code, "11348-0")
        self.assertEqual(
            inst.section[0].code.coding[0].display, "History of past illness Narrative"
        )
        ...
        self.assertEqual(
            inst.section[0].orderedBy.coding[0].display, "Sorted by Event Date"
        )
        self.assertEqual(
