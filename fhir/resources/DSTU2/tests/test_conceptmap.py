...
class ConceptMapTests(unittest.TestCase):
    ...
    def implConceptMap1(self, inst):
        ...
        self.assertEqual(
            inst.element[0].target[0].codeSystem, "http://hl7.org/fhir/v3/AddressUse"
        )
        ...
        self.assertEqual(
            inst.element[1].target[0].codeSystem, "http://hl7.org/fhir/v3/AddressUse"
        )
        ...
        self.assertEqual(
            inst.element[2].target[0].codeSystem, "http://hl7.org/fhir/v3/AddressUse"
        )
        ...
        self.assertEqual(
            inst.element[3].target[0].codeSystem, "http://hl7.org/fhir/v3/AddressUse"
        )
        ...
        self.assertEqual(
            inst.element[4].target[0].codeSystem, "http://hl7.org/fhir/v3/AddressUse"
        )
        self.assertEqual(
            inst.element[4].target[0].comments,
        ...
        self.assertEqual(
            inst.identifier.value, "urn:uuid:53cd62ee-033e-414c-9f58-3ca97b5ffc3b"
        )
        self.assertEqual(inst.name, "FHIR/v3 Address Use Mapping")
        self.assertEqual(inst.publisher, "HL7, Inc")
        self.assertEqual(
            inst.requirements, "To help implementers map from HL7 v3/CDA to FHIR"
        )
    ...
    def implConceptMap2(self, inst):
        ...
        self.assertEqual(
            inst.contact[1].telecom[0].value,
        ...
        self.assertEqual(
            inst.element[1].target[0].comments,
            "HL7 term is a historical term. mapped to Pus",
        )
        self.assertEqual(inst.element[1].target[0].equivalence, "equivalent")
        self.assertEqual(inst.element[1].target[0].product[0].code, "47002008")
        self.assertEqual(
            inst.element[1].target[0].product[0].codeSystem, "http://snomed.info/sct"
        )
        self.assertEqual(
            inst.element[1].target[0].product[0].element,
            "http://hl7.org/fhir/v2/element/SPM-5",
        )
        ...
        self.assertEqual(
            inst.element[3].target[0].product[0].codeSystem, "http://snomed.info/sct"
        )
        self.assertEqual(
            inst.element[3].target[0].product[0].element,
            "http://hl7.org/fhir/v2/element/SPM-5",
        )
        ...
        self.assertEqual(
            inst.element[4].target[0].product[0].codeSystem, "http://snomed.info/sct"
        )
        self.assertEqual(
            inst.element[4].target[0].product[0].element,
            "http://hl7.org/fhir/v2/element/SPM-7",
        )
        ...
        self.assertEqual(
            inst.element[8].target[0].product[0].codeSystem, "http://snomed.info/sct"
        )
        self.assertEqual(
            inst.element[8].target[0].product[0].element,
            "http://hl7.org/fhir/v2/element/SPM-7",
        )
