...
def test_Condition_1(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-f001-heart.canonical.json"
...
def test_Condition_2(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-f002-lung.canonical.json"
    inst = condition.Condition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "Condition" == inst.resource_type
...
def test_Condition_3(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-f003-abscess.canonical.json"
    inst = condition.Condition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "Condition" == inst.resource_type
...
def test_Condition_4(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-f201-fever.canonical.json"
    inst = condition.Condition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "Condition" == inst.resource_type
...
def test_Condition_5(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-f202-malignancy.canonical.json"
    inst = condition.Condition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "Condition" == inst.resource_type
...
def test_Condition_6(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-f203-sepsis.canonical.json"
    inst = condition.Condition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "Condition" == inst.resource_type
...
def test_Condition_7(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-f204-renal.canonical.json"
    inst = condition.Condition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "Condition" == inst.resource_type
...
def test_Condition_8(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-f205-infection.canonical.json"
    inst = condition.Condition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "Condition" == inst.resource_type
...
def test_Condition_9(base_settings):
    filename = base_settings["unittest_data_dir"] / "condition-example-stroke.canonical.json"
    inst = condition.Condition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "Condition" == inst.resource_type
...
def impl_Condition_10(inst):
    ...
    assert inst.extension[0].url == "http://hl7.org/fhir/StructureDefinition/condition-criticality"
    ...
    assert inst.extension[0].valueCodeableConcept.coding[0].system == "http://snomed.info/sct"
