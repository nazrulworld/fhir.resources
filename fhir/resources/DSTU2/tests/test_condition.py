...
class ConditionTests(unittest.TestCase):
    ...
    def implCondition2(self, inst):
        ...
        self.assertEqual(
            inst.category.coding[1].system, "http://hl7.org/fhir/condition-category"
        )
        self.assertEqual(inst.clinicalStatus, "active")
        ...
        self.assertEqual(
            inst.evidence[0].code.coding[0].system, "http://snomed.info/sct"
        )
    ...
    def implCondition5(self, inst):
        ...
        self.assertEqual(
            inst.category.coding[0].system, "http://hl7.org/fhir/condition-category"
        )
        self.assertEqual(inst.clinicalStatus, "active")
    ...
    def implCondition8(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "NSCLC - Non-small cell lung cancer"
        )
        self.assertEqual(inst.code.coding[0].system, "http://snomed.info/sct")
    ...
    def implCondition10(self, inst):
        ...
        self.assertEqual(
            inst.bodySite[0].coding[0].display, "Entire retropharyngeal area"
        )
        self.assertEqual(inst.bodySite[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.category.coding[0].code, "439401001")
        self.assertEqual(inst.category.coding[0].display, "diagnosis")
