...
class ConformanceTests(unittest.TestCase):
    ...
    def implConformance2(self, inst):
        ...
        self.assertEqual(
            inst.copyright, "Copyright © Acme Healthcare and GoodCorp EHR Systems"
        )
        ...
        self.assertEqual(
            inst.messaging[0].event[0].code.system, "http://hl7.org/fhir/message-type"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.rest[0].compartment[0], "http://hl7.org/fhir/compartment/Patient"
        )
        self.assertEqual(
            inst.rest[0].documentation, "Main FHIR endpoint for acem health"
        )
        ...
        self.assertEqual(
            inst.rest[0].resource[0].interaction[3].code, "history-instance"
        )
        ...
        self.assertEqual(
            inst.rest[0].security.certificate[0].blob,
        ...
        self.assertEqual(
            inst.rest[0].security.description, "See Smart on FHIR documentation"
        )
        self.assertEqual(
            inst.rest[0].security.service[0].coding[0].code, "SMART-on-FHIR"
        )
        self.assertEqual(
