...
class DataElementTests(unittest.TestCase):
    ...
    def implDataElement1(self, inst):
        ...
        self.assertEqual(
            inst.element[0].extension[0].valueCodeableConcept.coding[0].code, "s"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.element[0].extension[0].valueCodeableConcept.coding[0].version, "1.9"
        )
        self.assertEqual(
            inst.element[0].extension[0].valueCodeableConcept.text, "second"
        )
    ...
    def implDataElement2(self, inst):
        ...
        self.assertEqual(
            inst.element[0].definition, "The code representing the gender of a person."
        )
        self.assertEqual(
            inst.element[0].extension[0].url,
