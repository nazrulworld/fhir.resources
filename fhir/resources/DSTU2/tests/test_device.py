...
class DeviceTests(unittest.TestCase):
    ...
    def implDevice1(self, inst):
        ...
        self.assertEqual(
            ...
            "Performance pace maker for high octane patients",
        )
    ...
    def implDevice3(self, inst):
        ...
        self.assertEqual(
            inst.type.coding[0].display, "Electrocardiographic monitor and recorder"
        )
    ...
    def implDevice5(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http:/goodhealthhospital/identifier/devices"
        )
