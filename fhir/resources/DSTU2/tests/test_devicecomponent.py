...
class DeviceComponentTests(unittest.TestCase):
    ...
    def implDeviceComponent1(self, inst):
        ...
        self.assertEqual(
            inst.languageCode.coding[0].system, "http://tools.ietf.org/html/bcp47"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.operationalStatus[0].coding[0].system, "urn:iso:std:iso:11073:10101"
        )
        ...
        self.assertEqual(
            inst.productionSpecification[0].specType.coding[0].display, "Serial number"
        )
