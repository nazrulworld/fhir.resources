...
class DiagnosticOrderTests(unittest.TestCase):
    ...
    def implDiagnosticOrder1(self, inst):
        ...
        self.assertEqual(
            inst.event[0].dateTime.date, FHIRDate("2013-05-02T16:16:00-07:00").date
        )
        ...
        self.assertEqual(
            inst.reason[0].coding[0].system, "http://hl7.org/fhir/sid/icd-9"
        )
    ...
    def implDiagnosticOrder2(self, inst):
        self.assertEqual(
            inst.event[0].dateTime.date, FHIRDate("2013-05-08T09:33:27+07:00").date
        )
        ...
        self.assertEqual(
            inst.item[0].bodySite.coding[0].system, "http://snomed.info/sct"
        )
    ...
    def implDiagnosticOrder3(self, inst):
        ...
        self.assertEqual(
            inst.event[0].dateTime.date, FHIRDate("2015-08-27T09:33:27+07:00").date
        )
