...
class DiagnosticReportTests(unittest.TestCase):
    ...
    def implDiagnosticReport1(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Lipid panel with direct LDL - Serum or Plasma"
        )
    ...
    def implDiagnosticReport2(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Computed tomography (CT) of head and neck"
        )
        ...
        self.assertEqual(
            inst.codedDiagnosis[0].coding[0].system, "http://snomed.info/sct"
        )
    ...
    def implDiagnosticReport4(self, inst):
        ...
        self.assertEqual(
            inst.codedDiagnosis[0].coding[0].display, "At risk of osteoporotic fracture"
        )
        self.assertEqual(
            inst.codedDiagnosis[0].coding[0].system, "http://snomed.info/sct"
        )
    ...
    def implDiagnosticReport8(self, inst):
        ...
        self.assertEqual(
            inst.conclusion, "Blood culture tested positive on staphylococcus aureus"
        )
        self.assertEqual(inst.contained[0].id, "req")
        self.assertEqual(
            inst.effectiveDateTime.date, FHIRDate("2013-03-11T03:45:00+01:00").date
        )
