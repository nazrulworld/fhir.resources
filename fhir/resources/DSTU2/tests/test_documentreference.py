...
class DocumentReferenceTests(unittest.TestCase):
    ...
    def implDocumentReference1(self, inst):
        ...
        self.assertEqual(
            inst.content[0].attachment.contentType, "application/hl7-v3+xml"
        )
        self.assertEqual(
            inst.content[0].attachment.hash, "2jmj7l5rSw0yVb/vlWAYkK/YBwk="
        )
        ...
        self.assertEqual(
            inst.content[0].format[0].display, "History and Physical Specification"
        )
        self.assertEqual(
            inst.content[0].format[0].system, "urn:oid:1.3.6.1.4.1.19376.1.2.3"
        )
        ...
        self.assertEqual(
            inst.context.practiceSetting.coding[0].code, "General Medicine"
        )
        self.assertEqual(
            inst.context.practiceSetting.coding[0].display, "General Medicine"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.docStatus.coding[0].system, "http://hl7.org/fhir/composition-status"
        )
        self.assertEqual(inst.id, "example")
        self.assertEqual(inst.identifier[0].system, "urn:ietf:rfc:3986")
        self.assertEqual(
            inst.identifier[0].value, "urn:oid:1.3.6.1.4.1.21367.2005.3.7.1234"
        )
        ...
        self.assertEqual(
            inst.masterIdentifier.value, "urn:oid:1.3.6.1.4.1.21367.2005.3.7"
        )
