...
def test_DocumentReference_1(base_settings):
    filename = base_settings["unittest_data_dir"] / "documentreference-example.canonical.json"
...
def impl_DocumentReference_1(inst):
    ...
    assert inst.contained[0].practitionerRole[0].managingOrganization.display == "Cleveland Clinic"
    ...
    assert inst.content[0].attachment.url == "http://example.org/xds/mhd/Binary/07a6483f-732b-461e-86b6-edb665c45510"
    ...
    assert inst.securityLabel[0].coding[0].system == "http://hl7.org/fhir/v3/Confidentiality"
