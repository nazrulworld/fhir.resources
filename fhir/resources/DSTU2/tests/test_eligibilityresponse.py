...
def test_EligibilityResponse_1(base_settings):
    filename = base_settings["unittest_data_dir"] / "eligibilityresponse-example.canonical.json"
...
def impl_EligibilityResponse_1(inst):
    ...
    assert inst.identifier[0].system == "http://www.BenefitsInc.com/fhir/eligibilityresponse"
    ...
    assert inst.text.div == "<div>A human-readable rendering of the EligibilityResponse.</div>"
