...
class EncounterTests(unittest.TestCase):
    ...
    def implEncounter3(self, inst):
        ...
        self.assertEqual(inst.status, "finished")
        self.assertEqual(
            inst.text.div, "<div>Encounter with patient @example who is at home</div>"
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implEncounter5(self, inst):
        ...
        self.assertEqual(
            inst.hospitalization.admitSource.coding[0].system, "http://snomed.info/sct"
        )
        self.assertEqual(
            inst.hospitalization.dischargeDisposition.coding[0].code, "306689006"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.priority.coding[0].display, "Non-urgent cardiological admission"
        )
        self.assertEqual(inst.priority.coding[0].system, "http://snomed.info/sct")
    ...
    def implEncounter6(self, inst):
        ...
        self.assertEqual(
            inst.hospitalization.dietPreference[0].coding[0].code, "276026009"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.hospitalization.reAdmission.coding[0].display, "readmitted"
        )
