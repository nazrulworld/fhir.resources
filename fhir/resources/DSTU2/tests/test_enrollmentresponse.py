...
def test_EnrollmentResponse_1(base_settings):
    filename = base_settings["unittest_data_dir"] / "enrollmentresponse-example.canonical.json"
...
def impl_EnrollmentResponse_1(inst):
    ...
    assert inst.text.div == "<div>A human-readable rendering of the EnrollmentResponse</div>"
