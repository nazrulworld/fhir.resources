...
class EpisodeOfCareTests(unittest.TestCase):
    ...
    def implEpisodeOfCare1(self, inst):
        ...
        self.assertEqual(
            inst.type[0].coding[0].display, "Home and Community Care Package"
        )
        self.assertEqual(
            inst.type[0].coding[0].system, "http://example.org/EpisodeOfCare/Type"
        )
