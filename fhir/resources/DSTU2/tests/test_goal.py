...
class GoalTests(unittest.TestCase):
    ...
    def implGoal1(self, inst):
        ...
        self.assertEqual(
            inst.extension[0].extension[0].valueCodeableConcept.coding[0].code, "3141-9"
        )
        self.assertEqual(
            inst.extension[0].extension[0].valueCodeableConcept.coding[0].display,
            "Weight Measured",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.extension[0].extension[1].valueRange.high.system,
        ...
        self.assertEqual(
            inst.extension[0].extension[1].valueRange.low.system,
            "http://unitsofmeasure.org",
        )
        ...
        self.assertEqual(
            inst.extension[0].url, "http://hl7.org/fhir/StructureDefinition/goal-target"
        )
