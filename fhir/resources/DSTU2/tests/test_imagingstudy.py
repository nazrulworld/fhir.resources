...
class ImagingStudyTests(unittest.TestCase):
    ...
    def implImagingStudy1(self, inst):
        ...
        self.assertEqual(
            inst.series[0].instance[0].content[0].url,
            "http://localhost/fhir/Binary/1.2.840.11361907579238403408700.3.0.14.19970327150033",
        )
        self.assertEqual(inst.series[0].instance[0].number, 1)
        self.assertEqual(
            inst.series[0].instance[0].sopClass, "urn:oid:1.2.840.10008.5.1.4.1.1.2"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.text.div,
            "<div>Image 1 from Series 3: CT Images on Patient MINT (MINT1234) taken at 1-Jan 2011 01:20 AM</div>",
        )
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(
            inst.uid, "urn:oid:2.16.124.113543.6003.1154777499.30246.19789.3503430045"
        )
