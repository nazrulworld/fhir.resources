...
class ImmunizationTests(unittest.TestCase):
    ...
    def implImmunization1(self, inst):
        ...
        self.assertEqual(
            inst.explanation.reasonNotGiven[0].coding[0].display, "medical precaution"
        )
        self.assertEqual(
    ...
    def implImmunization2(self, inst):
        ...
        self.assertEqual(
            inst.explanation.reason[0].coding[0].system, "http://snomed.info/sct"
        )
        ...
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(
            inst.vaccinationProtocol[0].description, "Vaccination Protocol Sequence 1"
        )
        ...
        self.assertEqual(
            inst.vaccinationProtocol[0].doseStatus.coding[0].display, "Counts"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.vaccinationProtocol[0].doseStatusReason.coding[0].code, "coldchbrk"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.vaccinationProtocol[0].targetDisease[0].coding[0].code, "1857005"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.vaccineCode.coding[0].system, "urn:oid:1.2.36.1.2001.1005.17"
        )
