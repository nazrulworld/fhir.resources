...
class ListTests(unittest.TestCase):
    ...
    def implList1(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "History of family member diseases"
        )
    ...
    def implList2(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "urn:uuid:a9fcea7c-fcdf-4d17-a5e0-f26dda030b59"
        )
    ...
    def implList4(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Allergies and Adverse Drug Reactions"
        )
        self.assertEqual(inst.code.coding[0].system, "http://loinc.org")
        ...
        self.assertEqual(
            inst.orderedBy.coding[0].system, "http://hl7.org/fhir/list-order"
        )
        self.assertEqual(inst.status, "current")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implList5(self, inst):
        ...
        self.assertEqual(
            inst.emptyReason.coding[0].system, "http://hl7.org/fhir/list-empty-reason"
        )
