...
class LocationTests(unittest.TestCase):
    ...
    def implLocation4(self, inst):
        ...
        self.assertEqual(
            inst.text.div, "<div>Burgers UMC, South Wing, second floor</div>"
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implLocation5(self, inst):
        self.assertEqual(
            inst.description, "Ambulance provided by Burgers University Medical Center"
        )
    ...
    def implLocation6(self, inst):
        ...
        self.assertEqual(
            inst.text.div,
            "<div>Burgers UMC, South Wing, second floor, Neuro Radiology Operation Room 1</div>",
        )
        self.assertEqual(inst.text.status, "generated")
