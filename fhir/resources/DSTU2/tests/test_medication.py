...
class MedicationTests(unittest.TestCase):
    ...
    def implMedication2(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "25ug Flutacisone + 250ug Salmeterol"
        )
        self.assertEqual(inst.code.coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(
            inst.product.ingredient[0].amount.denominator.system,
        ...
        self.assertEqual(
            inst.product.ingredient[0].amount.numerator.system,
        ...
        self.assertEqual(
            inst.product.ingredient[1].amount.denominator.system,
            "http://hl7.org/fhir/v3/orderableDrugForm",
        )
        ...
        self.assertEqual(
            inst.product.ingredient[1].amount.numerator.system,
            "http://unitsofmeasure.org",
        )
    ...
    def implMedication3(self, inst):
        ...
        self.assertEqual(
            inst.package.container.coding[0].system, "http://snomed.info/sct"
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implMedication4(self, inst):
        ...
        self.assertEqual(
            ...
            "Salbutamol+ipratropium bromide 100micrograms/20micrograms inhaler",
        )
        self.assertEqual(inst.code.coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(
            inst.product.form.coding[0].display, "Inhaler (qualifier value)"
        )
        self.assertEqual(inst.product.form.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.product.ingredient[0].amount.denominator.value, 1)
