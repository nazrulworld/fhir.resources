...
class OrganizationTests(unittest.TestCase):
    ...
    def implOrganization2(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "urn:oid:2.16.840.1.113883.3.19.2.3"
        )
    ...
    def implOrganization4(self, inst):
        ...
        self.assertEqual(
            inst.type.coding[0].system, "http://hl7.org/fhir/organization-type"
        )
    ...
    def implOrganization6(self, inst):
        ...
        self.assertEqual(
            inst.type.coding[1].system, "urn:oid:2.16.840.1.113883.2.4.15.1060"
        )
        self.assertEqual(inst.type.coding[2].code, "prov")
        self.assertEqual(inst.type.coding[2].display, "Healthcare Provider")
        self.assertEqual(
            inst.type.coding[2].system, "http://hl7.org/fhir/organization-type"
        )
    ...
    def implOrganization7(self, inst):
        ...
        self.assertEqual(
            inst.type.coding[1].system, "http://hl7.org/fhir/organization-type"
        )
    ...
    def implOrganization10(self, inst):
        ...
        self.assertEqual(
            inst.type.coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.1060"
        )
        self.assertEqual(inst.type.coding[1].code, "prov")
