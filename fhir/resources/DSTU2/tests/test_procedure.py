...
class ProcedureTests(unittest.TestCase):
    ...
    def implProcedure2(self, inst):
        ...
        self.assertEqual(
            inst.reasonCodeableConcept.text, "ensure breathing during surgery"
        )
        self.assertEqual(inst.status, "completed")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implProcedure4(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Incision of retropharyngeal abscess"
        )
        self.assertEqual(inst.code.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.followUp[0].text, "described in care plan")
        ...
        self.assertEqual(inst.performer[0].role.text, "Care role")
        self.assertEqual(
            inst.reasonCodeableConcept.text, "abcess in retropharyngeal area"
        )
        self.assertEqual(inst.status, "completed")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implProcedure5(self, inst):
        ...
        self.assertEqual(
            inst.performer[0].role.coding[0].system, "http://snomed.info/sct"
        )
    ...
    def implProcedure7(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Biopsy of soft tissue of forearm (Procedure)"
        )
        self.assertEqual(inst.code.coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(inst.status, "completed")
        self.assertEqual(
            inst.text.div, "<div>Biopsy of suspected melanoma L) arm</div>"
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implProcedure8(self, inst):
        ...
        self.assertEqual(inst.outcome.text, "improved blood circulation")
        self.assertEqual(
            inst.performedPeriod.end.date, FHIRDate("2013-03-08T09:30:10+01:00").date
        )
        self.assertEqual(
            inst.performedPeriod.end.as_json(), "2013-03-08T09:30:10+01:00"
        )
        self.assertEqual(
            inst.performedPeriod.start.date, FHIRDate("2013-03-08T09:00:10+01:00").date
        )
        self.assertEqual(
            inst.performedPeriod.start.as_json(), "2013-03-08T09:00:10+01:00"
        )
        self.assertEqual(inst.performer[0].role.coding[0].code, "01.000")
        self.assertEqual(inst.performer[0].role.coding[0].display, "Arts")
        self.assertEqual(
