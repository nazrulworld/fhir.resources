...
class ProcessRequestTests(unittest.TestCase):
    ...
    def implProcessRequest1(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://happyvalley.com/processrequest"
        )
        self.assertEqual(inst.identifier[0].value, "112")
        self.assertEqual(inst.include[0], "Reconciliation")
        self.assertEqual(
            inst.text.div,
            "<div>A human-readable rendering of the Poll ProcessRequest</div>",
        )
    ...
    def implProcessRequest2(self, inst):
        ...
        self.assertEqual(
            inst.text.div,
            "<div>A human-readable rendering of the Status ProcessRequest</div>",
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implProcessRequest4(self, inst):
        ...
        self.assertEqual(
            inst.text.div,
            "<div>A human-readable rendering of the Reversal ProcessRequest</div>",
        )
        self.assertEqual(inst.text.status, "generated")
    ...
    def implProcessRequest8(self, inst):
        ...
        self.assertEqual(
            inst.text.div,
            "<div>A human-readable rendering of the ReProcess ProcessRequest resource.</div>",
        )
        self.assertEqual(inst.text.status, "generated")
