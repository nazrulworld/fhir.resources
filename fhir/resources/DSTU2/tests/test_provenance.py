...
class ProvenanceTests(unittest.TestCase):
    ...
    def implProvenance1(self, inst):
        ...
        self.assertEqual(
            inst.agent[0].role.system, "http://hl7.org/fhir/provenance-participant-role"
        )
        ...
        self.assertEqual(
            inst.agent[1].role.system, "http://hl7.org/fhir/v3/ParticipationType"
        )
        self.assertEqual(inst.entity[0].display, "CDA Document in XDS repository")
        self.assertEqual(
            inst.entity[0].reference,
            "DocumentReference/90f55916-9d15-4b8f-87a9-2d7ade8670c8",
        )
        ...
        self.assertEqual(
            inst.text.div,
            "<div>procedure record authored on 27-June 2015 by Harold Hippocrates, MD Content extracted from Referral received 26-June</div>",
        )
    ...
    def implProvenance2(self, inst):
        ...
        self.assertEqual(
            inst.activity.coding[0].system, "http://hl7.org/fhir/v3/DocumentCompletion"
        )
        ...
        self.assertEqual(
            inst.reason[0].coding[0].system, "http://hl7.org/fhir/v3/ActReason"
        )
