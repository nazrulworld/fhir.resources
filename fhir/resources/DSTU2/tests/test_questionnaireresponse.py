...
class QuestionnaireResponseTests(unittest.TestCase):
    ...
    def implQuestionnaireResponse1(self, inst):
        ...
        self.assertEqual(
            inst.group.group[0].group[0].question[0].answer[0].valueString,
            "Cathy Jones",
        )
        ...
        self.assertEqual(
            inst.group.group[0].group[0].question[1].answer[0].valueCoding.code, "f"
        )
        ...
        self.assertEqual(
            inst.group.group[0].group[1].question[0].answer[0].valueDecimal, 3.25
        )
        ...
        self.assertEqual(
            inst.group.group[0].group[1].question[1].answer[0].valueDecimal, 44.3
        )
        ...
        self.assertEqual(
            inst.group.group[0].group[1].question[2].answer[0].group[0].linkId,
            "vitaminKgivenDoses",
        )
        self.assertEqual(
            inst.group.group[0]
        ...
        self.assertEqual(
            inst.group.group[0].group[1].question[2].answer[0].valueCoding.code,
            "INJECTION",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            inst.group.group[0].group[1].question[3].answer[0].group[0].linkId,
            "hepBgivenDate",
        )
        self.assertEqual(
            inst.group.group[0]
        ...
        self.assertEqual(
            inst.group.group[0].group[1].question[4].answer[0].valueString,
        ...
        self.assertEqual(
            inst.group.title, "NSW Government My Personal Health Record, january 2013"
        )
    ...
    def implQuestionnaireResponse2(self, inst):
        ...
        self.assertEqual(
            inst.group.question[0].answer[0].valueCoding.extension[0].url,
            "http://hl7.org/fhir/StructureDefinition/iso21090-CO-value",
        )
        self.assertEqual(
            inst.group.question[0].answer[0].valueCoding.extension[0].valueDecimal, 4
        )
        self.assertEqual(
            inst.group.question[0].answer[0].valueCoding.system, "http://loinc.org"
        )
        ...
        self.assertEqual(
            inst.group.question[1].answer[0].valueCoding.display, "Localizing pain"
        )
        self.assertEqual(
            inst.group.question[1].answer[0].valueCoding.extension[0].url,
            "http://hl7.org/fhir/StructureDefinition/iso21090-CO-value",
        )
        self.assertEqual(
            inst.group.question[1].answer[0].valueCoding.extension[0].valueDecimal, 5
        )
        self.assertEqual(
            inst.group.question[1].answer[0].valueCoding.system, "http://loinc.org"
        )
        ...
        self.assertEqual(
            inst.group.question[2].answer[0].valueCoding.display,
            "Eyes open spontaneously",
        )
        self.assertEqual(
            inst.group.question[2].answer[0].valueCoding.extension[0].url,
            "http://hl7.org/fhir/StructureDefinition/iso21090-CO-value",
        )
        self.assertEqual(
            inst.group.question[2].answer[0].valueCoding.extension[0].valueDecimal, 4
        )
        self.assertEqual(
            inst.group.question[2].answer[0].valueCoding.system, "http://loinc.org"
        )
    ...
    def implQuestionnaireResponse3(self, inst):
        ...
        self.assertEqual(
            inst.group.group[0].question[0].answer[0].valueString,
        ...
        self.assertEqual(
            inst.group.group[1].question[1].answer[0].valueDate.date,
            FHIRDate("1960-03-13").date,
        )
        self.assertEqual(
            inst.group.group[1].question[1].answer[0].valueDate.as_json(), "1960-03-13"
        )
        ...
        self.assertEqual(
            inst.group.group[1].question[2].answer[0].valueString, "The Netherlands"
        )
        ...
        self.assertEqual(
            inst.group.group[1].question[3].answer[0].valueString, "married"
        )
        ...
        self.assertEqual(
            inst.group.group[2].question[1].answer[0].valueString,
    ...
    def implQuestionnaireResponse4(self, inst):
        ...
        self.assertEqual(
            inst.group.group[0].question[0].answer[0].valueCoding.code, "1"
        )
        self.assertEqual(
            inst.group.group[0].question[0].answer[0].valueCoding.display, "Yes"
        )
        self.assertEqual(
            inst.group.group[0].question[0].answer[0].valueCoding.system,
            "http://cancer.questionnaire.org/system/code/yesno",
        )
