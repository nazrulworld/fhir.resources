...
class ReferralRequestTests(unittest.TestCase):
    ...
    def implReferralRequest1(self, inst):
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://orionhealth.com/fhir/apps/referralids"
        )
        ...
        self.assertEqual(
            ...
            "http://orionhealth.com/fhir/apps/prioritycodes",
        )
        ...
        self.assertEqual(
            inst.serviceRequested[0].coding[0].system, "http://snomed.info/sct"
        )
        ...
        self.assertEqual(
            inst.text.div,
            "<div>Referral to Dr Dave for Beverly weaver to have grommets inserted in her r) ear</div>",
        )
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(inst.type.coding[0].code, "rfs")
        self.assertEqual(inst.type.coding[0].display, "Referral for service")
        self.assertEqual(
            inst.type.coding[0].system, "http://orionhealth.com/fhir/apps/referraltypes"
        )
