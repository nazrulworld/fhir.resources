...
class RiskAssessmentTests(unittest.TestCase):
    ...
    def implRiskAssessment2(self, inst):
        ...
        self.assertEqual(
            inst.prediction[0].whenRange.high.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[0].whenRange.low.system, "http://unitsofmeasure.org"
        )
    ...
    def implRiskAssessment3(self, inst):
        ...
        self.assertEqual(
            inst.prediction[0].outcome.coding[0].system, "http://snomed.info/sct"
        )
        self.assertEqual(
            inst.prediction[0].outcome.text, "permanent weakness of the left arm"
        )
        self.assertEqual(
            inst.prediction[0].probabilityCodeableConcept.coding[0].code, "moderate"
        )
        self.assertEqual(
            inst.prediction[0].probabilityCodeableConcept.coding[0].display,
            "moderate likelihood",
        )
        self.assertEqual(
            inst.prediction[0].probabilityCodeableConcept.coding[0].system,
    ...
    def implRiskAssessment4(self, inst):
        ...
        self.assertEqual(
            inst.prediction[1].whenRange.high.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[1].whenRange.low.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[2].whenRange.high.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[2].whenRange.low.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[3].whenRange.high.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[3].whenRange.low.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[4].whenRange.high.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[4].whenRange.low.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[5].whenRange.high.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[5].whenRange.low.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[6].whenRange.high.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[6].whenRange.low.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[7].whenRange.high.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.prediction[7].whenRange.low.system, "http://unitsofmeasure.org"
        )
