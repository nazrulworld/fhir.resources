...
class SpecimenTests(unittest.TestCase):
    ...
    def implSpecimen1(self, inst):
        self.assertEqual(
            inst.accessionIdentifier.system, "http://lab.acme.org/specimens/2011"
        )
        ...
        self.assertEqual(
            inst.collection.method.coding[0].system, "http://hl7.org/fhir/v2/0488"
        )
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://ehr.acme.org/identifiers/collections"
        )
    ...
    def implSpecimen3(self, inst):
        self.assertEqual(
            inst.accessionIdentifier.system, "http://lab.acme.org/specimens/2015"
        )
        self.assertEqual(inst.accessionIdentifier.value, "X352356")
        self.assertEqual(
            inst.collection.collectedDateTime.date,
        ...
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(
            inst.treatment[0].description, "Acidify to pH < 3.0 with 6 N HCl."
        )
        self.assertEqual(inst.treatment[0].procedure.coding[0].code, "ACID")
        self.assertEqual(
            inst.treatment[0].procedure.coding[0].system, "http://hl7.org/fhir/v2/0373"
        )
