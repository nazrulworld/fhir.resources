...
class SubstanceTests(unittest.TestCase):
    ...
    def implSubstance1(self, inst):
        ...
        self.assertEqual(
            inst.category[0].coding[0].system, "http://hl7.org.fhir/substance-category"
        )
        ...
        self.assertEqual(
            inst.identifier[0].system, "http://acme.org/indentifiers/substances"
        )
    ...
    def implSubstance5(self, inst):
        ...
        self.assertEqual(
            inst.code.coding[0].display, "Silver nitrate 20% solution (product)"
        )
        self.assertEqual(inst.code.coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(
            ...
            "http://acme.org/indentifiers/substances/lot",
        )
    ...
    def implSubstance6(self, inst):
        ...
        self.assertEqual(
            inst.ingredient[0].quantity.denominator.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.ingredient[0].quantity.numerator.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.ingredient[1].quantity.denominator.system, "http://unitsofmeasure.org"
        )
        ...
        self.assertEqual(
            inst.ingredient[1].quantity.numerator.system, "http://unitsofmeasure.org"
        )
