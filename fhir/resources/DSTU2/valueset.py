...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ValueSet) on 2019-05-14.
#  2019, SMART Health IT.


from . import (backboneelement, codeableconcept, coding, contactpoint,
               domainresource, fhirdate, identifier)
...
class ValueSetCodeSystemConcept(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ValueSetCodeSystemConcept, self).__init__(
...
class ValueSetCodeSystemConceptDesignation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        super(ValueSetCodeSystemConceptDesignation, self).__init__(
            jsondict=jsondict, strict=strict
        )
