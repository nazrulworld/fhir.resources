...
def impl_capabilitystatement_1(inst):
    ...
    assert inst.date == fhirtypes.DateTime.validate("2012-01-04T12:09:24+00:06")
    assert inst.description == (
        "Sample capability statement showing new MessageDefinition " "structure"
    )
    assert inst.experimental is True
    assert inst.fhirVersion == "4.0.1"
    ...
    assert (
        inst.messaging[0].supportedMessage[0].definition == "MessageDefinition/example"
    )
...
def impl_capabilitystatement_2(inst):
    ...
    assert inst.software.name == "EHR"
    assert inst.software.releaseDate == fhirtypes.DateTime.validate(
        "2012-01-04T12:09:24+00:06"
    )
...
def impl_capabilitystatement_3(inst):
    ...
    assert inst.date == fhirtypes.DateTime.validate("2016-09-16T12:09:24+00:06")
    assert inst.description == (
    ...
    assert inst.rest[0].resource[0].profile == "StructureDefinition/Measure"
    assert (
        inst.rest[0].resource[0].searchParam[0].definition
...
def impl_capabilitystatement_4(inst):
    ...
    assert inst.contact[0].telecom[0].value == "http://hl7.org/fhir"
    assert inst.date == fhirtypes.DateTime.validate("2015-07-05T12:09:24+00:06")
    assert inst.description == (
    ...
    assert inst.rest[0].mode == "server"
    assert inst.rest[0].operation[0].definition == "OperationDefinition/ValueSet-expand"
    ...
    assert (
        inst.rest[0].operation[1].definition == "OperationDefinition/CodeSystem-lookup"
    )
    ...
    assert (
        inst.rest[0].operation[4].definition == "OperationDefinition/ConceptMap-closure"
    )
    ...
    assert inst.rest[0].resource[0].profile == "StructureDefinition/ValueSet"
    assert (
        inst.rest[0].resource[0].searchParam[0].definition
    ...
    assert inst.rest[0].resource[1].profile == "StructureDefinition/ConceptMap"
    assert (
...
def impl_capabilitystatement_6(inst):
    assert inst.contact[0].telecom[0].system == "url"
    assert inst.contact[0].telecom[0].value == "http://hl7.org/fhir"
    assert inst.date == fhirtypes.DateTime.validate("2013-06-18T12:09:24+00:06")
    assert inst.description == (
...
def impl_capabilitystatement_7(inst):
    ...
    assert inst.contact[0].telecom[0].system == "other"
    assert inst.contact[0].telecom[0].value == "http://hl7.org/fhir"
    assert inst.date == fhirtypes.DateTime.validate("2017-02-25T12:09:24+00:06")
    assert inst.description == (
    ...
    assert inst.rest[0].resource[0].profile == "StructureDefinition/Library"
    assert (
        inst.rest[0].resource[0].searchParam[0].definition
    ...
    assert inst.rest[0].resource[1].profile == "StructureDefinition/PlanDefinition"
    ...
    assert inst.rest[0].resource[2].profile == "StructureDefinition/ActivityDefinition"
    ...
    assert inst.rest[0].resource[3].profile == "StructureDefinition/Measure"
    assert (
    ...
    assert inst.rest[0].resource[4].profile == "StructureDefinition/Questionnaire"
    assert (
...
def impl_capabilitystatement_8(inst):
    ...
    assert inst.rest[0].resource[0].searchParam[4].name == "patient"
    ...
    assert inst.rest[0].resource[1].searchParam[5].name == "description"
    assert inst.rest[0].resource[1].searchParam[5].type == "string"
    assert inst.rest[0].resource[1].searchParam[6].definition == (
        "http://hl7.org/fhir/SearchParameter/ActivityDefinition-" "derived-from"
    )
    ...
    assert inst.rest[0].resource[1].searchParam[9].name == "title"
    ...
    assert (
        inst.rest[0].resource[1].searchRevInclude[2]
    ...
    assert inst.rest[0].resource[1].searchRevInclude[4] == "MessageDefinition.parent"
    assert (
        inst.rest[0].resource[1].searchRevInclude[5]
        == "NutritionOrder.instantiates-canonical"
    )
    assert inst.rest[0].resource[1].searchRevInclude[6] == "PlanDefinition.definition"
    assert (
    ...
    assert inst.rest[0].resource[2].searchInclude[2] == "AdverseEvent.subject"
    assert (
        inst.rest[0].resource[2].searchInclude[3] == "AdverseEvent.resultingcondition"
    )
    ...
    assert inst.rest[0].resource[2].searchParam[1].name == "severity"
    assert inst.rest[0].resource[2].searchParam[1].type == "token"
    assert (
    ...
    assert inst.rest[0].resource[2].searchParam[2].name == "recorder"
    assert inst.rest[0].resource[2].searchParam[2].type == "reference"
    assert (
        inst.rest[0].resource[2].searchParam[3].definition
        == "http://hl7.org/fhir/SearchParameter/AdverseEvent-study"
    )
    assert inst.rest[0].resource[2].searchParam[3].documentation == "AdverseEvent.study"
    assert inst.rest[0].resource[2].searchParam[3].name == "study"
    assert inst.rest[0].resource[2].searchParam[3].type == "reference"
    assert (
        inst.rest[0].resource[2].searchParam[4].definition
        == "http://hl7.org/fhir/SearchParameter/AdverseEvent-actuality"
    )
    assert inst.rest[0].resource[2].searchParam[4].documentation == "actual | potential"
    assert inst.rest[0].resource[2].searchParam[4].name == "actuality"
    assert inst.rest[0].resource[2].searchParam[4].type == "token"
    assert (
    ...
    assert inst.rest[0].resource[2].searchParam[5].name == "seriousness"
    ...
    assert inst.rest[0].resource[2].searchParam[6].name == "subject"
    assert inst.rest[0].resource[2].searchParam[6].type == "reference"
    assert inst.rest[0].resource[2].searchParam[7].definition == (
    ...
    assert inst.rest[0].resource[2].searchParam[7].name == "resultingcondition"
    assert inst.rest[0].resource[2].searchParam[7].type == "reference"
    assert (
    ...
    assert inst.rest[0].resource[2].searchParam[8].name == "substance"
    assert inst.rest[0].resource[2].searchParam[8].type == "reference"
    assert (
    ...
    assert inst.rest[0].resource[2].searchParam[9].name == "location"
    assert inst.rest[0].resource[2].searchParam[9].type == "reference"
    ...
    assert inst.rest[0].resource[4].searchInclude[0] == "Appointment.practitioner"
    assert inst.rest[0].resource[4].searchInclude[1] == "Appointment.slot"
    assert inst.rest[0].resource[4].searchInclude[2] == "Appointment.actor"
    assert inst.rest[0].resource[4].searchInclude[3] == "Appointment.based-on"
    assert inst.rest[0].resource[4].searchInclude[4] == "Appointment.patient"
    assert inst.rest[0].resource[4].searchInclude[5] == "Appointment.reason-reference"
    assert inst.rest[0].resource[4].searchInclude[6] == "Appointment.supporting-info"
    assert inst.rest[0].resource[4].searchInclude[7] == "Appointment.location"
    assert (
        inst.rest[0].resource[4].searchParam[0].definition
    ...
    assert inst.rest[0].resource[4].searchParam[2].documentation == (
        "The specialty of a practitioner that would be required to "
        "perform the service requested in this appointment"
    )
    assert inst.rest[0].resource[4].searchParam[2].name == "specialty"
    ...
    assert inst.rest[0].resource[4].searchParam[3].name == "service-category"
    assert inst.rest[0].resource[4].searchParam[3].type == "token"
    assert (
        inst.rest[0].resource[4].searchParam[4].definition
    ...
    assert inst.rest[0].resource[4].searchParam[4].name == "practitioner"
    ...
    assert inst.rest[0].resource[4].searchParam[6].documentation == (
        "The style of appointment or patient that has been booked in "
        "the slot (not service type)"
    )
    assert inst.rest[0].resource[4].searchParam[6].name == "appointment-type"
    ...
    assert inst.rest[0].resource[4].searchParam[7].name == "service-type"
    ...
    assert inst.rest[0].resource[4].searchParam[8].name == "slot"
    ...
    assert inst.rest[0].resource[4].searchParam[9].name == "reason-code"
    ...
    assert inst.rest[0].resource[4].searchRevInclude[2] == "Encounter.appointment"
    assert inst.rest[0].resource[4].searchRevInclude[3] == "ImagingStudy.basedon"
    ...
    assert inst.rest[0].resource[5].searchRevInclude[0] == "ImagingStudy.basedon"
    ...
    assert inst.rest[0].resource[6].searchInclude[1] == "AuditEvent.source"
    assert inst.rest[0].resource[6].searchInclude[2] == "AuditEvent.patient"
    assert inst.rest[0].resource[6].searchInclude[3] == "AuditEvent.entity"
    assert (
    ...
    assert inst.rest[0].resource[6].searchParam[2].documentation == "Identifier of who"
    ...
    assert inst.rest[0].resource[9].profile == (
        "http://hl7.org/fhir/StructureDefinition/BiologicallyDerivedP" "roduct"
    )
    assert inst.rest[0].resource[9].referencePolicy[0] == "literal"
    assert inst.rest[0].resource[9].referencePolicy[1] == "logical"
    assert inst.rest[0].resource[9].type == "BiologicallyDerivedProduct"
    assert (
