...
def impl_coverage_1(inst):
    ...
    assert inst.costToBeneficiary[0].exception[
        0
    ].period.end == fhirtypes.DateTime.validate("2018-12-31T11:15:33+10:00")
    assert inst.costToBeneficiary[0].exception[
        0
    ...
    assert inst.period.end == fhirtypes.DateTime.validate("2012-03-17T11:15:33+10:00")
    assert inst.period.start == fhirtypes.DateTime.validate("2011-03-17T11:15:33+10:00")
...
def impl_coverage_4(inst):
    ...
    assert inst.payor[0].reference == "Organization/2"
    assert inst.period.end == fhirtypes.DateTime.validate("2012-05-23T11:15:33+10:00")
    assert inst.period.start == fhirtypes.DateTime.validate("2011-05-23T11:15:33+10:00")
    assert (
