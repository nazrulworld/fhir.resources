...
def impl_encounter_6(inst):
    ...
    assert inst.period.end == fhirtypes.DateTime.validate("2013-03-20T09:23:00+10:00")
    assert inst.period.start == fhirtypes.DateTime.validate("2013-03-11T09:23:00+10:00")
