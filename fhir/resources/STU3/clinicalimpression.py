...
class ClinicalImpression(domainresource.DomainResource):
    ...
    action: typing.List[fhirtypes.ReferenceType] = Field(  # type: ignore
        None,
        alias="action",
    ...
    assessor: fhirtypes.ReferenceType = Field(  # type: ignore
        None,
        alias="assessor",
    ...
    investigation: typing.List[fhirtypes.ClinicalImpressionInvestigationType] = Field(  # type: ignore
        None,
        alias="investigation",
...
class ClinicalImpressionInvestigation(backboneelement.BackboneElement):
    ...
    item: typing.List[fhirtypes.ReferenceType] = Field(  # type: ignore
        None,
        alias="item",
