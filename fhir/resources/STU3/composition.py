...
class Composition(domainresource.DomainResource):
    ...
    confidentiality: fhirtypes.CodeType = Field(  # type: ignore
        None,
    ...
    confidentiality__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(  # type: ignore
    ...
    relatesTo: typing.List[fhirtypes.CompositionRelatesToType] = Field(  # type: ignore
        None,
        alias="relatesTo",
...
class CompositionAttester(backboneelement.BackboneElement):
    ...
    mode: typing.List[typing.Optional[fhirtypes.CodeType]] = Field(  # type: ignore
        None,
        alias="mode",
    ...
    mode__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(  # type: ignore
