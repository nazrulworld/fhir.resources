...
class ActivityDefinitionTests(unittest.TestCase):
    ...
    def implActivityDefinition4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.dosage[0].doseQuantity.unit), force_bytes("{tbl}"))
        ...
        self.assertEqual(force_bytes(inst.dynamicValue[0].description), force_bytes("dispenseRequest.numberOfRepeatsAllowed is three (3)"))
        self.assertEqual(force_bytes(inst.dynamicValue[0].expression), force_bytes("3"))
        self.assertEqual(force_bytes(inst.dynamicValue[0].language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.dynamicValue[0].path), force_bytes("dispenseRequest.numberOfRepeatsAllowed"))
        self.assertEqual(force_bytes(inst.dynamicValue[1].description), force_bytes("dispenseRequest.quantity is thirty (30) tablets"))
        self.assertEqual(force_bytes(inst.dynamicValue[1].expression), force_bytes("30 '{tbl}'"))
        self.assertEqual(force_bytes(inst.dynamicValue[1].language), force_bytes("text/cql"))
