...
class AuditEventTests(unittest.TestCase):
    ...
    def implAuditEvent1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.agent[0].userId.value), force_bytes("95"))
        ...
        self.assertEqual(
            force_bytes(inst.agent[1].role[0].coding[0].code), force_bytes("110153")
        )
        self.assertEqual(
            force_bytes(inst.agent[1].role[0].coding[0].display),
        ...
        self.assertEqual(
            force_bytes(inst.agent[1].userId.value),
            force_bytes("2.16.840.1.113883.4.2|2.16.840.1.113883.4.2"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            force_bytes("http://hl7.org/fhir/object-role"),
        )
        ...
        self.assertEqual(
            ...
            force_bytes("http://hl7.org/fhir/object-type"),
        )
        ...
        self.assertEqual(
            force_bytes(inst.source.identifier.value),
            force_bytes("hl7connect.healthintersections.com.au"),
        )
        ...
        self.assertEqual(
            ...
            force_bytes("http://hl7.org/fhir/security-source-type"),
        )
        ...
        self.assertEqual(
            ...
            force_bytes("http://hl7.org/fhir/audit-event-type"),
        )
    ...
    def implAuditEvent4(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.agent[0].role[0].coding[0].code), force_bytes("110153")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.agent[0].userId.value), force_bytes("ExportToMedia.app")
        )
        ...
        self.assertEqual(force_bytes(inst.agent[1].userId.value), force_bytes("95"))
        ...
        self.assertEqual(
            force_bytes(inst.entity[0].identifier.value),
            force_bytes("e3cdfc81a0d24bd^^^&2.16.840.1.113883.4.2&ISO"),
        )
        ...
        self.assertEqual(
            force_bytes(inst.entity[1].identifier.type.coding[0].code),
            force_bytes("IHE XDS Metadata"),
        )
        self.assertEqual(
            force_bytes(inst.entity[1].identifier.type.coding[0].display),
            force_bytes("submission set classificationNode"),
        )
        self.assertEqual(
            force_bytes(inst.entity[1].identifier.type.coding[0].system),
            force_bytes("urn:uuid:a54d6aa5-d40d-43f9-88c5-b4633d873bdd"),
        )
        self.assertEqual(
            force_bytes(inst.entity[1].identifier.value),
            force_bytes("e3cdfc81a0d24bd^^^&2.16.840.1.113883.4.2&ISO"),
        )
    ...
    def implAuditEvent6(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.agent[0].userId.value),
            force_bytes("2.16.840.1.113883.4.2|2.16.840.1.113883.4.2"),
        )
        self.assertEqual(force_bytes(inst.agent[1].altId), force_bytes("601847123"))
        self.assertEqual(force_bytes(inst.agent[1].name), force_bytes("Grahame Grieve"))
        ...
        self.assertEqual(
            force_bytes(inst.entity[1].detail[0].value),
    ...
    def implAuditEvent7(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.agent[0].userId.value), force_bytes("Grahame")
        )
        self.assertEqual(force_bytes(inst.agent[1].altId), force_bytes("6580"))
        self.assertEqual(
            force_bytes(inst.agent[1].network.address),
        ...
        self.assertEqual(
            force_bytes(inst.entity[0].identifier.type.coding[0].code),
            force_bytes("SNO"),
        )
        self.assertEqual(
            force_bytes(inst.entity[0].identifier.type.coding[0].system),
            force_bytes("http://hl7.org/fhir/identifier-type"),
        )
        self.assertEqual(
            force_bytes(inst.entity[0].identifier.type.text),
            force_bytes("Dell Serial Number"),
        )
        self.assertEqual(
            force_bytes(inst.entity[0].identifier.value), force_bytes("ABCDEF")
        )
        self.assertEqual(force_bytes(inst.entity[0].lifecycle.code), force_bytes("6"))
        self.assertEqual(
            force_bytes(inst.entity[0].lifecycle.display), force_bytes("Access / Use")
        ...
        self.assertEqual(
            force_bytes(inst.source.identifier.value), force_bytes("Grahame's Laptop")
        )
    ...
    def implAuditEvent8(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.agent[0].userId.value),
            force_bytes("SomeIdiot@nowhere.com"),
        )
        self.assertEqual(
        ...
        self.assertFalse(inst.agent[1].requestor)
        self.assertEqual(
            force_bytes(inst.agent[1].role[0].coding[0].code), force_bytes("110152")
        )
        self.assertEqual(
            force_bytes(inst.agent[1].role[0].coding[0].display),
        ...
        self.assertEqual(force_bytes(inst.agent[1].userId.value), force_bytes("Where"))
        self.assertEqual(force_bytes(inst.entity[0].role.code), force_bytes("1"))
        self.assertEqual(
            force_bytes(inst.entity[0].role.display), force_bytes("Patient")
        )
        ...
        self.assertEqual(
            force_bytes(inst.entity[1].identifier.value), force_bytes("What.id")
        )
        ...
        self.assertEqual(
            force_bytes(inst.source.identifier.value),
            force_bytes("Watchers Accounting of Disclosures Application"),
        )
