...
class CarePlanTests(unittest.TestCase):
    ...
    def implCarePlan4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.activity[0].detail.category.coding[0].system), force_bytes("http://hl7.org/fhir/care-plan-activity-category"))
        self.assertEqual(force_bytes(inst.activity[0].detail.code.coding[0].code), force_bytes("3141-9"))
        self.assertEqual(force_bytes(inst.activity[0].detail.code.coding[0].display), force_bytes("Weight Measured"))
        self.assertEqual(force_bytes(inst.activity[0].detail.code.coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.activity[0].detail.code.coding[1].code), force_bytes("27113001"))
        self.assertEqual(force_bytes(inst.activity[0].detail.code.coding[1].display), force_bytes("Body weight"))
        self.assertEqual(force_bytes(inst.activity[0].detail.code.coding[1].system), force_bytes("http://snomed.info/sct"))
        self.assertFalse(inst.activity[0].detail.prohibited)
        ...
        self.assertEqual(force_bytes(inst.activity[0].detail.scheduledTiming.repeat.periodUnit), force_bytes("d"))
        self.assertEqual(force_bytes(inst.activity[0].detail.status), force_bytes("completed"))
        self.assertEqual(force_bytes(inst.activity[0].detail.statusReason), force_bytes("Achieved weight loss to mitigate diabetes risk."))
        self.assertEqual(force_bytes(inst.activity[0].outcomeCodeableConcept[0].coding[0].code), force_bytes("161832001"))
        self.assertEqual(force_bytes(inst.activity[0].outcomeCodeableConcept[0].coding[0].display), force_bytes("Progressive weight loss"))
        self.assertEqual(force_bytes(inst.activity[0].outcomeCodeableConcept[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.category[0].text), force_bytes("Weight management plan"))
        self.assertEqual(force_bytes(inst.contained[0].id), force_bytes("p1"))
        self.assertEqual(force_bytes(inst.description), force_bytes("Manage obesity and weight loss"))
