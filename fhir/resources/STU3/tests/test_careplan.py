...
class CarePlanTests(unittest.TestCase):
    ...
    def implCarePlan1(self, inst):
        self.assertEqual(
            force_bytes(inst.activity[0].detail.category.coding[0].code),
            force_bytes("procedure"),
        )
        self.assertEqual(
            force_bytes(inst.activity[0].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
    ...
    def implCarePlan4(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.activity[0].detail.statusReason),
    ...
    def implCarePlan5(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.activity[1].detail.category.coding[0].code),
            force_bytes("observation"),
        )
        self.assertEqual(
            force_bytes(inst.activity[1].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
    ...
    def implCarePlan7(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.activity[2].detail.category.coding[0].code),
            force_bytes("other"),
        )
        self.assertEqual(
            force_bytes(inst.activity[2].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.activity[3].detail.category.coding[0].code),
            force_bytes("other"),
        )
        self.assertEqual(
            force_bytes(inst.activity[3].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.activity[4].detail.category.coding[0].code),
            force_bytes("other"),
        )
        self.assertEqual(
            force_bytes(inst.activity[4].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.activity[5].detail.category.coding[0].code),
            force_bytes("other"),
        )
        self.assertEqual(
            force_bytes(inst.activity[5].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.activity[6].detail.category.coding[0].code),
            force_bytes("other"),
        )
        self.assertEqual(
            force_bytes(inst.activity[6].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.activity[7].detail.category.coding[0].code),
            force_bytes("other"),
        )
        self.assertEqual(
            force_bytes(inst.activity[7].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.activity[8].detail.category.coding[0].code),
            force_bytes("other"),
        )
        self.assertEqual(
            force_bytes(inst.activity[8].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.activity[9].detail.category.coding[0].code),
            force_bytes("other"),
        )
        self.assertEqual(
            force_bytes(inst.activity[9].detail.category.coding[0].system),
            force_bytes("http://hl7.org/fhir/care-plan-activity-category"),
        )
        self.assertEqual(
