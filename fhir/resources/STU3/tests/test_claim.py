...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim2(self, inst):
        ...
        self.assertEqual(inst.item[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].code), force_bytes("smokecess"))
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-pharmaservice"))
        self.assertEqual(inst.item[0].servicedDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].servicedDate.as_json(), "2014-08-16")
        self.assertEqual(force_bytes(inst.item[0].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
    ...
    def implClaim4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.information[0].category.coding[0].code), force_bytes("prosthesis"))
        ...
        self.assertEqual(force_bytes(inst.information[0].code.coding[0].code), force_bytes("2"))
        self.assertEqual(force_bytes(inst.information[0].code.coding[0].display), force_bytes("Maryland Bridge"))
        self.assertEqual(force_bytes(inst.information[0].code.coding[0].system), force_bytes("http://hl7.org/fhir/ex-oralprostho"))
        ...
        self.assertEqual(force_bytes(inst.item[0].locationCodeableConcept.coding[0].system), force_bytes("http://hl7.org/fhir/ex-serviceplace"))
        self.assertEqual(force_bytes(inst.item[0].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].net.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[0].net.value, 1050.0)
        self.assertEqual(inst.item[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].code), force_bytes("67221"))
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].display), force_bytes("Maryland Bridge"))
        ...
        self.assertEqual(force_bytes(inst.item[1].locationCodeableConcept.coding[0].system), force_bytes("http://hl7.org/fhir/ex-serviceplace"))
        ...
        self.assertEqual(force_bytes(inst.item[2].locationCodeableConcept.coding[0].system), force_bytes("http://hl7.org/fhir/ex-serviceplace"))
        ...
        self.assertEqual(force_bytes(inst.related[0].relationship.coding[0].system), force_bytes("http://hl7.org/fhir/ex-relatedclaimrelationship"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
