...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.accident.type.coding[0].system), force_bytes("http://hl7.org/fhir/v3/ActIncidentCode"))
        ...
        self.assertEqual(force_bytes(inst.careTeam[0].qualification.coding[0].system), force_bytes("http://hl7.org/fhir/provider-qualification"))
        ...
        self.assertEqual(force_bytes(inst.careTeam[0].role.coding[0].system), force_bytes("http://hl7.org/fhir/claim-careteamrole"))
        ...
        self.assertEqual(force_bytes(inst.diagnosis[0].packageCode.coding[0].system), force_bytes("http://hl7.org/fhir/ex-diagnosisrelatedgroup"))
        ...
        self.assertEqual(force_bytes(inst.diagnosis[0].type[0].coding[0].system), force_bytes("http://hl7.org/fhir/ex-diagnosistype"))
        ...
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].code), force_bytes("exam"))
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-serviceproduct"))
    ...
    def implClaim4(self, inst):
        ...
        self.assertEqual(inst.item[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].code), force_bytes("exam"))
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-visionservice"))
        self.assertEqual(inst.item[0].servicedDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].servicedDate.as_json(), "2014-08-16")
        self.assertEqual(force_bytes(inst.item[0].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.priority.coding[0].code), force_bytes("normal"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.div), force_bytes("<div xmlns=\"http://www.w3.org/1999/xhtml\">A human-readable rendering of the Vision Claim</div>"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
    ...
    def implClaim5(self, inst):
        self.assertEqual(inst.careTeam[0].sequence, 1)
        self.assertEqual(force_bytes(inst.contained[0].id), force_bytes("claimresponse-1"))
        ...
        self.assertEqual(force_bytes(inst.item[0].category.coding[0].system), force_bytes("http://hl7.org/fhir/benefit-subcategory"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[0].category.coding[0].system), force_bytes("http://hl7.org/fhir/benefit-subcategory"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[0].modifier[0].coding[0].system), force_bytes("http://hl7.org/fhir/modifiers"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].net.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[0].revenue.coding[0].system), force_bytes("http://hl7.org/fhir/ex-revenue-center"))
        self.assertEqual(inst.item[0].detail[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].detail[0].service.coding[0].code), force_bytes("frame"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-visionservice"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].category.coding[0].system), force_bytes("http://hl7.org/fhir/benefit-subcategory"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].net.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].programCode[0].coding[0].system), force_bytes("http://hl7.org/fhir/ex-programcode"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].revenue.coding[0].system), force_bytes("http://hl7.org/fhir/ex-revenue-center"))
        self.assertEqual(inst.item[0].detail[1].sequence, 2)
        self.assertEqual(force_bytes(inst.item[0].detail[1].service.coding[0].code), force_bytes("lens"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-visionservice"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].category.coding[0].system), force_bytes("http://hl7.org/fhir/benefit-subcategory"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].modifier[0].coding[0].system), force_bytes("http://hl7.org/fhir/modifiers"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].net.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].programCode[0].coding[0].system), force_bytes("http://hl7.org/fhir/ex-programcode"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].revenue.coding[0].system), force_bytes("http://hl7.org/fhir/ex-revenue-center"))
        self.assertEqual(inst.item[0].detail[1].subDetail[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].service.coding[0].code), force_bytes("lens"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-visionservice"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[0].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].category.coding[0].system), force_bytes("http://hl7.org/fhir/benefit-subcategory"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].modifier[0].coding[0].system), force_bytes("http://hl7.org/fhir/modifiers"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].net.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].revenue.coding[0].system), force_bytes("http://hl7.org/fhir/ex-revenue-center"))
        self.assertEqual(inst.item[0].detail[1].subDetail[1].sequence, 2)
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].service.coding[0].code), force_bytes("hardening"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-visionservice"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[1].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].category.coding[0].system), force_bytes("http://hl7.org/fhir/benefit-subcategory"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].modifier[0].coding[0].system), force_bytes("http://hl7.org/fhir/modifiers"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].net.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].revenue.coding[0].system), force_bytes("http://hl7.org/fhir/ex-revenue-center"))
        self.assertEqual(inst.item[0].detail[1].subDetail[2].sequence, 3)
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].service.coding[0].code), force_bytes("UV coating"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-visionservice"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].subDetail[2].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[0].detail[1].subDetail[2].unitPrice.value, 5.0)
        self.assertEqual(force_bytes(inst.item[0].detail[1].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[2].category.coding[0].system), force_bytes("http://hl7.org/fhir/benefit-subcategory"))
        self.assertEqual(inst.item[0].detail[2].factor, 0.07)
        self.assertEqual(force_bytes(inst.item[0].detail[2].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].net.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[2].revenue.coding[0].system), force_bytes("http://hl7.org/fhir/ex-revenue-center"))
        self.assertEqual(inst.item[0].detail[2].sequence, 3)
        self.assertEqual(force_bytes(inst.item[0].detail[2].service.coding[0].code), force_bytes("fst"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-visionservice"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].modifier[0].coding[0].system), force_bytes("http://hl7.org/fhir/modifiers"))
        self.assertEqual(force_bytes(inst.item[0].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].net.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].programCode[0].coding[0].system), force_bytes("http://hl7.org/fhir/ex-programcode"))
        ...
        self.assertEqual(force_bytes(inst.item[0].revenue.coding[0].system), force_bytes("http://hl7.org/fhir/ex-revenue-center"))
        self.assertEqual(inst.item[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].code), force_bytes("glasses"))
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-visionservice"))
        self.assertEqual(inst.item[0].servicedDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].servicedDate.as_json(), "2014-08-16")
        self.assertEqual(force_bytes(inst.item[0].unitPrice.code), force_bytes("USD"))
    ...
    def implClaim6(self, inst):
        ...
        self.assertEqual(force_bytes(inst.priority.coding[0].code), force_bytes("normal"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.subType[0].coding[0].code), force_bytes("emergency"))
        self.assertEqual(force_bytes(inst.subType[0].coding[0].system), force_bytes("http://hl7.org/fhir/ex-claimsubtype"))
        self.assertEqual(force_bytes(inst.text.div), force_bytes("<div xmlns=\"http://www.w3.org/1999/xhtml\">A human-readable rendering of the Claim</div>"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.total.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.total.system), force_bytes("urn:iso:std:iso:4217"))
    ...
    def implClaim8(self, inst):
        ...
        self.assertEqual(force_bytes(inst.information[0].category.coding[0].code), force_bytes("pharmacyrefill"))
        self.assertEqual(force_bytes(inst.information[0].code.coding[0].code), force_bytes("new"))
        self.assertEqual(force_bytes(inst.information[0].code.coding[0].system), force_bytes("http://hl7.org/fhir/pharmacy-refill"))
        self.assertEqual(inst.information[0].sequence, 1)
        self.assertEqual(force_bytes(inst.information[1].category.coding[0].code), force_bytes("pharmacyinformation"))
        self.assertEqual(force_bytes(inst.information[1].code.coding[0].code), force_bytes("refillsremaining"))
        self.assertEqual(force_bytes(inst.information[1].code.coding[0].system), force_bytes("http://hl7.org/fhir/pharmacy-information"))
        self.assertEqual(inst.information[1].sequence, 2)
        self.assertEqual(inst.information[1].valueQuantity.value, 2)
        self.assertEqual(force_bytes(inst.information[2].category.coding[0].code), force_bytes("pharmacyinformation"))
        self.assertEqual(force_bytes(inst.information[2].code.coding[0].code), force_bytes("dayssupply"))
        self.assertEqual(force_bytes(inst.information[2].code.coding[0].system), force_bytes("http://hl7.org/fhir/pharmacy-information"))
        ...
        self.assertEqual(inst.item[0].detail[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].detail[0].service.coding[0].code), force_bytes("drugcost"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-pharmaservice"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].net.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[0].detail[1].net.value, 9.0)
        self.assertEqual(inst.item[0].detail[1].sequence, 2)
        self.assertEqual(force_bytes(inst.item[0].detail[1].service.coding[0].code), force_bytes("markup"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-pharmaservice"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].net.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[0].detail[2].net.value, 36.0)
        self.assertEqual(inst.item[0].detail[2].sequence, 3)
        self.assertEqual(force_bytes(inst.item[0].detail[2].service.coding[0].code), force_bytes("dispensefee"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].service.coding[0].system), force_bytes("http://hl7.org/fhir/ex-pharmaservice"))
        ...
        self.assertEqual(inst.item[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].code), force_bytes("562721"))
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].display), force_bytes("Alprazolam 0.25mg (Xanax)"))
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].system), force_bytes("http://hl7.org/fhir/RxNorm"))
        self.assertEqual(inst.item[0].servicedDate.date, FHIRDate("2014-08-16").date)
        self.assertEqual(inst.item[0].servicedDate.as_json(), "2014-08-16")
        self.assertEqual(force_bytes(inst.payee.type.coding[0].code), force_bytes("provider"))
    ...
    def implClaim9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.diagnosis[0].diagnosisCodeableConcept.coding[0].code), force_bytes("123457"))
        self.assertEqual(force_bytes(inst.diagnosis[0].diagnosisCodeableConcept.coding[0].system), force_bytes("http://hl7.org/fhir/sid/icd-10"))
        self.assertEqual(inst.diagnosis[0].sequence, 1)
        self.assertEqual(force_bytes(inst.fundsReserve.coding[0].code), force_bytes("provider"))
        ...
        self.assertEqual(inst.item[0].detail[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].detail[0].service.coding[0].code), force_bytes("ORTHOEXAM"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(inst.item[0].detail[1].sequence, 2)
        self.assertEqual(force_bytes(inst.item[0].detail[1].service.coding[0].code), force_bytes("ORTHODIAG"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(inst.item[0].detail[2].sequence, 3)
        self.assertEqual(force_bytes(inst.item[0].detail[2].service.coding[0].code), force_bytes("ORTHOINITIAL"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[3].service.coding[0].code), force_bytes("ORTHOMONTHS"))
        self.assertEqual(force_bytes(inst.item[0].detail[3].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(force_bytes(inst.item[0].detail[4].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[4].net.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[4].service.coding[0].code), force_bytes("ORTHOPERIODIC"))
        self.assertEqual(force_bytes(inst.item[0].detail[4].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(force_bytes(inst.item[0].detail[4].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[0].detail[4].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(inst.item[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].code), force_bytes("ORTHPLAN"))
        self.assertEqual(force_bytes(inst.item[0].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        ...
        self.assertEqual(force_bytes(inst.item[1].net.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[1].net.value, 105.0)
        self.assertEqual(inst.item[1].sequence, 2)
        self.assertEqual(force_bytes(inst.item[1].service.coding[0].code), force_bytes("21211"))
        self.assertEqual(force_bytes(inst.item[1].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        ...
        self.assertEqual(force_bytes(inst.item[1].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[2].detail[0].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[2].detail[0].net.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[2].detail[0].net.value, 750.0)
        self.assertEqual(inst.item[2].detail[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[2].detail[0].service.coding[0].code), force_bytes("27211"))
        self.assertEqual(force_bytes(inst.item[2].detail[0].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(force_bytes(inst.item[2].detail[0].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[2].detail[0].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[2].detail[0].unitPrice.value, 750.0)
        self.assertEqual(force_bytes(inst.item[2].detail[1].net.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[2].detail[1].net.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[2].detail[1].net.value, 350.0)
        self.assertEqual(inst.item[2].detail[1].sequence, 2)
        self.assertEqual(force_bytes(inst.item[2].detail[1].service.coding[0].code), force_bytes("lab"))
        self.assertEqual(force_bytes(inst.item[2].detail[1].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(force_bytes(inst.item[2].detail[1].unitPrice.code), force_bytes("USD"))
        self.assertEqual(force_bytes(inst.item[2].detail[1].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
        ...
        self.assertEqual(force_bytes(inst.item[2].net.system), force_bytes("urn:iso:std:iso:4217"))
        self.assertEqual(inst.item[2].net.value, 1100.0)
        self.assertEqual(inst.item[2].sequence, 3)
        self.assertEqual(force_bytes(inst.item[2].service.coding[0].code), force_bytes("27211"))
        self.assertEqual(force_bytes(inst.item[2].service.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        ...
        self.assertEqual(force_bytes(inst.item[2].unitPrice.system), force_bytes("urn:iso:std:iso:4217"))
    ...
    def implClaim10(self, inst):
        ...
        self.assertEqual(force_bytes(inst.information[0].category.coding[0].code), force_bytes("missingtooth"))
        self.assertEqual(force_bytes(inst.information[0].category.coding[0].system), force_bytes("http://hl7.org/fhir/claiminformationcategory"))
        self.assertEqual(force_bytes(inst.information[0].code.coding[0].code), force_bytes("15"))
        self.assertEqual(force_bytes(inst.information[0].code.coding[0].system), force_bytes("http://hl7.org/fhir/ex-tooth"))
        self.assertEqual(force_bytes(inst.information[0].reason.coding[0].code), force_bytes("e"))
        self.assertEqual(force_bytes(inst.information[0].reason.coding[0].system), force_bytes("http://hl7.org/fhir/missingtoothreason"))
        self.assertEqual(inst.information[0].sequence, 1)
        ...
        self.assertEqual(force_bytes(inst.information[1].category.coding[0].code), force_bytes("exception"))
        self.assertEqual(force_bytes(inst.information[1].category.coding[0].system), force_bytes("http://hl7.org/fhir/claiminformationcategory"))
        self.assertEqual(force_bytes(inst.information[1].code.coding[0].code), force_bytes("student"))
        self.assertEqual(force_bytes(inst.information[1].code.coding[0].system), force_bytes("http://hl7.org/fhir/claim-exception"))
        self.assertEqual(inst.information[1].sequence, 2)
        self.assertEqual(force_bytes(inst.information[1].valueString), force_bytes("Happy Valley Community College"))
        self.assertTrue(inst.insurance[0].focal)
        self.assertEqual(inst.insurance[0].sequence, 1)
        self.assertEqual(inst.item[0].careTeamLinkId[0], 1)
        self.assertEqual(force_bytes(inst.item[0].net.code), force_bytes("USD"))
