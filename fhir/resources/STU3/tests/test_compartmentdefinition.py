...
class CompartmentDefinitionTests(unittest.TestCase):
    ...
    def implCompartmentDefinition2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.name), force_bytes("Base FHIR compartment definition for RelatedPerson"))
        ...
        self.assertEqual(force_bytes(inst.resource[1].code), force_bytes("ActivityDefinition"))
        self.assertEqual(force_bytes(inst.resource[2].code), force_bytes("AdverseEvent"))
        self.assertEqual(force_bytes(inst.resource[2].param[0]), force_bytes("recorder"))
        self.assertEqual(force_bytes(inst.resource[3].code), force_bytes("AllergyIntolerance"))
        self.assertEqual(force_bytes(inst.resource[3].param[0]), force_bytes("asserter"))
        ...
        self.assertEqual(force_bytes(inst.resource[5].code), force_bytes("AppointmentResponse"))
        ...
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/CompartmentDefinition/relatedPerson"))
    ...
    def implCompartmentDefinition3(self, inst):
        ...
        self.assertEqual(force_bytes(inst.name), force_bytes("Base FHIR compartment definition for Patient"))
        self.assertEqual(force_bytes(inst.publisher), force_bytes("FHIR Project Team"))
        self.assertEqual(force_bytes(inst.resource[0].code), force_bytes("Account"))
        ...
        self.assertEqual(force_bytes(inst.resource[3].param[1]), force_bytes("recorder"))
        self.assertEqual(force_bytes(inst.resource[3].param[2]), force_bytes("asserter"))
        self.assertEqual(force_bytes(inst.resource[4].code), force_bytes("Appointment"))
        self.assertEqual(force_bytes(inst.resource[4].param[0]), force_bytes("actor"))
        self.assertEqual(force_bytes(inst.resource[5].code), force_bytes("AppointmentResponse"))
        self.assertEqual(force_bytes(inst.resource[5].param[0]), force_bytes("actor"))
        ...
        self.assertEqual(force_bytes(inst.resource[6].param[1]), force_bytes("agent.patient"))
        self.assertEqual(force_bytes(inst.resource[6].param[2]), force_bytes("entity.patient"))
        self.assertEqual(force_bytes(inst.resource[7].code), force_bytes("Basic"))
        ...
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/CompartmentDefinition/patient"))
    ...
    def implCompartmentDefinition4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.name), force_bytes("Base FHIR compartment definition for Practitioner"))
        self.assertEqual(force_bytes(inst.publisher), force_bytes("FHIR Project Team"))
        self.assertEqual(force_bytes(inst.resource[0].code), force_bytes("Account"))
        self.assertEqual(force_bytes(inst.resource[0].param[0]), force_bytes("subject"))
        self.assertEqual(force_bytes(inst.resource[1].code), force_bytes("ActivityDefinition"))
        ...
        self.assertEqual(force_bytes(inst.resource[2].param[0]), force_bytes("recorder"))
        self.assertEqual(force_bytes(inst.resource[3].code), force_bytes("AllergyIntolerance"))
        self.assertEqual(force_bytes(inst.resource[3].param[0]), force_bytes("recorder"))
        self.assertEqual(force_bytes(inst.resource[3].param[1]), force_bytes("asserter"))
        self.assertEqual(force_bytes(inst.resource[4].code), force_bytes("Appointment"))
        self.assertEqual(force_bytes(inst.resource[4].param[0]), force_bytes("actor"))
        self.assertEqual(force_bytes(inst.resource[5].code), force_bytes("AppointmentResponse"))
        self.assertEqual(force_bytes(inst.resource[5].param[0]), force_bytes("actor"))
        ...
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/CompartmentDefinition/practitioner"))
    ...
    def implCompartmentDefinition5(self, inst):
        ...
        self.assertEqual(force_bytes(inst.name), force_bytes("Base FHIR compartment definition for Encounter"))
        self.assertEqual(force_bytes(inst.publisher), force_bytes("FHIR Project Team"))
        self.assertEqual(force_bytes(inst.resource[0].code), force_bytes("Account"))
        self.assertEqual(force_bytes(inst.resource[1].code), force_bytes("ActivityDefinition"))
        self.assertEqual(force_bytes(inst.resource[2].code), force_bytes("AdverseEvent"))
        ...
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/CompartmentDefinition/encounter"))
    ...
    def implCompartmentDefinition6(self, inst):
        ...
        self.assertEqual(inst.date.date, FHIRDate("2017-04-19T07:44:43+10:00").date)
        self.assertEqual(inst.date.as_json(), "2017-04-19T07:44:43+10:00")
        self.assertEqual(force_bytes(inst.description), force_bytes("There is an instance of the practitioner compartment for each Device resource, and the identity of the compartment is the same as the Device. The set of resources associated with a particular device"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("device"))
        self.assertEqual(force_bytes(inst.name), force_bytes("Base FHIR compartment definition for Device"))
        self.assertEqual(force_bytes(inst.publisher), force_bytes("FHIR Project Team"))
        self.assertEqual(force_bytes(inst.resource[0].code), force_bytes("Account"))
        self.assertEqual(force_bytes(inst.resource[0].param[0]), force_bytes("subject"))
        self.assertEqual(force_bytes(inst.resource[1].code), force_bytes("ActivityDefinition"))
        ...
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/CompartmentDefinition/device"))
