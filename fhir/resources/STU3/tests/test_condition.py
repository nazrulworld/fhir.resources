...
class ConditionTests(unittest.TestCase):
    ...
    def implCondition2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.category[0].coding[1].system), force_bytes("http://hl7.org/fhir/condition-category"))
        self.assertEqual(force_bytes(inst.clinicalStatus), force_bytes("active"))
    ...
    def implCondition3(self, inst):
        ...
        self.assertEqual(force_bytes(inst.category[0].coding[0].system), force_bytes("http://hl7.org/fhir/condition-category"))
        self.assertEqual(force_bytes(inst.clinicalStatus), force_bytes("active"))
    ...
    def implCondition5(self, inst):
        ...
        self.assertEqual(force_bytes(inst.bodySite[0].coding[0].code), force_bytes("51185008"))
        self.assertEqual(force_bytes(inst.bodySite[0].coding[0].display), force_bytes("Thorax"))
        self.assertEqual(force_bytes(inst.bodySite[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.category[0].coding[0].code), force_bytes("439401001"))
        self.assertEqual(force_bytes(inst.category[0].coding[0].display), force_bytes("diagnosis"))
        self.assertEqual(force_bytes(inst.category[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.clinicalStatus), force_bytes("active"))
        self.assertEqual(force_bytes(inst.code.coding[0].code), force_bytes("254637007"))
        self.assertEqual(force_bytes(inst.code.coding[0].display), force_bytes("NSCLC - Non-small cell lung cancer"))
        self.assertEqual(force_bytes(inst.code.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.evidence[0].code[0].coding[0].code), force_bytes("169069000"))
        self.assertEqual(force_bytes(inst.evidence[0].code[0].coding[0].display), force_bytes("CT of thorax"))
        self.assertEqual(force_bytes(inst.evidence[0].code[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        ...
        self.assertEqual(force_bytes(inst.severity.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.stage.summary.coding[0].code), force_bytes("258219007"))
        self.assertEqual(force_bytes(inst.stage.summary.coding[0].display), force_bytes("stage II"))
        self.assertEqual(force_bytes(inst.stage.summary.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.verificationStatus), force_bytes("confirmed"))
    ...
    def implCondition6(self, inst):
        ...
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.verificationStatus), force_bytes("differential"))
    ...
    def implCondition7(self, inst):
        ...
        self.assertEqual(force_bytes(inst.severity.coding[0].display), force_bytes("Severe"))
        self.assertEqual(force_bytes(inst.severity.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.stage.summary.coding[0].code), force_bytes("14803004"))
        self.assertEqual(force_bytes(inst.stage.summary.coding[0].display), force_bytes("Temporary"))
        self.assertEqual(force_bytes(inst.stage.summary.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.verificationStatus), force_bytes("differential"))
    ...
    def implCondition9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.meta.security[0].system), force_bytes("http://hl7.org/fhir/v3/ActCode"))
