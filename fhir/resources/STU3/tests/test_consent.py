...
class ConsentTests(unittest.TestCase):
    ...
    def implConsent5(self, inst):
        self.assertEqual(force_bytes(inst.actor[0].role.coding[0].code), force_bytes("PRCP"))
        self.assertEqual(force_bytes(inst.actor[0].role.coding[0].system), force_bytes("http://hl7.org/fhir/v3/ParticipationType"))
        self.assertEqual(force_bytes(inst.category[0].coding[0].code), force_bytes("HIPAA-Auth"))
        self.assertEqual(force_bytes(inst.category[0].coding[0].system), force_bytes("http://hl7.org/fhir/consentcategorycodes"))
        ...
        self.assertEqual(force_bytes(inst.except_fhir[0].actor[0].role.coding[0].code), force_bytes("AUT"))
        self.assertEqual(force_bytes(inst.except_fhir[0].actor[0].role.coding[0].system), force_bytes("http://hl7.org/fhir/v3/ParticipationType"))
        self.assertEqual(force_bytes(inst.except_fhir[0].class_fhir[0].code), force_bytes("application/hl7-cda+xml"))
        self.assertEqual(force_bytes(inst.except_fhir[0].class_fhir[0].system), force_bytes("urn:ietf:bcp:13"))
        self.assertEqual(force_bytes(inst.except_fhir[0].code[0].code), force_bytes("34133-9"))
        self.assertEqual(force_bytes(inst.except_fhir[0].code[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.except_fhir[0].code[1].code), force_bytes("18842-5"))
        self.assertEqual(force_bytes(inst.except_fhir[0].code[1].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.except_fhir[0].type), force_bytes("permit"))
        self.assertEqual(force_bytes(inst.id), force_bytes("consent-example-signature"))
        self.assertEqual(force_bytes(inst.identifier.system), force_bytes("urn:oid:2.16.840.1.113883.3.72.5.9.1"))
        self.assertEqual(force_bytes(inst.identifier.value), force_bytes("494e0c7a-a69e-4fb4-9d02-6aae747790d7"))
