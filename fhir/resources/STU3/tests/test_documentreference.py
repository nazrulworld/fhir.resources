...
def impl_documentreference_1(inst):
    ...
    assert (
        inst.class_fhir.coding[0].system == "http://ihe.net/xds/connectathon/classCodes"
    )
    ...
    assert inst.created == fhirtypes.DateTime.validate("2005-12-24T09:35:00+11:00")
    ...
    assert inst.indexed == fhirtypes.Instant.validate("2005-12-24T09:43:41+11:00")
