...
class EncounterTests(unittest.TestCase):
    ...
    def implEncounter1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.class_fhir.system), force_bytes("http://hl7.org/fhir/v3/ActCode"))
        ...
        self.assertEqual(force_bytes(inst.reason[0].coding[0].code), force_bytes("T-D8200"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].display), force_bytes("Arm"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].system), force_bytes("http://ihe.net/xds/connectathon/eventCodes"))
    ...
    def implEncounter2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.reason[0].coding[0].code), force_bytes("18099001"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].display), force_bytes("Retropharyngeal abscess"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.reason[0].extension[0].url), force_bytes("http://hl7.org/fhir/StructureDefinition/encounter-primaryDiagnosis"))
    ...
    def implEncounter5(self, inst):
        ...
        self.assertEqual(force_bytes(inst.classHistory[0].class_fhir.system), force_bytes("http://hl7.org/fhir/v3/ActCode"))
        ...
        self.assertEqual(force_bytes(inst.classHistory[1].class_fhir.system), force_bytes("http://hl7.org/fhir/v3/ActCode"))
        ...
        self.assertEqual(force_bytes(inst.hospitalization.admitSource.coding[0].system), force_bytes("http://hl7.org/fhir/admit-source"))
    ...
    def implEncounter6(self, inst):
        ...
        self.assertEqual(force_bytes(inst.priority.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].code), force_bytes("34068001"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].display), force_bytes("Partial lobectomy of lung"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.status), force_bytes("finished"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.type[0].coding[0].code), force_bytes("270427003"))
    ...
    def implEncounter7(self, inst):
        ...
        self.assertEqual(force_bytes(inst.priority.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].code), force_bytes("34068001"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].display), force_bytes("Heart valve replacement"))
        self.assertEqual(force_bytes(inst.reason[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.status), force_bytes("finished"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.type[0].coding[0].code), force_bytes("270427003"))
    ...
    def implEncounter8(self, inst):
        ...
        self.assertEqual(force_bytes(inst.priority.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.reason[0].text), force_bytes("The patient had fever peaks over the last couple of days. He is worried about these peaks."))
        self.assertEqual(force_bytes(inst.status), force_bytes("finished"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
    ...
    def implEncounter9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.diagnosis[0].role.coding[0].code), force_bytes("AD"))
        self.assertEqual(force_bytes(inst.diagnosis[0].role.coding[0].display), force_bytes("Admission diagnosis"))
        ...
        self.assertEqual(force_bytes(inst.reason[0].text), force_bytes("The patient is treated for a tumor."))
        self.assertEqual(force_bytes(inst.status), force_bytes("finished"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
    ...
    def implEncounter10(self, inst):
        ...
        self.assertEqual(force_bytes(inst.diagnosis[0].role.coding[0].display), force_bytes("Admission diagnosis"))
        self.assertEqual(force_bytes(inst.diagnosis[0].role.coding[0].system), force_bytes("http://hl7.org/fhir/diagnosis-role"))
        self.assertEqual(force_bytes(inst.diagnosis[1].role.coding[0].code), force_bytes("DD"))
        self.assertEqual(force_bytes(inst.diagnosis[1].role.coding[0].display), force_bytes("Discharge diagnosis"))
        self.assertEqual(force_bytes(inst.diagnosis[1].role.coding[0].system), force_bytes("http://hl7.org/fhir/diagnosis-role"))
        ...
        self.assertEqual(force_bytes(inst.hospitalization.specialArrangement[0].coding[0].system), force_bytes("http://hl7.org/fhir/encounter-special-arrangements"))
        ...
        self.assertEqual(force_bytes(inst.hospitalization.specialCourtesy[0].coding[0].system), force_bytes("http://hl7.org/fhir/v3/EncounterSpecialCourtesy"))
        ...
        self.assertEqual(force_bytes(inst.participant[0].type[0].coding[0].system), force_bytes("http://hl7.org/fhir/v3/ParticipationType"))
        ...
        self.assertEqual(force_bytes(inst.priority.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.reason[0].text), force_bytes("The patient seems to suffer from bilateral pneumonia and renal insufficiency, most likely due to chemotherapy."))
        self.assertEqual(force_bytes(inst.status), force_bytes("finished"))
