...
class FlagTests(unittest.TestCase):
    ...
    def implFlag1(self, inst):
        self.assertEqual(
            force_bytes(inst.category.coding[0].code), force_bytes("admin")
        )
        self.assertEqual(
            force_bytes(inst.category.coding[0].display), force_bytes("Admin")
        )
        self.assertEqual(
    ...
    def implFlag2(self, inst):
        self.assertEqual(
            force_bytes(inst.category.coding[0].code), force_bytes("infection")
        )
        self.assertEqual(
