...
def impl_healthcareservice_1(inst):
    ...
    assert inst.category.coding[0].code == "8"
    assert inst.category.coding[0].display == "Counselling"
    ...
    assert inst.programName[0] == "PTSD outreach"
    ...
    assert (
        ...
        == "http://hl7.org/fhir/service-provision-conditions"
    )
