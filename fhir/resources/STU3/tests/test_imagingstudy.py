...
class ImagingStudyTests(unittest.TestCase):
    ...
    def implImagingStudy2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("XR Wrist 3+ Views"))
        ...
        self.assertEqual(force_bytes(inst.modalityList[0].system), force_bytes("http://dicom.nema.org/resources/ontology/DCM"))
        ...
        self.assertEqual(force_bytes(inst.reason.coding[0].display), force_bytes("Closed fracture of trapezoidal bone of wrist"))
        self.assertEqual(force_bytes(inst.reason.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.series[0].availability), force_bytes("ONLINE"))
        ...
        self.assertEqual(force_bytes(inst.series[0].instance[0].uid), force_bytes("urn:oid:2.16.124.113543.6003.1154777499.30246.19789.3503430045.1.1"))
        self.assertEqual(inst.series[0].instance[1].number, 2)
        self.assertEqual(force_bytes(inst.series[0].instance[1].sopClass), force_bytes("urn:oid:1.2.840.10008.5.1.4.1.1.2"))
        self.assertEqual(force_bytes(inst.series[0].instance[1].title), force_bytes("LL VIEW"))
        self.assertEqual(force_bytes(inst.series[0].instance[1].uid), force_bytes("urn:oid:2.16.124.113543.6003.1154777499.30246.19789.3503430045.1.2"))
        ...
        self.assertEqual(force_bytes(inst.series[0].uid), force_bytes("urn:oid:2.16.124.113543.6003.1154777499.30246.19789.3503430045.1"))
