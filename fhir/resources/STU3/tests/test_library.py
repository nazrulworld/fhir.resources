...
class LibraryTests(unittest.TestCase):
    ...
    def implLibrary5(self, inst):
        self.assertEqual(force_bytes(inst.content[0].contentType), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.content[0].url), force_bytes("http://cqlrepository.org/CMS9v4_CQM.cql"))
        self.assertEqual(force_bytes(inst.dataRequirement[0].codeFilter[0].path), force_bytes("code"))
        self.assertEqual(force_bytes(inst.dataRequirement[0].codeFilter[0].valueSetString), force_bytes("Single Live Birth"))
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Quality measure logic for measuring outcomes for exclusive breastmilk feeding of newborns"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("library-exclusive-breastfeeding-cqm-logic"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("Exclusive_Breastfeeding_CQM_Logic"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].type), force_bytes("depends-on"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("Exclusive Breastfeeding CQM Logic"))
    ...
    def implLibrary6(self, inst):
        ...
        self.assertEqual(force_bytes(inst.content[0].contentType), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.content[0].url), force_bytes("library-mmi-suiciderisk-orderset-logic-content.cql"))
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[0].codeFilter[0].path), force_bytes("code"))
        self.assertEqual(force_bytes(inst.dataRequirement[0].codeFilter[0].valueSetString), force_bytes("Suicide Risk Assessment"))
        self.assertEqual(force_bytes(inst.dataRequirement[0].type), force_bytes("RiskAssessment"))
        self.assertEqual(inst.date.date, FHIRDate("2015-07-22").date)
        self.assertEqual(inst.date.as_json(), "2015-07-22")
        self.assertEqual(force_bytes(inst.description), force_bytes("Logic for Suicide Risk Order Sets"))
        ...
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("suiciderisk-orderset-logic"))
        self.assertEqual(force_bytes(inst.identifier[0].system), force_bytes("http://motivemi.com/artifacts"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("mmi:suiciderisk-orderset-logic"))
        ...
        self.assertEqual(force_bytes(inst.name), force_bytes("SuicideRiskOrderSetLogic"))
        ...
        self.assertEqual(force_bytes(inst.parameter[2].name), force_bytes("Practitioner"))
        self.assertEqual(force_bytes(inst.parameter[2].type), force_bytes("Practitioner"))
        ...
        self.assertEqual(force_bytes(inst.relatedArtifact[2].type), force_bytes("depends-on"))
        self.assertEqual(force_bytes(inst.relatedArtifact[3].type), force_bytes("depends-on"))
        self.assertEqual(force_bytes(inst.relatedArtifact[4].type), force_bytes("depends-on"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("Suicide Risk Order Set Logic"))
        self.assertEqual(force_bytes(inst.topic[0].text), force_bytes("Suicide Risk Order Set Logic"))
        self.assertEqual(force_bytes(inst.type.coding[0].code), force_bytes("logic-library"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://motivemi.com/artifacts/Library/suiciderisk-orderset-logic"))
        ...
        self.assertEqual(force_bytes(inst.useContext[4].valueCodeableConcept.coding[0].code), force_bytes("309343006"))
        self.assertEqual(force_bytes(inst.useContext[4].valueCodeableConcept.coding[0].display), force_bytes("Physician"))
        self.assertEqual(force_bytes(inst.useContext[4].valueCodeableConcept.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.useContext[5].code.code), force_bytes("venue"))
        self.assertEqual(force_bytes(inst.useContext[5].code.system), force_bytes("http://hl7.org/fhir/usage-context-type"))
        self.assertEqual(force_bytes(inst.useContext[5].valueCodeableConcept.coding[0].code), force_bytes("440655000"))
        self.assertEqual(force_bytes(inst.useContext[5].valueCodeableConcept.coding[0].display), force_bytes("Outpatient environment"))
    ...
    def implLibrary9(self, inst):
        self.assertEqual(force_bytes(inst.content[0].contentType), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.content[0].url), force_bytes("http://cqlrepository.org/CMS9v4_CDS.cql"))
        self.assertEqual(force_bytes(inst.dataRequirement[0].codeFilter[0].path), force_bytes("code"))
        self.assertEqual(force_bytes(inst.dataRequirement[0].codeFilter[0].valueSetString), force_bytes("Single Live Birth"))
        self.assertEqual(force_bytes(inst.dataRequirement[0].type), force_bytes("Condition"))
        self.assertEqual(inst.date.date, FHIRDate("2016-03-08").date)
        self.assertEqual(inst.date.as_json(), "2016-03-08")
        self.assertEqual(force_bytes(inst.description), force_bytes("Decision support logic for improving outcomes for exclusive breastmilk feeding of newborns"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("library-exclusive-breastfeeding-cds-logic"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("Exclusive_Breastfeeding_CDS_Logic"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].type), force_bytes("depends-on"))
        self.assertEqual(force_bytes(inst.relatedArtifact[1].type), force_bytes("derived-from"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("Exclusive Breastfeeding CDS Logic"))
        self.assertEqual(force_bytes(inst.topic[0].text), force_bytes("Exclusive Breastfeeding"))
        self.assertEqual(force_bytes(inst.type.coding[0].code), force_bytes("logic-library"))
        self.assertEqual(force_bytes(inst.version), force_bytes("1.0.0"))
