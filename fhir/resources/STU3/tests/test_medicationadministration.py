...
def impl_medicationadministration_1(inst):
    ...
    assert inst.prescription.reference == "MedicationRequest/medrx0318"
...
def impl_medicationadministration_2(inst):
    ...
    assert inst.prescription.reference == "MedicationRequest/medrx0317"
    assert inst.reasonNotGiven[0].coding[0].code == "373147003"
    assert inst.reasonNotGiven[0].coding[0].display == (
        "Administration of medication not done due to a " "contraindication (situation)"
    )
    assert inst.reasonNotGiven[0].coding[0].system == "http://snomed.info/sct"
...
def impl_medicationadministration_3(inst):
    ...
    assert inst.performer[0].actor.display == "Patrick Pump"
    assert inst.performer[0].actor.reference == "Practitioner/f007"
    assert inst.prescription.reference == "MedicationRequest/medrx0315"
...
def impl_medicationadministration_4(inst):
    ...
    assert inst.dosage.dose.system == "http://hl7.org/fhir/v3/orderableDrugForm"
    ...
    assert inst.performer[0].actor.display == "Patrick Pump"
    assert inst.performer[0].actor.reference == "Practitioner/f007"
    assert inst.prescription.reference == "MedicationRequest/medrx0305"
...
def impl_medicationadministration_5(inst):
    ...
    assert inst.performer[0].actor.display == "Patrick Pump"
    assert inst.performer[0].actor.reference == "Practitioner/f007"
    assert inst.prescription.reference == "MedicationRequest/medrx0306"
    assert inst.status == "completed"
    assert inst.subject.display == "Donald Duck"
    assert inst.subject.reference == "Patient/pat1"
    assert inst.text.status == "generated"
...
def impl_medicationadministration_6(inst):
    ...
    assert inst.performer[0].actor.display == "Patrick Pump"
    assert inst.performer[0].actor.reference == "Practitioner/f007"
    assert inst.prescription.reference == "MedicationRequest/medrx0302"
    assert inst.status == "completed"
    assert inst.subject.display == "Donald Duck"
    assert inst.subject.reference == "Patient/pat1"
    assert inst.text.status == "generated"
...
def impl_medicationadministration_7(inst):
    ...
    assert inst.performer[0].actor.display == "Patrick Pump"
    assert inst.performer[0].actor.reference == "Practitioner/f007"
    assert inst.prescription.reference == "MedicationRequest/medrx0323"
    assert inst.status == "completed"
    assert inst.subject.display == "Donald Duck"
    assert inst.subject.reference == "Patient/pat1"
    assert inst.text.status == "generated"
...
def impl_medicationadministration_8(inst):
    ...
    assert inst.performer[0].actor.display == "Patrick Pump"
    assert inst.performer[0].actor.reference == "Practitioner/f007"
    assert inst.prescription.reference == "MedicationRequest/medrx0324"
...
def impl_medicationadministration_9(inst):
    ...
    assert inst.performer[0].actor.display == "Patrick Pump"
    assert inst.performer[0].actor.reference == "Practitioner/f007"
    assert inst.prescription.reference == "MedicationRequest/medrx0316"
    assert inst.status == "completed"
    assert inst.subject.display == "Donald Duck"
    assert inst.subject.reference == "Patient/pat1"
    assert inst.text.status == "generated"
...
def impl_medicationadministration_10(inst):
    ...
    assert inst.performer[0].actor.display == "Patrick Pump"
    assert inst.performer[0].actor.reference == "Practitioner/f007"
    assert inst.prescription.reference == "MedicationRequest/medrx0319"
