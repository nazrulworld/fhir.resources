...
class NutritionOrderTests(unittest.TestCase):
    ...
    def implNutritionOrder1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.foodPreferenceModifier[0].coding[0].system), force_bytes("http://hl7.org/fhir/diet"))
    ...
    def implNutritionOrder2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.enteralFormula.additiveType.coding[0].system), force_bytes("http://hl7.org/fhir/entformula-additive"))
        ...
        self.assertEqual(force_bytes(inst.enteralFormula.baseFormulaType.coding[0].code), force_bytes("659311000124118"))
        self.assertEqual(force_bytes(inst.enteralFormula.baseFormulaType.coding[0].display), force_bytes("Adult high protein formula"))
        self.assertEqual(force_bytes(inst.enteralFormula.baseFormulaType.coding[0].system), force_bytes("http://usextension/snomed.info/sct"))
        ...
        self.assertEqual(force_bytes(inst.enteralFormula.routeofAdministration.coding[0].system), force_bytes("http://hl7.org/fhir/v3/RouteOfAdministration"))
        self.assertEqual(force_bytes(inst.excludeFoodModifier[0].coding[0].code), force_bytes("227493005"))
        self.assertEqual(force_bytes(inst.excludeFoodModifier[0].coding[0].display), force_bytes("Cashew Nut"))
        self.assertEqual(force_bytes(inst.excludeFoodModifier[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.excludeFoodModifier[0].coding[0].version), force_bytes("20140730"))
    ...
    def implNutritionOrder3(self, inst):
        ...
        self.assertEqual(force_bytes(inst.oralDiet.nutrient[0].modifier.coding[0].code), force_bytes("256674009"))
        self.assertEqual(force_bytes(inst.oralDiet.nutrient[0].modifier.coding[0].display), force_bytes("Fat"))
        ...
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[0].code), force_bytes("15108003"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[0].display), force_bytes("Restricted fiber diet"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[1].code), force_bytes("1000"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[1].display), force_bytes("Fiber restricted"))
        ...
        self.assertEqual(force_bytes(inst.oralDiet.type[0].text), force_bytes("Fiber restricted diet"))
        self.assertEqual(force_bytes(inst.oralDiet.type[1].coding[0].code), force_bytes("16208003"))
        self.assertEqual(force_bytes(inst.oralDiet.type[1].coding[0].display), force_bytes("Low fat diet"))
        self.assertEqual(force_bytes(inst.oralDiet.type[1].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.oralDiet.type[1].coding[1].code), force_bytes("1100"))
        self.assertEqual(force_bytes(inst.oralDiet.type[1].coding[1].display), force_bytes("Low Fat"))
        ...
        self.assertEqual(force_bytes(inst.oralDiet.type[1].text), force_bytes("Low fat diet"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
    ...
    def implNutritionOrder4(self, inst):
        ...
        self.assertEqual(inst.oralDiet.schedule[0].repeat.period, 1)
        self.assertEqual(force_bytes(inst.oralDiet.schedule[0].repeat.periodUnit), force_bytes("d"))
        self.assertEqual(force_bytes(inst.oralDiet.texture[0].foodType.coding[0].code), force_bytes("28647000"))
        self.assertEqual(force_bytes(inst.oralDiet.texture[0].foodType.coding[0].display), force_bytes("Meat"))
        self.assertEqual(force_bytes(inst.oralDiet.texture[0].foodType.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.oralDiet.texture[0].foodType.text), force_bytes("Regular, Chopped Meat"))
        self.assertEqual(force_bytes(inst.oralDiet.texture[0].modifier.coding[0].code), force_bytes("228049004"))
        self.assertEqual(force_bytes(inst.oralDiet.texture[0].modifier.coding[0].display), force_bytes("Chopped food"))
        self.assertEqual(force_bytes(inst.oralDiet.texture[0].modifier.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.oralDiet.texture[0].modifier.text), force_bytes("Regular, Chopped Meat"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[0].code), force_bytes("435801000124108"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[0].display), force_bytes("Texture modified diet"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[1].code), force_bytes("1010"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[1].display), force_bytes("Texture modified diet"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].coding[1].system), force_bytes("http://goodhealthhospital.org/diet-type-codes"))
        self.assertEqual(force_bytes(inst.oralDiet.type[0].text), force_bytes("Texture modified diet"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
    ...
    def implNutritionOrder7(self, inst):
        self.assertEqual(inst.dateTime.date, FHIRDate("2014-09-17").date)
        self.assertEqual(inst.dateTime.as_json(), "2014-09-17")
        self.assertEqual(force_bytes(inst.enteralFormula.administrationInstruction), force_bytes("Hold feedings from 7 pm to 7 am. Add MCT oil to increase calories from 1.0 cal/mL to 1.5 cal/mL"))
        self.assertEqual(force_bytes(inst.enteralFormula.administration[0].rateQuantity.code), force_bytes("mL/h"))
        self.assertEqual(force_bytes(inst.enteralFormula.administration[0].rateQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.enteralFormula.administration[0].rateQuantity.unit), force_bytes("ml/hr"))
        ...
        self.assertEqual(force_bytes(inst.enteralFormula.administration[1].rateQuantity.code), force_bytes("mL/h"))
        self.assertEqual(force_bytes(inst.enteralFormula.administration[1].rateQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.enteralFormula.administration[1].rateQuantity.unit), force_bytes("ml/hr"))
        ...
        self.assertEqual(force_bytes(inst.enteralFormula.administration[2].rateQuantity.code), force_bytes("mL/h"))
        self.assertEqual(force_bytes(inst.enteralFormula.administration[2].rateQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.enteralFormula.administration[2].rateQuantity.unit), force_bytes("ml/hr"))
        ...
        self.assertEqual(force_bytes(inst.enteralFormula.baseFormulaProductName), force_bytes(" Acme Diabetes Formula"))
        self.assertEqual(force_bytes(inst.enteralFormula.baseFormulaType.coding[0].code), force_bytes("6547210000124112"))
        self.assertEqual(force_bytes(inst.enteralFormula.baseFormulaType.coding[0].display), force_bytes("Diabetic specialty enteral formula"))
        self.assertEqual(force_bytes(inst.enteralFormula.baseFormulaType.coding[0].system), force_bytes("http://snomed/sct"))
        self.assertEqual(force_bytes(inst.enteralFormula.caloricDensity.code), force_bytes("cal/mL"))
        self.assertEqual(force_bytes(inst.enteralFormula.caloricDensity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.enteralFormula.caloricDensity.unit), force_bytes("calories per milliliter"))
        ...
        self.assertEqual(force_bytes(inst.enteralFormula.routeofAdministration.coding[0].code), force_bytes("NGT"))
        self.assertEqual(force_bytes(inst.enteralFormula.routeofAdministration.coding[0].display), force_bytes("Instillation, nasogastric tube"))
        self.assertEqual(force_bytes(inst.enteralFormula.routeofAdministration.coding[0].system), force_bytes("http://hl7.org/fhir/v3/RouteOfAdministration"))
