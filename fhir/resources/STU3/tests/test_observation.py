...
class ObservationTests(unittest.TestCase):
    ...
    def implObservation1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.extension[0].url), force_bytes("http://hl7.org/fhir/StructureDefinition/observation-geneticsDNASequenceVariantName"))
        self.assertEqual(force_bytes(inst.extension[0].valueCodeableConcept.text), force_bytes("NG_007726.3:g.146252T>G"))
        self.assertEqual(force_bytes(inst.extension[1].url), force_bytes("http://hl7.org/fhir/StructureDefinition/observation-geneticsGene"))
        self.assertEqual(force_bytes(inst.extension[1].valueCodeableConcept.coding[0].code), force_bytes("3236"))
        self.assertEqual(force_bytes(inst.extension[1].valueCodeableConcept.coding[0].display), force_bytes("EGFR"))
        self.assertEqual(force_bytes(inst.extension[1].valueCodeableConcept.coding[0].system), force_bytes("http://www.genenames.org"))
        self.assertEqual(force_bytes(inst.extension[2].url), force_bytes("http://hl7.org/fhir/StructureDefinition/observation-geneticsDNARegionName"))
        self.assertEqual(force_bytes(inst.extension[2].valueString), force_bytes("Exon 21"))
        self.assertEqual(force_bytes(inst.extension[3].url), force_bytes("http://hl7.org/fhir/StructureDefinition/observation-geneticsGenomicSourceClass"))
        self.assertEqual(force_bytes(inst.extension[3].valueCodeableConcept.coding[0].code), force_bytes("LA6684-0"))
        self.assertEqual(force_bytes(inst.extension[3].valueCodeableConcept.coding[0].display), force_bytes("somatic"))
        self.assertEqual(force_bytes(inst.extension[3].valueCodeableConcept.coding[0].system), force_bytes("http://loinc.org"))
