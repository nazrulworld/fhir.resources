...
def impl_organization_1(inst):
    ...
    assert inst.extension[0].valueString == "HL7 International"
    assert inst.id == "hl7"
...
def impl_organization_3(inst):
    ...
    assert inst.partOf.display == "ACME Healthcare, Inc"
    assert inst.partOf.reference == "Organization/1"
    assert inst.telecom[0].system == "phone"
...
def impl_organization_5(inst):
    ...
    assert inst.type[0].coding[0].system == "http://hl7.org/fhir/organization-type"
...
def impl_organization_6(inst):
    ...
    assert inst.type[0].coding[2].system == "http://hl7.org/fhir/organization-type"
...
def impl_organization_7(inst):
    ...
    assert inst.identifier[0].value == "2.16.840.1.113883.19.5"
...
def impl_organization_8(inst):
    ...
    assert inst.type[0].coding[1].system == "http://hl7.org/fhir/organization-type"
