...
class PatientTests(unittest.TestCase):
    ...
    def implPatient8(self, inst):
        ...
        self.assertEqual(force_bytes(inst.address[0].text), force_bytes("534 Erewhon St PeasantVille, Rainbow, Vic  3999"))
        ...
        self.assertEqual(force_bytes(inst.contact[0].address.city), force_bytes("PleasantVille"))
        self.assertEqual(force_bytes(inst.contact[0].address.district), force_bytes("Rainbow"))
        self.assertEqual(force_bytes(inst.contact[0].address.line[0]), force_bytes("534 Erewhon St"))
        ...
        self.assertEqual(force_bytes(inst.contact[0].address.postalCode), force_bytes("3999"))
        ...
        self.assertEqual(force_bytes(inst.contact[0].name.family), force_bytes("du Marché"))
        self.assertEqual(force_bytes(inst.contact[0].name.given[0]), force_bytes("Bénédicte"))
        ...
        self.assertEqual(force_bytes(inst.contact[0].relationship[0].coding[0].code), force_bytes("N"))
        self.assertEqual(force_bytes(inst.contact[0].relationship[0].coding[0].system), force_bytes("http://hl7.org/fhir/v2/0131"))
        self.assertEqual(force_bytes(inst.contact[0].telecom[0].system), force_bytes("phone"))
        self.assertEqual(force_bytes(inst.contact[0].telecom[0].value), force_bytes("+33 (237) 998327"))
        self.assertFalse(inst.deceasedBoolean)
        self.assertEqual(force_bytes(inst.gender), force_bytes("male"))
        ...
        self.assertEqual(force_bytes(inst.telecom[2].value), force_bytes("(03) 3410 5613"))
        ...
        self.assertEqual(force_bytes(inst.telecom[3].value), force_bytes("(03) 5555 8834"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
