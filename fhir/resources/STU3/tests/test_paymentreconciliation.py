...
class PaymentReconciliationTests(unittest.TestCase):
    ...
    def implPaymentReconciliation1(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.detail[0].amount.system),
        ...
        self.assertEqual(
            ...
            force_bytes("http://hl7.org/fhir/payment-type"),
        )
        self.assertEqual(force_bytes(inst.detail[1].amount.code), force_bytes("USD"))
        self.assertEqual(
            force_bytes(inst.detail[1].amount.system),
            force_bytes("urn:iso:std:iso:4217"),
        )
        ...
        self.assertEqual(
            force_bytes(inst.detail[2].amount.system),
            force_bytes("urn:iso:std:iso:4217"),
        )
        ...
        self.assertEqual(
            force_bytes(inst.form.coding[0].code), force_bytes("PAYREC/2016/01B")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.processNote[0].type.coding[0].code), force_bytes("display")
        )
        self.assertEqual(
            force_bytes(inst.processNote[0].type.coding[0].system),
