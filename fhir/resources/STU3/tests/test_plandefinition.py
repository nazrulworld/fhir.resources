...
class PlanDefinitionTests(unittest.TestCase):
    ...
    def implPlanDefinition3(self, inst):
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression), force_bytes("Communication Request to Provider"))
        ...
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression), force_bytes("Should Notify Provider to Sign Assessment Order"))
        ...
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[0].eventName), force_bytes("Admission"))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[0].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[1].eventName), force_bytes("Birth"))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[1].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[2].eventName), force_bytes("Infant Transfer to Recovery"))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[2].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[3].eventName), force_bytes("Transfer to Post-Partum"))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[3].type), force_bytes("named-event"))
    ...
    def implPlanDefinition4(self, inst):
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression), force_bytes("Communication Request to Charge Nurse"))
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].path), force_bytes("/"))
        ...
        self.assertEqual(force_bytes(inst.action[0].action[0].type.code), force_bytes("create"))
        self.assertEqual(force_bytes(inst.action[0].action[1].dynamicValue[0].expression), force_bytes("Communication Request to Bedside Nurse"))
        ...
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression), force_bytes("Should Notify Nurse to Perform Assessment"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].kind), force_bytes("applicability"))
        self.assertEqual(force_bytes(inst.action[0].title), force_bytes("Mother should be administered a breastfeeding readiness assessment."))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[0].eventName), force_bytes("Admission"))
        self.assertEqual(force_bytes(inst.action[0].triggerDefinition[0].type), force_bytes("named-event"))
    ...
    def implPlanDefinition7(self, inst):
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression), force_bytes("Create Lactation Consult Request"))
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].path), force_bytes("/"))
        ...
        self.assertEqual(force_bytes(inst.action[0].action[0].type.code), force_bytes("create"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression), force_bytes("Should Create Lactation Consult"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].kind), force_bytes("applicability"))
    ...
    def testPlanDefinition10(self):
        inst = self.instantiate_from("plandefinition-chlamydia-screening-intervention.json")
        self.assertIsNotNone(inst, "Must have instantiated a PlanDefinition instance")
    ...
    def implPlanDefinition10(self, inst):
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression), force_bytes("NoScreening"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].kind), force_bytes("applicability"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[0].expression), force_bytes("ChlamydiaScreeningRequest"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[0].path), force_bytes("~"))
        self.assertEqual(force_bytes(inst.action[0].title), force_bytes("Patient has not had chlamydia screening within the recommended timeframe..."))
        self.assertEqual(inst.date.date, FHIRDate("2015-07-22").date)
        self.assertEqual(inst.date.as_json(), "2015-07-22")
        self.assertEqual(force_bytes(inst.description), force_bytes("Chlamydia Screening CDS Example Using Common"))
        self.assertEqual(force_bytes(inst.id), force_bytes("chlamydia-screening-intervention"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("ChlamydiaScreening_CDS_UsingCommon"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("Chalmydia Screening CDS Example Using Common"))
        self.assertEqual(force_bytes(inst.topic[0].text), force_bytes("Chlamydia Screeening"))
        self.assertEqual(force_bytes(inst.version), force_bytes("2.0.0"))
