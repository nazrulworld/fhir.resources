...
class PractitionerTests(unittest.TestCase):
    ...
    def implPractitioner6(self, inst):
        ...
        self.assertEqual(force_bytes(inst.identifier[0].system), force_bytes("urn:oid:2.16.528.1.1007.3.1"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("730291637"))
        self.assertEqual(force_bytes(inst.identifier[1].system), force_bytes("urn:oid:2.16.840.1.113883.2.4.6.3"))
        self.assertEqual(force_bytes(inst.identifier[1].use), force_bytes("usual"))
        self.assertEqual(force_bytes(inst.identifier[1].value), force_bytes("174BIP3JH438"))
        ...
        self.assertEqual(force_bytes(inst.telecom[1].system), force_bytes("email"))
        self.assertEqual(force_bytes(inst.telecom[1].use), force_bytes("work"))
        self.assertEqual(force_bytes(inst.telecom[1].value), force_bytes("p.voigt@bmc.nl"))
        self.assertEqual(force_bytes(inst.telecom[2].system), force_bytes("fax"))
        self.assertEqual(force_bytes(inst.telecom[2].use), force_bytes("work"))
    ...
    def implPractitioner7(self, inst):
        ...
        self.assertEqual(force_bytes(inst.name[0].prefix[0]), force_bytes("Dr"))
        self.assertEqual(force_bytes(inst.qualification[0].code.coding[0].code), force_bytes("BS"))
        self.assertEqual(force_bytes(inst.qualification[0].code.coding[0].display), force_bytes("Bachelor of Science"))
        self.assertEqual(force_bytes(inst.qualification[0].code.coding[0].system), force_bytes("http://hl7.org/fhir/v2/0360/2.7"))
        self.assertEqual(force_bytes(inst.qualification[0].code.text), force_bytes("Bachelor of Science"))
        self.assertEqual(force_bytes(inst.qualification[0].identifier[0].system), force_bytes("http://example.org/UniversityIdentifier"))
        self.assertEqual(force_bytes(inst.qualification[0].identifier[0].value), force_bytes("12345"))
    ...
    def implPractitioner8(self, inst):
        ...
        self.assertEqual(force_bytes(inst.identifier[0].system), force_bytes("urn:oid:2.16.528.1.1007.3.1"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("874635264"))
        self.assertEqual(force_bytes(inst.identifier[1].system), force_bytes("urn:oid:2.16.840.1.113883.2.4.6.3"))
        self.assertEqual(force_bytes(inst.identifier[1].use), force_bytes("usual"))
        self.assertEqual(force_bytes(inst.identifier[1].value), force_bytes("567IUI51C154"))
        ...
        self.assertEqual(force_bytes(inst.telecom[1].system), force_bytes("email"))
        self.assertEqual(force_bytes(inst.telecom[1].use), force_bytes("work"))
        self.assertEqual(force_bytes(inst.telecom[1].value), force_bytes("S.M.Heps@bmc.nl"))
        self.assertEqual(force_bytes(inst.telecom[2].system), force_bytes("fax"))
        self.assertEqual(force_bytes(inst.telecom[2].use), force_bytes("work"))
