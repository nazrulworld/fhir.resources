...
class ProcedureRequestTests(unittest.TestCase):
    ...
    def implProcedureRequest7(self, inst):
        self.assertEqual(force_bytes(inst.bodySite[0].coding[0].display), force_bytes("Right arm"))
        ...
        self.assertEqual(force_bytes(inst.reasonCode[0].text), force_bytes("Check for Peanut Allergy"))
    ...
    def implProcedureRequest8(self, inst):
        self.assertEqual(force_bytes(inst.asNeededCodeableConcept.text), force_bytes("as needed to clear mucus"))
        ...
        self.assertEqual(force_bytes(inst.code.coding[0].display), force_bytes("Physiotherapy of chest (regime/therapy) "))
        self.assertEqual(force_bytes(inst.code.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.contained[0].id), force_bytes("signature"))
        self.assertEqual(force_bytes(inst.contained[1].id), force_bytes("cystic-fibrosis"))
        ...
        self.assertEqual(force_bytes(inst.identifier[0].type.coding[0].code), force_bytes("PLAC"))
        self.assertEqual(force_bytes(inst.identifier[0].type.coding[0].display), force_bytes("Placer Identifier"))
        self.assertEqual(force_bytes(inst.identifier[0].type.coding[0].system), force_bytes("http://hl7.org/fhir/identifier-type"))
        self.assertEqual(force_bytes(inst.identifier[0].type.text), force_bytes("Placer"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("20170201-0001"))
        self.assertEqual(force_bytes(inst.intent), force_bytes("order"))
        self.assertEqual(inst.occurrenceTiming.repeat.duration, 15)
        self.assertEqual(inst.occurrenceTiming.repeat.durationMax, 25)
        self.assertEqual(force_bytes(inst.occurrenceTiming.repeat.durationUnit), force_bytes("min"))
        self.assertEqual(inst.occurrenceTiming.repeat.frequency, 1)
        self.assertEqual(inst.occurrenceTiming.repeat.frequencyMax, 4)
        self.assertEqual(inst.occurrenceTiming.repeat.period, 1)
        self.assertEqual(force_bytes(inst.occurrenceTiming.repeat.periodUnit), force_bytes("d"))
        self.assertEqual(force_bytes(inst.status), force_bytes("completed"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
