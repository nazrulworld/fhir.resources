...
class QuestionnaireResponseTests(unittest.TestCase):
    ...
    def implQuestionnaireResponse3(self, inst):
        ...
        self.assertEqual(force_bytes(inst.item[1].item[0].item[7].answer[0].item[0].item[0].answer[0].valueCoding.code), force_bytes("lb"))
        ...
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[0].answer[0].valueCoding.code), force_bytes("LA10405-1"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[0].answer[0].valueCoding.display), force_bytes("Daughter"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[0].answer[0].valueCoding.system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[0].definition), force_bytes("http://loinc.org/fhir/DataElement/54136-7"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[0].linkId), force_bytes("2.1.1.1"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[0].text), force_bytes("Relationship to you"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[1].answer[0].valueString), force_bytes("Susan"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[1].definition), force_bytes("http://loinc.org/fhir/DataElement/54138-3"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[1].linkId), force_bytes("2.1.1.2"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[1].text), force_bytes("Name"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[2].answer[0].valueCoding.code), force_bytes("LA3-6"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[2].answer[0].valueCoding.display), force_bytes("Female"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[2].answer[0].valueCoding.system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[2].definition), force_bytes("http://loinc.org/fhir/DataElement/54123-5"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[2].linkId), force_bytes("2.1.1.3"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[2].text), force_bytes("Gender"))
        self.assertEqual(inst.item[2].item[0].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal, 17)
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].answer[0].item[0].item[0].definition), force_bytes("http://loinc.org/fhir/DataElement/54141-7"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].answer[0].item[0].item[0].linkId), force_bytes("2.1.1.4.2.2"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].answer[0].item[0].item[0].text), force_bytes("Age"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].answer[0].item[0].linkId), force_bytes("2.1.1.4.2"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].answer[0].valueCoding.code), force_bytes("LA33-6"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].answer[0].valueCoding.display), force_bytes("Yes"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].answer[0].valueCoding.system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].definition), force_bytes("http://loinc.org/fhir/DataElement/54139-1"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].linkId), force_bytes("2.1.1.4"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[3].text), force_bytes("Living?"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[4].answer[0].valueCoding.code), force_bytes("LA32-8"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[4].answer[0].valueCoding.display), force_bytes("No"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[4].answer[0].valueCoding.system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[4].definition), force_bytes("http://loinc.org/fhir/DataElement/54121-9"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[4].linkId), force_bytes("2.1.1.5"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[4].text), force_bytes("Was this person born a twin?"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[5].answer[0].valueCoding.code), force_bytes("LA32-8"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[5].answer[0].valueCoding.display), force_bytes("No"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[5].answer[0].valueCoding.system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[5].definition), force_bytes("http://loinc.org/fhir/DataElement/54122-7"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[5].linkId), force_bytes("2.1.1.6"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].item[5].text), force_bytes("Was this person adopted?"))
        self.assertEqual(force_bytes(inst.item[2].item[0].item[0].linkId), force_bytes("2.1.1"))
