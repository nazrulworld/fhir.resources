...
class SearchParameterTests(unittest.TestCase):
    ...
    def implSearchParameter4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Matches on the partOf extension value"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("condition-extensions-Condition-part-of"))
        self.assertEqual(force_bytes(inst.name), force_bytes("part-of"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("reference"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/condition-extensions-Condition-part-of"))
        self.assertEqual(force_bytes(inst.xpath), force_bytes("f:Condition/f:extension[@url='http://hl7.org/fhir/StructureDefinition/condition-partOf'] | f:Condition/f:extension[@url='http://hl7.org/fhir/StructureDefinition/condition-partOf']"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))
    ...
    def implSearchParameter5(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Matches on the definition extension value"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("condition-extensions-Condition-definition"))
        self.assertEqual(force_bytes(inst.name), force_bytes("definition"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("reference"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/condition-extensions-Condition-definition"))
        self.assertEqual(force_bytes(inst.xpath), force_bytes("f:Condition/f:extension[@url='http://hl7.org/fhir/StructureDefinition/condition-definition'] | f:Condition/f:extension[@url='http://hl7.org/fhir/StructureDefinition/condition-definition']"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))
    ...
    def testSearchParameter7(self):
        try:
            inst = self.instantiate_from("organization-extensions-Organization-alias.json")
        except ValueError as exc:
            sys.stderr.write(str(exc) + "\n")
            return 1
        self.assertIsNotNone(inst, "Must have instantiated a SearchParameter instance")
    ...
    def implSearchParameter7(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Include Organizations that contain the provided alias"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("organization-extensions-Organization-alias"))
        self.assertEqual(force_bytes(inst.name), force_bytes("alias"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("string"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/organization-extensions-Organization-alias"))
        self.assertEqual(force_bytes(inst.xpath), force_bytes("f:Organization/f:extension[@url='http://hl7.org/fhir/StructureDefinition/organization-alias'] | /f:#alias"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))

    def testSearchParameter8(self):
        inst = self.instantiate_from("elementdefinition-11179-DataElement-objectClass.json")
        self.assertIsNotNone(inst, "Must have instantiated a SearchParameter instance")
    ...
    def implSearchParameter8(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Matches on the 11179-objectClass extension value"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("elementdefinition-11179-DataElement-objectClass"))
        self.assertEqual(force_bytes(inst.name), force_bytes("objectClass"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("token"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/elementdefinition-11179-DataElement-objectClass"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))
