...
class SequenceTests(unittest.TestCase):
    ...
    def implSequence2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.quality[0].method.coding[0].code), force_bytes("app-BxfGF8j02pBZzZxbzZxP725P"))
        self.assertEqual(force_bytes(inst.quality[0].method.coding[0].system), force_bytes("https://precision.fda.gov/apps/"))
        self.assertEqual(force_bytes(inst.quality[0].method.text), force_bytes("Vcfeval + Hap.py Comparison"))
        ...
        self.assertEqual(force_bytes(inst.quality[1].method.coding[0].code), force_bytes("app-BxfGF8j02pBZzZxbzZxP725P"))
        self.assertEqual(force_bytes(inst.quality[1].method.coding[0].system), force_bytes("https://precision.fda.gov/apps/"))
        self.assertEqual(force_bytes(inst.quality[1].method.text), force_bytes("Vcfeval + Hap.py Comparison"))
        ...
        self.assertEqual(force_bytes(inst.quality[1].standardSequence.coding[0].code), force_bytes("file-BkZxBZ00bpJVk2q6x43b1YBx"))
        self.assertEqual(force_bytes(inst.quality[1].standardSequence.coding[0].system), force_bytes("https://precision.fda.gov/files/"))
        ...
        self.assertEqual(force_bytes(inst.repository[0].url), force_bytes("https://precision.fda.gov/jobs/job-ByxYPx809jFVy21KJG74Jg3Y"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
    ...
    def implSequence3(self, inst):
        ...
        self.assertEqual(inst.referenceSeq.windowStart, 128273724)
        self.assertEqual(force_bytes(inst.repository[0].datasetId), force_bytes("Ensembl"))
        self.assertEqual(force_bytes(inst.repository[0].readsetId), force_bytes("v1beta2"))
        ...
        self.assertEqual(force_bytes(inst.variant[0].observedAllele), force_bytes("CTCATTGT"))
        self.assertEqual(force_bytes(inst.variant[0].referenceAllele), force_bytes("CTCCATTGCATGCGTT"))
    ...
    def implSequence7(self, inst):
        ...
        self.assertEqual(inst.quality[0].gtFP, 2186)
        self.assertEqual(force_bytes(inst.quality[0].method.coding[0].code), force_bytes("job-ByxYPx809jFVy21KJG74Jg3Y"))
        self.assertEqual(force_bytes(inst.quality[0].method.coding[0].system), force_bytes("https://precision.fda.gov/jobs/"))
        self.assertEqual(force_bytes(inst.quality[0].method.text), force_bytes("Vcfeval + Hap.py Comparison"))
        self.assertEqual(inst.quality[0].precision, 0.428005)
        self.assertEqual(inst.quality[0].queryFP, 10670)
        self.assertEqual(inst.quality[0].queryTP, 7984)
        self.assertEqual(inst.quality[0].recall, 0.752111)
        self.assertEqual(force_bytes(inst.quality[0].standardSequence.coding[0].code), force_bytes("file-Bk50V4Q0qVb65P0v2VPbfYPZ"))
        self.assertEqual(force_bytes(inst.quality[0].standardSequence.coding[0].system), force_bytes("https://precision.fda.gov/files/"))
        self.assertEqual(inst.quality[0].start, 10453)
        self.assertEqual(inst.quality[0].truthFN, 2554)
        self.assertEqual(inst.quality[0].truthTP, 7749)
        ...
        self.assertEqual(force_bytes(inst.repository[0].name), force_bytes("FDA"))
        self.assertEqual(force_bytes(inst.repository[0].type), force_bytes("login"))
        self.assertEqual(force_bytes(inst.repository[0].url), force_bytes("https://precision.fda.gov/files/file-Bx37ZK009P4bX5g3qjkFZV38"))
        self.assertEqual(force_bytes(inst.repository[0].variantsetId), force_bytes("file-Bx37ZK009P4bX5g3qjkFZV38"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.type), force_bytes("dna"))
        self.assertEqual(inst.variant[0].end, 13117)
        self.assertEqual(force_bytes(inst.variant[0].observedAllele), force_bytes("T"))
