...
def impl_testscript_1(inst):
    ...
    assert (
        inst.metadata.capability[0].capabilities.reference
    ...
    assert (
        inst.metadata.capability[1].capabilities.reference
        == "CapabilityStatement/example"
    )
    ...
    assert (
        inst.metadata.link[0].description
    ...
    assert (
        inst.test[0].action[0].operation.description
    ...
    assert inst.url == "http://hl7.org/fhir/TestScript/testscript-example-multisystem"
...
def impl_testscript_2(inst):
    ...
    assert (
        inst.setup.action[1].assert_fhir.description
    ...
    assert (
        inst.setup.action[2].operation.description
    ...
    assert (
        inst.setup.action[4].operation.description
...
def impl_testscript_3(inst):
    ...
    assert (
        inst.test[0].action[3].assert_fhir.description
        == "Confirm that the returned HTTP Header Last-Modified is present. Warning only as the server may not support versioning."
    )
...
def impl_testscript_4(inst):
    ...
    assert inst.id == "testscript-example-rule"
    assert inst.identifier.system == "urn:ietf:rfc:3986"
    assert inst.identifier.value == "urn:oid:1.3.6.1.4.1.21367.2005.3.7.9880"
    assert inst.jurisdiction[0].coding[0].code == "US"
    assert inst.jurisdiction[0].coding[0].display == "United States of America (the)"
    assert inst.jurisdiction[0].coding[0].system == "urn:iso:std:iso:3166"
    assert (
    ...
    assert inst.rule[0].id == "rule-responseStatusCode"
    assert inst.rule[0].param[0].name == "expectedStatusCode"
    assert inst.rule[0].param[0].value == "200"
    assert inst.rule[0].resource.reference == "TestScript/testscript-example"
    assert inst.ruleset[0].id == "ruleset-responseContentTypeStatusCode"
    assert inst.ruleset[0].resource.reference == "TestScript/testscript-example"
    assert inst.ruleset[0].rule[0].param[0].name == "expectedContentType"
    assert inst.ruleset[0].rule[0].param[0].value == "json"
    assert inst.ruleset[0].rule[0].ruleId == "RuleResponseContentType"
    assert inst.ruleset[0].rule[1].param[0].name == "expectedStatusCode"
    assert inst.ruleset[0].rule[1].param[0].value == "200"
    assert inst.ruleset[0].rule[1].ruleId == "RuleResponseStatusCode"
    assert inst.setup.action[0].operation.accept == "json"
    assert (
        inst.setup.action[0].operation.description
        == "Execute a delete operation to insure the patient does not exist on the server."
    ...
    assert inst.setup.action[3].assert_fhir.direction == "response"
    assert inst.setup.action[3].assert_fhir.label == "Setup-RuleCreateOK"
    assert inst.setup.action[3].assert_fhir.rule.param[0].name == "expectedStatusCode"
    assert inst.setup.action[3].assert_fhir.rule.param[0].value == "201"
    assert inst.setup.action[3].assert_fhir.rule.ruleId == "rule-responseStatusCode"
    assert inst.status == "draft"
    assert (
        inst.test[0].action[0].operation.description
    ...
    assert inst.test[0].action[1].assert_fhir.label == "01-RuleReadPatientOK"
    assert inst.test[0].action[1].assert_fhir.rule.ruleId == "rule-responseStatusCode"
    assert inst.test[0].action[2].assert_fhir.label == "01-RuleReadPatientContentType"
    assert (
        inst.test[0].action[2].assert_fhir.ruleset.rule[0].param[0].name
        == "expectedContentType"
    )
    assert inst.test[0].action[2].assert_fhir.ruleset.rule[0].param[0].value == "XML"
    assert (
        inst.test[0].action[2].assert_fhir.ruleset.rule[0].ruleId
        == "RuleResponseContentType"
    )
    assert (
        inst.test[0].action[2].assert_fhir.ruleset.rulesetId
        == "ruleset-responseResourcePatient"
    )
    assert (
        inst.test[0].action[3].assert_fhir.description
        == "Confirm that the returned HTTP Header Last-Modified is present. Warning only as the server may not support versioning."
    ...
    assert (
        inst.test[0].action[6].assert_fhir.description
    ...
    assert inst.test[0].action[6].assert_fhir.value == "Chalmers"
    assert (
        inst.test[0].action[7].assert_fhir.description
    ...
    assert inst.test[0].action[7].assert_fhir.sourceId == "fixture-patient-read"
    assert inst.test[0].action[7].assert_fhir.value == "Peter"
    assert (
    ...
    assert inst.test[0].action[8].assert_fhir.operator == "equals"
    assert (
        inst.test[0].action[8].assert_fhir.path
        == "fhir:Patient/fhir:name/fhir:family/@value"
    )
    assert (
        inst.test[0].action[9].assert_fhir.compareToSourceId == "fixture-patient-create"
    )
    assert (
        inst.test[0].action[9].assert_fhir.compareToSourcePath
        == "fhir:Patient/fhir:name/fhir:given/@value"
    )
    assert (
        inst.test[0].action[9].assert_fhir.path
        == "fhir:Patient/fhir:name/fhir:given/@value"
    )
    assert inst.test[0].action[9].assert_fhir.sourceId == "fixture-patient-read"
    ...
    assert inst.text.status == "generated"
    assert inst.url == "http://hl7.org/fhir/TestScript/testscript-example-rule"
    assert inst.variable[0].name == "createResourceId"
    assert inst.variable[0].path == "Patient/id"
    assert inst.variable[0].sourceId == "fixture-patient-create"
    assert inst.version == "1.0"
...
def test_testscript_4(base_settings):
    ...
    Test File: testscript-example-rule.json
    """
    filename = base_settings["unittest_data_dir"] / "testscript-example-rule.json"
    inst = testscript.TestScript.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
    assert "TestScript" == inst.resource_type
...
def impl_testscript_5(inst):
    ...
    assert (
        inst.setup.action[4].assert_fhir.description
    ...
    assert (
        inst.test[0].action[3].operation.description
    ...
    assert (
        inst.test[1].action[0].operation.params
    ...
    assert (
        inst.test[1].action[6].assert_fhir.description
...
def impl_testscript_6(inst):
    ...
    assert (
        inst.setup.action[6].assert_fhir.description
    ...
    assert inst.status == "draft"
    assert (
        inst.teardown.action[0].operation.description
    ...
    assert (
        inst.test[0].action[9].assert_fhir.description
...
def impl_testscript_7(inst):
    ...
    assert (
        inst.test[2].action[0].operation.description
    ...
    assert (
        inst.test[3].action[0].operation.description
...
def test_testscript_7(base_settings):
    """No. 7 tests collection for TestScript.
