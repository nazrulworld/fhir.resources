...
class ActivityDefinition(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("observationRequirement", "observationRequirement", fhirreference.FHIRReference, "Reference", True, None, False),
            ("observationResultRequirement", "observationResultRequirement", fhirreference.FHIRReference, "Reference", True, None, False),
            ...
            ("specimenRequirement", "specimenRequirement", fhirreference.FHIRReference, "Reference", True, None, False),
...
class ActivityDefinitionDynamicValue(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("expression", "expression", expression.Expression, "Expression", False, None, True),
