...
class BiologicallyDerivedProduct(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "productCategory", "productCode", "status", "request", "quantity", "parent", "collection", "processing", "manipulation", "storage"]
...
class BiologicallyDerivedProductCollection(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "collector", "source", "collectedDateTime", "collectedPeriod"]
...
class BiologicallyDerivedProductManipulation(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "timeDateTime", "timePeriod"]
...
class BiologicallyDerivedProductStorage(backboneelement.BackboneElement):
    ...
    scale__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_scale",
        title="Extension field for ``scale``."
    )
    ...
    temperature__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_temperature",
        title="Extension field for ``temperature``."
    )
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "temperature", "scale", "duration"]
