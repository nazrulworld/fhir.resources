...
class ChargeItem(domainresource.DomainResource):
    ...
    definitionCanonical: typing.List[typing.Optional[fhirtypes.CanonicalType]] = Field(
        None,
    ...
    definitionUri: typing.List[typing.Optional[fhirtypes.UriType]] = Field(
        None,
        alias="definitionUri",
    ...
    enteredDate: fhirtypes.DateTimeType = Field(
        None,
        alias="enteredDate",
