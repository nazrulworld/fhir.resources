...
class ClaimResponse(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "type", "subType", "use", "patient", "created", "insurer", "requestor", "request", "outcome", "disposition", "preAuthRef", "preAuthPeriod", "payeeType", "item", "addItem", "adjudication", "total", "payment", "fundsReserve", "formCode", "form", "processNote", "communicationRequest", "insurance", "error"]
...
class ClaimResponseError(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "itemSequence", "detailSequence", "subDetailSequence", "code"]
...
class ClaimResponseInsurance(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "sequence", "focal", "coverage", "businessArrangement", "claimResponse"]
...
class ClaimResponseItem(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "itemSequence", "noteNumber", "adjudication", "detail"]
    ...
    def validate_required_primitive_elements_1908(
        ...
        """
        required_fields = [
			("itemSequence", "itemSequence__ext")]
        _missing = object()
...
class ClaimResponseItemDetail(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "detailSequence", "noteNumber", "adjudication", "subDetail"]
    ...
    def validate_required_primitive_elements_2502(
        ...
        """
        required_fields = [
			("detailSequence", "detailSequence__ext")]
        _missing = object()
...
class ClaimResponseItemDetailSubDetail(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "subDetailSequence", "noteNumber", "adjudication"]
    ...
    def validate_required_primitive_elements_3395(
        ...
        """
        required_fields = [
			("subDetailSequence", "subDetailSequence__ext")]
        _missing = object()
