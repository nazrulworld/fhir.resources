...
class CoverageEligibilityRequest(domainresource.DomainResource):
    ...
    supportingInfo: typing.List[fhirtypes.CoverageEligibilityRequestSupportingInfoType] = Field(
		None,
...
class CoverageEligibilityRequestInsurance(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "focal", "coverage", "businessArrangement"]
...
class CoverageEligibilityRequestItem(backboneelement.BackboneElement):
    ...
    diagnosis: typing.List[fhirtypes.CoverageEligibilityRequestItemDiagnosisType] = Field(
		None,
		alias="diagnosis",
    ...
    supportingInfoSequence__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "supportingInfoSequence", "category", "productOrService", "modifier", "provider", "quantity", "unitPrice", "facility", "diagnosis", "detail"]
...
class CoverageEligibilityRequestItemDiagnosis(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "diagnosisCodeableConcept", "diagnosisReference"]
...
class CoverageEligibilityRequestSupportingInfo(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "sequence", "information", "appliesToAll"]
