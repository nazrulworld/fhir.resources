...
class Evidence(domainresource.DomainResource):
    ...
    assertion__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_assertion",
        title="Extension field for ``assertion``."
    )
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "url", "identifier", "version", "title", "citeAsReference", "citeAsMarkdown", "status", "date", "useContext", "approvalDate", "lastReviewDate", "publisher", "contact", "author", "editor", "reviewer", "endorser", "relatedArtifact", "description", "assertion", "note", "variableDefinition", "synthesisType", "studyType", "statistic", "certainty"]
...
class EvidenceCertainty(backboneelement.BackboneElement):
    ...
    rater__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_rater",
        title="Extension field for ``rater``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "note", "type", "rating", "rater", "subcomponent"]
...
class EvidenceStatistic(backboneelement.BackboneElement):
    ...
    attributeEstimate: typing.List[fhirtypes.EvidenceStatisticAttributeEstimateType] = Field(
		None,
    ...
    modelCharacteristic: typing.List[fhirtypes.EvidenceStatisticModelCharacteristicType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "note", "statisticType", "category", "quantity", "numberOfEvents", "numberAffected", "sampleSize", "attributeEstimate", "modelCharacteristic"]
...
class EvidenceStatisticAttributeEstimate(backboneelement.BackboneElement):
    ...
    level__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_level",
        title="Extension field for ``level``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "note", "type", "quantity", "level", "range", "attributeEstimate"]
...
class EvidenceStatisticModelCharacteristic(backboneelement.BackboneElement):
    ...
    variable: typing.List[fhirtypes.EvidenceStatisticModelCharacteristicVariableType] = Field(
		None,
		alias="variable",
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "code", "value", "variable", "attributeEstimate"]
...
class EvidenceStatisticModelCharacteristicVariable(backboneelement.BackboneElement):
    ...
    handling__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_handling",
        title="Extension field for ``handling``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "variableDefinition", "handling", "valueCategory", "valueQuantity", "valueRange"]
...
class EvidenceStatisticSampleSize(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "note", "numberOfStudies", "numberOfParticipants", "knownDataCount"]
...
class EvidenceVariableDefinition(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "note", "variableRole", "observed", "intended", "directnessMatch"]
