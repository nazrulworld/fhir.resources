...
class Expression(element.Element):
    ...
    "identifier | text/cql-expression | etc."
		...
		enum_values=["text/cql", "text/fhirpath", "application/x-fhir-query", "text/cql-identifier", "text/cql-expression", "etc."],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "extension", "description", "name", "language", "expression", "reference"]
