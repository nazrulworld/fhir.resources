...
MODEL_CLASSES = {
     ...
     "AdministrableProductDefinitionRouteOfAdministration": (None, ".administrableproductdefinition"),
     
     "AdministrableProductDefinitionRouteOfAdministrationTargetSpecies": (None, ".administrableproductdefinition"),
     
     "AdministrableProductDefinitionRouteOfAdministrationTargetSpeciesWithdrawalPeriod": (None, ".administrableproductdefinition"),
     ...
     "CitationCitedArtifactContributorshipEntryContributionInstance": (None, ".citation"),
     ...
     "CitationCitedArtifactPublicationFormPeriodicReleaseDateOfPublication": (None, ".citation"),
     ...
     "ClinicalUseDefinitionContraindicationOtherTherapy": (None, ".clinicalusedefinition"),
     ...
     "CoverageEligibilityResponseInsuranceItemBenefit": (None, ".coverageeligibilityresponse"),
     ...
     "ImmunizationRecommendationRecommendationDateCriterion": (None, ".immunizationrecommendation"),
     ...
     "MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics": (None, ".medicationknowledge"),
     ...
     "MedicinalProductDefinitionNameCountryLanguage": (None, ".medicinalproductdefinition"),
     ...
     "PackagedProductDefinitionLegalStatusOfSupply": (None, ".packagedproductdefinition"),
     
     "PackagedProductDefinitionPackage": (None, ".packagedproductdefinition"),
     
     "PackagedProductDefinitionPackageContainedItem": (None, ".packagedproductdefinition"),
     
     "PackagedProductDefinitionPackageProperty": (None, ".packagedproductdefinition"),
     
     "PackagedProductDefinitionPackageShelfLifeStorage": (None, ".packagedproductdefinition"),
     ...
     "TerminologyCapabilitiesCodeSystemVersionFilter": (None, ".terminologycapabilities"),
...
def activitydefinitiondynamicvalue_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ActivityDefinitionDynamicValue", v)

def activitydefinitionparticipant_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def administrableproductdefinition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdministrableProductDefinition", v)

def administrableproductdefinitionproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdministrableProductDefinitionProperty", v)

def administrableproductdefinitionrouteofadministration_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdministrableProductDefinitionRouteOfAdministration", v)

def administrableproductdefinitionrouteofadministrationtargetspecies_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdministrableProductDefinitionRouteOfAdministrationTargetSpecies", v)

def administrableproductdefinitionrouteofadministrationtargetspecieswithdrawalperiod_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdministrableProductDefinitionRouteOfAdministrationTargetSpeciesWithdrawalPeriod", v)

def adverseevent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdverseEvent", v)

def adverseeventsuspectentity_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdverseEventSuspectEntity", v)

def adverseeventsuspectentitycausality_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def biologicallyderivedproduct_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("BiologicallyDerivedProduct", v)

def biologicallyderivedproductcollection_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("BiologicallyDerivedProductCollection", v)

def biologicallyderivedproductmanipulation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("BiologicallyDerivedProductManipulation", v)

def biologicallyderivedproductprocessing_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("BiologicallyDerivedProductProcessing", v)

def biologicallyderivedproductstorage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def capabilitystatementdocument_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementDocument", v)

def capabilitystatementimplementation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementImplementation", v)

def capabilitystatementmessaging_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementMessaging", v)

def capabilitystatementmessagingendpoint_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementMessagingEndpoint", v)

def capabilitystatementmessagingsupportedmessage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementMessagingSupportedMessage", v)

def capabilitystatementrest_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementRest", v)

def capabilitystatementrestinteraction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementRestInteraction", v)

def capabilitystatementrestresource_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementRestResource", v)

def capabilitystatementrestresourceinteraction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementRestResourceInteraction", v)

def capabilitystatementrestresourceoperation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementRestResourceOperation", v)

def capabilitystatementrestresourcesearchparam_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementRestResourceSearchParam", v)

def capabilitystatementrestsecurity_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CapabilityStatementRestSecurity", v)

def capabilitystatementsoftware_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def catalogentryrelatedentry_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def chargeitemdefinitionapplicability_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ChargeItemDefinitionApplicability", v)

def chargeitemdefinitionpropertygroup_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ChargeItemDefinitionPropertyGroup", v)

def chargeitemdefinitionpropertygrouppricecomponent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def citationcitedartifactabstract_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactAbstract", v)

def citationcitedartifactclassification_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactClassification", v)

def citationcitedartifactclassificationwhoclassified_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactClassificationWhoClassified", v)

def citationcitedartifactcontributorship_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactContributorship", v)

def citationcitedartifactcontributorshipentry_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactContributorshipEntry", v)

def citationcitedartifactcontributorshipentryaffiliationinfo_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactContributorshipEntryAffiliationInfo", v)

def citationcitedartifactcontributorshipentrycontributioninstance_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactContributorshipEntryContributionInstance", v)

def citationcitedartifactcontributorshipsummary_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactContributorshipSummary", v)

def citationcitedartifactpart_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactPart", v)

def citationcitedartifactpublicationform_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactPublicationForm", v)

def citationcitedartifactpublicationformperiodicrelease_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactPublicationFormPeriodicRelease", v)

def citationcitedartifactpublicationformperiodicreleasedateofpublication_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactPublicationFormPeriodicReleaseDateOfPublication", v)

def citationcitedartifactpublicationformpublishedin_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactPublicationFormPublishedIn", v)

def citationcitedartifactrelatesto_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactRelatesTo", v)

def citationcitedartifactstatusdate_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactStatusDate", v)

def citationcitedartifacttitle_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactTitle", v)

def citationcitedartifactversion_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CitationCitedArtifactVersion", v)

def citationcitedartifactweblocation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def claimitemdetailsubdetail_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def claimresponseadditemdetail_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClaimResponseAddItemDetail", v)

def claimresponseadditemdetailsubdetail_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def claimresponseitemadjudication_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClaimResponseItemAdjudication", v)

def claimresponseitemdetail_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def claimresponseprocessnote_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def clinicalimpressionfinding_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClinicalImpressionFinding", v)

def clinicalimpressioninvestigation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def clinicalusedefinitioncontraindication_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClinicalUseDefinitionContraindication", v)

def clinicalusedefinitioncontraindicationothertherapy_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClinicalUseDefinitionContraindicationOtherTherapy", v)

def clinicalusedefinitionindication_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClinicalUseDefinitionIndication", v)

def clinicalusedefinitioninteraction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClinicalUseDefinitionInteraction", v)

def clinicalusedefinitioninteractioninteractant_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClinicalUseDefinitionInteractionInteractant", v)

def clinicalusedefinitionundesirableeffect_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ClinicalUseDefinitionUndesirableEffect", v)

def clinicalusedefinitionwarning_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def codesystemconceptdesignation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CodeSystemConceptDesignation", v)

def codesystemconceptproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def communicationrequestpayload_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def compartmentdefinitionresource_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def conceptmapgroupelementtarget_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ConceptMapGroupElementTarget", v)

def conceptmapgroupelementtargetdependson_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def contractcontentdefinition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def contracttermactionsubject_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def contracttermassetcontext_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ContractTermAssetContext", v)

def contracttermassetvalueditem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def contracttermofferanswer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def contracttermsecuritylabel_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def coveragecosttobeneficiary_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CoverageCostToBeneficiary", v)

def coveragecosttobeneficiaryexception_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CoverageCostToBeneficiaryException", v)

def coverageeligibilityrequest_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def coverageeligibilityrequestitem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CoverageEligibilityRequestItem", v)

def coverageeligibilityrequestitemdiagnosis_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CoverageEligibilityRequestItemDiagnosis", v)

def coverageeligibilityrequestsupportinginfo_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CoverageEligibilityRequestSupportingInfo", v)

def coverageeligibilityresponse_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def coverageeligibilityresponseinsuranceitem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("CoverageEligibilityResponseInsuranceItem", v)

def coverageeligibilityresponseinsuranceitembenefit_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def datarequirementcodefilter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DataRequirementCodeFilter", v)

def datarequirementdatefilter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def detectedissuemitigation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def devicedefinitioncapability_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DeviceDefinitionCapability", v)

def devicedefinitiondevicename_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DeviceDefinitionDeviceName", v)

def devicedefinitionmaterial_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DeviceDefinitionMaterial", v)

def devicedefinitionproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DeviceDefinitionProperty", v)

def devicedefinitionspecialization_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DeviceDefinitionSpecialization", v)

def devicedefinitionudideviceidentifier_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def devicemetriccalibration_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def documentreferencecontent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DocumentReferenceContent", v)

def documentreferencecontext_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DocumentReferenceContext", v)

def documentreferencerelatesto_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def elementdefinitionbinding_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def elementdefinitionexample_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ElementDefinitionExample", v)

def elementdefinitionmapping_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ElementDefinitionMapping", v)

def elementdefinitionslicing_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ElementDefinitionSlicing", v)

def elementdefinitionslicingdiscriminator_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def encounterhospitalization_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def evidencereportrelatesto_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def evidencereportsubjectcharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def evidencestatisticattributeestimate_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("EvidenceStatisticAttributeEstimate", v)

def evidencestatisticmodelcharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("EvidenceStatisticModelCharacteristic", v)

def evidencestatisticmodelcharacteristicvariable_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("EvidenceStatisticModelCharacteristicVariable", v)

def evidencestatisticsamplesize_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def evidencevariablecategory_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("EvidenceVariableCategory", v)

def evidencevariablecharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("EvidenceVariableCharacteristic", v)

def evidencevariablecharacteristictimefromstart_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("EvidenceVariableCharacteristicTimeFromStart", v)

def evidencevariabledefinition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def examplescenarioinstance_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExampleScenarioInstance", v)

def examplescenarioinstancecontainedinstance_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExampleScenarioInstanceContainedInstance", v)

def examplescenarioinstanceversion_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def examplescenarioprocessstep_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExampleScenarioProcessStep", v)

def examplescenarioprocessstepalternative_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExampleScenarioProcessStepAlternative", v)

def examplescenarioprocessstepoperation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def explanationofbenefitaccident_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitAccident", v)

def explanationofbenefitadditem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitAddItem", v)

def explanationofbenefitadditemdetail_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitAddItemDetail", v)

def explanationofbenefitadditemdetailsubdetail_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitAddItemDetailSubDetail", v)

def explanationofbenefitbenefitbalance_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitBenefitBalance", v)

def explanationofbenefitbenefitbalancefinancial_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitBenefitBalanceFinancial", v)

def explanationofbenefitcareteam_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitCareTeam", v)

def explanationofbenefitdiagnosis_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def explanationofbenefititem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitItem", v)

def explanationofbenefititemadjudication_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitItemAdjudication", v)

def explanationofbenefititemdetail_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def explanationofbenefitpayment_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitPayment", v)

def explanationofbenefitprocedure_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitProcedure", v)

def explanationofbenefitprocessnote_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitProcessNote", v)

def explanationofbenefitrelated_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitRelated", v)

def explanationofbenefitsupportinginfo_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ExplanationOfBenefitSupportingInfo", v)

def explanationofbenefittotal_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def healthcareserviceavailabletime_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("HealthcareServiceAvailableTime", v)

def healthcareserviceeligibility_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("HealthcareServiceEligibility", v)

def healthcareservicenotavailable_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def imagingstudyseriesinstance_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImagingStudySeriesInstance", v)

def imagingstudyseriesperformer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def immunizationprotocolapplied_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def immunizationrecommendation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImmunizationRecommendation", v)

def immunizationrecommendationrecommendation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImmunizationRecommendationRecommendation", v)

def immunizationrecommendationrecommendationdatecriterion_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImmunizationRecommendationRecommendationDateCriterion", v)
...
def implementationguidedefinition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideDefinition", v)

def implementationguidedefinitiongrouping_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideDefinitionGrouping", v)

def implementationguidedefinitionpage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideDefinitionPage", v)

def implementationguidedefinitionparameter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideDefinitionParameter", v)

def implementationguidedefinitionresource_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideDefinitionResource", v)

def implementationguidedefinitiontemplate_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideDefinitionTemplate", v)

def implementationguidedependson_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideDependsOn", v)

def implementationguideglobal_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideGlobal", v)

def implementationguidemanifest_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideManifest", v)

def implementationguidemanifestpage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ImplementationGuideManifestPage", v)

def implementationguidemanifestresource_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def ingredientsubstancestrength_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("IngredientSubstanceStrength", v)

def ingredientsubstancestrengthreferencestrength_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def insuranceplancoveragebenefit_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("InsurancePlanCoverageBenefit", v)

def insuranceplancoveragebenefitlimit_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def insuranceplanplangeneralcost_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("InsurancePlanPlanGeneralCost", v)

def insuranceplanplanspecificcost_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("InsurancePlanPlanSpecificCost", v)

def insuranceplanplanspecificcostbenefit_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("InsurancePlanPlanSpecificCostBenefit", v)

def insuranceplanplanspecificcostbenefitcost_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def invoicelineitempricecomponent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def locationhoursofoperation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def manufactureditemdefinition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ManufacturedItemDefinition", v)

def manufactureditemdefinitionproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def measuregroupstratifiercomponent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def measurereportgrouppopulation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MeasureReportGroupPopulation", v)

def measurereportgroupstratifier_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MeasureReportGroupStratifier", v)

def measurereportgroupstratifierstratum_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MeasureReportGroupStratifierStratum", v)

def measurereportgroupstratifierstratumcomponent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MeasureReportGroupStratifierStratumComponent", v)

def measurereportgroupstratifierstratumpopulation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MeasureReportGroupStratifierStratumPopulation", v)

def measuresupplementaldata_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def medicationadministration_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationAdministration", v)

def medicationadministrationdosage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationAdministrationDosage", v)

def medicationadministrationperformer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def medicationdispenseperformer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationDispensePerformer", v)

def medicationdispensesubstitution_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def medicationknowledgeadministrationguidelines_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeAdministrationGuidelines", v)

def medicationknowledgeadministrationguidelinesdosage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeAdministrationGuidelinesDosage", v)

def medicationknowledgeadministrationguidelinespatientcharacteristics_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics", v)

def medicationknowledgecost_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeCost", v)

def medicationknowledgedrugcharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeDrugCharacteristic", v)

def medicationknowledgeingredient_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeIngredient", v)

def medicationknowledgekinetics_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeKinetics", v)

def medicationknowledgemedicineclassification_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeMedicineClassification", v)

def medicationknowledgemonitoringprogram_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeMonitoringProgram", v)

def medicationknowledgemonograph_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeMonograph", v)

def medicationknowledgepackaging_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgePackaging", v)

def medicationknowledgeregulatory_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeRegulatory", v)

def medicationknowledgeregulatorymaxdispense_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeRegulatoryMaxDispense", v)

def medicationknowledgeregulatoryschedule_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeRegulatorySchedule", v)

def medicationknowledgeregulatorysubstitution_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeRegulatorySubstitution", v)

def medicationknowledgerelatedmedicationknowledge_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def medicationrequestdispenserequest_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationRequestDispenseRequest", v)

def medicationrequestdispenserequestinitialfill_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def medicinalproductdefinitioncharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicinalProductDefinitionCharacteristic", v)

def medicinalproductdefinitioncontact_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicinalProductDefinitionContact", v)

def medicinalproductdefinitioncrossreference_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicinalProductDefinitionCrossReference", v)

def medicinalproductdefinitionname_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicinalProductDefinitionName", v)

def medicinalproductdefinitionnamecountrylanguage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicinalProductDefinitionNameCountryLanguage", v)

def medicinalproductdefinitionnamenamepart_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicinalProductDefinitionNameNamePart", v)

def medicinalproductdefinitionoperation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def messagedefinitionallowedresponse_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def messageheaderdestination_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def molecularsequencequality_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceQuality", v)

def molecularsequencequalityroc_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceQualityRoc", v)

def molecularsequencereferenceseq_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceReferenceSeq", v)

def molecularsequencerepository_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceRepository", v)

def molecularsequencestructurevariant_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceStructureVariant", v)

def molecularsequencestructurevariantinner_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceStructureVariantInner", v)

def molecularsequencestructurevariantouter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceStructureVariantOuter", v)

def molecularsequencevariant_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def nutritionproductingredient_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("NutritionProductIngredient", v)

def nutritionproductinstance_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("NutritionProductInstance", v)

def nutritionproductnutrient_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("NutritionProductNutrient", v)

def nutritionproductproductcharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def observationdefinitionqualifiedinterval_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def operationdefinitionoverload_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def operationdefinitionparameterreferencedfrom_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def organizationaffiliation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def packagedproductdefinition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PackagedProductDefinition", v)

def packagedproductdefinitionlegalstatusofsupply_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PackagedProductDefinitionLegalStatusOfSupply", v)

def packagedproductdefinitionpackage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PackagedProductDefinitionPackage", v)

def packagedproductdefinitionpackagecontaineditem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PackagedProductDefinitionPackageContainedItem", v)

def packagedproductdefinitionpackageproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PackagedProductDefinitionPackageProperty", v)

def packagedproductdefinitionpackageshelflifestorage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def paymentreconciliationprocessnote_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def plandefinitionactioncondition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PlanDefinitionActionCondition", v)

def plandefinitionactiondynamicvalue_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PlanDefinitionActionDynamicValue", v)

def plandefinitionactionparticipant_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PlanDefinitionActionParticipant", v)

def plandefinitionactionrelatedaction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def practitionerroleavailabletime_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PractitionerRoleAvailableTime", v)

def practitionerrolenotavailable_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def questionnaireitemansweroption_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("QuestionnaireItemAnswerOption", v)

def questionnaireitemenablewhen_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("QuestionnaireItemEnableWhen", v)

def questionnaireiteminitial_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def questionnaireresponseitem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("QuestionnaireResponseItem", v)

def questionnaireresponseitemanswer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def regulatedauthorizationcase_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def relatedpersoncommunication_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def requestgroupactioncondition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("RequestGroupActionCondition", v)

def requestgroupactionrelatedaction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def researchelementdefinition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ResearchElementDefinition", v)

def researchelementdefinitioncharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def searchparametercomponent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def specimendefinitiontypetested_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SpecimenDefinitionTypeTested", v)

def specimendefinitiontypetestedcontainer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SpecimenDefinitionTypeTestedContainer", v)

def specimendefinitiontypetestedcontaineradditive_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SpecimenDefinitionTypeTestedContainerAdditive", v)

def specimendefinitiontypetestedhandling_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def structuredefinitioncontext_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("StructureDefinitionContext", v)

def structuredefinitiondifferential_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("StructureDefinitionDifferential", v)

def structuredefinitionmapping_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("StructureDefinitionMapping", v)

def structuredefinitionsnapshot_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def structuremapgroupruledependent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("StructureMapGroupRuleDependent", v)

def structuremapgrouprulesource_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("StructureMapGroupRuleSource", v)

def structuremapgroupruletarget_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("StructureMapGroupRuleTarget", v)

def structuremapgroupruletargetparameter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def subscriptionstatusnotificationevent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def subscriptiontopiccanfilterby_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubscriptionTopicCanFilterBy", v)

def subscriptiontopiceventtrigger_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubscriptionTopicEventTrigger", v)

def subscriptiontopicnotificationshape_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubscriptionTopicNotificationShape", v)

def subscriptiontopicresourcetrigger_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubscriptionTopicResourceTrigger", v)

def subscriptiontopicresourcetriggerquerycriteria_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def substancedefinitionmoiety_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceDefinitionMoiety", v)

def substancedefinitionmolecularweight_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceDefinitionMolecularWeight", v)

def substancedefinitionname_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceDefinitionName", v)

def substancedefinitionnameofficial_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceDefinitionNameOfficial", v)

def substancedefinitionproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceDefinitionProperty", v)

def substancedefinitionrelationship_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceDefinitionRelationship", v)

def substancedefinitionsourcematerial_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceDefinitionSourceMaterial", v)

def substancedefinitionstructure_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceDefinitionStructure", v)

def substancedefinitionstructurerepresentation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def supplydeliverysupplieditem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def terminologycapabilities_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilities", v)

def terminologycapabilitiesclosure_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesClosure", v)

def terminologycapabilitiescodesystem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesCodeSystem", v)

def terminologycapabilitiescodesystemversion_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesCodeSystemVersion", v)

def terminologycapabilitiescodesystemversionfilter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesCodeSystemVersionFilter", v)

def terminologycapabilitiesexpansion_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesExpansion", v)

def terminologycapabilitiesexpansionparameter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesExpansionParameter", v)

def terminologycapabilitiesimplementation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesImplementation", v)

def terminologycapabilitiessoftware_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesSoftware", v)

def terminologycapabilitiestranslation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("TerminologyCapabilitiesTranslation", v)

def terminologycapabilitiesvalidatecode_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def testreportteardownaction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def valuesetcomposeincludeconcept_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ValueSetComposeIncludeConcept", v)

def valuesetcomposeincludeconceptdesignation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ValueSetComposeIncludeConceptDesignation", v)

def valuesetcomposeincludefilter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def valuesetexpansioncontains_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ValueSetExpansionContains", v)

def valuesetexpansionparameter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def verificationresultattestation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("VerificationResultAttestation", v)

def verificationresultprimarysource_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("VerificationResultPrimarySource", v)

def verificationresultvalidator_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def visionprescriptionlensspecification_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("VisionPrescriptionLensSpecification", v)

def visionprescriptionlensspecificationprism_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
