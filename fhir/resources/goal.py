...
class Goal(domainresource.DomainResource):
    ...
    "intended to be addressed by the goal."
		...
		enum_reference_types=["Condition", "Observation", "MedicationStatement", "NutritionOrder", "ServiceRequest", "RiskAssessment"],
	)
    ...
    expressedBy: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Practitioner", "PractitionerRole", "RelatedPerson"],
	)
    ...
    "cancelled | entered-in-error | rejected"
		...
		enum_values=["proposed", "planned", "accepted", "active", "on-hold", "completed", "cancelled", "entered-in-error", "rejected"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "lifecycleStatus", "achievementStatus", "category", "priority", "description", "subject", "startDate", "startCodeableConcept", "target", "statusDate", "statusReason", "expressedBy", "addresses", "note", "outcomeCode", "outcomeReference"]
    ...
    def validate_required_primitive_elements_566(
        ...
        """
        required_fields = [
			("lifecycleStatus", "lifecycleStatus__ext")]
        _missing = object()
...
class GoalTarget(backboneelement.BackboneElement):
    ...
    dueDate__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_dueDate",
        title="Extension field for ``dueDate``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "measure", "detailQuantity", "detailRange", "detailCodeableConcept", "detailString", "detailBoolean", "detailInteger", "detailRatio", "dueDate", "dueDuration"]
