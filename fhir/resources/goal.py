...
class Goal(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("achievementStatus", "achievementStatus", codeableconcept.CodeableConcept, "CodeableConcept", False, None, False),
...
class GoalTarget(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("detailBoolean", "detailBoolean", bool, "boolean", False, "detail", False),
            ("detailCodeableConcept", "detailCodeableConcept", codeableconcept.CodeableConcept, "CodeableConcept", False, "detail", False),
            ("detailInteger", "detailInteger", int, "integer", False, "detail", False),
            ...
            ("detailRatio", "detailRatio", ratio.Ratio, "Ratio", False, "detail", False),
