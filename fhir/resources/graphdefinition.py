...
class GraphDefinition(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "url", "version", "name", "status", "experimental", "date", "publisher", "contact", "description", "useContext", "jurisdiction", "purpose", "start", "profile", "link"]
...
class GraphDefinitionLinkTargetCompartment(backboneelement.BackboneElement):
    ...
    rule__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_rule",
        title="Extension field for ``rule``."
    )
