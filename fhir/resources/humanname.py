...
class HumanName(element.Element):
    ...
    given__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_given",
    ...
    prefix__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_prefix",
    ...
    suffix__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_suffix",
    ...
    use: fhirtypes.Code = Field(
		...
		enum_values=["usual", "official", "temp", "nickname", "anonymous", "old", "maiden"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "extension", "use", "text", "family", "given", "prefix", "suffix", "period"]
