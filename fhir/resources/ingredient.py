...
class Ingredient(domainresource.DomainResource):
    ...
    for_fhir: typing.List[fhirtypes.ReferenceType] = Field(
		...
		enum_reference_types=["MedicinalProductDefinition", "AdministrableProductDefinition", "ManufacturedItemDefinition"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "for", "role", "function", "allergenicIndicator", "manufacturer", "substance"]
...
class IngredientSubstanceStrength(backboneelement.BackboneElement):
    ...
    referenceStrength: typing.List[fhirtypes.IngredientSubstanceStrengthReferenceStrengthType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "presentationRatio", "presentationRatioRange", "textPresentation", "concentrationRatio", "concentrationRatioRange", "textConcentration", "measurementPoint", "country", "referenceStrength"]
...
class IngredientSubstanceStrengthReferenceStrength(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "substance", "strengthRatio", "strengthRatioRange", "measurementPoint", "country"]
