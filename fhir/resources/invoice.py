...
class Invoice(domainresource.DomainResource):
    ...
    totalPriceComponent: typing.List[fhirtypes.InvoiceLineItemPriceComponentType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "cancelledReason", "type", "subject", "recipient", "date", "participant", "issuer", "account", "lineItem", "totalPriceComponent", "totalNet", "totalGross", "paymentTerms", "note"]
...
class InvoiceLineItem(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "sequence", "chargeItemReference", "chargeItemCodeableConcept", "priceComponent"]
...
class InvoiceParticipant(backboneelement.BackboneElement):
    ...
    "service."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Practitioner", "Organization", "Patient", "PractitionerRole", "Device", "RelatedPerson"],
	)
