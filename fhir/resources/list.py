...
class List(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "mode", "title", "code", "subject", "encounter", "date", "source", "orderedBy", "note", "entry", "emptyReason"]
...
class ListEntry(backboneelement.BackboneElement):
    ...
    deleted__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_deleted",
        title="Extension field for ``deleted``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "flag", "deleted", "date", "item"]
