...
class Location(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("hoursOfOperation", "hoursOfOperation", LocationHoursOfOperation, "LocationHoursOfOperation", True, None, False),
...
class LocationHoursOfOperation(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("closingTime", "closingTime", fhirdate.FHIRDate, "time", False, None, False),
            ("daysOfWeek", "daysOfWeek", str, "code", True, None, False),
            ("openingTime", "openingTime", fhirdate.FHIRDate, "time", False, None, False),
        ])
        return js
