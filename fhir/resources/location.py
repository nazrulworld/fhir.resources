...
class Location(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "operationalStatus", "name", "alias", "description", "mode", "type", "telecom", "address", "physicalType", "position", "managingOrganization", "partOf", "hoursOfOperation", "availabilityExceptions", "endpoint"]
...
class LocationHoursOfOperation(backboneelement.BackboneElement):
    ...
    closingTime__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_closingTime",
        title="Extension field for ``closingTime``."
    )
    ...
    daysOfWeek__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_daysOfWeek",
    ...
    openingTime__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_openingTime",
        title="Extension field for ``openingTime``."
    )
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "daysOfWeek", "allDay", "openingTime", "closingTime"]
...
class LocationPosition(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "longitude", "latitude", "altitude"]
