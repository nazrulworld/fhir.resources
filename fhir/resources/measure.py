...
class Measure(domainresource.DomainResource):
    ...
    definition__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_definition",
    ...
    disclaimer__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_disclaimer",
        title="Extension field for ``disclaimer``."
    )
    ...
    guidance__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_guidance",
        title="Extension field for ``guidance``."
    )
...
class MeasureGroup(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "code", "description", "population", "stratifier"]
