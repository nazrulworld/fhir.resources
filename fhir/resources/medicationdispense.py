...
class MedicationDispense(domainresource.DomainResource):
    ...
    "in-error | stopped | declined | unknown"
		...
		enum_values=["preparation", "in-progress", "cancelled", "on-hold", "completed", "entered-in-error", "stopped", "declined", "unknown"],
	)
...
class MedicationDispenseSubstitution(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "wasSubstituted", "type", "reason", "responsibleParty"]
    ...
    def validate_required_primitive_elements_3344(
        ...
        """
        required_fields = [
			("wasSubstituted", "wasSubstituted__ext")]
        _missing = object()
