...
class MedicinalProductDefinition(domainresource.DomainResource):
    ...
    characteristic: typing.List[fhirtypes.MedicinalProductDefinitionCharacteristicType] = Field(
		None,
    ...
    crossReference: typing.List[fhirtypes.MedicinalProductDefinitionCrossReferenceType] = Field(
		None,
    ...
    indication__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_indication",
        title="Extension field for ``indication``."
    )
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "type", "domain", "version", "status", "statusDate", "description", "combinedPharmaceuticalDoseForm", "route", "indication", "legalStatusOfSupply", "additionalMonitoringIndicator", "specialMeasures", "pediatricUseIndicator", "classification", "marketingStatus", "packagedMedicinalProduct", "ingredient", "impurity", "attachedDocument", "masterFile", "contact", "clinicalTrial", "code", "name", "crossReference", "operation", "characteristic"]
...
class MedicinalProductDefinitionName(backboneelement.BackboneElement):
    ...
    countryLanguage: typing.List[fhirtypes.MedicinalProductDefinitionNameCountryLanguageType] = Field(
		None,
    ...
    productName__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_productName",
        title="Extension field for ``productName``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "productName", "type", "namePart", "countryLanguage"]
...
class MedicinalProductDefinitionNameCountryLanguage(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "country", "jurisdiction", "language"]
...
class MedicinalProductDefinitionNameNamePart(backboneelement.BackboneElement):
    ...
    part__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_part",
        title="Extension field for ``part``."
    )
...
class MedicinalProductDefinitionOperation(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "effectiveDate", "organization", "confidentialityIndicator"]
