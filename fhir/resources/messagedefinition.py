...
class MessageDefinition(domainresource.DomainResource):
    ...
    allowedResponse: typing.List[fhirtypes.MessageDefinitionAllowedResponseType] = Field(
		None,
    ...
    eventUri__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_eventUri",
        title="Extension field for ``eventUri``."
    )
    ...
    graph__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_graph",
        title="Extension field for ``graph``."
    )
    ...
    parent__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_parent",
...
class MessageDefinitionAllowedResponse(backboneelement.BackboneElement):
    ...
    situation__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_situation",
        title="Extension field for ``situation``."
    )
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
