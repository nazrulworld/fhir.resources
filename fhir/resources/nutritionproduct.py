...
class NutritionProduct(domainresource.DomainResource):
    ...
    productCharacteristic: typing.List[fhirtypes.NutritionProductProductCharacteristicType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "status", "category", "code", "manufacturer", "nutrient", "ingredient", "knownAllergen", "productCharacteristic", "instance", "note"]
...
class NutritionProductInstance(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "quantity", "identifier", "lotNumber", "expiry", "useBy"]
