...
class PackagedProductDefinition(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "name", "type", "packageFor", "status", "statusDate", "containedItemQuantity", "description", "legalStatusOfSupply", "marketingStatus", "characteristic", "copackagedIndicator", "manufacturer", "package"]
...
class PackagedProductDefinitionPackage(backboneelement.BackboneElement):
    ...
    containedItem: typing.List[fhirtypes.PackagedProductDefinitionPackageContainedItemType] = Field(
		None,
		alias="containedItem",
    ...
    property: typing.List[fhirtypes.PackagedProductDefinitionPackagePropertyType] = Field(
		None,
		alias="property",
    ...
    shelfLifeStorage: typing.List[fhirtypes.PackagedProductDefinitionPackageShelfLifeStorageType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "identifier", "type", "quantity", "material", "alternateMaterial", "shelfLifeStorage", "manufacturer", "property", "containedItem", "package"]
...
class PackagedProductDefinitionPackageShelfLifeStorage(backboneelement.BackboneElement):
    ...
    """
    resource_type = Field("PackagedProductDefinitionPackageShelfLifeStorage", const=True)
