...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/PaymentNotice) on 2019-05-13.
...
class PaymentNotice(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("payment", "payment", fhirreference.FHIRReference, "Reference", False, None, True),
            ("paymentDate", "paymentDate", fhirdate.FHIRDate, "date", False, None, False),
            ...
            ("recipient", "recipient", fhirreference.FHIRReference, "Reference", False, None, True),
