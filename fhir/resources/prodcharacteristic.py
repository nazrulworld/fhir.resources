...
class ProdCharacteristic(backboneelement.BackboneElement):
    ...
    color__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_color",
    ...
    imprint__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_imprint",
        title="Extension field for ``imprint``."
    )
    ...
    shape__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_shape",
        title="Extension field for ``shape``."
    )
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "extension", "modifierExtension", "height", "width", "depth", "weight", "nominalVolume", "externalDiameter", "shape", "color", "imprint", "image", "scoring"]
