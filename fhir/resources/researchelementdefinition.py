...
class ResearchElementDefinition(domainresource.DomainResource):
    ...
    characteristic: typing.List[fhirtypes.ResearchElementDefinitionCharacteristicType] = Field(
		...,
    ...
    comment__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_comment",
