...
class SearchParameter(domainresource.DomainResource):
    ...
    base__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_base",
    ...
    chain__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_chain",
    ...
    "| type | identifier | ofType"
        ...
        # note: Enum values can be used in validation,
        # but use in your own responsibilities, read official FHIR documentation.
		enum_values=["missing", "exact", "contains", "not", "text", "in", "not-in", "below", "above", "type", "identifier", "ofType"],
	)
    ...
    target__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_target",
    ...
    xpathUsage__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_xpathUsage",
        title="Extension field for ``xpathUsage``."
    )
    @classmethod
