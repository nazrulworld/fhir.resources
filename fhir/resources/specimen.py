...
class Specimen(domainresource.DomainResource):
    ...
    subject: fhirtypes.ReferenceType = Field(
        None,
        alias="subject",
        title="Type `Reference` referencing `Patient, Group, Device, Substance, Location` (represented as `dict` in JSON)",
...
class SpecimenCollection(backboneelement.BackboneElement):
    ...
    fastingStatusCodeableConcept: fhirtypes.CodeableConceptType = Field(
        ...
        one_of_many="fastingStatus",  # Choice of Data Types. i.e value[x]
        one_of_many_required=False,
    )
