...
class SubscriptionStatus(domainresource.DomainResource):
    ...
    notificationEvent: typing.List[fhirtypes.SubscriptionStatusNotificationEventType] = Field(
		None,
    ...
    topic__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_topic",
        title="Extension field for ``topic``."
    )
    ...
    "event"
        ...
        # note: Enum values can be used in validation,
        # but use in your own responsibilities, read official FHIR documentation.
		enum_values=["handshake", "heartbeat", "event-notification", "query-status", "query-event"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "status", "type", "eventsSinceSubscriptionStart", "notificationEvent", "subscription", "topic", "error"]
...
class SubscriptionStatusNotificationEvent(backboneelement.BackboneElement):
    ...
    eventNumber__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_eventNumber",
        title="Extension field for ``eventNumber``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "eventNumber", "timestamp", "focus", "additionalContext"]
