...
class SubscriptionTopic(domainresource.DomainResource):
    ...
    resourceTrigger: typing.List[fhirtypes.SubscriptionTopicResourceTriggerType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "url", "identifier", "version", "title", "derivedFrom", "status", "experimental", "date", "publisher", "contact", "description", "useContext", "jurisdiction", "purpose", "copyright", "approvalDate", "lastReviewDate", "effectivePeriod", "resourceTrigger", "eventTrigger", "canFilterBy", "notificationShape"]
...
class SubscriptionTopicEventTrigger(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "event", "resource"]
...
class SubscriptionTopicNotificationShape(backboneelement.BackboneElement):
    ...
    include__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_include",
        title="Extension field for ``include``."
    )
    ...
    revInclude__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_revInclude",
        title="Extension field for ``revInclude``."
    )
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "resource", "include", "revInclude"]
...
class SubscriptionTopicResourceTrigger(backboneelement.BackboneElement):
    ...
    supportedInteraction: typing.List[fhirtypes.Code] = Field(
		None,
    ...
    supportedInteraction__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "resource", "supportedInteraction", "queryCriteria", "fhirPathCriteria"]
...
class SubscriptionTopicResourceTriggerQueryCriteria(backboneelement.BackboneElement):
    ...
    current__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_current",
        title="Extension field for ``current``."
    )
    ...
    previous__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_previous",
        title="Extension field for ``previous``."
    )
    ...
    requireBoth__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_requireBoth",
        title="Extension field for ``requireBoth``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "previous", "resultForCreate", "current", "resultForDelete", "requireBoth"]
