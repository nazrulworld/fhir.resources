...
class SubstancePolymer(domainresource.DomainResource):
    ...
    modification: fhirtypes.StringType = Field(
        None,
        alias="modification",
        title=(
...
class SubstancePolymerRepeat(backboneelement.BackboneElement):
    ...
    averageMolecularFormula: fhirtypes.StringType = Field(
        None,
...
class SubstancePolymerRepeatRepeatUnit(backboneelement.BackboneElement):
    ...
    amount: fhirtypes.IntegerType = Field(
        None,
        alias="amount",
...
class SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation(
    ...
    average: fhirtypes.IntegerType = Field(
        None,
        alias="average",
    ...
    high: fhirtypes.IntegerType = Field(
        None,
        alias="high",
    ...
    low: fhirtypes.IntegerType = Field(
        None,
        alias="low",
