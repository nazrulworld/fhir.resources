...
def impl_activitydefinition_1(inst):
    ...
    assert inst.relatedArtifact[0].document.url == "https://www.cdc.gov/zika/hc-providers/pregnant-woman.html"
    assert inst.relatedArtifact[0].type == "derived-from"
    assert inst.relatedArtifact[0].url == "https://www.cdc.gov/zika/hc-providers/pregnant-woman.html"
...
def test_activitydefinition_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-administer-zika-virus-exposure-assessment.json"
    )
...
def impl_activitydefinition_2(inst):
    ...
    assert inst.participant[0].type == "practitioner"
    assert inst.relatedArtifact[0].display == "Advice for patients about how to avoid Mosquito bites."
    assert inst.relatedArtifact[0].document.url == "http://www.cdc.gov/zika/prevention/index.html"
    assert inst.relatedArtifact[0].type == "documentation"
    assert inst.relatedArtifact[0].url == "http://www.cdc.gov/zika/prevention/index.html"
    ...
    "https://www.epa.gov/insect-repellents/find-insect-repellent-"
    "right-you"
    )
    ...
    assert inst.text.status == "generated"
    assert inst.url == (
    "http://example.org/ActivityDefinition/provide-mosquito-"
    "prevention-advice"
    )
...
def test_activitydefinition_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-provide-mosquito-prevention-advice.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_activitydefinition_3(inst):
    ...
    assert inst.useContext[3].valueCodeableConcept.coding[0].display == "At risk for suicide (finding)"
    ...
    assert inst.useContext[4].valueCodeableConcept.coding[0].display == "Referral to service (procedure)"
...
def test_activitydefinition_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-predecessor-example.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_activitydefinition_4(inst):
    ...
    assert inst.relatedArtifact[0].document.url == "http://www.cdc.gov/zika/hc-providers/diagnostic.html"
    assert inst.relatedArtifact[0].type == "documentation"
    assert inst.relatedArtifact[0].url == "http://www.cdc.gov/zika/hc-providers/diagnostic.html"
    assert inst.relatedArtifact[1].resource == (
    "http://example.org/fhir/ActivityDefinition/serum-dengue-"
    "virus-igm"
    )
    ...
    assert inst.text.status == "generated"
    assert inst.url == (
    "http://example.org/ActivityDefinition/serum-zika-dengue-"
    "virus-igm"
    )
...
def test_activitydefinition_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-order-serum-zika-dengue-virus-igm.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_activitydefinition_5(inst):
    ...
    assert inst.dynamicValue[0].expression.description == "dispenseRequest.numberOfRepeatsAllowed is three (3)"
    ...
    assert inst.dynamicValue[1].expression.description == "dispenseRequest.quantity is thirty (30) tablets"
    ...
    assert inst.url == (
    "http://motivemi.com/artifacts/ActivityDefinition/citalopramP"
    "rescription"
    )
    assert inst.usage == (
    "This activity definition is used as part of various suicide "
    "risk order sets"
    )
    assert inst.useContext[0].code.code == "age"
    assert inst.useContext[0].code.system == "http://terminology.hl7.org/CodeSystem/usage-context-type"
...
def test_activitydefinition_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-medicationorder-example.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_activitydefinition_6(inst):
    ...
    assert inst.dosage[1].doseAndRate[0].doseQuantity.system == "http://unitsofmeasure.org"
    ...
    assert inst.dosage[1].doseAndRate[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/dose-rate-type"
...
def test_activitydefinition_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-example-alteplase-dosing.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_activitydefinition_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-example.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_activitydefinition_8(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-order-serum-dengue-virus-igm.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_activitydefinition_9(inst):
    ...
    assert inst.participant[0].role.coding[0].system == "http://nucc.org/provider-taxonomy"
    assert inst.participant[0].role.text == "Interventional Cardiology"
    assert inst.participant[0].type == "practitioner"
    assert inst.purpose == "Describes the proposal to perform a Heart Valve replacement."
    assert inst.status == "draft"
    assert inst.text.status == "generated"
...
def test_activitydefinition_9(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-servicerequest-example.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_activitydefinition_10(inst):
    ...
    assert inst.meta.tag[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    assert inst.purpose == (
    "Describes a request for 10 Blood collection tubes with blue "
    "caps."
    )
    assert float(inst.quantity.value) == float(10)
    assert inst.status == "draft"
    assert inst.text.status == "generated"
    assert inst.transform == "http://example.org/fhir/StructureMap/supplyrequest-transform"
...
def test_activitydefinition_10(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "activitydefinition-supplyrequest-example.json"
    )
    inst = activitydefinition.ActivityDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
