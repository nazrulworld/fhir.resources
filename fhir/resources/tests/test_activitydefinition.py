...
class ActivityDefinitionTests(unittest.TestCase):
    ...
    def implActivityDefinition1(self, inst):
        ...
        self.assertEqual(
            ...
            force_bytes("Library/zika-virus-intervention-logic"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            force_bytes("Questionnaire/zika-virus-exposure-assessment"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.useContext[0].valueRange.low.unit), force_bytes("a")
        )
    ...
    def implActivityDefinition4(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.relatedArtifact[1].resource),
            force_bytes("ActivityDefinition/serum-dengue-virus-igm"),
        )
        self.assertEqual(
    ...
    def implActivityDefinition5(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.dynamicValue[0].expression.description),
            force_bytes("dispenseRequest.numberOfRepeatsAllowed is three (3)"),
        )
        self.assertEqual(
            force_bytes(inst.dynamicValue[0].expression.expression), force_bytes("3")
        )
        self.assertEqual(
            force_bytes(inst.dynamicValue[0].expression.language),
        ...
        self.assertEqual(
            force_bytes(inst.dynamicValue[1].expression.description),
            force_bytes("dispenseRequest.quantity is thirty (30) tablets"),
        )
        self.assertEqual(
            force_bytes(inst.dynamicValue[1].expression.expression),
            force_bytes("30 '{tbl}'"),
        )
        self.assertEqual(
            force_bytes(inst.dynamicValue[1].expression.language),
            force_bytes("text/cql"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.relatedArtifact[1].resource),
            force_bytes("#citalopramMedication"),
        )
        self.assertEqual(
    ...
    def implActivityDefinition6(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.relatedArtifact[1].resource),
            force_bytes("ActivityDefinition/referralPrimaryCareMentalHealth-initial"),
        )
        self.assertEqual(
    ...
    def implActivityDefinition9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(
            force_bytes(inst.transform),
            force_bytes("StructureMap/supplyrequest-transform"),
        )
