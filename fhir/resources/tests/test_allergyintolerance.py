...
class AllergyIntoleranceTests(unittest.TestCase):
    ...
    def implAllergyIntolerance1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.code.coding[0].code), force_bytes("716184000"))
        self.assertEqual(force_bytes(inst.code.coding[0].display), force_bytes("No Known Latex Allergy (situation)"))
        self.assertEqual(force_bytes(inst.code.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.code.text), force_bytes("No Known Latex Allergy"))
        self.assertEqual(force_bytes(inst.id), force_bytes("nkla"))
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
        self.assertEqual(inst.recordedDate.date, FHIRDate("2015-08-06T15:37:31-06:00").date)
    ...
    def implAllergyIntolerance3(self, inst):
        ...
        self.assertEqual(force_bytes(inst.clinicalStatus.coding[0].display), force_bytes("Active"))
        self.assertEqual(force_bytes(inst.clinicalStatus.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/allergyintolerance-clinical"))
        self.assertEqual(force_bytes(inst.code.coding[0].code), force_bytes("716186003"))
        self.assertEqual(force_bytes(inst.code.coding[0].display), force_bytes("No Known Allergy (situation)"))
        self.assertEqual(force_bytes(inst.code.coding[0].system), force_bytes("http://snomed.info/sct"))
    ...
    def implAllergyIntolerance4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.verificationStatus.coding[0].code), force_bytes("unconfirmed"))
        self.assertEqual(force_bytes(inst.verificationStatus.coding[0].display), force_bytes("Unconfirmed"))
        self.assertEqual(force_bytes(inst.verificationStatus.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/allergyintolerance-verification"))
    ...
    def implAllergyIntolerance6(self, inst):
        ...
        self.assertEqual(force_bytes(inst.clinicalStatus.coding[0].display), force_bytes("Active"))
        self.assertEqual(force_bytes(inst.clinicalStatus.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/allergyintolerance-clinical"))
        self.assertEqual(force_bytes(inst.code.coding[0].code), force_bytes("409137002"))
        self.assertEqual(force_bytes(inst.code.coding[0].display), force_bytes("No Known Drug Allergy (situation)"))
        self.assertEqual(force_bytes(inst.code.coding[0].system), force_bytes("http://snomed.info/sct"))
