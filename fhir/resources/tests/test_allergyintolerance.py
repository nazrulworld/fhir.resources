...
def test_allergyintolerance_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "allergyintolerance-nkla.json"
    )
...
def test_allergyintolerance_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "allergyintolerance-example.json"
    )
    inst = allergyintolerance.AllergyIntolerance.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_allergyintolerance_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "allergyintolerance-nka.json"
    )
    inst = allergyintolerance.AllergyIntolerance.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_allergyintolerance_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "allergyintolerance-medication.json"
    )
    inst = allergyintolerance.AllergyIntolerance.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_allergyintolerance_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "allergyintolerance-nkda.json"
    )
    inst = allergyintolerance.AllergyIntolerance.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
