...
class AppointmentTests(unittest.TestCase):
    ...
    def implAppointment1(self, inst):
        self.assertEqual(
            force_bytes(inst.appointmentType.coding[0].code), force_bytes("FOLLOWUP")
        )
        self.assertEqual(
            force_bytes(inst.appointmentType.coding[0].display),
            force_bytes("A follow up visit from a previous appointment"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.serviceCategory[0].coding[0].code), force_bytes("gp")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.serviceCategory[0].coding[0].system),
        ...
        self.assertEqual(
            force_bytes(inst.specialty[0].coding[0].code), force_bytes("394814009")
        )
        self.assertEqual(
    ...
    def implAppointment2(self, inst):
        ...
        self.assertEqual(inst.priority, 5)
        self.assertEqual(
            force_bytes(inst.reasonCode[0].coding[0].code), force_bytes("413095006")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.reasonCode[0].text), force_bytes("Clinical Review")
        )
