...
def impl_auditevent_1(inst):
    ...
    assert inst.entity[0].role.system == "http://terminology.hl7.org/CodeSystem/object-role"
    assert inst.entity[0].type.code == "2"
    assert inst.entity[0].type.display == "System Object"
    assert inst.entity[0].type.system == "http://terminology.hl7.org/CodeSystem/audit-entity-type"
    ...
    assert inst.source.type[0].system == "http://terminology.hl7.org/CodeSystem/security-source-type"
...
def impl_auditevent_3(inst):
    ...
    assert inst.entity[0].lifecycle.system == "http://terminology.hl7.org/CodeSystem/dicom-audit-lifecycle"
    assert inst.entity[0].type.code == "2"
    assert inst.entity[0].type.display == "System Object"
    assert inst.entity[0].type.system == "http://terminology.hl7.org/CodeSystem/audit-entity-type"
...
def impl_auditevent_4(inst):
    ...
    assert inst.agent[2].type.coding[0].system == "http://dicom.nema.org/resources/ontology/DCM"
    ...
    assert inst.entity[1].role.system == "http://terminology.hl7.org/CodeSystem/object-role"
    assert inst.entity[1].type.code == "2"
    assert inst.entity[1].type.display == "System Object"
    assert inst.entity[1].type.system == "http://terminology.hl7.org/CodeSystem/audit-entity-type"
    assert inst.entity[1].what.identifier.type.coding[0].code == "IHE XDS Metadata"
    assert inst.entity[1].what.identifier.type.coding[0].display == "submission set classificationNode"
    assert inst.entity[1].what.identifier.type.coding[0].system == "urn:uuid:a54d6aa5-d40d-43f9-88c5-b4633d873bdd"
    assert inst.entity[1].what.identifier.value == "e3cdfc81a0d24bd^^^&2.16.840.1.113883.4.2&ISO"
    assert inst.entity[2].type.code == "2"
    assert inst.entity[2].type.display == "System Object"
    assert inst.entity[2].type.system == "http://terminology.hl7.org/CodeSystem/audit-entity-type"
...
def test_auditevent_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "audit-event-example-media.json"
    )
    inst = auditevent.AuditEvent.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_auditevent_7(inst):
    ...
    assert inst.entity[0].what.identifier.type.coding[0].system == "http://terminology.hl7.org/CodeSystem/v2-0203"
...
def test_auditevent_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "auditevent-example.json"
    )
    inst = auditevent.AuditEvent.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_auditevent_8(inst):
    ...
    assert inst.agent[1].purposeOfUse[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    assert inst.agent[1].requestor is False
    ...
    assert inst.entity[1].lifecycle.system == "http://terminology.hl7.org/CodeSystem/dicom-audit-lifecycle"
    ...
    assert inst.entity[1].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    assert inst.entity[1].securityLabel[1].code == "STD"
    assert inst.entity[1].securityLabel[1].display == "sexually transmitted disease information sensitivity"
    assert inst.entity[1].securityLabel[1].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.entity[1].securityLabel[2].code == "DELAU"
    assert inst.entity[1].securityLabel[2].display == "delete after use"
    assert inst.entity[1].securityLabel[2].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.entity[1].type.code == "2"
    assert inst.entity[1].type.display == "System Object"
    assert inst.entity[1].type.system == "http://terminology.hl7.org/CodeSystem/audit-entity-type"
    ...
    assert inst.purposeOfEvent[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
