...
def impl_capabilitystatement_4(inst):
    ...
    assert inst.rest[0].mode == "server"
    assert inst.rest[0].operation[0].definition == "http://hl7.org/fhir/OperationDefinition/ValueSet-expand"
    ...
    assert inst.rest[0].operation[1].definition == "http://hl7.org/fhir/OperationDefinition/CodeSystem-lookup"
    ...
    assert inst.rest[0].operation[3].definition == "http://hl7.org/fhir/OperationDefinition/ConceptMap-translate"
    ...
    assert inst.rest[0].operation[4].definition == "http://hl7.org/fhir/OperationDefinition/ConceptMap-closure"
    ...
    assert inst.rest[0].resource[0].interaction[1].code == "search-type"
    assert inst.rest[0].resource[0].interaction[1].documentation == "Search allows clients to find value sets on the server"
    ...
    assert inst.rest[0].resource[0].profile == "http://hl7.org/fhir/StructureDefinition/ValueSet"
    assert inst.rest[0].resource[0].searchParam[0].definition == "http://hl7.org/fhir/SearchParameter/ValueSet-date"
    assert inst.rest[0].resource[0].searchParam[0].name == "date"
    assert inst.rest[0].resource[0].searchParam[0].type == "date"
    assert inst.rest[0].resource[0].searchParam[1].definition == "http://hl7.org/fhir/SearchParameter/ValueSet-name"
    assert inst.rest[0].resource[0].searchParam[1].name == "name"
    assert inst.rest[0].resource[0].searchParam[1].type == "string"
    assert inst.rest[0].resource[0].searchParam[2].definition == "http://hl7.org/fhir/SearchParameter/ValueSet-reference"
    assert inst.rest[0].resource[0].searchParam[2].name == "reference"
    assert inst.rest[0].resource[0].searchParam[2].type == "uri"
    assert inst.rest[0].resource[0].searchParam[3].definition == "http://hl7.org/fhir/SearchParameter/ValueSet-status"
    assert inst.rest[0].resource[0].searchParam[3].name == "status"
    assert inst.rest[0].resource[0].searchParam[3].type == "token"
    assert inst.rest[0].resource[0].searchParam[4].definition == "http://hl7.org/fhir/SearchParameter/ValueSet-url"
    assert inst.rest[0].resource[0].searchParam[4].name == "url"
    assert inst.rest[0].resource[0].searchParam[4].type == "uri"
    assert inst.rest[0].resource[0].searchParam[5].definition == "http://hl7.org/fhir/SearchParameter/ValueSet-version"
    ...
    assert inst.rest[0].resource[1].interaction[1].documentation == "Search allows clients to find concept maps on the server"
    ...
    assert inst.rest[0].resource[1].profile == "http://hl7.org/fhir/StructureDefinition/ConceptMap"
    assert inst.rest[0].resource[1].searchParam[0].definition == "http://hl7.org/fhir/SearchParameter/ConceptMap-date"
    assert inst.rest[0].resource[1].searchParam[0].name == "date"
    assert inst.rest[0].resource[1].searchParam[0].type == "date"
    assert inst.rest[0].resource[1].searchParam[1].definition == "http://hl7.org/fhir/SearchParameter/ConceptMap-name"
    assert inst.rest[0].resource[1].searchParam[1].name == "name"
    assert inst.rest[0].resource[1].searchParam[1].type == "string"
    assert inst.rest[0].resource[1].searchParam[2].definition == "http://hl7.org/fhir/SearchParameter/ConceptMap-status"
    assert inst.rest[0].resource[1].searchParam[2].name == "status"
    assert inst.rest[0].resource[1].searchParam[2].type == "token"
    assert inst.rest[0].resource[1].searchParam[3].definition == "http://hl7.org/fhir/SearchParameter/ConceptMap-source"
    assert inst.rest[0].resource[1].searchParam[3].name == "source"
    assert inst.rest[0].resource[1].searchParam[3].type == "reference"
    assert inst.rest[0].resource[1].searchParam[4].definition == "http://hl7.org/fhir/SearchParameter/ConceptMap-target"
    assert inst.rest[0].resource[1].searchParam[4].name == "target"
    assert inst.rest[0].resource[1].searchParam[4].type == "reference"
    assert inst.rest[0].resource[1].searchParam[5].definition == "http://hl7.org/fhir/SearchParameter/ConceptMap-url"
    assert inst.rest[0].resource[1].searchParam[5].name == "url"
    assert inst.rest[0].resource[1].searchParam[5].type == "uri"
    assert inst.rest[0].resource[1].searchParam[6].definition == "http://hl7.org/fhir/SearchParameter/ConceptMap-version"
...
def impl_capabilitystatement_8(inst):
    ...
    "http://hl7.org/fhir/OperationDefinition/capabilitystatement-"
    "subset"
    )
    ...
    assert inst.rest[0].resource[0].searchParam[6].definition == "http://hl7.org/fhir/SearchParameter/Account-type"
    assert inst.rest[0].resource[0].searchParam[6].documentation == "E.g. patient, expense, depreciation"
    assert inst.rest[0].resource[0].searchParam[6].name == "type"
    assert inst.rest[0].resource[0].searchParam[6].type == "token"
    assert inst.rest[0].resource[0].searchParam[7].definition == "http://hl7.org/fhir/SearchParameter/Account-status"
    assert inst.rest[0].resource[0].searchParam[7].documentation == "active | inactive | entered-in-error | on-hold | unknown"
    ...
    assert inst.rest[0].resource[1].searchParam[4].documentation == "Intended jurisdiction for the activity definition"
    ...
    assert inst.rest[0].resource[1].searchParam[5].documentation == "What resource is being referenced"
    ...
    assert inst.rest[0].resource[1].searchParam[6].documentation == "The description of the activity definition"
    ...
    assert inst.rest[0].resource[1].searchParam[7].documentation == "A type of use context assigned to the activity definition"
    ...
    assert inst.rest[0].resource[1].searchParam[8].documentation == "What resource is being referenced"
    ...
    assert inst.rest[0].resource[1].searchRevInclude[7] == "NutritionOrder.instantiates-canonical"
    assert inst.rest[0].resource[1].searchRevInclude[8] == "PlanDefinition.definition"
    assert inst.rest[0].resource[1].searchRevInclude[9] == "Procedure.instantiates-canonical"
    ...
    assert inst.rest[0].resource[2].searchInclude[0] == "AdministrableProductDefinition.manufactured-item"
    assert inst.rest[0].resource[2].searchInclude[1] == "AdministrableProductDefinition.device"
    assert inst.rest[0].resource[2].searchInclude[2] == "AdministrableProductDefinition.form-of"
    assert inst.rest[0].resource[2].searchParam[0].definition == (
    "http://hl7.org/fhir/SearchParameter/AdministrableProductDefi"
    "nition-identifier"
    )
    assert inst.rest[0].resource[2].searchParam[0].documentation == "An identifier for the administrable product"
    ...
    assert inst.rest[0].resource[2].searchParam[2].documentation == "The ingredients of this administrable medicinal product"
    ...
    assert inst.rest[0].resource[2].searchParam[3].documentation == "Coded expression for the route"
    ...
    assert inst.rest[0].resource[2].searchParam[7].documentation == "Coded expression for the species"
    ...
    assert inst.rest[0].resource[3].profile == "http://hl7.org/fhir/StructureDefinition/AdverseEvent"
    ...
    assert inst.rest[0].resource[3].searchInclude[3] == "AdverseEvent.resultingcondition"
    ...
    assert inst.rest[0].resource[3].searchParam[0].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-date"
    assert inst.rest[0].resource[3].searchParam[0].documentation == "When the event occurred"
    assert inst.rest[0].resource[3].searchParam[0].name == "date"
    assert inst.rest[0].resource[3].searchParam[0].type == "date"
    assert inst.rest[0].resource[3].searchParam[1].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-severity"
    assert inst.rest[0].resource[3].searchParam[1].documentation == "mild | moderate | severe"
    assert inst.rest[0].resource[3].searchParam[1].name == "severity"
    assert inst.rest[0].resource[3].searchParam[1].type == "token"
    assert inst.rest[0].resource[3].searchParam[2].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-recorder"
    assert inst.rest[0].resource[3].searchParam[2].documentation == "Who recorded the adverse event"
    assert inst.rest[0].resource[3].searchParam[2].name == "recorder"
    assert inst.rest[0].resource[3].searchParam[2].type == "reference"
    assert inst.rest[0].resource[3].searchParam[3].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-study"
    ...
    assert inst.rest[0].resource[3].searchParam[4].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-actuality"
    ...
    assert inst.rest[0].resource[3].searchParam[4].type == "token"
    assert inst.rest[0].resource[3].searchParam[5].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-seriousness"
    assert inst.rest[0].resource[3].searchParam[5].documentation == "Seriousness of the event"
    assert inst.rest[0].resource[3].searchParam[5].name == "seriousness"
    assert inst.rest[0].resource[3].searchParam[5].type == "token"
    assert inst.rest[0].resource[3].searchParam[6].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-subject"
    assert inst.rest[0].resource[3].searchParam[6].documentation == "Subject impacted by event"
    ...
    assert inst.rest[0].resource[3].searchParam[7].documentation == "Effect on the subject due to this event"
    assert inst.rest[0].resource[3].searchParam[7].name == "resultingcondition"
    assert inst.rest[0].resource[3].searchParam[7].type == "reference"
    assert inst.rest[0].resource[3].searchParam[8].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-substance"
    assert inst.rest[0].resource[3].searchParam[8].documentation == "Refers to the specific entity that caused the adverse event"
    assert inst.rest[0].resource[3].searchParam[8].name == "substance"
    assert inst.rest[0].resource[3].searchParam[8].type == "reference"
    assert inst.rest[0].resource[3].searchParam[9].definition == "http://hl7.org/fhir/SearchParameter/AdverseEvent-location"
    assert inst.rest[0].resource[3].searchParam[9].documentation == "Location where adverse event occurred"
    ...
    assert inst.rest[0].resource[4].profile == "http://hl7.org/fhir/StructureDefinition/AllergyIntolerance"
    ...
    assert inst.rest[0].resource[4].searchParam[0].documentation == "Date first version of the resource instance was recorded"
    ...
    assert inst.rest[0].resource[4].searchParam[1].documentation == "mild | moderate | severe (of event as a whole)"
    assert inst.rest[0].resource[4].searchParam[1].name == "severity"
    assert inst.rest[0].resource[4].searchParam[1].type == "token"
    assert inst.rest[0].resource[4].searchParam[2].definition == "http://hl7.org/fhir/SearchParameter/clinical-identifier"
    assert inst.rest[0].resource[4].searchParam[2].documentation == "External ids for this item"
    ...
    assert inst.rest[0].resource[4].searchParam[3].documentation == "Clinical symptoms/signs associated with the Event"
    ...
    assert inst.rest[0].resource[4].searchParam[4].documentation == "Who recorded the sensitivity"
    assert inst.rest[0].resource[4].searchParam[4].name == "recorder"
    assert inst.rest[0].resource[4].searchParam[4].type == "reference"
    assert inst.rest[0].resource[4].searchParam[5].definition == "http://hl7.org/fhir/SearchParameter/clinical-code"
    assert inst.rest[0].resource[4].searchParam[5].documentation == "Code that identifies the allergy or intolerance"
    ...
    assert inst.rest[0].resource[4].searchParam[6].documentation == "unconfirmed | confirmed | refuted | entered-in-error"
    ...
    assert inst.rest[0].resource[4].searchParam[7].documentation == "low | high | unable-to-assess"
    ...
    assert inst.rest[0].resource[4].searchParam[8].documentation == "active | inactive | resolved"
    assert inst.rest[0].resource[4].searchParam[8].name == "clinical-status"
    assert inst.rest[0].resource[4].searchParam[8].type == "token"
    assert inst.rest[0].resource[4].searchParam[9].definition == "http://hl7.org/fhir/SearchParameter/AllergyIntolerance-onset"
    assert inst.rest[0].resource[4].searchParam[9].documentation == "Date(/time) when manifestations showed"
    ...
    assert inst.rest[0].resource[5].profile == "http://hl7.org/fhir/StructureDefinition/Appointment"
    ...
    assert inst.rest[0].resource[5].searchParam[0].definition == "http://hl7.org/fhir/SearchParameter/Appointment-date"
    assert inst.rest[0].resource[5].searchParam[0].documentation == "Appointment date/time."
    assert inst.rest[0].resource[5].searchParam[0].name == "date"
    assert inst.rest[0].resource[5].searchParam[0].type == "date"
    assert inst.rest[0].resource[5].searchParam[1].definition == "http://hl7.org/fhir/SearchParameter/Appointment-identifier"
    assert inst.rest[0].resource[5].searchParam[1].documentation == "An Identifier of the Appointment"
    assert inst.rest[0].resource[5].searchParam[1].name == "identifier"
    assert inst.rest[0].resource[5].searchParam[1].type == "token"
    assert inst.rest[0].resource[5].searchParam[2].definition == "http://hl7.org/fhir/SearchParameter/Appointment-specialty"
    ...
    assert inst.rest[0].resource[5].searchParam[4].definition == "http://hl7.org/fhir/SearchParameter/Appointment-practitioner"
    ...
    assert inst.rest[0].resource[5].searchParam[6].definition == "http://hl7.org/fhir/SearchParameter/Appointment-part-status"
    ...
    assert inst.rest[0].resource[5].searchParam[7].definition == "http://hl7.org/fhir/SearchParameter/Appointment-service-type"
    ...
    assert inst.rest[0].resource[5].searchParam[8].definition == "http://hl7.org/fhir/SearchParameter/Appointment-slot"
    assert inst.rest[0].resource[5].searchParam[8].documentation == "The slots that this appointment is filling"
    assert inst.rest[0].resource[5].searchParam[8].name == "slot"
    assert inst.rest[0].resource[5].searchParam[8].type == "reference"
    assert inst.rest[0].resource[5].searchParam[9].definition == "http://hl7.org/fhir/SearchParameter/Appointment-reason-code"
    assert inst.rest[0].resource[5].searchParam[9].documentation == "Coded reason this appointment is scheduled"
    assert inst.rest[0].resource[5].searchParam[9].name == "reason-code"
    assert inst.rest[0].resource[5].searchParam[9].type == "token"
    assert inst.rest[0].resource[5].searchRevInclude[0] == "AppointmentResponse.appointment"
    ...
    assert inst.rest[0].resource[6].profile == "http://hl7.org/fhir/StructureDefinition/AppointmentResponse"
    ...
    assert inst.rest[0].resource[6].searchInclude[1] == "AppointmentResponse.practitioner"
    assert inst.rest[0].resource[6].searchInclude[2] == "AppointmentResponse.patient"
    assert inst.rest[0].resource[6].searchInclude[3] == "AppointmentResponse.appointment"
    ...
    assert inst.rest[0].resource[6].searchParam[1].documentation == "An Identifier in this appointment response"
    ...
    assert inst.rest[0].resource[6].searchParam[2].documentation == "This Response is for this Practitioner"
    ...
    assert inst.rest[0].resource[6].searchParam[3].documentation == "The participants acceptance status for this appointment"
    ...
    assert inst.rest[0].resource[6].searchParam[4].documentation == "This Response is for this Patient"
    ...
    assert inst.rest[0].resource[6].searchParam[5].documentation == "The appointment that the response is attached to"
    ...
    assert inst.rest[0].resource[6].searchParam[6].documentation == "This Response is for this Location"
    ...
    assert inst.rest[0].resource[7].profile == "http://hl7.org/fhir/StructureDefinition/AuditEvent"
    ...
    assert inst.rest[0].resource[7].searchParam[0].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-date"
    assert inst.rest[0].resource[7].searchParam[0].documentation == "Time when the event was recorded"
    assert inst.rest[0].resource[7].searchParam[0].name == "date"
    assert inst.rest[0].resource[7].searchParam[0].type == "date"
    assert inst.rest[0].resource[7].searchParam[1].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-entity-type"
    assert inst.rest[0].resource[7].searchParam[1].documentation == "Type of entity involved"
    assert inst.rest[0].resource[7].searchParam[1].name == "entity-type"
    assert inst.rest[0].resource[7].searchParam[1].type == "token"
    assert inst.rest[0].resource[7].searchParam[2].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-agent"
    ...
    assert inst.rest[0].resource[7].searchParam[3].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-address"
    assert inst.rest[0].resource[7].searchParam[3].documentation == "Identifier for the network access point of the user device"
    assert inst.rest[0].resource[7].searchParam[3].name == "address"
    assert inst.rest[0].resource[7].searchParam[3].type == "string"
    assert inst.rest[0].resource[7].searchParam[4].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-entity-role"
    assert inst.rest[0].resource[7].searchParam[4].documentation == "What role the entity played"
    assert inst.rest[0].resource[7].searchParam[4].name == "entity-role"
    assert inst.rest[0].resource[7].searchParam[4].type == "token"
    assert inst.rest[0].resource[7].searchParam[5].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-source"
    assert inst.rest[0].resource[7].searchParam[5].documentation == "The identity of source detecting the event"
    assert inst.rest[0].resource[7].searchParam[5].name == "source"
    assert inst.rest[0].resource[7].searchParam[5].type == "reference"
    assert inst.rest[0].resource[7].searchParam[6].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-type"
    assert inst.rest[0].resource[7].searchParam[6].documentation == "Type/identifier of event"
    assert inst.rest[0].resource[7].searchParam[6].name == "type"
    assert inst.rest[0].resource[7].searchParam[6].type == "token"
    assert inst.rest[0].resource[7].searchParam[7].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-altid"
    assert inst.rest[0].resource[7].searchParam[7].documentation == "Alternative User identity"
    assert inst.rest[0].resource[7].searchParam[7].name == "altid"
    assert inst.rest[0].resource[7].searchParam[7].type == "token"
    assert inst.rest[0].resource[7].searchParam[8].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-site"
    assert inst.rest[0].resource[7].searchParam[8].documentation == "Logical source location within the enterprise"
    assert inst.rest[0].resource[7].searchParam[8].name == "site"
    assert inst.rest[0].resource[7].searchParam[8].type == "token"
    assert inst.rest[0].resource[7].searchParam[9].definition == "http://hl7.org/fhir/SearchParameter/AuditEvent-agent-name"
    assert inst.rest[0].resource[7].searchParam[9].documentation == "Human friendly name for the agent"
    ...
    assert inst.rest[0].resource[8].profile == "http://hl7.org/fhir/StructureDefinition/Basic"
    ...
    assert inst.rest[0].resource[8].searchParam[0].definition == "http://hl7.org/fhir/SearchParameter/Basic-identifier"
    assert inst.rest[0].resource[8].searchParam[0].documentation == "Business identifier"
    assert inst.rest[0].resource[8].searchParam[0].name == "identifier"
    assert inst.rest[0].resource[8].searchParam[0].type == "token"
    assert inst.rest[0].resource[8].searchParam[1].definition == "http://hl7.org/fhir/SearchParameter/Basic-code"
    ...
    assert inst.rest[0].resource[8].searchParam[2].definition == "http://hl7.org/fhir/SearchParameter/Basic-author"
    ...
    assert inst.rest[0].resource[8].searchParam[3].definition == "http://hl7.org/fhir/SearchParameter/Basic-created"
    ...
    assert inst.rest[0].resource[8].searchParam[4].definition == "http://hl7.org/fhir/SearchParameter/Basic-patient"
    assert inst.rest[0].resource[8].searchParam[4].documentation == "Identifies the focus of this resource"
    assert inst.rest[0].resource[8].searchParam[4].name == "patient"
    assert inst.rest[0].resource[8].searchParam[4].type == "reference"
    assert inst.rest[0].resource[8].searchParam[5].definition == "http://hl7.org/fhir/SearchParameter/Basic-subject"
    assert inst.rest[0].resource[8].searchParam[5].documentation == "Identifies the focus of this resource"
    ...
    assert inst.rest[0].resource[9].profile == "http://hl7.org/fhir/StructureDefinition/Binary"
