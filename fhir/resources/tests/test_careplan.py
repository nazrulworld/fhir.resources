...
def test_careplan_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "careplan-example-f002-lung.json"
    )
...
def impl_careplan_4(inst):
    ...
    assert inst.activity[0].detail.status == "completed"
    assert inst.activity[0].detail.statusReason.text == "Achieved weight loss to mitigate diabetes risk."
    assert inst.activity[0].outcomeCodeableConcept[0].coding[0].code == "161832001"
    assert inst.activity[0].outcomeCodeableConcept[0].coding[0].display == "Progressive weight loss"
    assert inst.activity[0].outcomeCodeableConcept[0].coding[0].system == "http://snomed.info/sct"
...
def test_careplan_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "careplan-example.json"
    )
    inst = careplan.CarePlan.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_careplan_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "careplan-example-f201-renal.json"
    )
    inst = careplan.CarePlan.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_careplan_6(inst):
    ...
    assert inst.activity[0].detail.scheduledPeriod.end == fhirtypes.DateTime.validate("2013-01-01T10:50:00+00:00")
    assert inst.activity[0].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2013-01-01T10:38:00+00:00")
    assert inst.activity[0].detail.status == "completed"
...
def test_careplan_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "careplan-example-GPVisit.json"
    )
    inst = careplan.CarePlan.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_careplan_7(inst):
    ...
    assert inst.activity[0].detail.doNotPerform is False
    assert inst.activity[0].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[0].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-09-10")
    assert inst.activity[0].detail.goal[0].reference == "#g1"
    assert inst.activity[0].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-09-10")
    ...
    assert inst.activity[1].detail.doNotPerform is False
    assert inst.activity[1].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[1].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-09-10")
    assert inst.activity[1].detail.goal[0].reference == "#g1"
    assert inst.activity[1].detail.kind == "CommunicationRequest"
    assert inst.activity[1].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-09-10")
    ...
    assert inst.activity[2].detail.description == "Eve will reduce her intake of coffee and chocolate"
    assert inst.activity[2].detail.doNotPerform is False
    assert inst.activity[2].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[2].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-09-10")
    assert inst.activity[2].detail.goal[0].reference == "#g2"
    assert inst.activity[2].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-09-10")
    ...
    assert inst.activity[3].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[3].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-09-10")
    assert inst.activity[3].detail.goal[0].reference == "#g3"
    assert inst.activity[3].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-08-27")
    ...
    assert inst.activity[4].detail.description == "Eve will walk 3 blocks to her parents house twice a week"
    assert inst.activity[4].detail.doNotPerform is False
    assert inst.activity[4].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[4].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-09-10")
    assert inst.activity[4].detail.goal[0].reference == "#g3"
    assert inst.activity[4].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-07-23")
    ...
    "Eve did not walk to her parents the last week, but has plans"
    " to start again"
    )
    ...
    assert inst.activity[5].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[5].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-08-13")
    assert inst.activity[5].detail.goal[0].reference == "#g4"
    assert inst.activity[5].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-07-23")
    assert inst.activity[5].detail.status == "in-progress"
    assert inst.activity[6].detail.description == "Eve will use her lights MWF after her shower for 3 minutes"
    assert inst.activity[6].detail.doNotPerform is False
    assert inst.activity[6].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[6].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-08-27")
    assert inst.activity[6].detail.goal[0].reference == "#g5"
    assert inst.activity[6].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-07-23")
    ...
    assert inst.activity[6].progress[0].time == fhirtypes.DateTime.validate("2012-08-13")
    ...
    assert inst.activity[7].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[7].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-09-10")
    assert inst.activity[7].detail.goal[0].reference == "#g4"
    assert inst.activity[7].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-07-10")
    ...
    assert inst.activity[8].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[8].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-08-23")
    assert inst.activity[8].detail.goal[0].reference == "#g3"
    assert inst.activity[8].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-07-23")
    ...
    assert inst.activity[9].detail.extension[0].url == "http://example.org/fhir/StructureDefinition/RevisionDate"
    assert inst.activity[9].detail.extension[0].valueDate == fhirtypes.Date.validate("2012-07-23")
    assert inst.activity[9].detail.goal[0].reference == "#g4"
    assert inst.activity[9].detail.scheduledPeriod.start == fhirtypes.DateTime.validate("2012-07-10")
...
def test_careplan_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "careplan-example-integrated.json"
    )
    inst = careplan.CarePlan.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_careplan_8(inst):
    ...
    assert inst.activity[0].detail.code.coding[0].display == "Incision of retropharyngeal abscess"
    assert inst.activity[0].detail.code.coding[0].system == "http://snomed.info/sct"
    assert inst.activity[0].detail.doNotPerform is True
    assert inst.activity[0].detail.kind == "ServiceRequest"
...
def test_careplan_8(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "careplan-example-f003-pharynx.json"
    )
    inst = careplan.CarePlan.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_careplan_9(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "careplan-example-f001-heart.json"
    )
    inst = careplan.CarePlan.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_careplan_10(inst):
    ...
    assert inst.activity[1].detail.code.coding[0].system == "http://example.org/mySystem"
    ...
    assert inst.activity[1].detail.scheduledTiming.repeat.boundsPeriod.end == fhirtypes.DateTime.validate("2013-02-28")
    assert inst.activity[1].detail.scheduledTiming.repeat.boundsPeriod.start == fhirtypes.DateTime.validate("2013-02-14")
    assert inst.activity[1].detail.status == "scheduled"
    assert inst.activity[1].extension[0].url == (
    "http://example.org/fhir/StructureDefinition/careplan#andetai"
    "ls"
    )
    ...
    assert inst.activity[2].detail.code.coding[0].system == "http://example.org/mySystem"
    ...
    assert inst.activity[2].detail.scheduledTiming.repeat.boundsPeriod.end == fhirtypes.DateTime.validate("2013-03-14")
    assert inst.activity[2].detail.scheduledTiming.repeat.boundsPeriod.start == fhirtypes.DateTime.validate("2013-03-01")
    assert inst.activity[2].detail.status == "not-started"
    assert inst.activity[3].detail.code.coding[0].code == "del"
    assert inst.activity[3].detail.code.coding[0].system == "http://example.org/mySystem"
    ...
    assert inst.activity[3].detail.scheduledTiming.repeat.boundsPeriod.end == fhirtypes.DateTime.validate("2013-09-14")
    assert inst.activity[3].detail.scheduledTiming.repeat.boundsPeriod.start == fhirtypes.DateTime.validate("2013-09-01")
...
def test_careplan_10(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "careplan-example-pregnancy.json"
    )
    inst = careplan.CarePlan.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
