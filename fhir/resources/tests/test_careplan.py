...
class CarePlanTests(unittest.TestCase):
    ...
    def implCarePlan4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.activity[0].detail.status), force_bytes("completed"))
        self.assertEqual(force_bytes(inst.activity[0].detail.statusReason.text), force_bytes("Achieved weight loss to mitigate diabetes risk."))
        ...
        self.assertEqual(force_bytes(inst.instantiatesUri[0]), force_bytes("http://example.org/protocol-for-obesity"))
        self.assertEqual(force_bytes(inst.intent), force_bytes("plan"))
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
