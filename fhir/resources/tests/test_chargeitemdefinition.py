...
def impl_chargeitemdefinition_1(inst):
    assert inst.applicability[0].description == "Verify ChargeItem pertains to Device 12345"
    assert inst.applicability[0].expression == "%context.service.suppliedItem='Device/12345'"
    ...
    assert inst.propertyGroup[1].applicability[0].expression == "%context.occurenceDateTime > '2018-04-01'"
    ...
    assert inst.propertyGroup[2].applicability[0].expression == "%context.occurenceDateTime <= '2018-04-01'"
...
def impl_chargeitemdefinition_2(inst):
    assert inst.applicability[0].description == "Excludes billing code 13250 for same Encounter"
