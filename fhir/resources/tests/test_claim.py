...
def impl_claim_1(inst):
    ...
    assert inst.accident.type.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActIncidentCode"
    ...
    assert inst.careTeam[0].qualification.coding[0].system == "http://example.org/fhir/CodeSystem/provider-qualification"
    assert inst.careTeam[0].responsible is True
    assert inst.careTeam[0].role.coding[0].code == "primary"
    assert inst.careTeam[0].role.coding[0].system == "http://example.org/fhir/CodeSystem/claim-careteamrole"
    ...
    assert inst.diagnosis[0].type[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/ex-diagnosistype"
    assert inst.enterer.identifier.system == "http://jurisdiction.org/facilities/HOSP1234/users"
    ...
    assert inst.supportingInfo[0].timingPeriod.end == fhirtypes.DateTime.validate("2014-08-16")
    assert inst.supportingInfo[0].timingPeriod.start == fhirtypes.DateTime.validate("2014-08-16")
    ...
    assert inst.supportingInfo[1].timingPeriod.end == fhirtypes.DateTime.validate("2014-08-16")
    assert inst.supportingInfo[1].timingPeriod.start == fhirtypes.DateTime.validate("2014-08-15")
...
def impl_claim_6(inst):
    ...
    assert inst.procedure[0].procedureCodeableConcept.text == "Subcutaneous diagnostic implant"
...
def test_claim_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "claim-example-institutional.json"
    )
    inst = claim.Claim.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_claim_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "claim-example-oral-contained.json"
    )
    inst = claim.Claim.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_claim_8(inst):
    ...
    assert inst.item[0].detail[0].productOrService.coding[0].system == "http://hl7.org/fhir/ex-pharmaservice"
    assert inst.item[0].detail[0].sequence == 1
    assert inst.item[0].detail[1].net.currency == "USD"
    assert float(inst.item[0].detail[1].net.value) == float(9.0)
    assert inst.item[0].detail[1].productOrService.coding[0].code == "markup"
    assert inst.item[0].detail[1].productOrService.coding[0].system == "http://hl7.org/fhir/ex-pharmaservice"
    assert inst.item[0].detail[1].sequence == 2
    assert inst.item[0].detail[2].net.currency == "USD"
    ...
    assert inst.item[0].detail[2].productOrService.coding[0].system == "http://hl7.org/fhir/ex-pharmaservice"
    assert inst.item[0].detail[2].sequence == 3
    ...
    assert inst.item[0].productOrService.coding[0].display == "Alprazolam 0.25mg (Xanax)"
    assert inst.item[0].productOrService.coding[0].system == "http://www.nlm.nih.gov/research/umls/rxnorm"
    assert inst.item[0].quantity.code == "TAB"
    assert inst.item[0].quantity.system == "http://terminology.hl7.org/CodeSystem/v3-orderableDrugForm"
    ...
    assert inst.meta.tag[0].display == "test health data"
    assert inst.meta.tag[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    assert inst.originalPrescription.reference == "http://pharmacy.org/MedicationRequest/AB1202B"
    assert inst.patient.reference == "Patient/1"
    assert inst.payee.type.coding[0].code == "provider"
    assert inst.prescription.reference == "http://pharmacy.org/MedicationRequest/AB1234G"
    ...
    assert inst.supportingInfo[0].code.coding[0].system == "http://example.org/fhir/CodeSystem/pharmacy-refill"
    assert inst.supportingInfo[0].sequence == 1
    ...
    assert inst.supportingInfo[1].code.coding[0].system == "http://example.org/fhir/CodeSystem/pharmacy-information"
    assert inst.supportingInfo[1].sequence == 2
    ...
    assert inst.supportingInfo[2].code.coding[0].system == "http://example.org/fhir/CodeSystem/pharmacy-information"
...
def impl_claim_9(inst):
    ...
    assert inst.item[1].bodySite.coding[0].system == "http://fdi.org/fhir/oraltoothcodes"
    ...
    assert inst.item[1].subSite[0].coding[0].system == "http://fdi.org/fhir/oralsurfacecodes"
    ...
    assert inst.item[2].bodySite.coding[0].system == "http://fdi.org/fhir/oraltoothcodes"
...
def impl_claim_10(inst):
    ...
    assert inst.diagnosis[0].diagnosisCodeableConcept.coding[0].display == "Postlaminectomy syndrome, not elsewhere classified"
    assert inst.diagnosis[0].diagnosisCodeableConcept.coding[0].system == "http://hl7.org/fhir/sid/icd-10-cm"
    assert inst.diagnosis[0].sequence == 1
    assert inst.diagnosis[1].diagnosisCodeableConcept.coding[0].code == "G89.4"
    assert inst.diagnosis[1].diagnosisCodeableConcept.coding[0].display == "Chronic pain syndrome"
    assert inst.diagnosis[1].diagnosisCodeableConcept.coding[0].system == "http://hl7.org/fhir/sid/icd-10-cm"
    ...
    assert inst.diagnosis[2].diagnosisCodeableConcept.coding[0].system == "http://hl7.org/fhir/sid/icd-10-cm"
    ...
    "Spondylosis without myelopathy or radiculopathy, lumbar "
    "region"
    )
    assert inst.diagnosis[3].diagnosisCodeableConcept.coding[0].system == "http://hl7.org/fhir/sid/icd-10-cm"
    ...
    assert inst.insurance[0].coverage.reference == "#coverage-1"
    assert inst.insurance[0].focal is True
    assert inst.insurance[0].identifier.system == "http://CedarArmsMedicalCenter.com/claim"
    ...
    assert inst.item[0].locationCodeableConcept.coding[0].display == "Ambulatory Surgical Center"
    ...
    assert inst.item[0].productOrService.coding[0].display == "Surgical Procedures on the Spine and Spinal Cord"
    assert inst.item[0].productOrService.coding[0].system == "http://www.ama-assn.org/go/cpt"
    assert inst.item[0].sequence == 1
    ...
    assert inst.supportingInfo[0].sequence == 1
    assert inst.supportingInfo[0].timingPeriod.end == fhirtypes.DateTime.validate("2015-10-05T00:00:00-07:00")
    assert inst.supportingInfo[0].timingPeriod.start == fhirtypes.DateTime.validate("2015-10-01T00:00:00-07:00")
    ...
    assert inst.supportingInfo[1].code.coding[0].display == "Discharge to Home or Self Care"
...
def test_claim_10(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "claim-example-cms1500-medical.json"
    )
    inst = claim.Claim.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
