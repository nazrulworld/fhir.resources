...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim3(self, inst):
        ...
        self.assertTrue(inst.insurance[0].focal)
        self.assertEqual(force_bytes(inst.insurance[0].identifier.system), force_bytes("http://happyvalley.com/claim"))
        self.assertEqual(force_bytes(inst.insurance[0].identifier.value), force_bytes("12345"))
        self.assertEqual(inst.insurance[0].sequence, 1)
        self.assertEqual(inst.item[0].careTeamSequence[0], 1)
        self.assertEqual(force_bytes(inst.item[0].net.currency), force_bytes("USD"))
    ...
    def implClaim6(self, inst):
        ...
        self.assertEqual(force_bytes(inst.procedure[0].procedureCodeableConcept.coding[0].code), force_bytes("SDI9901"))
        self.assertEqual(force_bytes(inst.procedure[0].procedureCodeableConcept.text), force_bytes("Subcutaneous diagnostic implant"))
        self.assertEqual(inst.procedure[0].sequence, 1)
        self.assertEqual(force_bytes(inst.procedure[0].type[0].coding[0].code), force_bytes("primary"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
    ...
    def implClaim9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.item[0].detail[0].productOrService.coding[0].code), force_bytes("ORTHOEXAM"))
        self.assertEqual(force_bytes(inst.item[0].detail[0].productOrService.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(inst.item[0].detail[0].sequence, 1)
        self.assertEqual(force_bytes(inst.item[0].detail[0].unitPrice.currency), force_bytes("USD"))
        self.assertEqual(inst.item[0].detail[0].unitPrice.value, 1000.0)
        self.assertEqual(force_bytes(inst.item[0].detail[1].net.currency), force_bytes("USD"))
        self.assertEqual(inst.item[0].detail[1].net.value, 1500.0)
        self.assertEqual(force_bytes(inst.item[0].detail[1].productOrService.coding[0].code), force_bytes("ORTHODIAG"))
        self.assertEqual(force_bytes(inst.item[0].detail[1].productOrService.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(inst.item[0].detail[1].sequence, 2)
        self.assertEqual(force_bytes(inst.item[0].detail[1].unitPrice.currency), force_bytes("USD"))
        self.assertEqual(inst.item[0].detail[1].unitPrice.value, 1500.0)
        self.assertEqual(force_bytes(inst.item[0].detail[2].net.currency), force_bytes("USD"))
        self.assertEqual(inst.item[0].detail[2].net.value, 500.0)
        self.assertEqual(force_bytes(inst.item[0].detail[2].productOrService.coding[0].code), force_bytes("ORTHOINITIAL"))
        self.assertEqual(force_bytes(inst.item[0].detail[2].productOrService.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(inst.item[0].detail[2].sequence, 3)
        self.assertEqual(force_bytes(inst.item[0].detail[2].unitPrice.currency), force_bytes("USD"))
        self.assertEqual(inst.item[0].detail[2].unitPrice.value, 500.0)
        self.assertEqual(force_bytes(inst.item[0].detail[3].productOrService.coding[0].code), force_bytes("ORTHOMONTHS"))
        self.assertEqual(force_bytes(inst.item[0].detail[3].productOrService.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(inst.item[0].detail[3].quantity.value, 24)
        self.assertEqual(inst.item[0].detail[3].sequence, 4)
        self.assertEqual(force_bytes(inst.item[0].detail[4].net.currency), force_bytes("USD"))
        self.assertEqual(inst.item[0].detail[4].net.value, 250.0)
        self.assertEqual(force_bytes(inst.item[0].detail[4].productOrService.coding[0].code), force_bytes("ORTHOPERIODIC"))
        self.assertEqual(force_bytes(inst.item[0].detail[4].productOrService.coding[0].system), force_bytes("http://example.org/fhir/oralservicecodes"))
        self.assertEqual(inst.item[0].detail[4].quantity.value, 24)
        self.assertEqual(inst.item[0].detail[4].sequence, 5)
        self.assertEqual(force_bytes(inst.item[0].detail[4].unitPrice.currency), force_bytes("USD"))
        ...
        self.assertEqual(force_bytes(inst.item[0].productOrService.coding[0].code), force_bytes("ORTHPLAN"))
    ...
    def implClaim10(self, inst):
        ...
        self.assertEqual(force_bytes(inst.diagnosis[0].diagnosisCodeableConcept.coding[0].code), force_bytes("M96.1"))
        self.assertEqual(force_bytes(inst.diagnosis[0].diagnosisCodeableConcept.coding[0].display), force_bytes("Postlaminectomy syndrome"))
        self.assertEqual(force_bytes(inst.diagnosis[0].diagnosisCodeableConcept.coding[0].system), force_bytes("http://hl7.org/fhir/sid/icd-10"))
        self.assertEqual(inst.diagnosis[0].sequence, 1)
        self.assertEqual(force_bytes(inst.diagnosis[1].diagnosisCodeableConcept.coding[0].code), force_bytes("G89.4"))
        self.assertEqual(force_bytes(inst.diagnosis[1].diagnosisCodeableConcept.coding[0].display), force_bytes("Chronic pain syndrome"))
        self.assertEqual(force_bytes(inst.diagnosis[1].diagnosisCodeableConcept.coding[0].system), force_bytes("http://hl7.org/fhir/sid/icd-10"))
        self.assertEqual(inst.diagnosis[1].sequence, 2)
        self.assertEqual(force_bytes(inst.diagnosis[2].diagnosisCodeableConcept.coding[0].code), force_bytes("M53.88"))
        self.assertEqual(force_bytes(inst.diagnosis[2].diagnosisCodeableConcept.coding[0].display), force_bytes("Other specified dorsopathies, sacral and sacrococcygeal region"))
        self.assertEqual(force_bytes(inst.diagnosis[2].diagnosisCodeableConcept.coding[0].system), force_bytes("http://hl7.org/fhir/sid/icd-10"))
        self.assertEqual(inst.diagnosis[2].sequence, 3)
        self.assertEqual(force_bytes(inst.diagnosis[3].diagnosisCodeableConcept.coding[0].code), force_bytes("M47.816"))
        self.assertEqual(force_bytes(inst.diagnosis[3].diagnosisCodeableConcept.coding[0].display), force_bytes("Spondylosis without myelopathy or radiculopathy, lumbar region"))
        self.assertEqual(force_bytes(inst.diagnosis[3].diagnosisCodeableConcept.coding[0].system), force_bytes("http://hl7.org/fhir/sid/icd-10"))
        self.assertEqual(inst.diagnosis[3].sequence, 4)
        self.assertEqual(force_bytes(inst.id), force_bytes("MED-00050"))
        self.assertEqual(force_bytes(inst.identifier[0].system), force_bytes("http://CedarArmsMedicalCenter.com/claim"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("MED-00050"))
        self.assertTrue(inst.insurance[0].focal)
        self.assertEqual(force_bytes(inst.insurance[0].identifier.system), force_bytes("http://CedarArmsMedicalCenter.com/claim"))
        self.assertEqual(force_bytes(inst.insurance[0].identifier.value), force_bytes("MED-00050"))
        self.assertEqual(inst.insurance[0].sequence, 1)
        self.assertEqual(inst.item[0].careTeamSequence[0], 1)
        self.assertEqual(inst.item[0].diagnosisSequence[0], 2)
        self.assertEqual(inst.item[0].diagnosisSequence[1], 4)
        self.assertEqual(inst.item[0].informationSequence[0], 1)
        self.assertEqual(force_bytes(inst.item[0].locationCodeableConcept.coding[0].code), force_bytes("24"))
        self.assertEqual(force_bytes(inst.item[0].locationCodeableConcept.coding[0].display), force_bytes("Ambulatory Surgical Center"))
        self.assertEqual(force_bytes(inst.item[0].locationCodeableConcept.coding[0].system), force_bytes("https://www.cms.gov/medicare/coding/place-of-service-codes/place_of_service_code_set.html"))
        self.assertEqual(force_bytes(inst.item[0].net.currency), force_bytes("USD"))
        self.assertEqual(inst.item[0].net.value, 12500.0)
        self.assertEqual(force_bytes(inst.item[0].productOrService.coding[0].code), force_bytes("62264"))
        self.assertEqual(force_bytes(inst.item[0].productOrService.coding[0].display), force_bytes("Surgical Procedures on the Spine and Spinal Cord"))
        self.assertEqual(force_bytes(inst.item[0].productOrService.coding[0].system), force_bytes("http://www.ama-assn.org/go/cpt"))
        self.assertEqual(inst.item[0].sequence, 1)
        ...
        self.assertEqual(force_bytes(inst.subType.coding[0].system), force_bytes("https://www.cms.gov/codes/billtype"))
        self.assertEqual(force_bytes(inst.supportingInfo[0].category.coding[0].code), force_bytes("hospitalized"))
        self.assertEqual(force_bytes(inst.supportingInfo[0].category.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/claiminformationcategory"))
        self.assertEqual(inst.supportingInfo[0].sequence, 1)
        ...
        self.assertEqual(force_bytes(inst.supportingInfo[1].category.coding[0].code), force_bytes("discharge"))
        self.assertEqual(force_bytes(inst.supportingInfo[1].category.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/claiminformationcategory"))
        self.assertEqual(force_bytes(inst.supportingInfo[1].code.coding[0].code), force_bytes("01"))
        self.assertEqual(force_bytes(inst.supportingInfo[1].code.coding[0].display), force_bytes("Discharge to Home or Self Care"))
        self.assertEqual(force_bytes(inst.supportingInfo[1].code.coding[0].system), force_bytes("https://www.cms.gov/Outreach-and-Education/Medicare-Learning-Network-MLN/MLNMattersArticles/downloads/SE0801.pdf"))
        self.assertEqual(inst.supportingInfo[1].sequence, 2)
        self.assertEqual(force_bytes(inst.text.div), force_bytes("<div xmlns=\"http://www.w3.org/1999/xhtml\">A human-readable rendering of a CMS 1500 Claim</div>"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.total.currency), force_bytes("USD"))
