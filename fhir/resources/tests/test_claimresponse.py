...
def impl_claimresponse_1(inst):
    ...
    assert (
        ...
        == ExternalValidatorModel(valueUri="http://example.org/fhir/modifiers").valueUri
    )
...
def impl_claimresponse_2(inst):
    ...
    assert inst.payment.date == ExternalValidatorModel(valueDate="2014-08-31").valueDate
    assert (
...
def impl_claimresponse_4(inst):
    ...
    assert inst.payment.date == ExternalValidatorModel(valueDate="2014-08-16").valueDate
    assert (
        inst.payment.identifier.system
        == ExternalValidatorModel(
