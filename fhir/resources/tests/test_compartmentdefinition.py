...
class CompartmentDefinitionTests(unittest.TestCase):
    ...
    def implCompartmentDefinition2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.resource[9].code), force_bytes("BiologicallyDerivedProduct"))
        self.assertTrue(inst.search)
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
    ...
    def implCompartmentDefinition6(self, inst):
        ...
        self.assertEqual(inst.date.date, FHIRDate("2019-11-01T09:29:23+11:00").date)
        self.assertEqual(inst.date.as_json(), "2019-11-01T09:29:23+11:00")
        self.assertEqual(force_bytes(inst.description), force_bytes("There is an instance of the device compartment for each Device resource, and the identity of the compartment is the same as the Device. The set of resources associated with a particular device"))
        self.assertTrue(inst.experimental)
