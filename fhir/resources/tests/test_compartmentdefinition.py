...
def impl_compartmentdefinition_1(inst):
    ...
    assert inst.resource[0].documentation == "The device used as the message sender and recipient"
    ...
    assert inst.resource[1].documentation == "The device used as the message sender and recipient"
    ...
    assert inst.useContext[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/resource-types"
...
def test_compartmentdefinition_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "compartmentdefinition-example.json"
    )
...
def test_compartmentdefinition_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "compartmentdefinition-patient.json"
    )
    inst = compartmentdefinition.CompartmentDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_compartmentdefinition_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "compartmentdefinition-device.json"
    )
    inst = compartmentdefinition.CompartmentDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
