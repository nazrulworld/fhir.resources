...
class ConditionTests(unittest.TestCase):
    ...
    def implCondition5(self, inst):
        ...
        self.assertEqual(force_bytes(inst.severity.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.stage[0].summary.coding[0].code), force_bytes("258219007"))
        self.assertEqual(force_bytes(inst.stage[0].summary.coding[0].display), force_bytes("stage II"))
        self.assertEqual(force_bytes(inst.stage[0].summary.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.stage[0].type.coding[0].code), force_bytes("260998006"))
        self.assertEqual(force_bytes(inst.stage[0].type.coding[0].display), force_bytes("Clinical staging (qualifier value)"))
        self.assertEqual(force_bytes(inst.stage[0].type.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.verificationStatus.coding[0].code), force_bytes("confirmed"))
        self.assertEqual(force_bytes(inst.verificationStatus.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/condition-ver-status"))
