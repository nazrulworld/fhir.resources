...
class ConsentTests(unittest.TestCase):
    ...
    def implConsent5(self, inst):
        self.assertEqual(force_bytes(inst.category[0].coding[0].code), force_bytes("npp"))
        self.assertEqual(force_bytes(inst.category[0].coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/consentcategorycodes"))
        ...
        self.assertEqual(force_bytes(inst.identifier[0].system), force_bytes("urn:oid:2.16.840.1.113883.3.72.5.9.1"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("494e0c7a-a69e-4fb4-9d02-6aae747790d7"))
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
        self.assertEqual(force_bytes(inst.policyRule.coding[0].code), force_bytes("OPTIN"))
        ...
        self.assertEqual(force_bytes(inst.provision.provision[0].actor[0].role.coding[0].code), force_bytes("AUT"))
        ...
        self.assertEqual(force_bytes(inst.provision.provision[0].class_fhir[0].code), force_bytes("application/hl7-cda+xml"))
        self.assertEqual(force_bytes(inst.provision.provision[0].class_fhir[0].system), force_bytes("urn:ietf:bcp:13"))
        self.assertEqual(force_bytes(inst.provision.provision[0].code[0].coding[0].code), force_bytes("34133-9"))
        self.assertEqual(force_bytes(inst.provision.provision[0].code[0].coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.provision.provision[0].code[1].coding[0].code), force_bytes("18842-5"))
        self.assertEqual(force_bytes(inst.provision.provision[0].code[1].coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.provision.provision[0].type), force_bytes("permit"))
        self.assertEqual(force_bytes(inst.scope.coding[0].code), force_bytes("patient-privacy"))
        self.assertEqual(force_bytes(inst.scope.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/consentscope"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
