...
def impl_consent_1(inst):
    ...
    assert inst.policyRule.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    ...
    assert inst.scope.coding[0].system == "http://terminology.hl7.org/CodeSystem/consentscope"
...
def impl_consent_2(inst):
    ...
    assert inst.policyRule.coding[0].code == "OPTIN"
    assert inst.policyRule.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.period.end == fhirtypes.DateTime.validate("2016-06-23T17:32:33+10:00")
    assert inst.provision.period.start == fhirtypes.DateTime.validate("2016-06-23T17:02:33+10:00")
    assert inst.provision.provision[0].action[0].coding[0].code == "access"
    assert inst.provision.provision[0].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].class_fhir[0].code == "MedicationRequest"
    assert inst.provision.provision[0].class_fhir[0].system == "http://hl7.org/fhir/resource-types"
...
def impl_consent_3(inst):
    ...
    assert inst.provision.actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.scope.coding[0].code == "patient-privacy"
    assert inst.scope.coding[0].system == "http://terminology.hl7.org/CodeSystem/consentscope"
    assert inst.sourceAttachment.title == "The terms of the consent in lawyer speak."
    assert inst.status == "active"
...
def test_consent_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "consent-example-notTime.json"
    )
    inst = consent.Consent.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_consent_5(inst):
    ...
    assert inst.provision.provision[0].actor[0].reference.reference == "Practitioner/xcda-author"
    assert inst.provision.provision[0].actor[0].role.coding[0].code == "AUT"
    assert inst.provision.provision[0].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
...
def test_consent_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "consent-example-signature.json"
    )
    inst = consent.Consent.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_consent_6(inst):
    ...
    assert inst.provision.action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.action[1].coding[0].code == "correct"
    assert inst.provision.action[1].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
...
def impl_consent_7(inst):
    ...
    assert inst.provision.actor[1].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.scope.coding[0].code == "patient-privacy"
    assert inst.scope.coding[0].system == "http://terminology.hl7.org/CodeSystem/consentscope"
    assert inst.sourceAttachment.title == "The terms of the consent in lawyer speak."
    assert inst.status == "active"
...
def impl_consent_9(inst):
    ...
    assert inst.provision.provision[0].action[0].coding[0].code == "access"
    assert inst.provision.provision[0].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].actor[0].reference.reference == "Organization/f001"
    ...
    assert inst.provision.provision[0].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[1].action[0].coding[0].code == "access"
    assert inst.provision.provision[1].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[1].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[1].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[1].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[1].securityLabel[0].code == "SPI"
    assert inst.provision.provision[1].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[2].action[0].coding[0].code == "access"
    assert inst.provision.provision[2].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[2].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[2].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[2].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[2].securityLabel[0].code == "N"
    assert inst.provision.provision[2].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    assert inst.provision.provision[3].action[0].coding[0].code == "access"
    assert inst.provision.provision[3].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[3].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[3].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[3].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[3].securityLabel[0].code == "PSY"
    assert inst.provision.provision[3].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[4].action[0].coding[0].code == "access"
    assert inst.provision.provision[4].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[4].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[4].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[4].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[4].securityLabel[0].code == "SPI"
    assert inst.provision.provision[4].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[5].action[0].coding[0].code == "access"
    assert inst.provision.provision[5].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[5].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[5].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[5].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[5].securityLabel[0].code == "SEX"
    assert inst.provision.provision[5].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[6].action[0].coding[0].code == "access"
    assert inst.provision.provision[6].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[6].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[6].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[6].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[6].securityLabel[0].code == "N"
    assert inst.provision.provision[6].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    assert inst.provision.provision[7].action[0].coding[0].code == "access"
    assert inst.provision.provision[7].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[7].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[7].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[7].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[7].securityLabel[0].code == "PSY"
    assert inst.provision.provision[7].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[8].action[0].coding[0].code == "access"
    assert inst.provision.provision[8].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[8].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[8].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[8].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[8].securityLabel[0].code == "SPI"
    assert inst.provision.provision[8].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[9].action[0].coding[0].code == "access"
    assert inst.provision.provision[9].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[9].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[9].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[9].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[9].securityLabel[0].code == "SEX"
    assert inst.provision.provision[9].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.securityLabel[0].code == "N"
    assert inst.provision.securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    assert inst.scope.coding[0].code == "patient-privacy"
    assert inst.scope.coding[0].system == "http://terminology.hl7.org/CodeSystem/consentscope"
    assert inst.status == "active"
    assert inst.text.status == "generated"
...
def test_consent_10(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "consent-example.json"
    )
    inst = consent.Consent.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
