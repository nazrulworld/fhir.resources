...
def impl_contract_1(inst):
    ...
    assert inst.friendly[0].contentAttachment.title == "The terms of the consent in friendly consumer speak."
    assert inst.id == "pcd-example-notOrg"
    assert inst.issued == fhirtypes.DateTime.validate("2015-11-18")
    assert inst.legal[0].contentAttachment.title == "The terms of the consent in lawyer speak."
    ...
    assert inst.subType[0].coding[0].system == "http://www.infoway-inforoute.ca.org/Consent-subtype-codes"
    ...
    assert inst.term[0].type.coding[0].display == "Withhold all data from specified actor entity."
    assert inst.term[0].type.coding[0].system == "http://example.org/fhir/consent-term-type-codes"
...
def test_contract_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "pcd-example-notOrg.json"
    )
...
def impl_contract_2(inst):
    ...
    assert inst.term[0].asset[0].period[0].start == fhirtypes.DateTime.validate("2017-06-01")
    assert inst.term[0].asset[0].subtype[0].text == "sample"
    assert inst.term[0].asset[0].type[0].coding[0].code == "RicardianContract"
    assert inst.term[0].asset[0].type[0].coding[0].system == "http://something/something"
    assert inst.term[0].asset[0].valuedItem[0].effectiveTime == fhirtypes.DateTime.validate("1995")
    assert inst.term[0].asset[0].valuedItem[0].entityCodeableConcept.text == "Ford Bobcat"
    assert float(inst.term[0].asset[0].valuedItem[0].factor) == float(1.0)
    assert inst.term[0].asset[0].valuedItem[0].identifier.system == "http://somewhere.motor-vehicle.com/vin"
    ...
    assert inst.term[0].group[2].group[0].group[1].offer.text == "Professional Visit Copay"
    ...
    assert inst.term[0].group[2].group[3].group[3].offer.text == "Emergency Room Services"
    assert inst.term[0].group[2].group[3].group[4].offer.text == "Hospital Inpatient Care"
    ...
    assert inst.type.coding[0].system == "http://terminology.hl7.org/CodeSystem/contract-type"
...
def test_contract_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "contract-example-ins-policy.json"
    )
    inst = contract.Contract.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_contract_3(inst):
    assert inst.applies.start == fhirtypes.DateTime.validate("2013-11-01T21:18:27-04:00")
    assert inst.contentDerivative.coding[0].code == "registration"
    assert inst.contentDerivative.coding[0].system == (
    "http://terminology.hl7.org/CodeSystem/contract-content-"
    "derivative"
    )
    ...
    assert inst.legal[0].contentAttachment.title == "MDHHS-5515 Consent To Share Your Health Information"
    assert inst.legal[0].contentAttachment.url == "http://org.mihin.ecms/ConsentDirective-2121"
    assert inst.meta.lastUpdated == fhirtypes.Instant.validate("2016-07-19T18:18:42.108-04:00")
    assert inst.meta.tag[0].code == "HTEST"
    assert inst.meta.tag[0].display == "test health data"
    assert inst.meta.tag[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    ...
    assert inst.signer[0].signature[0].when == fhirtypes.Instant.validate("2017-02-08T10:57:34+01:00")
    ...
    assert inst.subType[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentcategorycodes"
    assert inst.subject[0].reference == "Patient/f201"
    assert inst.term[0].action[0].intent.coding[0].code == "HPRGRP"
    assert inst.term[0].action[0].intent.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    assert inst.term[0].action[0].status.text == "Sample"
    assert inst.term[0].action[0].subject[0].reference[0].display == "VA Ann Arbor Healthcare System"
    assert inst.term[0].action[0].subject[0].reference[0].reference == "Organization/f001"
    ...
    assert inst.term[0].action[0].subject[0].role.coding[0].system == "http://mdhhs.org/fhir/consent-actor-type"
    assert inst.term[0].action[0].subject[0].role.text == "Recipient of restricted health information"
    assert inst.term[0].action[0].subject[1].reference[0].display == "Community Mental Health Clinic"
    ...
    assert inst.term[0].action[0].subject[1].role.coding[0].system == "http://mdhhs.org/fhir/consent-actor-type"
    assert inst.term[0].action[0].subject[1].role.text == "Sender of restricted health information"
    assert inst.term[0].action[0].type.coding[0].code == "action-a"
    assert inst.term[0].action[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/contractaction"
    assert inst.term[0].asset[0].period[0].end == fhirtypes.DateTime.validate("2019-11-01T21:18:27-04:00")
    assert inst.term[0].asset[0].period[0].start == fhirtypes.DateTime.validate("2013-11-01T21:18:27-04:00")
    assert inst.term[0].offer.decision.coding[0].code == "OPTIN"
    assert inst.term[0].offer.decision.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.term[0].offer.text == "Can't refuse"
    assert inst.term[0].offer.type.coding[0].code == "statutory"
    assert inst.term[0].offer.type.coding[0].system == "http://terminology.hl7.org/CodeSystem/contracttermtypecodes"
    assert inst.text.status == "generated"
...
def test_contract_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "contract-example-42cfr-part2.json"
    )
    inst = contract.Contract.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_contract_4(inst):
    ...
    assert inst.term[0].group[0].subType.coding[0].system == "http://hl7.org/fhir/resource-types"
    assert inst.term[0].group[0].type.coding[0].code == "withhold-object-type"
    assert inst.term[0].group[0].type.coding[0].system == "http://example.org/fhir/consent-term-type-codes"
    assert inst.term[0].group[1].offer.text == "Withhold order results from any provider."
    assert inst.term[0].group[1].subType.coding[0].code == "DiagnosticReport"
    assert inst.term[0].group[1].subType.coding[0].system == "http://hl7.org/fhir/resource-types"
    assert inst.term[0].group[1].type.coding[0].code == "withhold-object-type"
    assert inst.term[0].group[1].type.coding[0].system == "http://example.org/fhir/consent-term-type-codes"
...
def test_contract_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "pcd-example-notLabs.json"
    )
    inst = contract.Contract.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_contract_5(inst):
    ...
    assert inst.signer[0].signature[0].type[0].code == "1.2.840.10065.1.12.1.1"
    assert inst.signer[0].signature[0].type[0].system == "urn:iso-astm:E1762-95:2013"
    assert inst.signer[0].signature[0].when == fhirtypes.Instant.validate("2013-06-08T10:57:34-07:00")
    ...
    "http://terminology.hl7.org/CodeSystem/contractsignertypecode"
    "s"
    )
    assert inst.subType[0].coding[0].code == "Opt-In"
    assert inst.subType[0].coding[0].display == "Default Authorization with exceptions."
...
def impl_contract_6(inst):
    ...
    assert inst.subject[0].display == "P. van de Heuvel"
    assert inst.subject[0].reference == "Patient/f001"
    assert inst.term[0].offer.text == "Withhold all data authored by Good Health provider."
    assert inst.term[0].offer.topic.display == "Good Health Clinic"
    assert inst.term[0].offer.topic.reference == "Organization/2.16.840.1.113883.19.5"
    assert inst.term[0].type.coding[0].code == "withhold-authored-by"
    assert inst.term[0].type.coding[0].display == "Withhold all data authored by specified actor entity."
    assert inst.term[0].type.coding[0].system == "http://example.org/fhir/consent-term-type-codes"
    assert inst.text.status == "generated"
    assert inst.type.coding[0].code == "57016-8"
    assert inst.type.coding[0].system == "http://loinc.org"
...
def test_contract_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "pcd-example-notAuthor.json"
    )
    inst = contract.Contract.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_contract_7(inst):
    ...
    assert inst.rule[0].contentAttachment.url == "http://www.rfc-editor.org/bcp/bcp13.txt"
    assert inst.term[0].asset[0].period[0].start == fhirtypes.DateTime.validate("2017-06-01")
    assert inst.term[0].asset[0].subtype[0].text == "sample"
    assert inst.term[0].asset[0].type[0].coding[0].code == "RicardianContract"
    assert inst.term[0].asset[0].type[0].coding[0].system == "http://something/something"
...
def test_contract_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "contract-example.json"
    )
    inst = contract.Contract.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_contract_8(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "pcd-example-notThis.json"
    )
    inst = contract.Contract.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
