...
def impl_coverage_1(inst):
    ...
    assert inst.class_fhir[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    assert inst.class_fhir[0].value == "WESTAIR"
    assert inst.class_fhir[1].name == "Full Coverage: Medical, Dental, Pharmacy, Vision, EHC"
    assert inst.class_fhir[1].type.coding[0].code == "plan"
    assert inst.class_fhir[1].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    ...
    assert inst.class_fhir[2].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    assert inst.class_fhir[2].value == "D15C9"
    assert inst.contract[0].reference == "Contract/INS-101"
    assert inst.costToBeneficiary[0].exception[0].period.end == fhirtypes.DateTime.validate("2018-12-31")
    assert inst.costToBeneficiary[0].exception[0].period.start == fhirtypes.DateTime.validate("2018-01-01")
    ...
    "http://terminology.hl7.org/CodeSystem/ex-coverage-financial-"
    "exception"
    )
    assert inst.costToBeneficiary[0].type.coding[0].code == "gpvisit"
    assert inst.costToBeneficiary[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-copay-type"
...
def test_coverage_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "coverage-example-2.json"
    )
...
def impl_coverage_2(inst):
    ...
    assert inst.type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-selfpay"
...
def test_coverage_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "coverage-example-selfpay.json"
    )
    inst = coverage.Coverage.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_coverage_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "coverage-example-ehic.json"
    )
    inst = coverage.Coverage.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_coverage_4(inst):
    ...
    assert inst.class_fhir[2].name == "Full Coverage: Medical, Dental, Pharmacy, Vision, EHC"
    ...
    assert inst.class_fhir[3].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    ...
    assert inst.class_fhir[4].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    ...
    assert inst.class_fhir[5].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    assert inst.class_fhir[5].value == "Tier2"
    assert inst.class_fhir[6].type.coding[0].code == "sequence"
    assert inst.class_fhir[6].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    assert inst.class_fhir[6].value == "9"
    assert inst.class_fhir[7].type.coding[0].code == "rxid"
    assert inst.class_fhir[7].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    assert inst.class_fhir[7].value == "MDF12345"
    assert inst.class_fhir[8].type.coding[0].code == "rxbin"
    assert inst.class_fhir[8].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    assert inst.class_fhir[8].value == "987654"
    assert inst.class_fhir[9].type.coding[0].code == "rxgroup"
    assert inst.class_fhir[9].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/coverage-class"
    ...
    assert inst.policyHolder.reference == "http://benefitsinc.com/FHIR/Organization/CBI35"
    assert inst.relationship.coding[0].code == "self"
    assert inst.status == "active"
...
def test_coverage_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "coverage-example.json"
    )
    inst = coverage.Coverage.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
