...
def impl_coverageeligibilityresponse_1(inst):
    ...
    assert inst.identifier[0].system == "http://www.BenefitsInc.com/fhir/coverageeligibilityresponse"
    ...
    "http://www.BenefitsInc.com/fhir/coverageeligibilityrequest/2"
    "25476332402"
    )
...
def test_coverageeligibilityresponse_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "coverageeligibilityresponse-example-error.json"
    )
    inst = coverageeligibilityresponse.CoverageEligibilityResponse.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_coverageeligibilityresponse_3(inst):
    ...
    assert float(inst.insurance[0].item[0].benefit[0].allowedMoney.value) == float(500000)
    ...
    assert inst.insurance[0].item[0].category.coding[0].display == "Health Benefit Plan Coverage"
    assert inst.insurance[0].item[0].category.coding[0].system == "http://terminology.hl7.org/CodeSystem/ex-benefitcategory"
    assert inst.insurance[0].item[0].network.coding[0].code == "in"
    assert inst.insurance[0].item[0].network.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-network"
    assert inst.insurance[0].item[0].term.coding[0].code == "annual"
    assert inst.insurance[0].item[0].term.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-term"
    assert inst.insurance[0].item[0].unit.coding[0].code == "individual"
    assert inst.insurance[0].item[0].unit.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-unit"
    assert inst.insurance[0].item[1].benefit[0].allowedMoney.currency == "USD"
    assert float(inst.insurance[0].item[1].benefit[0].allowedMoney.value) == float(15000)
    ...
    assert inst.insurance[0].item[1].category.coding[0].system == "http://terminology.hl7.org/CodeSystem/ex-benefitcategory"
    assert inst.insurance[0].item[1].network.coding[0].code == "in"
    assert inst.insurance[0].item[1].network.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-network"
    assert inst.insurance[0].item[1].term.coding[0].code == "annual"
    assert inst.insurance[0].item[1].term.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-term"
    assert inst.insurance[0].item[1].unit.coding[0].code == "individual"
    assert inst.insurance[0].item[1].unit.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-unit"
    ...
    assert inst.insurance[0].item[2].category.coding[0].system == "http://terminology.hl7.org/CodeSystem/ex-benefitcategory"
    assert inst.insurance[0].item[2].network.coding[0].code == "in"
    assert inst.insurance[0].item[2].network.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-network"
    assert inst.insurance[0].item[2].term.coding[0].code == "annual"
    assert inst.insurance[0].item[2].term.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-term"
    assert inst.insurance[0].item[2].unit.coding[0].code == "individual"
    assert inst.insurance[0].item[2].unit.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-unit"
    ...
    assert inst.insurance[0].item[3].category.coding[0].system == "http://terminology.hl7.org/CodeSystem/ex-benefitcategory"
    assert inst.insurance[0].item[3].description == (
    "Vision products and services such as exams, glasses and "
    "contact lenses."
    )
...
def test_coverageeligibilityresponse_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "coverageeligibilityresponse-example-benefits-2.json"
    )
    inst = coverageeligibilityresponse.CoverageEligibilityResponse.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_coverageeligibilityresponse_4(inst):
    ...
    assert inst.insurance[0].item[3].network.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-network"
    assert inst.insurance[0].item[3].term.coding[0].code == "annual"
    assert inst.insurance[0].item[3].term.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-term"
    assert inst.insurance[0].item[3].unit.coding[0].code == "individual"
    assert inst.insurance[0].item[3].unit.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-unit"
    ...
    assert inst.insurance[0].item[4].category.coding[0].display == "Hospital Room and Board"
    assert inst.insurance[0].item[4].category.coding[0].system == "http://terminology.hl7.org/CodeSystem/ex-benefitcategory"
    assert inst.insurance[0].item[4].network.coding[0].code == "in"
    assert inst.insurance[0].item[4].network.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-network"
    assert inst.insurance[0].item[4].term.coding[0].code == "day"
    assert inst.insurance[0].item[4].term.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-term"
    assert inst.insurance[0].item[4].unit.coding[0].code == "individual"
    assert inst.insurance[0].item[4].unit.coding[0].system == "http://terminology.hl7.org/CodeSystem/benefit-unit"
    assert inst.insurer.reference == "Organization/2"
    assert inst.meta.tag[0].code == "HTEST"
    assert inst.meta.tag[0].display == "test health data"
    assert inst.meta.tag[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
...
def test_coverageeligibilityresponse_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "coverageeligibilityresponse-example-benefits.json"
    )
    inst = coverageeligibilityresponse.CoverageEligibilityResponse.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
