...
def test_detectedissue_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "detectedissue-example-allergy.json"
    )
...
def impl_detectedissue_2(inst):
    ...
    assert inst.code.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
...
def test_detectedissue_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "detectedissue-example-dup.json"
    )
    inst = detectedissue.DetectedIssue.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_detectedissue_3(inst):
    ...
    assert inst.mitigation[0].action.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
...
def test_detectedissue_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "detectedissue-example.json"
    )
    inst = detectedissue.DetectedIssue.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_detectedissue_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "detectedissue-example-lab.json"
    )
    inst = detectedissue.DetectedIssue.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
