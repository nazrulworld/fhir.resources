...
def impl_detectedissue_2(inst):
    ...
    assert inst.identifiedDateTime == fhirtypes.DateTime.validate(
        "2013-05-08T09:23:00+10:00"
    )
...
def impl_detectedissue_3(inst):
    ...
    assert inst.mitigation[0].date == fhirtypes.DateTime.validate(
        "2014-01-05T09:23:00+10:00"
    )
