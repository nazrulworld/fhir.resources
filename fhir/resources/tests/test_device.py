...
def impl_device_1(inst):
    ...
    assert (
        ...
        == ExternalValidatorModel(valueUri="http://acme.com/ehr/client-ids").valueUri
    )
    ...
    assert (
        inst.url
        == ExternalValidatorModel(valueUri="http://acme.com/goodhealth/ehr/").valueUri
    )
...
def impl_device_2(inst):
    assert (
        inst.expirationDate
        == ExternalValidatorModel(valueDateTime="2020-02-02").valueDateTime
    )
    ...
    assert (
        ...
        == ExternalValidatorModel(valueDateTime="2013-02-02").valueDateTime
    )
...
def impl_device_3(inst):
    ...
    assert (
        ...
        == ExternalValidatorModel(valueUri="http://hl7.org/fhir/sid/eui-48").valueUri
    )
...
def impl_device_4(inst):
    assert (
        inst.expirationDate
        == ExternalValidatorModel(valueDateTime="2014-02-01").valueDateTime
    )
    ...
    assert (
        inst.manufactureDate
        == ExternalValidatorModel(valueDateTime="2013-02-01").valueDateTime
    )
    assert inst.manufacturer == "Acme Devices, Inc"
    assert inst.meta.tag[0].code == "HTEST"
    assert inst.meta.tag[0].display == "test health data"
...
def impl_device_6(inst):
    ...
    assert (
        inst.identifier[0].system
        == ExternalValidatorModel(valueUri="http://acme.com/containers/id").valueUri
    )
    ...
    assert (
        inst.property[0].type.coding[0].system
        == ExternalValidatorModel(valueUri="http://acme.com/containers/codes").valueUri
    )
    ...
    assert (
        inst.property[0].valueCodeableConcept.coding[0].system
        == ExternalValidatorModel(valueUri="http://acme.com/containers/types").valueUri
    )
