...
class DeviceRequestTests(unittest.TestCase):
    ...
    def implDeviceRequest2(self, inst):
        self.assertEqual(force_bytes(inst.codeCodeableConcept.coding[0].code), force_bytes("lens"))
        self.assertEqual(force_bytes(inst.codeCodeableConcept.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/ex-visionprescriptionproduct"))
        self.assertEqual(force_bytes(inst.groupIdentifier.system), force_bytes("http://acme.org"))
        ...
        self.assertEqual(force_bytes(inst.parameter[0].code.coding[0].code), force_bytes("28842-3"))
        self.assertEqual(force_bytes(inst.parameter[0].code.coding[0].display), force_bytes("Sphere distance Glasses prescription.lens - left"))
        self.assertEqual(force_bytes(inst.parameter[0].code.coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.parameter[0].code.text), force_bytes("sphere, left lens"))
        self.assertEqual(force_bytes(inst.parameter[0].valueQuantity.code), force_bytes("[diop]"))
        self.assertEqual(force_bytes(inst.parameter[0].valueQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.parameter[0].valueQuantity.unit), force_bytes("Diopter"))
        self.assertEqual(inst.parameter[0].valueQuantity.value, -1.0)
        self.assertEqual(force_bytes(inst.parameter[1].code.coding[0].code), force_bytes("28843-1"))
        self.assertEqual(force_bytes(inst.parameter[1].code.coding[0].display), force_bytes("Cylinder base distance Glasses prescription.lens - left"))
        self.assertEqual(force_bytes(inst.parameter[1].code.coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.parameter[1].code.text), force_bytes("cylinder, left lens"))
        self.assertEqual(force_bytes(inst.parameter[1].valueQuantity.code), force_bytes("[diop]"))
        self.assertEqual(force_bytes(inst.parameter[1].valueQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.parameter[1].valueQuantity.unit), force_bytes("Diopter"))
        self.assertEqual(inst.parameter[1].valueQuantity.value, -0.5)
        self.assertEqual(force_bytes(inst.parameter[2].code.coding[0].code), force_bytes("28844-9"))
        self.assertEqual(force_bytes(inst.parameter[2].code.coding[0].display), force_bytes(" Axis distance Glasses prescription.lens - left"))
        self.assertEqual(force_bytes(inst.parameter[2].code.coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.parameter[2].code.text), force_bytes("axis, left lens"))
        self.assertEqual(force_bytes(inst.parameter[2].valueQuantity.code), force_bytes("deg"))
        self.assertEqual(force_bytes(inst.parameter[2].valueQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.parameter[2].valueQuantity.unit), force_bytes("Degrees"))
    ...
    def implDeviceRequest3(self, inst):
        ...
        self.assertEqual(inst.occurrenceDateTime.date, FHIRDate("2014-06-15").date)
        self.assertEqual(inst.occurrenceDateTime.as_json(), "2014-06-15")
        self.assertEqual(force_bytes(inst.parameter[0].code.coding[0].code), force_bytes("28826-6"))
        self.assertEqual(force_bytes(inst.parameter[0].code.coding[0].display), force_bytes("Sphere distance Glasses prescription.lens - right"))
        self.assertEqual(force_bytes(inst.parameter[0].code.coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.parameter[0].code.text), force_bytes("sphere, right lens"))
        self.assertEqual(force_bytes(inst.parameter[0].valueQuantity.code), force_bytes("[diop]"))
        self.assertEqual(force_bytes(inst.parameter[0].valueQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.parameter[0].valueQuantity.unit), force_bytes("Diopter"))
        self.assertEqual(inst.parameter[0].valueQuantity.value, -2.0)
        self.assertEqual(force_bytes(inst.parameter[1].code.coding[0].code), force_bytes("28829-0"))
        self.assertEqual(force_bytes(inst.parameter[1].code.coding[0].display), force_bytes("Prism base distance Glasses prescription.lens - right"))
        self.assertEqual(force_bytes(inst.parameter[1].code.coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.parameter[1].code.text), force_bytes("prisms, right lens"))
        self.assertEqual(force_bytes(inst.parameter[1].valueQuantity.code), force_bytes("[diop]"))
        self.assertEqual(force_bytes(inst.parameter[1].valueQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.parameter[1].valueQuantity.unit), force_bytes("Diopter"))
        self.assertEqual(inst.parameter[1].valueQuantity.value, -2.0)
        self.assertEqual(force_bytes(inst.parameter[2].code.coding[0].code), force_bytes("28810-0"))
        self.assertEqual(force_bytes(inst.parameter[2].code.coding[0].display), force_bytes("Add 1 LM glasses lens - right"))
        self.assertEqual(force_bytes(inst.parameter[2].code.coding[0].system), force_bytes("http://loinc.org"))
        self.assertEqual(force_bytes(inst.parameter[2].code.text), force_bytes("add, right lens"))
        self.assertEqual(force_bytes(inst.parameter[2].valueQuantity.code), force_bytes("[diop]"))
        self.assertEqual(force_bytes(inst.parameter[2].valueQuantity.system), force_bytes("http://unitsofmeasure.org"))
        self.assertEqual(force_bytes(inst.parameter[2].valueQuantity.unit), force_bytes("Diopter"))
