...
def impl_evidence_1(inst):
    ...
    assert inst.relatedArtifact[0].url == "https://doi.org/10.1016/S0140-6736(14)60584-5"
    ...
    assert inst.statistic[0].statisticType.coding[0].system == "http://terminology.hl7.org/CodeSystem/statistic-type"
    assert inst.status == "draft"
    assert inst.studyType.coding[0].code == "RCT"
    assert inst.studyType.coding[0].display == "randomized trial"
    assert inst.studyType.coding[0].system == "http://terminology.hl7.org/CodeSystem/study-type"
    assert inst.synthesisType.coding[0].code == "IPD-MA"
    assert inst.synthesisType.coding[0].display == "individual patient data meta-analysis"
    assert inst.synthesisType.coding[0].system == "http://terminology.hl7.org/CodeSystem/synthesis-type"
    assert inst.text.status == "generated"
    assert inst.title == "Risk of fatal ICH without alteplase for stroke"
    assert inst.url == (
    "http://hl7.org/fhir/Evidence/example-stroke-no-alteplase-"
    "fatalICH"
    )
    ...
    assert inst.variableDefinition[0].intended.display == "adults with acute ischemic stroke"
    ...
    assert inst.variableDefinition[0].observed.display == "adults with acute ischemic stroke"
    ...
    assert inst.variableDefinition[0].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
    assert inst.variableDefinition[1].intended.display == "adults with acute ischemic stroke treated without alteplase"
    assert inst.variableDefinition[1].intended.reference == "Group/AcuteIschemicStrokeTreatedWithoutAlteplase"
    assert inst.variableDefinition[1].intended.type == "Group"
    assert inst.variableDefinition[1].observed.display == "Emberson 2014 IPD-MA No Alteplase Cohort"
    assert inst.variableDefinition[1].observed.reference == "Group/Emberson-2014-IPD-MA-No-Alteplase-Cohort"
    ...
    assert inst.variableDefinition[1].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
    assert inst.variableDefinition[2].intended.display == "fatal ICH"
    assert inst.variableDefinition[2].intended.reference == "EvidenceVariable/example-fatal-ICH-in-7-days"
    ...
    assert inst.variableDefinition[2].observed.reference == "EvidenceVariable/example-fatal-ICH-in-7-days"
    ...
    assert inst.variableDefinition[2].variableRole.coding[0].display == "measured variable"
    assert inst.variableDefinition[2].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
...
def test_evidence_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "evidence-example-stroke-no-alteplase-fatalICH.json"
    )
...
def impl_evidence_2(inst):
    ...
    assert inst.certainty[0].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    assert inst.certainty[0].subcomponent[0].rating.coding[0].code == "no-concern"
    assert inst.certainty[0].subcomponent[0].rating.coding[0].display == "no serious concern"
    assert inst.certainty[0].subcomponent[0].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    assert inst.certainty[0].subcomponent[0].type.coding[0].code == "PublicationBias"
    assert inst.certainty[0].subcomponent[0].type.coding[0].display == "Publication bias"
    assert inst.certainty[0].subcomponent[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    assert inst.certainty[0].subcomponent[1].note[0].text == (
    "IST-3 had inconsistent results and contributed large "
    "proportion of data"
    )
    assert inst.certainty[0].subcomponent[1].rating.coding[0].code == "serious-concern"
    assert inst.certainty[0].subcomponent[1].rating.coding[0].display == "serious concern"
    assert inst.certainty[0].subcomponent[1].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[1].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    assert inst.certainty[0].subcomponent[2].rating.coding[0].code == "serious-concern"
    assert inst.certainty[0].subcomponent[2].rating.coding[0].display == "serious concern"
    assert inst.certainty[0].subcomponent[2].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[2].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    ...
    assert inst.certainty[0].subcomponent[3].rating.coding[0].display == "serious concern"
    assert inst.certainty[0].subcomponent[3].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[3].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    ...
    assert inst.certainty[0].subcomponent[4].rating.coding[0].display == "serious concern"
    assert inst.certainty[0].subcomponent[4].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[4].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    assert inst.certainty[0].type.coding[0].code == "Overall"
    assert inst.certainty[0].type.coding[0].display == "Overall quality"
    assert inst.certainty[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    assert inst.description == (
    ...
    assert inst.statistic[0].attributeEstimate[0].type.coding[0].display == "Confidence interval"
    assert inst.statistic[0].attributeEstimate[0].type.coding[0].system == (
    "http://terminology.hl7.org/CodeSystem/attribute-estimate-"
    "type"
    )
    ...
    assert inst.variableDefinition[0].directnessMatch.coding[0].display == "Moderate quality match"
    assert inst.variableDefinition[0].directnessMatch.coding[0].system == "http://terminology.hl7.org/CodeSystem/directness"
    assert inst.variableDefinition[0].intended.display == "stroke at 3-4.5 hours"
    assert inst.variableDefinition[0].intended.reference == "Group/AcuteIschemicStroke3-4halfHours"
    assert inst.variableDefinition[0].intended.type == "Group"
    assert inst.variableDefinition[0].observed.display == "Stroke Thrombolysis Trialists’ 2014-2016 IPD-MA Cohort"
    assert inst.variableDefinition[0].observed.reference == (
    "EvidenceVariable/Stroke-Thrombolysis-"
    "Trialists-2014-2016-IPD-MA-Cohort"
    )
    assert inst.variableDefinition[0].observed.type == "EvidenceVariable"
    assert inst.variableDefinition[0].variableRole.coding[0].code == "population"
    assert inst.variableDefinition[0].variableRole.coding[0].display == "population"
    assert inst.variableDefinition[0].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
    assert inst.variableDefinition[1].intended.display == "Alive and not functionally dependent at 90 days"
    assert inst.variableDefinition[1].intended.reference == "EvidenceVariable/example-alive-independent-90day"
    ...
    assert inst.variableDefinition[1].observed.reference == "EvidenceVariable/example-mRS0-2-at-90days"
    ...
    assert inst.variableDefinition[1].variableRole.coding[0].display == "measured variable"
    assert inst.variableDefinition[1].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
    assert inst.variableDefinition[2].intended.display == "Alteplase for Stroke"
    assert inst.variableDefinition[2].intended.reference == "EvidenceVariable/example-alteplase-for-stroke"
    assert inst.variableDefinition[2].intended.type == "EvidenceVariable"
    assert inst.variableDefinition[2].observed.display == "Alteplase for Stroke"
    assert inst.variableDefinition[2].observed.reference == "EvidenceVariable/example-alteplase-for-stroke"
    assert inst.variableDefinition[2].observed.type == "EvidenceVariable"
    ...
    assert inst.variableDefinition[3].intended.reference == "EvidenceVariable/example-no-alteplase"
    ...
    assert inst.variableDefinition[3].observed.reference == "EvidenceVariable/example-no-alteplase"
    ...
    assert inst.variableDefinition[3].variableRole.coding[0].display == "reference exposure"
    assert inst.variableDefinition[3].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
...
def test_evidence_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "evidence-example-stroke-3-4half-alteplase-vs-no-alteplase-mRS0-2.json"
    )
    inst = evidence.Evidence.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_evidence_3(inst):
    ...
    assert inst.certainty[0].subcomponent[1].rating.coding[0].display == "no serious concern"
    assert inst.certainty[0].subcomponent[1].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    assert inst.certainty[0].subcomponent[1].type.coding[0].code == "Inconsistency"
    assert inst.certainty[0].subcomponent[1].type.coding[0].display == "Inconsistency"
    assert inst.certainty[0].subcomponent[1].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    assert inst.certainty[0].subcomponent[2].rating.coding[0].code == "no-concern"
    assert inst.certainty[0].subcomponent[2].rating.coding[0].display == "no serious concern"
    assert inst.certainty[0].subcomponent[2].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    assert inst.certainty[0].subcomponent[2].type.coding[0].code == "Imprecision"
    assert inst.certainty[0].subcomponent[2].type.coding[0].display == "Imprecision"
    assert inst.certainty[0].subcomponent[2].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    assert inst.certainty[0].subcomponent[3].rating.coding[0].code == "no-concern"
    assert inst.certainty[0].subcomponent[3].rating.coding[0].display == "no serious concern"
    assert inst.certainty[0].subcomponent[3].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    assert inst.certainty[0].subcomponent[3].type.coding[0].code == "Indirectness"
    assert inst.certainty[0].subcomponent[3].type.coding[0].display == "Indirectness"
    assert inst.certainty[0].subcomponent[3].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    ...
    assert inst.relatedArtifact[0].type == "citation"
    assert inst.relatedArtifact[0].url == "https://doi.org/10.1002/14651858.CD000213.pub3"
    ...
    assert float(inst.statistic[0].attributeEstimate[1].quantity.value) == float(2.3e-05)
    ...
    assert inst.statistic[0].attributeEstimate[2].description == "Heterogeneity I-sq = 0.0%"
    assert inst.statistic[0].attributeEstimate[2].quantity.code == "%"
    assert inst.statistic[0].attributeEstimate[2].quantity.system == "http://unitsofmeasure.org"
    ...
    assert inst.variableDefinition[0].intended.reference == "Group/AcuteIschemicStroke0-3Hours"
    assert inst.variableDefinition[0].intended.type == "Group"
    assert inst.variableDefinition[0].observed.display == "Wardlaw 2014 Analysis 1.16.3 Evidence set"
    assert inst.variableDefinition[0].observed.reference == "EvidenceVariable/Wardlaw2014Analysis1.16.3EvidenceSet"
    assert inst.variableDefinition[0].observed.type == "EvidenceVariable"
    assert inst.variableDefinition[0].variableRole.coding[0].code == "population"
    assert inst.variableDefinition[0].variableRole.coding[0].display == "population"
    assert inst.variableDefinition[0].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
    assert inst.variableDefinition[1].intended.display == "Dead or functionally dependent at 90 days"
    assert inst.variableDefinition[1].intended.reference == "EvidenceVariable/example-dead-or-dependent-90day"
    assert inst.variableDefinition[1].intended.type == "EvidenceVariable"
    assert inst.variableDefinition[1].observed.display == "mRS 3-6 at 90 days"
    assert inst.variableDefinition[1].observed.reference == "EvidenceVariable/example-mRS3-6-at-90days"
    assert inst.variableDefinition[1].observed.type == "EvidenceVariable"
    assert inst.variableDefinition[1].variableRole.coding[0].code == "measuredVariable"
    assert inst.variableDefinition[1].variableRole.coding[0].display == "measured variable"
    assert inst.variableDefinition[1].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
...
def test_evidence_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "evidence-example-stroke-0-3-alteplase-vs-no-alteplase-mRS3-6.json"
    )
    inst = evidence.Evidence.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_evidence_4(inst):
    ...
    assert inst.url == (
    "http://hl7.org/fhir/Evidence/example-stroke-alteplase-"
    "fatalICH"
    )
    assert inst.useContext[0].code.code == "focus"
    assert inst.useContext[0].code.system == "http://terminology.hl7.org/CodeSystem/usage-context-type"
    ...
    assert inst.variableDefinition[0].variableRole.coding[0].display == "population"
    assert inst.variableDefinition[0].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
    assert inst.variableDefinition[1].intended.display == "adults with acute ischemic stroke treated with alteplase"
    assert inst.variableDefinition[1].intended.reference == "Group/AcuteIschemicStrokeTreatedWithAlteplase"
    assert inst.variableDefinition[1].intended.type == "Group"
    assert inst.variableDefinition[1].observed.display == "Emberson 2014 IPD-MA Alteplase Cohort"
    assert inst.variableDefinition[1].observed.reference == "Group/Emberson-2014-IPD-MA-Alteplase-Cohort"
    assert inst.variableDefinition[1].observed.type == "Group"
    assert inst.variableDefinition[1].variableRole.coding[0].code == "population"
    assert inst.variableDefinition[1].variableRole.coding[0].display == "population"
    assert inst.variableDefinition[1].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
...
def test_evidence_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "evidence-example-stroke-alteplase-fatalICH.json"
    )
    inst = evidence.Evidence.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_evidence_5(inst):
    ...
    assert inst.certainty[0].subcomponent[4].rating.coding[0].display == "no serious concern"
    assert inst.certainty[0].subcomponent[4].rating.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-rating"
    assert inst.certainty[0].subcomponent[4].type.coding[0].code == "PublicationBias"
    assert inst.certainty[0].subcomponent[4].type.coding[0].display == "Publication bias"
    assert inst.certainty[0].subcomponent[4].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    assert inst.certainty[0].type.coding[0].code == "Overall"
    assert inst.certainty[0].type.coding[0].display == "Overall quality"
    assert inst.certainty[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/certainty-type"
    ...
    assert inst.text.status == "generated"
    assert inst.title == (
    "Risk of mRS3-6 at 90 days after Alteplase for Stroke if "
    "ASTRAL score 12"
    )
    assert inst.url == (
    "http://hl7.org/fhir/Evidence/example-ASTRAL-12-alteplase-"
    "mRS3-6"
    )
    assert inst.useContext[0].code.code == "focus"
    assert inst.useContext[0].code.system == "http://terminology.hl7.org/CodeSystem/usage-context-type"
    ...
    assert inst.variableDefinition[0].observed.reference == "Group/ASTRAL-Cooray-validation-cohort"
    assert inst.variableDefinition[0].observed.type == "Group"
    assert inst.variableDefinition[0].variableRole.coding[0].code == "population"
    assert inst.variableDefinition[0].variableRole.coding[0].display == "population"
    assert inst.variableDefinition[0].variableRole.coding[0].system == "http://terminology.hl7.org/CodeSystem/variable-role"
    assert inst.variableDefinition[1].description == "functionally dependent or dead at 3 months"
    assert inst.variableDefinition[1].directnessMatch.coding[0].code == "high"
    assert inst.variableDefinition[1].directnessMatch.coding[0].display == "High quality match"
    assert inst.variableDefinition[1].directnessMatch.coding[0].system == "http://terminology.hl7.org/CodeSystem/directness"
    assert inst.variableDefinition[1].intended.display == "Dead or functionally dependent at 90 days"
    assert inst.variableDefinition[1].intended.reference == "EvidenceVariable/example-dead-or-dependent-90day"
    assert inst.variableDefinition[1].intended.type == "EvidenceVariable"
    assert inst.variableDefinition[1].observed.display == "mRS 3-6 at 90 days"
    ...
    assert inst.variableDefinition[2].directnessMatch.coding[0].system == "http://terminology.hl7.org/CodeSystem/directness"
    assert inst.variableDefinition[2].intended.display == "Alteplase for Stroke"
    assert inst.variableDefinition[2].intended.reference == "EvidenceVariable/example-alteplase-for-stroke"
    assert inst.variableDefinition[2].intended.type == "EvidenceVariable"
    assert inst.variableDefinition[2].observed.display == "Alteplase for Stroke"
...
def test_evidence_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "evidence-example-ASTRAL-12-alteplase-mRS3-6.json"
    )
    inst = evidence.Evidence.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
