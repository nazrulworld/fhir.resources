...
def impl_evidencevariable_2(inst):
    ...
    assert inst.characteristic[0].timeFromStart.quantity.system == "http://unitsofmeasure.org"
...
def impl_evidencevariable_5(inst):
    ...
    assert inst.characteristic[0].definitionCodeableConcept.coding[0].code == "718705001"
    assert inst.characteristic[0].definitionCodeableConcept.coding[0].display == "Functionally dependent (finding)"
    assert inst.characteristic[0].definitionCodeableConcept.coding[0].system == "http://snomed.info/sct"
    ...
    assert inst.characteristic[0].timeFromStart.quantity.unit == "day"
    assert float(inst.characteristic[0].timeFromStart.quantity.value) == float(90)
    assert inst.characteristic[1].definitionCodeableConcept.coding[0].code == "419099009"
    assert inst.characteristic[1].definitionCodeableConcept.coding[0].display == "Dead (finding)"
    ...
    assert inst.characteristic[1].timeFromStart.quantity.system == "http://unitsofmeasure.org"
...
def impl_evidencevariable_6(inst):
    assert inst.actual is True
    assert inst.characteristicCombination == "union"
    assert inst.characteristic[0].definitionReference.display == "ECASS III Trial Cohort"
    assert inst.characteristic[0].definitionReference.reference == "Group/ECASSIII-Trial-Cohort"
    ...
    assert inst.characteristic[1].definitionReference.reference == "Group/IST3-Trial-Cohort"
    ...
    assert inst.characteristic[2].definitionReference.reference == "Group/ECASS-Trial-Cohort"
    ...
    assert inst.characteristic[3].definitionReference.reference == "Group/ECASSII-Trial-Cohort"
    ...
    assert inst.characteristic[4].definitionReference.reference == "Group/EPITHET-Trial-Cohort"
    ...
    assert inst.characteristic[5].definitionReference.reference == "Group/ATLANTIS-Trial-Cohort"
    ...
    assert inst.characteristic[6].definitionReference.reference == "Group/NINDS-Trial-Cohort"
...
def impl_evidencevariable_7(inst):
    ...
    assert inst.characteristic[0].timeFromStart.range.high.system == "http://unitsofmeasure.org"
    ...
    assert inst.characteristic[0].timeFromStart.range.low.system == "http://unitsofmeasure.org"
    ...
    assert inst.characteristic[1].timeFromStart.range.high.system == "http://unitsofmeasure.org"
    ...
    assert inst.characteristic[1].timeFromStart.range.low.system == "http://unitsofmeasure.org"
...
def test_evidencevariable_8(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "evidencevariable-example-alive-independent-90day.json"
    )
    inst = evidencevariable.EvidenceVariable.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
