...
def impl_examplescenario_1(inst):
    ...
    assert inst.process[0].step[1].process[0].step[0].operation.request.resourceId == "iherxqry"
    assert inst.process[0].step[1].process[0].step[0].operation.response.resourceId == "iherx001bundle"
    assert inst.process[0].step[1].process[0].title == "P1. Query Administration Requests"
    ...
    assert inst.process[0].step[7].alternative[0].description == "Invoke if patient took medications"
    assert inst.process[0].step[7].alternative[0].step[0].process[0].step[0].operation.initiator == "Nurse"
    assert inst.process[0].step[7].alternative[0].step[0].process[0].step[0].operation.initiatorActive is True
    assert inst.process[0].step[7].alternative[0].step[0].process[0].step[0].operation.name == "Register Meds taken"
    assert inst.process[0].step[7].alternative[0].step[0].process[0].step[0].operation.number == "1a"
    assert inst.process[0].step[7].alternative[0].step[0].process[0].step[0].operation.receiver == "MAP"
    assert inst.process[0].step[7].alternative[0].step[0].process[0].title == "Register Meds taken"
    assert inst.process[0].step[7].alternative[0].title == "Patient took drugs"
    assert inst.process[0].step[7].alternative[1].description == "No, patient did not take drugs"
    assert inst.process[0].step[7].alternative[1].step[0].process[0].step[0].operation.initiator == "Nurse"
    assert inst.process[0].step[7].alternative[1].step[0].process[0].step[0].operation.initiatorActive is True
    assert inst.process[0].step[7].alternative[1].step[0].process[0].step[0].operation.name == "Register Meds NOT taken"
    assert inst.process[0].step[7].alternative[1].step[0].process[0].step[0].operation.number == "1b"
    assert inst.process[0].step[7].alternative[1].step[0].process[0].step[0].operation.receiver == "MAP"
    assert inst.process[0].step[7].alternative[1].step[0].process[0].title == "Register Meds NOT taken"
    assert inst.process[0].step[7].alternative[1].title == "No drugs"
    assert inst.process[0].step[7].alternative[2].description == "Unknown whether patient took medications or not"
