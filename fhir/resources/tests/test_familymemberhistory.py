...
def impl_familymemberhistory_1(inst):
    ...
    "Was fishing at the time. At least he went doing someting he "
    "loved."
    )
    ...
    assert inst.instantiatesUri[0] == "http://example.org/family-member-history-questionnaire"
    ...
    assert inst.relationship.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-RoleCode"
...
def test_familymemberhistory_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "familymemberhistory-example.json"
    )
