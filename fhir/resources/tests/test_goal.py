...
class GoalTests(unittest.TestCase):
    ...
    def implGoal1(self, inst):
        ...
        self.assertEqual(
            ...
            force_bytes("http://terminology.hl7.org/CodeSystem/goal-category"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            force_bytes("http://terminology.hl7.org/CodeSystem/goal-priority"),
        )
        ...
        self.assertEqual(
            force_bytes(inst.target[0].detailRange.high.code), force_bytes("[lb_av]")
        )
        self.assertEqual(
            force_bytes(inst.target[0].detailRange.high.system),
            force_bytes("http://unitsofmeasure.org"),
        )
        self.assertEqual(
            force_bytes(inst.target[0].detailRange.high.unit), force_bytes("lbs")
        )
        self.assertEqual(inst.target[0].detailRange.high.value, 180)
        self.assertEqual(
            force_bytes(inst.target[0].detailRange.low.code), force_bytes("[lb_av]")
        )
        self.assertEqual(
            force_bytes(inst.target[0].detailRange.low.system),
            force_bytes("http://unitsofmeasure.org"),
        )
        self.assertEqual(
            force_bytes(inst.target[0].detailRange.low.unit), force_bytes("lbs")
        )
        ...
        self.assertEqual(
            force_bytes(inst.target[0].measure.coding[0].code), force_bytes("3141-9")
        )
        self.assertEqual(
            force_bytes(inst.target[0].measure.coding[0].display),
            force_bytes("Weight Measured"),
        )
        self.assertEqual(
            force_bytes(inst.target[0].measure.coding[0].system),
    ...
    def implGoal2(self, inst):
        self.assertEqual(
            force_bytes(inst.achievementStatus.coding[0].code), force_bytes("achieved")
        )
        self.assertEqual(
            force_bytes(inst.achievementStatus.coding[0].display),
            force_bytes("Achieved"),
        )
        self.assertEqual(
            force_bytes(inst.achievementStatus.coding[0].system),
            force_bytes("http://terminology.hl7.org/CodeSystem/goal-achievement"),
        )
        self.assertEqual(
            force_bytes(inst.achievementStatus.text), force_bytes("Achieved")
        )
        self.assertEqual(
