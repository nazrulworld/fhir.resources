...
def impl_imagingstudy_1(inst):
    ...
    "urn:oid:2.16.124.113543.6003.1154777499.30246.19789.35034300"
    "46"
    )
    ...
    assert inst.identifier[1].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/v2-0203"
    ...
    assert inst.reasonCode[0].coding[0].display == "Closed fracture of trapezoidal bone of wrist"
    ...
    assert inst.series[0].instance[0].sopClass.code == "urn:oid:1.2.840.10008.5.1.4.1.1.2"
    assert inst.series[0].instance[0].sopClass.system == "urn:ietf:rfc:3986"
    assert inst.series[0].instance[0].title == "PA VIEW"
    assert inst.series[0].instance[0].uid == "2.16.124.113543.6003.1154777499.30246.19789.3503430045.1.1"
    assert inst.series[0].instance[1].number == 2
    assert inst.series[0].instance[1].sopClass.code == "urn:oid:1.2.840.10008.5.1.4.1.1.2"
    assert inst.series[0].instance[1].sopClass.system == "urn:ietf:rfc:3986"
    assert inst.series[0].instance[1].title == "LL VIEW"
    assert inst.series[0].instance[1].uid == "2.16.124.113543.6003.1154777499.30246.19789.3503430045.1.2"
    ...
    assert inst.series[0].modality.system == "http://dicom.nema.org/resources/ontology/DCM"
    ...
    assert inst.series[0].performer[0].function.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.series[0].started == fhirtypes.DateTime.validate("2011-01-01T11:01:20+03:00")
    assert inst.series[0].uid == "2.16.124.113543.6003.1154777499.30246.19789.3503430045.1"
...
def test_imagingstudy_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "imagingstudy-example-xr.json"
    )
...
def impl_imagingstudy_2(inst):
    ...
    assert inst.series[0].instance[0].sopClass.code == "urn:oid:1.2.840.10008.5.1.4.1.1.2"
    assert inst.series[0].instance[0].sopClass.system == "urn:ietf:rfc:3986"
    assert inst.series[0].instance[0].uid == "2.16.124.113543.6003.189642796.63084.16748.2599092903"
    assert inst.series[0].modality.code == "CT"
    assert inst.series[0].modality.system == "http://dicom.nema.org/resources/ontology/DCM"
    assert inst.series[0].number == 3
    assert inst.series[0].numberOfInstances == 1
    assert inst.series[0].uid == "2.16.124.113543.6003.2588828330.45298.17418.2723805630"
...
def test_imagingstudy_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "imagingstudy-example.json"
    )
    inst = imagingstudy.ImagingStudy.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
