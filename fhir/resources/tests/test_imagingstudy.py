...
class ImagingStudyTests(unittest.TestCase):
    ...
    def implImagingStudy1(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.identifier[1].type.coding[0].code), force_bytes("ACSN")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.identifier[1].value), force_bytes("W12342398")
        )
        ...
        self.assertEqual(
            force_bytes(inst.modality[0].system),
            force_bytes("http://dicom.nema.org/resources/ontology/DCM"),
        )
        self.assertEqual(
            force_bytes(inst.note[0].text), force_bytes("XR Wrist 3+ Views")
        )
        ...
        self.assertEqual(
            force_bytes(inst.reasonCode[0].coding[0].code), force_bytes("357009")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.series[0].instance[0].sopClass.code),
            force_bytes("urn:oid:1.2.840.10008.5.1.4.1.1.2"),
        )
        self.assertEqual(
            force_bytes(inst.series[0].instance[0].sopClass.system),
        ...
        self.assertEqual(
            ...
            force_bytes("2.16.124.113543.6003.1154777499.30246.19789.3503430045.1.1"),
        )
        self.assertEqual(inst.series[0].instance[1].number, 2)
        self.assertEqual(
            force_bytes(inst.series[0].instance[1].sopClass.code),
            force_bytes("urn:oid:1.2.840.10008.5.1.4.1.1.2"),
        )
        self.assertEqual(
            force_bytes(inst.series[0].instance[1].sopClass.system),
            force_bytes("urn:ietf:rfc:3986"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            force_bytes("2.16.124.113543.6003.1154777499.30246.19789.3503430045.1.2"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.series[0].performer[0].function.coding[0].code),
            force_bytes("PRF"),
        )
        self.assertEqual(
            force_bytes(inst.series[0].performer[0].function.coding[0].system),
        ...
        self.assertEqual(
            ...
            force_bytes("2.16.124.113543.6003.1154777499.30246.19789.3503430045.1"),
        )
    ...
    def implImagingStudy2(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.series[0].instance[0].uid),
            force_bytes("2.16.124.113543.6003.189642796.63084.16748.2599092903"),
        )
        ...
        self.assertEqual(
            force_bytes(inst.series[0].uid),
            force_bytes("2.16.124.113543.6003.2588828330.45298.17418.2723805630"),
        )
