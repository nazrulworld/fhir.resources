...
def impl_immunizationrecommendation_1(inst):
    ...
    assert inst.recommendation[0].dateCriterion[0].code.coding[0].display == "Earliest Date"
    ...
    assert inst.recommendation[0].dateCriterion[0].value == fhirtypes.DateTime.validate("2015-12-01T00:00:00-05:00")
    assert inst.recommendation[0].dateCriterion[1].code.coding[0].code == "recommended"
    assert inst.recommendation[0].dateCriterion[1].code.coding[0].display == "Recommended"
    assert inst.recommendation[0].dateCriterion[1].code.coding[0].system == (
    "http://example.org/fhir/CodeSystem/immunization-"
    "recommendation-date-criterion"
    )
    assert inst.recommendation[0].dateCriterion[1].value == fhirtypes.DateTime.validate("2015-12-01T00:00:00-05:00")
    assert inst.recommendation[0].dateCriterion[2].code.coding[0].code == "overdue"
    assert inst.recommendation[0].dateCriterion[2].code.coding[0].display == "Past Due Date"
    assert inst.recommendation[0].dateCriterion[2].code.coding[0].system == (
    "http://example.org/fhir/CodeSystem/immunization-"
    "recommendation-date-criterion"
    )
    assert inst.recommendation[0].dateCriterion[2].value == fhirtypes.DateTime.validate("2016-12-28T00:00:00-05:00")
    ...
    assert inst.recommendation[0].supportingImmunization[0].reference == "Immunization/example"
    assert inst.recommendation[0].supportingPatientInformation[0].reference == "Observation/example"
    assert inst.recommendation[0].vaccineCode[0].coding[0].code == "14745005"
    assert inst.recommendation[0].vaccineCode[0].coding[0].display == "Hepatitis A vaccine"
    assert inst.recommendation[0].vaccineCode[0].coding[0].system == "http://snomed.info/sct"
    assert inst.text.div == (
    "<div xmlns=\"http://www.w3.org/1999/xhtml\">Authored by "
    "Joginder Madra</div>"
    )
...
def impl_immunizationrecommendation_2(inst):
    ...
    assert inst.recommendation[0].dateCriterion[0].code.coding[0].display == "Earliest date to give"
    assert inst.recommendation[0].dateCriterion[0].code.coding[0].system == "http://loinc.org"
    assert inst.recommendation[0].dateCriterion[0].value == fhirtypes.DateTime.validate("2015-12-01T00:00:00-05:00")
    assert inst.recommendation[0].dateCriterion[1].code.coding[0].code == "recommended"
    assert inst.recommendation[0].dateCriterion[1].code.coding[0].display == "Recommended"
    assert inst.recommendation[0].dateCriterion[1].code.coding[0].system == (
    ...
    assert inst.recommendation[0].targetDisease.coding[0].system == "http://snomed.info/sct"
    assert inst.text.div == (
    "<div xmlns=\"http://www.w3.org/1999/xhtml\">Authored by "
    "Joginder Madra</div>"
    )
...
def test_immunizationrecommendation_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "immunizationrecommendation-example-target-disease.json"
    )
    inst = immunizationrecommendation.ImmunizationRecommendation.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
