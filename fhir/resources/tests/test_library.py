...
class LibraryTests(unittest.TestCase):
    ...
    def implLibrary1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[0].codeFilter[0].valueSet), force_bytes("urn:oid:2.16.840.1.113883.3.464.1003.111.12.1006"))
        ...
        self.assertEqual(force_bytes(inst.relatedArtifact[0].resource), force_bytes("Library/library-quick-model-definition"))
    ...
    def implLibrary2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].resource), force_bytes("ActivityDefinition/administer-zika-virus-exposure-assessment"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].type), force_bytes("composed-of"))
        self.assertEqual(force_bytes(inst.relatedArtifact[1].resource), force_bytes("ActivityDefinition/order-serum-zika-dengue-virus-igm"))
        self.assertEqual(force_bytes(inst.relatedArtifact[1].type), force_bytes("composed-of"))
        self.assertEqual(force_bytes(inst.relatedArtifact[2].resource), force_bytes("ActivityDefinition/provide-mosquito-prevention-advice"))
        self.assertEqual(force_bytes(inst.relatedArtifact[2].type), force_bytes("composed-of"))
        self.assertEqual(force_bytes(inst.relatedArtifact[3].resource), force_bytes("Library/zika-virus-intervention-logic"))
        self.assertEqual(force_bytes(inst.relatedArtifact[3].type), force_bytes("composed-of"))
        self.assertEqual(force_bytes(inst.relatedArtifact[4].resource), force_bytes("PlanDefinition/zika-virus-intervention"))
        self.assertEqual(force_bytes(inst.relatedArtifact[4].type), force_bytes("composed-of"))
        self.assertEqual(force_bytes(inst.relatedArtifact[5].resource), force_bytes("Questionnaire/zika-virus-exposure-assessment"))
    ...
    def implLibrary3(self, inst):
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[1].codeFilter[0].code[0].code), force_bytes("diagnosis"))
        self.assertEqual(force_bytes(inst.dataRequirement[1].codeFilter[0].path), force_bytes("category"))
        self.assertEqual(force_bytes(inst.dataRequirement[1].codeFilter[1].code[0].code), force_bytes("confirmed"))
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[1].codeFilter[2].valueSet), force_bytes("urn:oid:2.16.840.1.113883.3.464.1003.102.12.1011"))
        self.assertEqual(force_bytes(inst.dataRequirement[1].type), force_bytes("Condition"))
        self.assertEqual(force_bytes(inst.dataRequirement[2].codeFilter[0].code[0].code), force_bytes("diagnosis"))
        self.assertEqual(force_bytes(inst.dataRequirement[2].codeFilter[0].path), force_bytes("category"))
        self.assertEqual(force_bytes(inst.dataRequirement[2].codeFilter[1].code[0].code), force_bytes("confirmed"))
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[2].codeFilter[2].valueSet), force_bytes("urn:oid:2.16.840.1.113883.3.464.1003.102.12.1012"))
        self.assertEqual(force_bytes(inst.dataRequirement[2].type), force_bytes("Condition"))
        self.assertEqual(force_bytes(inst.dataRequirement[3].codeFilter[0].code[0].code), force_bytes("finished"))
        self.assertEqual(force_bytes(inst.dataRequirement[3].codeFilter[0].path), force_bytes("status"))
        self.assertEqual(force_bytes(inst.dataRequirement[3].codeFilter[1].code[0].code), force_bytes("ambulatory"))
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[3].codeFilter[2].valueSet), force_bytes("urn:oid:2.16.840.1.113883.3.464.1003.101.12.1061"))
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[4].codeFilter[0].valueSet), force_bytes("urn:oid:2.16.840.1.113883.3.464.1003.198.12.1012"))
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[5].codeFilter[0].valueSet), force_bytes("urn:oid:2.16.840.1.113883.3.464.1003.196.12.1001"))
        self.assertEqual(force_bytes(inst.dataRequirement[5].type), force_bytes("Medication"))
        self.assertEqual(force_bytes(inst.dataRequirement[6].codeFilter[0].code[0].code), force_bytes("active"))
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[6].codeFilter[1].valueSet), force_bytes("urn:oid:2.16.840.1.113883.3.464.1003.196.12.1001"))
        self.assertEqual(force_bytes(inst.dataRequirement[6].type), force_bytes("MedicationRequest"))
        self.assertEqual(force_bytes(inst.dataRequirement[7].codeFilter[0].code[0].code), force_bytes("completed"))
        ...
        self.assertEqual(force_bytes(inst.dataRequirement[7].codeFilter[1].valueSet), force_bytes("urn:oid:2.16.840.1.113883.3.464.1003.196.12.1001"))
    ...
    def implLibrary4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].resource), force_bytes("Library/fhir-model-definition"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].type), force_bytes("depends-on"))
        self.assertEqual(force_bytes(inst.relatedArtifact[1].resource), force_bytes("Library/library-fhir-helpers"))
