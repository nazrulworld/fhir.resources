...
import json
import six
from fhir.resources import list
...
class ListTests(unittest.TestCase):
    ...
    def implList1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.emptyReason.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/list-empty-reason"))
    ...
    def implList9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.orderedBy.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/list-order"))
        self.assertEqual(force_bytes(inst.status), force_bytes("current"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
