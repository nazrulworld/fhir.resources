...
class ListTests(unittest.TestCase):
    ...
    def implList1(self, inst):
        self.assertEqual(
            force_bytes(inst.code.coding[0].code), force_bytes("182836005")
        )
        self.assertEqual(
            force_bytes(inst.code.coding[0].display),
            force_bytes("Review of medication"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.entry[0].flag.coding[0].code), force_bytes("01")
        )
        self.assertEqual(
            force_bytes(inst.entry[0].flag.coding[0].display), force_bytes("Prescribed")
        )
        self.assertEqual(
            force_bytes(inst.entry[0].flag.coding[0].system),
            force_bytes("http://nehta.gov.au/codes/medications/changetype"),
        )
        self.assertTrue(inst.entry[1].deleted)
        self.assertEqual(
            force_bytes(inst.entry[1].flag.coding[0].code), force_bytes("02")
        )
        self.assertEqual(
            force_bytes(inst.entry[1].flag.coding[0].display), force_bytes("Cancelled")
        )
        self.assertEqual(
            force_bytes(inst.entry[1].flag.coding[0].system),
            force_bytes("http://nehta.gov.au/codes/medications/changetype"),
        )
    ...
    def implList3(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.code.coding[0].display),
            force_bytes("Patient Admission List"),
        )
        self.assertEqual(
            force_bytes(inst.code.coding[0].system),
            force_bytes("http://acme.com/list-codes"),
        )
    ...
    def implList4(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.emptyReason.coding[0].code), force_bytes("nilknown")
        )
        self.assertEqual(
            force_bytes(inst.emptyReason.coding[0].display), force_bytes("Nil Known")
        )
        self.assertEqual(
            force_bytes(inst.emptyReason.coding[0].system),
            force_bytes("http://terminology.hl7.org/CodeSystem/list-empty-reason"),
        )
        self.assertEqual(
            force_bytes(inst.emptyReason.text),
            force_bytes("The patient is not on any medications"),
        )
    ...
    def implList7(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.entry[0].flag.text), force_bytes("Deleted due to error")
        )
        self.assertEqual(force_bytes(inst.entry[1].flag.text), force_bytes("Added"))
        self.assertEqual(force_bytes(inst.id), force_bytes("example"))
        self.assertEqual(
            force_bytes(inst.identifier[0].system),
            force_bytes("urn:uuid:a9fcea7c-fcdf-4d17-a5e0-f26dda030b59"),
        )
    ...
    def implList8(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.code.coding[0].display),
            force_bytes("Allergies and Adverse Drug Reactions"),
        )
        self.assertEqual(
            force_bytes(inst.code.coding[0].system), force_bytes("http://loinc.org")
        )
        self.assertEqual(
            force_bytes(inst.code.text), force_bytes("Current Allergy List")
        )
        ...
        self.assertEqual(
            force_bytes(inst.orderedBy.coding[0].code), force_bytes("entry-date")
        )
        self.assertEqual(
            force_bytes(inst.orderedBy.coding[0].system),
    ...
    def implList9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.contained[5].id), force_bytes("6"))
        self.assertEqual(
            force_bytes(inst.id), force_bytes("example-double-cousin-relationship")
        )
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(
            force_bytes(inst.meta.tag[0].display), force_bytes("test health data")
    ...
    def implList10(self, inst):
        ...
        self.assertEqual(force_bytes(inst.id), force_bytes("long"))
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(
            force_bytes(inst.meta.tag[0].display), force_bytes("test health data")
        )
