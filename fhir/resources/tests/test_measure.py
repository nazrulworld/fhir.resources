...
class MeasureTests(unittest.TestCase):
    ...
    def implMeasure4(self, inst):
        ...
        self.assertEqual(force_bytes(inst.group[0].code.coding[0].code), force_bytes("QRPH_ADX_ART1_N"))
        self.assertEqual(force_bytes(inst.group[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[0].description), force_bytes("Number of adults and children newly enrolled on antiretroviral therapy (ART) in the reporting period"))
        self.assertEqual(force_bytes(inst.group[0].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[0].population[0].criteria.expression), force_bytes("Newly enrolled on antiretroviral therapy (ART) during measurement period"))
        self.assertEqual(force_bytes(inst.group[0].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].code.coding[0].code), force_bytes("AGE_GROUP:SEX"))
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].criteria.expression), force_bytes("Age Group/Sex"))
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[1].code.coding[0].code), force_bytes("QRPH_ADX_ART1_N_PREG_BF"))
        self.assertEqual(force_bytes(inst.group[1].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[1].description), force_bytes("Number of adults and children newly enrolled on ART in the reporting period_pregnant and breastfeeding"))
        self.assertEqual(force_bytes(inst.group[1].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[1].population[0].criteria.expression), force_bytes("Newly enrolled on antiretroviral therapy (ART) during measurement period (pregnant and breastfeeding)"))
        self.assertEqual(force_bytes(inst.group[1].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].code.coding[0].code), force_bytes("PREG_BF"))
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].criteria.expression), force_bytes("Pregnant/Breastfeeding"))
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[2].code.coding[0].code), force_bytes("QRPH_ADX_ART3_N"))
        self.assertEqual(force_bytes(inst.group[2].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[2].description), force_bytes("Number of adults and children currently receiving antiretroviral therapy (ART)"))
        self.assertEqual(force_bytes(inst.group[2].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[2].population[0].criteria.expression), force_bytes("Receiving antiretroviral therapy (ART) during measurement period"))
        self.assertEqual(force_bytes(inst.group[2].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[3].code.coding[0].code), force_bytes("QRPH_ADX_ART5_N"))
        self.assertEqual(force_bytes(inst.group[3].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[3].description), force_bytes("Number of adults and children who are still on treatment at 12 months after initiating ART"))
        self.assertEqual(force_bytes(inst.group[3].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[3].population[0].criteria.expression), force_bytes("Receiving antiretroviral therapy (ART) at 12 months after initiating"))
        self.assertEqual(force_bytes(inst.group[3].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[3].stratifier[0].component[0].code.coding[0].code), force_bytes("AGE_GROUP"))
        self.assertEqual(force_bytes(inst.group[3].stratifier[0].component[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[3].stratifier[0].component[0].criteria.expression), force_bytes("Age Group"))
        self.assertEqual(force_bytes(inst.group[3].stratifier[0].component[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[3].stratifier[0].component[1].code.coding[0].code), force_bytes("SEX"))
        self.assertEqual(force_bytes(inst.group[3].stratifier[0].component[1].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[3].stratifier[0].component[1].criteria.expression), force_bytes("Sex"))
        self.assertEqual(force_bytes(inst.group[3].stratifier[0].component[1].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[4].code.coding[0].code), force_bytes("QRPH_ADX_ART5_N_PREG_BF"))
        self.assertEqual(force_bytes(inst.group[4].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[4].description), force_bytes("Number of adults and children who are still on treatment at 12 months after initiating ART-pregnant and breastfeeding"))
        self.assertEqual(force_bytes(inst.group[4].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[4].population[0].criteria.expression), force_bytes("Receiving antiretroviral therapy (ART) at 12 months after initiating (pregnant and breastfeeding)"))
        self.assertEqual(force_bytes(inst.group[4].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[4].stratifier[0].code.coding[0].code), force_bytes("PREG_BF"))
        self.assertEqual(force_bytes(inst.group[4].stratifier[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[4].stratifier[0].criteria.expression), force_bytes("Pregnant/Breastfeeding"))
        self.assertEqual(force_bytes(inst.group[4].stratifier[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[5].code.coding[0].code), force_bytes("QRPH_ADX_ART5_D"))
        self.assertEqual(force_bytes(inst.group[5].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[5].description), force_bytes("Number of adults and children who initiated ART in the 12 months prior to the beginning of the reporting period"))
        self.assertEqual(force_bytes(inst.group[5].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[5].population[0].criteria.expression), force_bytes("Initiated antiretroviral therapy (ART) in the 12 months prior to measurement period"))
        self.assertEqual(force_bytes(inst.group[5].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[5].stratifier[0].code.coding[0].code), force_bytes("AGE_GROUP:SEX"))
        self.assertEqual(force_bytes(inst.group[5].stratifier[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[5].stratifier[0].criteria.expression), force_bytes("Age Group/Sex"))
        self.assertEqual(force_bytes(inst.group[5].stratifier[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[6].code.coding[0].code), force_bytes("QRPH_ADX_MTCT1_D"))
        self.assertEqual(force_bytes(inst.group[6].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[6].description), force_bytes("Number of pregnant women who attended ANC or had a facility-based delivery in the reporting period"))
        self.assertEqual(force_bytes(inst.group[6].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[6].population[0].criteria.expression), force_bytes("Antenatal Care Visit or Live Birth during the Measurement Period"))
        self.assertEqual(force_bytes(inst.group[6].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[6].stratifier[0].code.coding[0].code), force_bytes("PMTCT_HIV_STATUS"))
        self.assertEqual(force_bytes(inst.group[6].stratifier[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[6].stratifier[0].criteria.expression), force_bytes("PMTCT HIV Status"))
        self.assertEqual(force_bytes(inst.group[6].stratifier[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[7].code.coding[0].code), force_bytes("QRPH_ADX_MTCT2_D"))
        self.assertEqual(force_bytes(inst.group[7].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[7].description), force_bytes("Number of HIV positive pregnant women who attended ANC or had a facility-based delivery within the reporting period"))
        self.assertEqual(force_bytes(inst.group[7].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[7].population[0].criteria.expression), force_bytes("Antenatal Care Visit or Live Birth during Measurement Period (HIV Positive)"))
        self.assertEqual(force_bytes(inst.group[7].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[8].code.coding[0].code), force_bytes("QRPH_ADX_MTCT2_N"))
        self.assertEqual(force_bytes(inst.group[8].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[8].description), force_bytes("Number of HIV-positive pregnant women who received ART to reduce the risk of mother-to-child-transmission during pregnancy"))
        self.assertEqual(force_bytes(inst.group[8].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[8].population[0].criteria.expression), force_bytes("HIV-positive, pregnant, and receiving antiretroviral therapy (ART) to reduce the risk of mother-to-child-transmission during pregnancy"))
        self.assertEqual(force_bytes(inst.group[8].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[8].stratifier[0].code.coding[0].code), force_bytes("PMTCT_ART_STATUS"))
        self.assertEqual(force_bytes(inst.group[8].stratifier[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[8].stratifier[0].criteria.expression), force_bytes("PMTCT ART Status"))
        self.assertEqual(force_bytes(inst.group[8].stratifier[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[9].code.coding[0].code), force_bytes("QRPH_ADX_VLS3_N"))
        self.assertEqual(force_bytes(inst.group[9].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[9].description), force_bytes("Number of people living with HIV and on ART who have a suppressed viral load results (<1000 copies/mL)"))
        self.assertEqual(force_bytes(inst.group[9].population[0].code.text), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.group[9].population[0].criteria.expression), force_bytes("Living with HIV and on ART with suppressed viral load results (<1000 copies/mL)"))
        self.assertEqual(force_bytes(inst.group[9].population[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.group[9].stratifier[0].code.coding[0].code), force_bytes("AGE_GROUP:SEX"))
        self.assertEqual(force_bytes(inst.group[9].stratifier[0].code.coding[0].system), force_bytes("http://ihe.net/qrph/adx/"))
        self.assertEqual(force_bytes(inst.group[9].stratifier[0].criteria.expression), force_bytes("Age Group/Sex"))
        self.assertEqual(force_bytes(inst.group[9].stratifier[0].criteria.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.id), force_bytes("hiv-indicators"))
        self.assertEqual(force_bytes(inst.identifier[0].system), force_bytes("http://ohie.org/Measure/"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("hiv-indicators"))
        self.assertEqual(force_bytes(inst.library[0]), force_bytes("http://ohie.org/Library/hiv-indicators"))
        ...
        self.assertEqual(force_bytes(inst.scoring.coding[0].code), force_bytes("cohort"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("HIV Indicators"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://ohie.org/Measure/hiv-indicators"))
