...
class MeasureReportTests(unittest.TestCase):
    ...
    def implMeasureReport3(self, inst):
        ...
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].code[0].coding[0].code), force_bytes("AGE_GROUP:SEX"))
        self.assertEqual(inst.group[0].stratifier[0].stratum[0].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].stratum[0].value.coding[0].code), force_bytes("P0Y--P1Y:F"))
        self.assertEqual(inst.group[0].stratifier[0].stratum[1].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].stratum[1].value.coding[0].code), force_bytes("P0Y--P1Y:M"))
        self.assertEqual(inst.group[0].stratifier[0].stratum[2].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].stratum[2].value.coding[0].code), force_bytes("P1Y--P5Y:F"))
        self.assertEqual(inst.group[0].stratifier[0].stratum[3].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].stratum[3].value.coding[0].code), force_bytes("P1Y--P5Y:M"))
        self.assertEqual(inst.group[0].stratifier[0].stratum[4].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].stratum[4].value.coding[0].code), force_bytes("P10Y--P15Y:F"))
        self.assertEqual(inst.group[0].stratifier[0].stratum[5].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[0].stratifier[0].stratum[5].value.coding[0].code), force_bytes("P10Y--P15Y:M"))
        self.assertEqual(force_bytes(inst.group[1].code.coding[0].code), force_bytes("QRPH_ADX_ART1_N"))
        self.assertEqual(inst.group[1].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].code[0].coding[0].code), force_bytes("AGE_GROUP:SEX"))
        self.assertEqual(inst.group[1].stratifier[0].stratum[0].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].stratum[0].value.coding[0].code), force_bytes("P0Y--P1Y:F"))
        self.assertEqual(inst.group[1].stratifier[0].stratum[1].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].stratum[1].value.coding[0].code), force_bytes("P0Y--P1Y:M"))
        self.assertEqual(inst.group[1].stratifier[0].stratum[2].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].stratum[2].value.coding[0].code), force_bytes("P1Y--P5Y:F"))
        self.assertEqual(inst.group[1].stratifier[0].stratum[3].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].stratum[3].value.coding[0].code), force_bytes("P1Y--P5Y:M"))
        self.assertEqual(inst.group[1].stratifier[0].stratum[4].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].stratum[4].value.coding[0].code), force_bytes("P10Y--P15Y:F"))
        self.assertEqual(inst.group[1].stratifier[0].stratum[5].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[1].stratifier[0].stratum[5].value.coding[0].code), force_bytes("P10Y--P15Y:M"))
        self.assertEqual(force_bytes(inst.group[2].code.coding[0].code), force_bytes("QRPH_ADX_ART1_N"))
        self.assertEqual(inst.group[2].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].code[0].coding[0].code), force_bytes("AGE_GROUP"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].code[1].coding[0].code), force_bytes("SEX"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[0].component[0].code.coding[0].code), force_bytes("AGE_GROUP"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[0].component[0].value.coding[0].code), force_bytes("P0Y--P1Y"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[0].component[1].code.coding[0].code), force_bytes("SEX"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[0].component[1].value.coding[0].code), force_bytes("F"))
        self.assertEqual(inst.group[2].stratifier[0].stratum[0].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[1].component[0].code.coding[0].code), force_bytes("AGE_GROUP"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[1].component[0].value.coding[0].code), force_bytes("P0Y--P1Y"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[1].component[1].code.coding[0].code), force_bytes("SEX"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[1].component[1].value.coding[0].code), force_bytes("M"))
        self.assertEqual(inst.group[2].stratifier[0].stratum[1].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[2].component[0].code.coding[0].code), force_bytes("AGE_GROUP"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[2].component[0].value.coding[0].code), force_bytes("P1Y--P5Y"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[2].component[1].code.coding[0].code), force_bytes("SEX"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[2].component[1].value.coding[0].code), force_bytes("F"))
        self.assertEqual(inst.group[2].stratifier[0].stratum[2].measureScore.value, 0)
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[3].component[0].code.coding[0].code), force_bytes("AGE_GROUP"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[3].component[0].value.coding[0].code), force_bytes("P1Y--P5Y"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[3].component[1].code.coding[0].code), force_bytes("SEX"))
        self.assertEqual(force_bytes(inst.group[2].stratifier[0].stratum[3].component[1].value.coding[0].code), force_bytes("F"))
        ...
        self.assertEqual(force_bytes(inst.measure), force_bytes("http://ohie.org/Measure/hiv-indicators"))
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
