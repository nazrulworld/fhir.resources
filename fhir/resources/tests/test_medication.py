...
def impl_medication_1(inst):
    ...
    assert inst.ingredient[0].itemCodeableConcept.coding[0].display == "Insulin Aspart (substance)"
    assert inst.ingredient[0].itemCodeableConcept.coding[0].system == "http://snomed.info/sct"
...
def test_medication_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationexample0307.json"
    )
...
def impl_medication_2(inst):
    ...
    assert inst.ingredient[0].strength.denominator.system == "http://terminology.hl7.org/CodeSystem/v3-orderableDrugForm"
    assert float(inst.ingredient[0].strength.denominator.value) == float(1)
...
def impl_medication_4(inst):
    ...
    assert inst.form.coding[0].display == "Lyophilized powder for injectable solution (qualifier value)"
    assert inst.form.coding[0].system == "http://snomed.info/sct"
...
def impl_medication_5(inst):
    ...
    assert inst.code.coding[0].display == "Vancomycin Hydrochloride (VANCOMYCIN HYDROCHLORIDE)"
    assert inst.code.coding[0].system == "http://hl7.org/fhir/sid/ndc"
    ...
    assert inst.ingredient[0].itemCodeableConcept.coding[0].display == "Vancomycin Hydrochloride"
    assert inst.ingredient[0].itemCodeableConcept.coding[0].system == "http://www.nlm.nih.gov/research/umls/rxnorm"
    assert inst.ingredient[0].strength.denominator.code == "mL"
    assert inst.ingredient[0].strength.denominator.system == "http://unitsofmeasure.org"
...
def test_medication_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationexample0301.json"
    )
    inst = medication.Medication.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_medication_6(inst):
    ...
    assert inst.ingredient[0].itemCodeableConcept.coding[0].display == "Potassium Chloride"
    assert inst.ingredient[0].itemCodeableConcept.coding[0].system == "http://www.nlm.nih.gov/research/umls/rxnorm"
    assert inst.ingredient[0].strength.denominator.code == "mL"
    assert inst.ingredient[0].strength.denominator.system == "http://unitsofmeasure.org"
    assert float(inst.ingredient[0].strength.denominator.value) == float(1)
    ...
    assert inst.ingredient[1].itemCodeableConcept.coding[0].display == "Sodium Chloride 0.9% injectable solution"
    assert inst.ingredient[1].itemCodeableConcept.coding[0].system == "http://www.nlm.nih.gov/research/umls/rxnorm"
...
def test_medication_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationexample0317.json"
    )
    inst = medication.Medication.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_medication_9(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationexample0321.json"
    )
    inst = medication.Medication.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_medication_10(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationexample0320.json"
    )
    inst = medication.Medication.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
