...
def impl_medicationadministration_1(inst):
    ...
    assert inst.effectivePeriod.start == fhirtypes.DateTime.validate("2015-01-15T14:30:00+01:00")
    ...
    "http://terminology.hl7.org/CodeSystem/reason-medication-"
    "given"
    )
...
def test_medicationadministration_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0301.json"
    )
...
def impl_medicationadministration_2(inst):
    ...
    assert inst.context.reference == "Encounter/f001"
    assert inst.effectivePeriod.end == fhirtypes.DateTime.validate("2015-01-15T14:30:00+01:00")
    assert inst.effectivePeriod.start == fhirtypes.DateTime.validate("2015-01-15T14:30:00+01:00")
    ...
    "Administration of medication not done due to a "
...
def impl_medicationadministration_3(inst):
    ...
    assert inst.dosage.method.coding[0].display == "Push - dosing instruction imperative (qualifier value)"
    ...
    "0.05 - 0.1mg/kg IV over 2-5 minutes every 15 minutes as "
    "needed"
    )
    assert inst.effectivePeriod.end == fhirtypes.DateTime.validate("2015-01-15T14:30:00+01:00")
    assert inst.effectivePeriod.start == fhirtypes.DateTime.validate("2015-01-15T04:30:00+01:00")
    ...
    "http://terminology.hl7.org/CodeSystem/med-admin-perform-"
    "function"
    )
...
def test_medicationadministration_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0307.json"
    )
    inst = medicationadministration.MedicationAdministration.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_medicationadministration_4(inst):
    ...
    assert inst.dosage.dose.system == "http://terminology.hl7.org/CodeSystem/v3-orderableDrugForm"
    ...
    assert inst.effectivePeriod.end == fhirtypes.DateTime.validate("2015-01-16T02:03:00+01:00")
    assert inst.effectivePeriod.start == fhirtypes.DateTime.validate("2015-01-15T22:03:00+01:00")
...
def test_medicationadministration_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0311.json"
    )
    inst = medicationadministration.MedicationAdministration.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_medicationadministration_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0310.json"
    )
    inst = medicationadministration.MedicationAdministration.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_medicationadministration_6(inst):
    ...
    assert inst.dosage.method.coding[0].display == "Swallow - dosing instruction imperative (qualifier value)"
    assert inst.dosage.method.coding[0].system == "http://snomed.info/sct"
    assert inst.dosage.route.coding[0].code == "26643006"
    assert inst.dosage.route.coding[0].display == "Oral Route"
    assert inst.dosage.route.coding[0].system == "http://snomed.info/sct"
...
def test_medicationadministration_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0306.json"
    )
    inst = medicationadministration.MedicationAdministration.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_medicationadministration_7(inst):
    ...
    assert inst.dosage.site.coding[0].display == "Structure of ligament of left superior vena cava"
    assert inst.dosage.site.coding[0].system == "http://snomed.info/sct"
    assert inst.dosage.text == "1000mL infused at 50ml/hour for 4 hours - hung at 2200 hours"
    assert inst.effectivePeriod.end == fhirtypes.DateTime.validate("2015-01-16T02:03:00+01:00")
    assert inst.effectivePeriod.start == fhirtypes.DateTime.validate("2015-01-15T22:03:00+01:00")
...
def test_medicationadministration_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0309.json"
    )
    inst = medicationadministration.MedicationAdministration.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_medicationadministration_8(inst):
    ...
    assert inst.medicationCodeableConcept.coding[0].display == "Paracetamol 240mg suppository (product)"
...
def test_medicationadministration_8(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0313.json"
    )
    inst = medicationadministration.MedicationAdministration.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_medicationadministration_9(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0305.json"
    )
    inst = medicationadministration.MedicationAdministration.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_medicationadministration_10(inst):
    ...
    assert inst.dosage.method.coding[0].display == "Inject - dosing instruction imperative (qualifier value)"
    assert inst.dosage.method.coding[0].system == "http://snomed.info/sct"
    assert inst.dosage.route.coding[0].code == "47625008"
    assert inst.dosage.route.coding[0].display == "Intravenous route (qualifier value)"
    assert inst.dosage.route.coding[0].system == "http://snomed.info/sct"
...
def test_medicationadministration_10(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationadministration0304.json"
    )
    inst = medicationadministration.MedicationAdministration.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
