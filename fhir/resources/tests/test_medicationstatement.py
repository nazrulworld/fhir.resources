...
def test_medicationstatement_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationstatementexample5.json"
    )
...
def impl_medicationstatement_2(inst):
    ...
    assert inst.dosage[0].maxDosePerPeriod.denominator.system == "http://unitsofmeasure.org"
...
def test_medicationstatement_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationstatementexample4.json"
    )
    inst = medicationstatement.MedicationStatement.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_medicationstatement_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationstatementexample3.json"
    )
    inst = medicationstatement.MedicationStatement.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_medicationstatement_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationstatementexample2.json"
    )
    inst = medicationstatement.MedicationStatement.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_medicationstatement_5(inst):
    ...
    assert inst.dosage[0].asNeededCodeableConcept.coding[0].system == "http://snomed.info/sct"
...
def test_medicationstatement_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationstatementexample1.json"
    )
    inst = medicationstatement.MedicationStatement.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_medicationstatement_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "medicationstatementexample7.json"
    )
    inst = medicationstatement.MedicationStatement.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
