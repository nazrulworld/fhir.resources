...
class MessageDefinitionTests(unittest.TestCase):
    ...
    def implMessageDefinition1(self, inst):
        ...
        self.assertEqual(
            force_bytes(inst.eventCoding.code), force_bytes("admin-notify")
        )
        self.assertEqual(
            force_bytes(inst.eventCoding.system),
            force_bytes("http://example.org/fhir/message-events"),
        )
    ...
    def implMessageDefinition2(self, inst):
        self.assertEqual(
            force_bytes(inst.allowedResponse[0].message),
            force_bytes("MessageDefinition/patient-link-response"),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            force_bytes(inst.base), force_bytes("MessageDefinition/example")
        )
        self.assertEqual(force_bytes(inst.category), force_bytes("notification"))
        self.assertEqual(
            force_bytes(inst.contact[0].telecom[0].system), force_bytes("url")
        ...
        self.assertEqual(
            force_bytes(inst.focus[0].profile),
            force_bytes("StructureDefinition/example"),
        )
