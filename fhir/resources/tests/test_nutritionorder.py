...
def impl_nutritionorder_1(inst):
    ...
    assert inst.supplement[0].schedule.timing[
        0
    ...
    assert inst.supplement[0].type.concept.coding[0].system == "http://snomed.info/sct"
...
def impl_nutritionorder_2(inst):
    ...
    assert inst.enteralFormula.administration[0].schedule.timing[
        0
    ].repeat.boundsPeriod.start == fhirtypes.DateTime.validate("2014-09-17T16:00:00Z")
    assert (
...
def impl_nutritionorder_3(inst):
    ...
    assert inst.oralDiet.schedule.timing[
        0
...
def impl_nutritionorder_6(inst):
    ...
    assert inst.enteralFormula.administration[0].schedule.timing[
        0
    ].repeat.boundsPeriod.start == fhirtypes.DateTime.validate("2014-09-17")
    assert (
        inst.enteralFormula.administration[0].schedule.timing[0].repeat.frequency == 1
    )
    assert float(
...
def impl_nutritionorder_7(inst):
    ...
    assert inst.enteralFormula.administration[0].schedule.timing[
        0
    ].repeat.boundsPeriod.start == fhirtypes.DateTime.validate("2014-09-17T07:00:00Z")
    ...
    assert inst.enteralFormula.administration[1].schedule.timing[
        0
    ].repeat.boundsPeriod.start == fhirtypes.DateTime.validate("2014-09-17T11:00:00Z")
    ...
    assert inst.enteralFormula.administration[2].schedule.timing[
        0
    ].repeat.boundsPeriod.start == fhirtypes.DateTime.validate("2014-09-17T15:00:00Z")
