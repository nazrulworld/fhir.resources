...
def impl_operationdefinition_2(inst):
    ...
    assert inst.parameter[4].documentation == "The system for the code that is to be translated"
    ...
    "The version of the system, if one was provided in the source"
    " data"
    )
...
def test_operationdefinition_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "operation-valueset-expand.json"
    )
    inst = operationdefinition.OperationDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_operationdefinition_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "operation-resource-meta-add.json"
    )
    inst = operationdefinition.OperationDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_operationdefinition_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "operation-resource-graph.json"
    )
    inst = operationdefinition.OperationDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_operationdefinition_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "operation-resource-meta.json"
    )
    inst = operationdefinition.OperationDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_operationdefinition_8(inst):
    ...
    assert inst.parameter[2].type == "string"
    assert inst.parameter[2].use == "in"
    assert inst.parameter[3].documentation == "Subject for which the care gaps report will be produced"
    assert inst.parameter[3].max == "1"
    assert inst.parameter[3].min == 1
...
def test_operationdefinition_8(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "operation-measure-care-gaps.json"
    )
    inst = operationdefinition.OperationDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
