...
class OperationDefinitionTests(unittest.TestCase):
    ...
    def implOperationDefinition1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.extension[0].url), force_bytes("http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm"))
    ...
    def implOperationDefinition2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.parameter[0].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[1].documentation), force_bytes("The concept map is provided directly as part of the request. Servers may choose not to accept concept maps in this fashion."))
        self.assertEqual(force_bytes(inst.parameter[1].max), force_bytes("1"))
        ...
        self.assertEqual(force_bytes(inst.parameter[2].name), force_bytes("conceptMapVersion"))
        ...
        self.assertEqual(force_bytes(inst.parameter[3].documentation), force_bytes("The code that is to be translated. If a code is provided, a system must be provided"))
        ...
        self.assertEqual(force_bytes(inst.parameter[4].documentation), force_bytes("The system for the code that is to be translated"))
        ...
        self.assertEqual(force_bytes(inst.parameter[5].documentation), force_bytes("The version of the system, if one was provided in the source data"))
        ...
        self.assertEqual(force_bytes(inst.parameter[7].documentation), force_bytes("A coding to translate"))
        ...
        self.assertEqual(force_bytes(inst.parameter[8].documentation), force_bytes("A full codeableConcept to validate. The server can translate any of the coding values (e.g. existing translations) as it chooses"))
        self.assertEqual(force_bytes(inst.parameter[8].max), force_bytes("1"))
        self.assertEqual(inst.parameter[8].min, 0)
        self.assertEqual(force_bytes(inst.parameter[8].name), force_bytes("codeableConcept"))
    ...
    def implOperationDefinition3(self, inst):
        ...
        self.assertEqual(force_bytes(inst.parameter[0].documentation), force_bytes("A canonical reference to a value set. The server must know the value set (e.g. it is defined explicitly in the server's value sets, or it is defined implicitly by some code system known to the server"))
        self.assertEqual(force_bytes(inst.parameter[0].max), force_bytes("1"))
        self.assertEqual(inst.parameter[0].min, 0)
        self.assertEqual(force_bytes(inst.parameter[0].name), force_bytes("url"))
        self.assertEqual(force_bytes(inst.parameter[0].type), force_bytes("uri"))
        ...
        self.assertEqual(force_bytes(inst.parameter[2].max), force_bytes("1"))
        self.assertEqual(inst.parameter[2].min, 0)
        self.assertEqual(force_bytes(inst.parameter[2].name), force_bytes("valueSetVersion"))
        self.assertEqual(force_bytes(inst.parameter[2].type), force_bytes("string"))
        self.assertEqual(force_bytes(inst.parameter[2].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[3].max), force_bytes("1"))
        self.assertEqual(inst.parameter[3].min, 0)
        ...
        self.assertEqual(force_bytes(inst.parameter[4].max), force_bytes("1"))
        self.assertEqual(inst.parameter[4].min, 0)
        self.assertEqual(force_bytes(inst.parameter[4].name), force_bytes("contextDirection"))
        ...
        self.assertEqual(force_bytes(inst.parameter[6].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[7].documentation), force_bytes("Paging support - where to start if a subset is desired (default = 0). Offset is number of records (not number of pages)"))
        self.assertEqual(force_bytes(inst.parameter[7].max), force_bytes("1"))
        self.assertEqual(inst.parameter[7].min, 0)
        ...
        self.assertEqual(force_bytes(inst.parameter[8].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[9].documentation), force_bytes("Controls whether concept designations are to be included or excluded in value set expansions"))
        self.assertEqual(force_bytes(inst.parameter[9].max), force_bytes("1"))
        self.assertEqual(inst.parameter[9].min, 0)
        self.assertEqual(force_bytes(inst.parameter[9].name), force_bytes("includeDesignations"))
    ...
    def implOperationDefinition4(self, inst):
        ...
        self.assertEqual(inst.date.date, FHIRDate("2019-11-01T09:29:23+11:00").date)
        self.assertEqual(inst.date.as_json(), "2019-11-01T09:29:23+11:00")
        self.assertEqual(force_bytes(inst.description), force_bytes("This operation takes a meta, and adds the profiles, tags, and security labels found in it to the nominated resource"))
        self.assertEqual(force_bytes(inst.extension[0].url), force_bytes("http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm"))
        self.assertEqual(inst.extension[0].valueInteger, 3)
        self.assertEqual(force_bytes(inst.extension[1].url), force_bytes("http://hl7.org/fhir/StructureDefinition/structuredefinition-standards-status"))
        self.assertEqual(force_bytes(inst.extension[1].valueCode), force_bytes("trial-use"))
    ...
    def implOperationDefinition5(self, inst):
        ...
        self.assertEqual(force_bytes(inst.parameter[0].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[1].documentation), force_bytes("One or more parameters, each containing one or more comma-delimited FHIR resource types to include in the return resources. In the absense of any specified types, the server returns all resource types"))
        ...
        self.assertEqual(force_bytes(inst.parameter[1].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[2].documentation), force_bytes("See discussion below on the utility of paging through the results of the $everything operation"))
        self.assertEqual(force_bytes(inst.parameter[2].max), force_bytes("1"))
        self.assertEqual(inst.parameter[2].min, 0)
        ...
        self.assertEqual(force_bytes(inst.parameter[2].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[3].documentation), force_bytes("The bundle type is \"searchset\""))
        self.assertEqual(force_bytes(inst.parameter[3].max), force_bytes("1"))
    ...
    def implOperationDefinition6(self, inst):
        ...
        self.assertTrue(inst.instance)
        self.assertEqual(force_bytes(inst.kind), force_bytes("operation"))
        self.assertEqual(force_bytes(inst.name), force_bytes("Return a graph of resources"))
        self.assertEqual(force_bytes(inst.parameter[0].max), force_bytes("1"))
        self.assertEqual(inst.parameter[0].min, 1)
        self.assertEqual(force_bytes(inst.parameter[0].name), force_bytes("graph"))
        self.assertEqual(force_bytes(inst.parameter[0].type), force_bytes("uri"))
        self.assertEqual(force_bytes(inst.parameter[0].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[1].documentation), force_bytes("The set of resources that were in the graph based on the provided definition"))
        self.assertEqual(force_bytes(inst.parameter[1].max), force_bytes("1"))
        self.assertEqual(inst.parameter[1].min, 1)
        ...
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertFalse(inst.type)
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/OperationDefinition/Resource-graph"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
    ...
    def implOperationDefinition8(self, inst):
        ...
        self.assertEqual(inst.date.date, FHIRDate("2019-11-01T09:29:23+11:00").date)
        self.assertEqual(inst.date.as_json(), "2019-11-01T09:29:23+11:00")
        self.assertEqual(force_bytes(inst.description), force_bytes("The care-gaps operation is used to determine gaps-in-care based on the results of quality measures"))
        self.assertEqual(force_bytes(inst.extension[0].url), force_bytes("http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm"))
        self.assertEqual(inst.extension[0].valueInteger, 2)
        self.assertEqual(force_bytes(inst.extension[1].url), force_bytes("http://hl7.org/fhir/StructureDefinition/structuredefinition-standards-status"))
        self.assertEqual(force_bytes(inst.extension[1].valueCode), force_bytes("trial-use"))
        ...
        self.assertEqual(force_bytes(inst.parameter[1].type), force_bytes("date"))
        self.assertEqual(force_bytes(inst.parameter[1].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[2].documentation), force_bytes("The topic to be used to determine which measures are considered for the care gaps report. Any measure with the given topic will be included in the report"))
        self.assertEqual(force_bytes(inst.parameter[2].max), force_bytes("1"))
        self.assertEqual(inst.parameter[2].min, 1)
        self.assertEqual(force_bytes(inst.parameter[2].name), force_bytes("topic"))
        self.assertEqual(force_bytes(inst.parameter[2].type), force_bytes("string"))
        self.assertEqual(force_bytes(inst.parameter[2].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[3].documentation), force_bytes("Subject for which the care gaps report will be produced"))
        self.assertEqual(force_bytes(inst.parameter[3].max), force_bytes("1"))
        self.assertEqual(inst.parameter[3].min, 1)
        self.assertEqual(force_bytes(inst.parameter[3].name), force_bytes("subject"))
        self.assertEqual(force_bytes(inst.parameter[3].searchType), force_bytes("reference"))
        self.assertEqual(force_bytes(inst.parameter[3].type), force_bytes("string"))
        self.assertEqual(force_bytes(inst.parameter[3].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[4].documentation), force_bytes("The result of the care gaps report will be returned as a document bundle with a MeasureReport entry for each included measure"))
        self.assertEqual(force_bytes(inst.parameter[4].max), force_bytes("1"))
        ...
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertTrue(inst.type)
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/OperationDefinition/Measure-care-gaps"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
    ...
    def implOperationDefinition9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.parameter[0].documentation), force_bytes("The measure report being submitted"))
        self.assertEqual(force_bytes(inst.parameter[0].max), force_bytes("1"))
        self.assertEqual(inst.parameter[0].min, 1)
        self.assertEqual(force_bytes(inst.parameter[0].name), force_bytes("measureReport"))
        self.assertEqual(force_bytes(inst.parameter[0].type), force_bytes("MeasureReport"))
        self.assertEqual(force_bytes(inst.parameter[0].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[1].documentation), force_bytes("The individual resources that make up the data-of-interest being submitted"))
        self.assertEqual(force_bytes(inst.parameter[1].max), force_bytes("*"))
        self.assertEqual(inst.parameter[1].min, 0)
        ...
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertTrue(inst.type)
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/OperationDefinition/Measure-submit-data"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
    ...
    def implOperationDefinition10(self, inst):
        ...
        self.assertEqual(inst.date.date, FHIRDate("2019-11-01T09:29:23+11:00").date)
        self.assertEqual(inst.date.as_json(), "2019-11-01T09:29:23+11:00")
        self.assertEqual(force_bytes(inst.description), force_bytes("The evaluate-measure operation is used to calculate an eMeasure and obtain the results"))
        self.assertEqual(force_bytes(inst.extension[0].url), force_bytes("http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm"))
        self.assertEqual(inst.extension[0].valueInteger, 2)
        self.assertEqual(force_bytes(inst.extension[1].url), force_bytes("http://hl7.org/fhir/StructureDefinition/structuredefinition-standards-status"))
        self.assertEqual(force_bytes(inst.extension[1].valueCode), force_bytes("trial-use"))
        ...
        self.assertEqual(force_bytes(inst.parameter[2].searchType), force_bytes("reference"))
        self.assertEqual(force_bytes(inst.parameter[2].type), force_bytes("string"))
        self.assertEqual(force_bytes(inst.parameter[2].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[3].documentation), force_bytes("The type of measure report: subject, subject-list, or population. If not specified, a default value of subject will be used if the subject parameter is supplied, otherwise, population will be used"))
        self.assertEqual(force_bytes(inst.parameter[3].max), force_bytes("1"))
        self.assertEqual(inst.parameter[3].min, 0)
        ...
        self.assertEqual(force_bytes(inst.parameter[4].searchType), force_bytes("reference"))
        self.assertEqual(force_bytes(inst.parameter[4].type), force_bytes("string"))
        self.assertEqual(force_bytes(inst.parameter[4].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[5].documentation), force_bytes("Practitioner for which the measure will be calculated. If specified, the measure will be calculated only for subjects that have a primary relationship to the identified practitioner"))
        self.assertEqual(force_bytes(inst.parameter[5].max), force_bytes("1"))
        self.assertEqual(inst.parameter[5].min, 0)
        self.assertEqual(force_bytes(inst.parameter[5].name), force_bytes("practitioner"))
        self.assertEqual(force_bytes(inst.parameter[5].searchType), force_bytes("reference"))
        self.assertEqual(force_bytes(inst.parameter[5].type), force_bytes("string"))
        self.assertEqual(force_bytes(inst.parameter[5].use), force_bytes("in"))
        self.assertEqual(force_bytes(inst.parameter[6].max), force_bytes("1"))
        self.assertEqual(inst.parameter[6].min, 0)
