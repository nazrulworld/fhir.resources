...
def test_organization_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "organization-example-lab.json"
    )
    inst = organization.Organization.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_organization_6(inst):
    ...
    assert inst.contact[0].purpose.coding[0].system == "http://terminology.hl7.org/CodeSystem/contactentity-type"
    ...
    assert inst.type[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/organization-type"
...
def test_organization_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "organization-example-f002-burgers-card.json"
    )
    inst = organization.Organization.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_organization_9(inst):
    ...
    assert inst.contact[1].purpose.coding[0].system == "http://terminology.hl7.org/CodeSystem/contactentity-type"
