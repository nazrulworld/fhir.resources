...
def impl_organizationaffiliation_1(inst):
    ...
    assert inst.period.end == fhirtypes.DateTime.validate("2012-03-31T11:15:33+10:00")
    assert inst.period.start == fhirtypes.DateTime.validate("2012-01-01T11:15:33+10:00")
...
def impl_organizationaffiliation_3(inst):
    ...
    assert inst.period.end == fhirtypes.DateTime.validate("2022-02-01T11:15:33+10:00")
    assert inst.period.start == fhirtypes.DateTime.validate("2018-02-09T11:15:33+10:00")
