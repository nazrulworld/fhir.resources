...
def impl_patient_2(inst):
    ...
    assert inst.maritalStatus.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-MaritalStatus"
...
def test_patient_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "patient-example-f001-pieter.json"
    )
    inst = patient.Patient.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_patient_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "patient-example-d.json"
    )
    inst = patient.Patient.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_patient_4(inst):
    ...
    assert inst.identifier[0].system == "http://coruscanthealth.org/main-hospital/patient-identifier"
    assert inst.identifier[0].type.coding[0].code == "MR"
    assert inst.identifier[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/v2-0203"
    assert inst.identifier[0].value == "MRN7465737865"
    assert inst.identifier[1].system == "http://new-republic.gov/galactic-citizen-identifier"
...
def test_patient_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "patient-example-infant-twin-1.json"
    )
    inst = patient.Patient.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_patient_5(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "patient-example-infant-mom.json"
    )
    inst = patient.Patient.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_patient_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "patient-example-newborn.json"
    )
    inst = patient.Patient.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_patient_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "patient-example-infant-fetal.json"
    )
    inst = patient.Patient.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def test_patient_9(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "patient-example-b.json"
    )
    inst = patient.Patient.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_patient_10(inst):
    ...
    assert inst.deceasedDateTime == fhirtypes.DateTime.validate("2015-02-14T13:42:00+10:00")
    assert inst.gender == "male"
    assert inst.id == "pat3"
    assert inst.identifier[0].system == "urn:oid:0.1.2.3.4.5.6.7"
    assert inst.identifier[0].type.coding[0].code == "MR"
...
def test_patient_10(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "patient-example-c.json"
    )
    inst = patient.Patient.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
