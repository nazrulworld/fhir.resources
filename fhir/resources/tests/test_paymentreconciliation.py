...
def impl_paymentreconciliation_1(inst):
    ...
    assert inst.detail[0].identifier.system == "http://www.BenefitsInc.com/payment/2018/detail"
    assert inst.detail[0].identifier.value == "10-12345-001"
    assert inst.detail[0].payee.reference == "Organization/1"
    assert inst.detail[0].request.identifier.system == "http://happyvalleyclinic.com/claim"
    assert inst.detail[0].request.identifier.value == "AB12345"
    assert inst.detail[0].response.identifier.system == "http://www.BenefitsInc.com/fhir/claimresponse"
    ...
    assert inst.detail[0].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/payment-type"
    ...
    assert inst.detail[1].identifier.system == "http://www.BenefitsInc.com/payment/2018/detail"
    assert inst.detail[1].identifier.value == "10-12345-002"
    assert inst.detail[1].request.reference == "http://www.BenefitsInc.com/fhir/oralhealthclaim/225476332699"
    assert inst.detail[1].type.coding[0].code == "payment"
    assert inst.detail[1].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/payment-type"
    ...
    assert inst.detail[2].identifier.system == "http://www.BenefitsInc.com/payment/2018/detail"
    assert inst.detail[2].identifier.value == "10-12345-003"
    assert inst.detail[2].type.coding[0].code == "advance"
    assert inst.detail[2].type.coding[0].system == "http://terminology.hl7.org/CodeSystem/payment-type"
