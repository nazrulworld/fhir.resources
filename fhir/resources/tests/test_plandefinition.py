...
def impl_plandefinition_1(inst):
    ...
    assert inst.action[0].action[0].action[0].action[0].action[1].relatedAction[0].actionId == "action-1"
...
def impl_plandefinition_2(inst):
    assert inst.action[0].action[0].definitionCanonical == "#activitydefinition-medicationrequest-1"
    assert inst.action[0].action[0].id == "medication-action-1"
    assert inst.action[0].action[0].title == "Administer Medication 1"
    assert inst.action[0].action[1].definitionCanonical == "#activitydefinition-medicationrequest-2"
    ...
    assert inst.action[0].action[1].relatedAction[0].offsetDuration.system == "http://unitsofmeasure.org"
    assert inst.action[0].action[1].relatedAction[0].offsetDuration.unit == "h"
    assert float(inst.action[0].action[1].relatedAction[0].offsetDuration.value) == float(1)
...
def impl_plandefinition_5(inst):
    assert inst.action[0].action[0].action[0].definitionCanonical == "#referralToCardiologyConsult"
    assert inst.action[0].action[0].action[0].dynamicValue[0].expression.expression == "Now()"
    assert inst.action[0].action[0].action[0].dynamicValue[0].expression.language == "text/cql"
    ...
    assert inst.action[0].action[0].action[0].dynamicValue[1].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[1].path == "specialty"
    assert inst.action[0].action[0].action[0].dynamicValue[2].expression.expression == "CardiologyChestPainLogic.ServiceRequestFulfillmentTime"
    assert inst.action[0].action[0].action[0].dynamicValue[2].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[2].path == "occurrenceDateTime"
    assert inst.action[0].action[0].action[0].dynamicValue[3].expression.expression == "CardiologyChestPainLogic.Patient"
    assert inst.action[0].action[0].action[0].dynamicValue[3].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[3].path == "subject"
    assert inst.action[0].action[0].action[0].dynamicValue[4].expression.expression == "CardiologyChestPainLogic.Practitioner"
    assert inst.action[0].action[0].action[0].dynamicValue[4].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[4].path == "requester.agent"
    assert inst.action[0].action[0].action[0].dynamicValue[5].expression.expression == "CardiologyChestPainLogic.CardiologyReferralReason"
    assert inst.action[0].action[0].action[0].dynamicValue[5].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[5].path == "reasonCode"
    assert inst.action[0].action[0].action[0].dynamicValue[6].expression.expression == "CardiologyChestPainLogic.RiskAssessment"
    assert inst.action[0].action[0].action[0].dynamicValue[6].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[6].path == "reasonReference"
    assert inst.action[0].action[0].action[0].textEquivalent == "Referral to cardiology to evaluate chest pain (routine)"
    assert inst.action[0].action[0].action[1].definitionCanonical == "#CollectReferralReason"
    assert inst.action[0].action[0].action[1].title == "Reason for cardiology consultation"
    assert inst.action[0].action[0].action[2].definitionCanonical == "#CardiologyConsultationGoal"
    ...
    assert inst.action[0].action[1].action[1].action[0].definitionCanonical == "#metoprololTartrate25Prescription"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[0].expression.expression == "'draft'"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[0].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[0].path == "status"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[1].expression.expression == "CardiologyChestPainLogic.Patient"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[1].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[1].path == "patient"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[2].expression.expression == "CardiologyChestPainLogic.Practitioner"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[2].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[0].dynamicValue[2].path == "prescriber"
    assert inst.action[0].action[1].action[1].action[0].textEquivalent == "metoprolol tartrate 25 mg tablet 1 tablet oral 2 time daily"
    assert inst.action[0].action[1].action[1].action[1].definitionCanonical == "#metoprololTartrate50Prescription"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[0].expression.expression == "'draft'"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[0].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[0].path == "status"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[1].expression.expression == "CardiologyChestPainLogic.Patient"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[1].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[1].path == "patient"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[2].expression.expression == "CardiologyChestPainLogic.Practitioner"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[2].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[1].dynamicValue[2].path == "prescriber"
    assert inst.action[0].action[1].action[1].action[1].textEquivalent == "metoprolol tartrate 50 mg tablet 1 tablet oral 2 time daily"
    assert inst.action[0].action[1].action[1].action[2].definitionCanonical == "#amlodipinePrescription"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[0].expression.expression == "'draft'"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[0].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[0].path == "status"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[1].expression.expression == "CardiologyChestPainLogic.Patient"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[1].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[1].path == "patient"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[2].expression.expression == "CardiologyChestPainLogic.Practitioner"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[2].expression.language == "text/cql"
    assert inst.action[0].action[1].action[1].action[2].dynamicValue[2].path == "prescriber"
    assert inst.action[0].action[1].action[1].action[2].textEquivalent == "amlodipine 5  tablet 1 tablet oral  daily"
    ...
    assert inst.action[0].action[1].action[2].action[0].definitionCanonical == "#nitroglycerinPrescription"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[0].expression.expression == "'draft'"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[0].expression.language == "text/cql"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[0].path == "status"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[1].expression.expression == "CardiologyChestPainLogic.Patient"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[1].expression.language == "text/cql"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[1].path == "patient"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[2].expression.expression == "CardiologyChestPainLogic.Practitioner"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[2].expression.language == "text/cql"
    assert inst.action[0].action[1].action[2].action[0].dynamicValue[2].path == "prescriber"
    ...
    "urn:va.gov:kbs:contract:VA118-16-D-1008:to:VA-118-16-F-1008-"
    "0007"
    )
    ...
    assert inst.relatedArtifact[5].display == "LABEL: ASPIRIN 81 MG- aspirin tablet, coated"
    ...
    "LABEL: CLOPIDOGREL- clopidogrel bisulfate tablet, film "
    "coated"
    )
    ...
    assert inst.relatedArtifact[7].display == "LABEL: LIPITOR- atorvastatin calcium tablet, film coated"
    ...
    assert inst.relatedArtifact[9].display == "LABEL: NITROGLYCERIN- nitroglycerin tablet"
    ...
    assert inst.useContext[0].valueCodeableConcept.coding[0].display == "appropriate snomed condition"
...
def impl_plandefinition_6(inst):
    ...
    assert inst.action[0].description == "Measure, Weight, Height, Waist, Circumference; Calculate BMI"
    ...
    assert inst.author[0].telecom[0].value == "https://www.nhlbi.nih.gov/health-pro/guidelines"
    ...
    assert inst.goal[0].target[0].measure.coding[0].display == "Body mass index (BMI) [Ratio]"
    ...
    assert inst.relatedArtifact[0].display == "Overweight and Obesity Treatment Guidelines"
    assert inst.relatedArtifact[0].document.url == (
    ...
    assert inst.useContext[0].valueCodeableConcept.coding[0].display == "Obesity (disorder)"
    assert inst.useContext[0].valueCodeableConcept.coding[0].system == "http://snomed.info/sct"
...
def impl_plandefinition_7(inst):
    assert inst.action[0].action[0].action[0].definitionCanonical == "#referralToMentalHealthCare"
    assert inst.action[0].action[0].action[0].dynamicValue[0].expression.expression == "Now()"
    assert inst.action[0].action[0].action[0].dynamicValue[0].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[0].path == "timing.event"
    assert inst.action[0].action[0].action[0].dynamicValue[1].expression.expression == (
    ...
    assert inst.action[0].action[0].action[0].dynamicValue[1].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[1].path == "specialty"
    assert inst.action[0].action[0].action[0].dynamicValue[2].expression.expression == "SuicideRiskLogic.ServiceRequestFulfillmentTime"
    assert inst.action[0].action[0].action[0].dynamicValue[2].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[2].path == "occurrenceDateTime"
    assert inst.action[0].action[0].action[0].dynamicValue[3].expression.expression == "SuicideRiskLogic.Patient"
    assert inst.action[0].action[0].action[0].dynamicValue[3].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[3].path == "subject"
    assert inst.action[0].action[0].action[0].dynamicValue[4].expression.expression == "SuicideRiskLogic.Practitioner"
    assert inst.action[0].action[0].action[0].dynamicValue[4].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[4].path == "requester.agent"
    assert inst.action[0].action[0].action[0].dynamicValue[5].expression.expression == "SuicideRiskLogic.RiskAssessmentScore"
    assert inst.action[0].action[0].action[0].dynamicValue[5].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[5].path == "reasonCode"
    assert inst.action[0].action[0].action[0].dynamicValue[6].expression.expression == "SuicideRiskLogic.RiskAssessment"
    assert inst.action[0].action[0].action[0].dynamicValue[6].expression.language == "text/cql"
    assert inst.action[0].action[0].action[0].dynamicValue[6].path == "reasonReference"
    ...
    assert inst.action[0].action[0].selectionBehavior == "any"
    assert inst.action[0].action[0].title == "Consults and Referrals"
    assert inst.action[0].action[1].action[0].action[0].action[0].definitionCanonical == "#citalopramPrescription"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[0].expression.expression == "'draft'"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[0].expression.language == "text/cql"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[0].path == "status"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[1].expression.expression == "SuicideRiskLogic.Patient"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[1].expression.language == "text/cql"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[1].path == "patient"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[2].expression.expression == "SuicideRiskLogic.Practitioner"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[2].expression.language == "text/cql"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[2].path == "prescriber"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[3].expression.expression == "SuicideRiskLogic.RiskAssessmentScore"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[3].expression.language == "text/cql"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[3].path == "reasonCode"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[4].expression.expression == "SuicideRiskLogic.RiskAssessment"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[4].expression.language == "text/cql"
    assert inst.action[0].action[1].action[0].action[0].action[0].dynamicValue[4].path == "reasonReference"
    ...
    assert inst.action[0].action[1].action[0].action[0].documentation[0].document.contentType == "text/html"
    assert inst.action[0].action[1].action[0].action[0].documentation[0].document.title == (
    "National Library of Medicine. DailyMed website. CITALOPRAM- "
    "citalopram hydrobromide tablet, film coated."
    )
    assert inst.action[0].action[1].action[0].action[0].documentation[0].document.url == (
    "http://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=6dae"
    "b45c-451d-b135-bf8f-2d6dff4b6b01"
    )
    assert inst.action[0].action[1].action[0].action[0].documentation[0].type == "citation"
    assert inst.action[0].action[1].action[0].action[0].documentation[0].url == (
    "http://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=6dae"
    "b45c-451d-b135-bf8f-2d6dff4b6b01"
    )
    assert inst.action[0].action[1].action[0].action[0].groupingBehavior == "logical-group"
    assert inst.action[0].action[1].action[0].action[0].selectionBehavior == "at-most-one"
    ...
    assert inst.action[0].action[1].action[0].documentation[0].document.contentType == "text/html"
    assert inst.action[0].action[1].action[0].documentation[0].document.extension[0].url == (
    "http://hl7.org/fhir/StructureDefinition/cqf-"
    "qualityOfEvidence"
    )
    assert inst.action[0].action[1].action[0].documentation[0].document.extension[0].valueCodeableConcept.coding[0].code == "high"
    assert inst.action[0].action[1].action[0].documentation[0].document.extension[0].valueCodeableConcept.coding[0].system == "http://terminology.hl7.org/CodeSystem/evidence-quality"
    assert inst.action[0].action[1].action[0].documentation[0].document.extension[0].valueCodeableConcept.text == "High Quality"
    ...
    assert inst.copyright == (
    "© Copyright 2016 Motive Medical Intelligence. All rights "
    "reserved."
    )
    assert inst.date == fhirtypes.DateTime.validate("2015-08-15")
    assert inst.description == (
    "Orders to be applied to a patient characterized as low "
    "suicide risk."
    )
    ...
    assert inst.library[0] == "http://example.org/fhir/Library/suiciderisk-orderset-logic"
    ...
    "http://example.org/fhir/ActivityDefinition/citalopramPrescri"
    "ption"
    )
    ...
    assert inst.useContext[0].valueCodeableConcept.coding[0].system == "https://meshb.nlm.nih.gov"
    ...
    assert inst.useContext[1].valueCodeableConcept.coding[0].display == "Mild major depression"
    ...
    assert inst.useContext[2].valueCodeableConcept.coding[0].display == "Major depression, recurrent, mild"
    assert inst.useContext[2].valueCodeableConcept.coding[0].system == "http://snomed.info/sct"
    assert inst.useContext[3].code.code == "focus"
    assert inst.useContext[3].code.system == "http://terminology.hl7.org/CodeSystem/usage-context-type"
    assert inst.useContext[3].valueCodeableConcept.coding[0].code == "394687007"
    assert inst.useContext[3].valueCodeableConcept.coding[0].display == "Low suicide risk"
    assert inst.useContext[3].valueCodeableConcept.coding[0].system == "http://snomed.info/sct"
    assert inst.useContext[4].code.code == "focus"
    assert inst.useContext[4].code.system == "http://terminology.hl7.org/CodeSystem/usage-context-type"
    assert inst.useContext[4].valueCodeableConcept.coding[0].code == "225337009"
    assert inst.useContext[4].valueCodeableConcept.coding[0].display == "Suicide risk assessment"
    assert inst.useContext[4].valueCodeableConcept.coding[0].system == "http://snomed.info/sct"
    ...
    assert inst.useContext[5].valueCodeableConcept.coding[0].system == "http://snomed.info/sct"
    assert inst.useContext[6].code.code == "venue"
    assert inst.useContext[6].code.system == "http://terminology.hl7.org/CodeSystem/usage-context-type"
    assert inst.useContext[6].valueCodeableConcept.coding[0].code == "440655000"
    assert inst.useContext[6].valueCodeableConcept.coding[0].display == "Outpatient environment"
    assert inst.useContext[6].valueCodeableConcept.coding[0].system == "http://snomed.info/sct"
    assert inst.version == "1.0.0"
...
def test_plandefinition_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "plandefinition-example.json"
    )
    inst = plandefinition.PlanDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_plandefinition_8(inst):
    ...
    assert inst.action[0].selectionBehavior == "exactly-one"
    assert inst.action[0].title == (
    "Existing patient exhibits risk factors for opioid-related "
    "harms."
    )
    ...
    assert inst.jurisdiction[0].coding[0].system == "urn:iso:std:iso:3166"
    assert inst.library[0] == "http://example.org/fhir/Library/opioidcds-recommendation-08"
    ...
    "cds/PlanDefinition/opioidcds-08"
    )
    assert inst.usage == (
