...
class PlanDefinitionTests(unittest.TestCase):
    ...
    def testPlanDefinition3(self):
        inst = self.instantiate_from("plandefinition-exclusive-breastfeeding-intervention-02.json")
        self.assertIsNotNone(inst, "Must have instantiated a PlanDefinition instance")
    ...
    def implPlanDefinition3(self, inst):
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression.expression), force_bytes("Communication Request to Provider"))
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].path), force_bytes("/"))
        self.assertEqual(force_bytes(inst.action[0].action[0].textEquivalent), force_bytes("A Breastfeeding Readiness Assessment is recommended, please authorize or reject the order."))
        self.assertEqual(force_bytes(inst.action[0].action[0].title), force_bytes("Notify the provider to sign the order."))
        self.assertEqual(force_bytes(inst.action[0].action[0].type.coding[0].code), force_bytes("create"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.expression), force_bytes("Should Notify Provider to Sign Assessment Order"))
        ...
        self.assertEqual(force_bytes(inst.action[0].title), force_bytes("Mother should be administered a breastfeeding readiness assessment."))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].name), force_bytes("Admission"))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.action[0].trigger[1].name), force_bytes("Birth"))
        self.assertEqual(force_bytes(inst.action[0].trigger[1].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.action[0].trigger[2].name), force_bytes("Infant Transfer to Recovery"))
        self.assertEqual(force_bytes(inst.action[0].trigger[2].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.action[0].trigger[3].name), force_bytes("Transfer to Post-Partum"))
        self.assertEqual(force_bytes(inst.action[0].trigger[3].type), force_bytes("named-event"))
        self.assertEqual(inst.date.date, FHIRDate("2015-03-08").date)
        self.assertEqual(inst.date.as_json(), "2015-03-08")
        self.assertEqual(force_bytes(inst.id), force_bytes("exclusive-breastfeeding-intervention-02"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("exclusive-breastfeeding-intervention-02"))
        self.assertEqual(force_bytes(inst.library[0]), force_bytes("Library/library-exclusive-breastfeeding-cds-logic"))
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].resource), force_bytes("Measure/measure-exclusive-breastfeeding"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].type), force_bytes("derived-from"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("Exclusive Breastfeeding Intervention-02"))
    ...
    def testPlanDefinition4(self):
        inst = self.instantiate_from("plandefinition-exclusive-breastfeeding-intervention-03.json")
        self.assertIsNotNone(inst, "Must have instantiated a PlanDefinition instance")
    ...
    def implPlanDefinition4(self, inst):
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression.expression), force_bytes("Communication Request to Charge Nurse"))
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].path), force_bytes("/"))
        self.assertEqual(force_bytes(inst.action[0].action[0].textEquivalent), force_bytes("A Breastfeeding Readiness Assessment is recommended, please administer the assessment."))
        self.assertEqual(force_bytes(inst.action[0].action[0].title), force_bytes("Notify the charge nurse to perform the assessment."))
        self.assertEqual(force_bytes(inst.action[0].action[0].type.coding[0].code), force_bytes("create"))
        self.assertEqual(force_bytes(inst.action[0].action[1].dynamicValue[0].expression.expression), force_bytes("Communication Request to Bedside Nurse"))
        self.assertEqual(force_bytes(inst.action[0].action[1].dynamicValue[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].action[1].dynamicValue[0].path), force_bytes("/"))
        self.assertEqual(force_bytes(inst.action[0].action[1].textEquivalent), force_bytes("A Breastfeeding Readiness Assessment is recommended, please administer the assessment."))
        self.assertEqual(force_bytes(inst.action[0].action[1].title), force_bytes("Notify the bedside nurse to perform the assessment."))
        self.assertEqual(force_bytes(inst.action[0].action[1].type.coding[0].code), force_bytes("create"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.expression), force_bytes("Should Notify Nurse to Perform Assessment"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].kind), force_bytes("applicability"))
        self.assertEqual(force_bytes(inst.action[0].title), force_bytes("Mother should be administered a breastfeeding readiness assessment."))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].name), force_bytes("Admission"))
        ...
        self.assertEqual(inst.date.date, FHIRDate("2015-03-08").date)
        self.assertEqual(inst.date.as_json(), "2015-03-08")
        self.assertEqual(force_bytes(inst.id), force_bytes("exclusive-breastfeeding-intervention-03"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("exclusive-breastfeeding-intervention-03"))
        self.assertEqual(force_bytes(inst.library[0]), force_bytes("Library/library-exclusive-breastfeeding-cds-logic"))
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
        ...
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("Exclusive Breastfeeding Intervention-03"))
        self.assertEqual(force_bytes(inst.topic[0].text), force_bytes("Exclusive Breastfeeding"))
        self.assertEqual(force_bytes(inst.version), force_bytes("1.0.0"))
    ...
    def implPlanDefinition8(self, inst):
        self.assertEqual(force_bytes(inst.action[0].action[0].description), force_bytes("Will offer Naloxone instead"))
        self.assertEqual(force_bytes(inst.action[0].action[1].description), force_bytes("Risk of overdose carefully considered and outweighed by benefit; snooze 3 mo"))
        self.assertEqual(force_bytes(inst.action[0].action[2].description), force_bytes("N/A - see comment; snooze 3 mo"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.expression), force_bytes("Inclusion Criteria"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].kind), force_bytes("applicability"))
        self.assertEqual(force_bytes(inst.action[0].description), force_bytes("Checking if the trigger prescription meets the inclusion criteria for recommendation #8 workflow."))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[0].url), force_bytes("http://hl7.org/fhir/StructureDefinition/cqf-strengthOfRecommendation"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[0].valueCodeableConcept.coding[0].code), force_bytes("strong"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[0].valueCodeableConcept.coding[0].display), force_bytes("Strong"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[0].valueCodeableConcept.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/recommendation-strength"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[1].url), force_bytes("http://hl7.org/fhir/StructureDefinition/cqf-qualityOfEvidence"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[1].valueCodeableConcept.coding[0].code), force_bytes("low"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[1].valueCodeableConcept.coding[0].display), force_bytes("Low quality"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[1].valueCodeableConcept.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/evidence-quality"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].type), force_bytes("documentation"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[0].expression.expression), force_bytes("Get Detail"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[0].path), force_bytes("action.description"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[1].expression.expression), force_bytes("Get Summary"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[1].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[1].path), force_bytes("action.title"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[2].expression.expression), force_bytes("Get Indicator"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[2].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[2].path), force_bytes("action.extension"))
        self.assertEqual(force_bytes(inst.action[0].groupingBehavior), force_bytes("visual-group"))
        self.assertEqual(force_bytes(inst.action[0].selectionBehavior), force_bytes("exactly-one"))
        self.assertEqual(force_bytes(inst.action[0].title), force_bytes("Existing patient exhibits risk factors for opioid-related harms."))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].name), force_bytes("medication-prescribe"))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.author[0].name), force_bytes("Kensaku Kawamoto, MD, PhD, MHS"))
        self.assertEqual(force_bytes(inst.author[1].name), force_bytes("Bryn Rhodes"))
        self.assertEqual(force_bytes(inst.author[2].name), force_bytes("Floyd Eisenberg, MD, MPH"))
        self.assertEqual(force_bytes(inst.author[3].name), force_bytes("Robert McClure, MD, MPH"))
        ...
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("cdc-opioid-guidance"))
        self.assertEqual(force_bytes(inst.jurisdiction[0].coding[0].code), force_bytes("US"))
        self.assertEqual(force_bytes(inst.jurisdiction[0].coding[0].display), force_bytes("United States of America"))
        self.assertEqual(force_bytes(inst.jurisdiction[0].coding[0].system), force_bytes("urn:iso:std:iso:3166"))
        self.assertEqual(force_bytes(inst.library[0]), force_bytes("Library/opioidcds-recommendation-08"))
        self.assertEqual(force_bytes(inst.name), force_bytes("cdc-opioid-08"))
        self.assertEqual(force_bytes(inst.publisher), force_bytes("Centers for Disease Control and Prevention (CDC)"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].display), force_bytes("CDC guideline for prescribing opioids for chronic pain"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].type), force_bytes("documentation"))
        self.assertEqual(force_bytes(inst.relatedArtifact[0].url), force_bytes("https://guidelines.gov/summaries/summary/50153/cdc-guideline-for-prescribing-opioids-for-chronic-pain---united-states-2016#420"))
        self.assertEqual(force_bytes(inst.relatedArtifact[1].display), force_bytes("MME Conversion Tables"))
        self.assertEqual(force_bytes(inst.relatedArtifact[1].type), force_bytes("documentation"))
        self.assertEqual(force_bytes(inst.relatedArtifact[1].url), force_bytes("https://www.cdc.gov/drugoverdose/pdf/calculating_total_daily_dose-a.pdf"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("CDC Opioid Prescribing Guideline Recommendation #8"))
        self.assertEqual(force_bytes(inst.topic[0].text), force_bytes("Opioid Prescribing"))
        self.assertEqual(force_bytes(inst.type.coding[0].code), force_bytes("eca-rule"))
        self.assertEqual(force_bytes(inst.type.coding[0].display), force_bytes("ECA Rule"))
        self.assertEqual(force_bytes(inst.type.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/plan-definition-type"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/ig/opioid-cds/PlanDefinition/opioidcds-08"))
        self.assertEqual(force_bytes(inst.usage), force_bytes("Before starting and periodically during continuation of opioid therapy, clinicians should evaluate risk factors for opioid-related harms."))
        self.assertEqual(force_bytes(inst.useContext[0].code.code), force_bytes("focus"))
        self.assertEqual(force_bytes(inst.useContext[0].code.display), force_bytes("Clinical Focus"))
        self.assertEqual(force_bytes(inst.useContext[0].code.system), force_bytes("http://terminology.hl7.org/CodeSystem/usage-context-type"))
        self.assertEqual(force_bytes(inst.useContext[0].valueCodeableConcept.coding[0].code), force_bytes("182888003"))
        self.assertEqual(force_bytes(inst.useContext[0].valueCodeableConcept.coding[0].display), force_bytes("Medication requested (situation)"))
        self.assertEqual(force_bytes(inst.useContext[0].valueCodeableConcept.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.useContext[1].code.code), force_bytes("focus"))
        self.assertEqual(force_bytes(inst.useContext[1].code.display), force_bytes("Clinical Focus"))
        self.assertEqual(force_bytes(inst.useContext[1].code.system), force_bytes("http://terminology.hl7.org/CodeSystem/usage-context-type"))
        self.assertEqual(force_bytes(inst.useContext[1].valueCodeableConcept.coding[0].code), force_bytes("82423001"))
        self.assertEqual(force_bytes(inst.useContext[1].valueCodeableConcept.coding[0].display), force_bytes("Chronic pain (finding)"))
        self.assertEqual(force_bytes(inst.useContext[1].valueCodeableConcept.coding[0].system), force_bytes("http://snomed.info/sct"))
        self.assertEqual(force_bytes(inst.version), force_bytes("0.1.0"))

    def testPlanDefinition9(self):
        inst = self.instantiate_from("plandefinition-exclusive-breastfeeding-intervention-04.json")
        self.assertIsNotNone(inst, "Must have instantiated a PlanDefinition instance")
    ...
    def implPlanDefinition9(self, inst):
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression.expression), force_bytes("Create Lactation Consult Request"))
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].action[0].dynamicValue[0].path), force_bytes("/"))
        self.assertEqual(force_bytes(inst.action[0].action[0].textEquivalent), force_bytes("Create a lactation consult request"))
        self.assertEqual(force_bytes(inst.action[0].action[0].title), force_bytes("Create a lactation consult request."))
        self.assertEqual(force_bytes(inst.action[0].action[0].type.coding[0].code), force_bytes("create"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.expression), force_bytes("Should Create Lactation Consult"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].kind), force_bytes("applicability"))
        self.assertEqual(force_bytes(inst.action[0].title), force_bytes("Mother should be referred to a lactation specialist for consultation."))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].name), force_bytes("Admission"))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.action[0].trigger[1].name), force_bytes("Birth"))
        self.assertEqual(force_bytes(inst.action[0].trigger[1].type), force_bytes("named-event"))
        ...
        self.assertEqual(inst.date.date, FHIRDate("2015-03-08").date)
        self.assertEqual(inst.date.as_json(), "2015-03-08")
        self.assertEqual(force_bytes(inst.description), force_bytes("Exclusive breastfeeding intervention intended to improve outcomes for exclusive breastmilk feeding of newborns by creating a lactation consult for the mother if appropriate."))
        self.assertEqual(force_bytes(inst.id), force_bytes("exclusive-breastfeeding-intervention-04"))
        self.assertEqual(force_bytes(inst.identifier[0].use), force_bytes("official"))
        self.assertEqual(force_bytes(inst.identifier[0].value), force_bytes("exclusive-breastfeeding-intervention-04"))
        self.assertEqual(force_bytes(inst.library[0]), force_bytes("Library/library-exclusive-breastfeeding-cds-logic"))
        self.assertEqual(force_bytes(inst.meta.tag[0].code), force_bytes("HTEST"))
        self.assertEqual(force_bytes(inst.meta.tag[0].display), force_bytes("test health data"))
        self.assertEqual(force_bytes(inst.meta.tag[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ActReason"))
        ...
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("Exclusive Breastfeeding Intervention-04"))
        self.assertEqual(force_bytes(inst.topic[0].text), force_bytes("Exclusive Breastfeeding"))
        self.assertEqual(force_bytes(inst.version), force_bytes("1.0.0"))
    ...
    def implPlanDefinition10(self, inst):
        self.assertEqual(force_bytes(inst.action[0].action[0].description), force_bytes("Will precribe immediate release"))
        self.assertEqual(force_bytes(inst.action[0].action[1].description), force_bytes("Risk of overdose carefully considered and outweighed by benefit; snooze 3 mo"))
        self.assertEqual(force_bytes(inst.action[0].action[2].description), force_bytes("N/A - see comment; snooze 3 mo"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.description), force_bytes("Check whether the opioid prescription for the existing patient is extended-release without any opioids-with-abuse-potential prescribed in the past 90 days."))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.expression), force_bytes("Inclusion Criteria"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].condition[0].kind), force_bytes("applicability"))
        self.assertEqual(force_bytes(inst.action[0].description), force_bytes("Checking if the trigger prescription meets the inclusion criteria for recommendation #4 workflow."))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[0].url), force_bytes("http://hl7.org/fhir/StructureDefinition/cqf-strengthOfRecommendation"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[0].valueCodeableConcept.coding[0].code), force_bytes("strong"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[0].valueCodeableConcept.coding[0].display), force_bytes("Strong"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[0].valueCodeableConcept.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/recommendation-strength"))
        ...
        self.assertEqual(force_bytes(inst.action[0].documentation[0].document.extension[1].valueCodeableConcept.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/evidence-quality"))
        self.assertEqual(force_bytes(inst.action[0].documentation[0].type), force_bytes("documentation"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[0].expression.expression), force_bytes("Get Summary"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[0].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[0].path), force_bytes("action.title"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[1].expression.expression), force_bytes("Get Detail"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[1].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[1].path), force_bytes("action.description"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[2].expression.expression), force_bytes("Get Indicator"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[2].expression.language), force_bytes("text/cql"))
        self.assertEqual(force_bytes(inst.action[0].dynamicValue[2].path), force_bytes("activity.extension"))
        self.assertEqual(force_bytes(inst.action[0].groupingBehavior), force_bytes("visual-group"))
        self.assertEqual(force_bytes(inst.action[0].selectionBehavior), force_bytes("exactly-one"))
        self.assertEqual(force_bytes(inst.action[0].title), force_bytes("Extended-release opioid prescription triggered."))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].name), force_bytes("medication-prescribe"))
        self.assertEqual(force_bytes(inst.action[0].trigger[0].type), force_bytes("named-event"))
        self.assertEqual(force_bytes(inst.author[0].name), force_bytes("Kensaku Kawamoto, MD, PhD, MHS"))
        self.assertEqual(force_bytes(inst.author[1].name), force_bytes("Bryn Rhodes"))
        ...
        self.assertEqual(inst.date.date, FHIRDate("2018-03-19").date)
        self.assertEqual(inst.date.as_json(), "2018-03-19")
        self.assertEqual(force_bytes(inst.description), force_bytes("When starting opioid therapy for chronic pain, clinicians should prescribe immediate-release opioids instead of extended-release/long-acting (ER/LA) opioids."))
        ...
        self.assertEqual(force_bytes(inst.jurisdiction[0].coding[0].display), force_bytes("United States of America"))
        self.assertEqual(force_bytes(inst.jurisdiction[0].coding[0].system), force_bytes("urn:iso:std:iso:3166"))
        self.assertEqual(force_bytes(inst.library[0]), force_bytes("Library/opioidcds-recommendation-04"))
        ...
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.title), force_bytes("CDC Opioid Prescribing Guideline Recommendation #4"))
        self.assertEqual(force_bytes(inst.topic[0].text), force_bytes("Opioid Prescribing"))
        self.assertEqual(force_bytes(inst.type.coding[0].code), force_bytes("eca-rule"))
        self.assertEqual(force_bytes(inst.type.coding[0].display), force_bytes("ECA Rule"))
        self.assertEqual(force_bytes(inst.type.coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/plan-definition-type"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/ig/opioid-cds/PlanDefinition/opioidcds-04"))
        self.assertEqual(force_bytes(inst.usage), force_bytes("Providers should use caution when prescribing extended-release/long-acting (ER/LA) opioids as they carry a higher risk and negligible benefit compared to immediate-release opioids."))
        self.assertEqual(force_bytes(inst.useContext[0].code.code), force_bytes("focus"))
        self.assertEqual(force_bytes(inst.useContext[0].code.display), force_bytes("Clinical Focus"))
        self.assertEqual(force_bytes(inst.useContext[0].code.system), force_bytes("http://terminology.hl7.org/CodeSystem/usage-context-type"))
        self.assertEqual(force_bytes(inst.useContext[0].valueCodeableConcept.coding[0].code), force_bytes("182888003"))
