...
def impl_procedure_1(inst):
    ...
    assert inst.performedPeriod.end == fhirtypes.DateTime.validate("2013-01-28T14:27:00+01:00")
    assert inst.performedPeriod.start == fhirtypes.DateTime.validate("2013-01-28T13:31:00+01:00")
...
def test_procedure_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "procedure-example-f201-tpf.json"
    )
...
def impl_procedure_5(inst):
    ...
    assert inst.performedPeriod.end == fhirtypes.DateTime.validate("2013-03-22T10:30:10+01:00")
    assert inst.performedPeriod.start == fhirtypes.DateTime.validate("2013-03-22T09:30:10+01:00")
...
def impl_procedure_9(inst):
    ...
    assert inst.meta.tag[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    assert inst.outcome.text == "removal of the retropharyngeal abscess"
    assert inst.performedPeriod.end == fhirtypes.DateTime.validate("2013-03-24T10:30:10+01:00")
    assert inst.performedPeriod.start == fhirtypes.DateTime.validate("2013-03-24T09:30:10+01:00")
