...
def impl_provenance_1(inst):
    ...
    assert inst.reason[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    ...
    assert inst.signature[0].when == fhirtypes.Instant.validate("2015-08-27T08:39:24+10:00")
...
def test_provenance_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "provenance-example-sig.json"
    )
