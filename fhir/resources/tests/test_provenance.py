...
class ProvenanceTests(unittest.TestCase):
    ...
    def implProvenance2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.agent[0].role[0].coding[0].system), force_bytes("http://terminology.hl7.org/CodeSystem/v3-ParticipationType"))
        ...
        self.assertEqual(force_bytes(inst.signature[0].data), force_bytes("dGhpcyBibG9iIGlzIHNuaXBwZWQ="))
        self.assertEqual(force_bytes(inst.signature[0].sigFormat), force_bytes("application/signature+xml"))
        self.assertEqual(force_bytes(inst.signature[0].targetFormat), force_bytes("application/fhir+xml"))
        self.assertEqual(force_bytes(inst.signature[0].type[0].code), force_bytes("1.2.840.10065.1.12.1.1"))
        self.assertEqual(force_bytes(inst.signature[0].type[0].display), force_bytes("Author's Signature"))
        self.assertEqual(force_bytes(inst.signature[0].type[0].system), force_bytes("urn:iso-astm:E1762-95:2013"))
        self.assertEqual(inst.signature[0].when.date, FHIRDate("2016-05-26T00:41:10-04:00").date)
