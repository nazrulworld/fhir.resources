...
def test_questionnaire_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "person-questionnaire.json"
    )
...
def impl_questionnaire_2(inst):
    ...
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[4].item[0].linkId == "DiagnosticReport.implicitRules-flyover"
    assert inst.item[0].item[4].item[0].type == "display"
    ...
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[9].item[0].linkId == "DiagnosticReport.modifierExtension-flyover"
    assert inst.item[0].item[9].item[0].type == "display"
...
def test_questionnaire_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "hlaresult-questionnaire.json"
    )
    inst = questionnaire.Questionnaire.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_questionnaire_3(inst):
    ...
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[4].item[0].linkId == "OperationOutcome.implicitRules-flyover"
    assert inst.item[0].item[4].item[0].type == "display"
    ...
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[9].item[0].linkId == "OperationOutcome.modifierExtension-flyover"
    assert inst.item[0].item[9].item[0].type == "display"
...
def impl_questionnaire_4(inst):
    ...
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[3].item[0].linkId == "EventDefinition.implicitRules-flyover"
    assert inst.item[0].item[3].item[0].type == "display"
    ...
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[8].item[0].linkId == "EventDefinition.modifierExtension-flyover"
    assert inst.item[0].item[8].item[0].type == "display"
    ...
    assert inst.meta.tag[0].display == "test health data"
    assert inst.meta.tag[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    assert inst.publisher == "Health Level Seven International (Clinical Decision Support)"
    assert inst.status == "draft"
    assert inst.version == "4.3.0"
...
def test_questionnaire_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "eventdefinition-questionnaire.json"
    )
    inst = questionnaire.Questionnaire.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_questionnaire_5(inst):
    ...
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[3].item[0].linkId == "ActivityDefinition.implicitRules-flyover"
    assert inst.item[0].item[3].item[0].type == "display"
    assert inst.item[0].item[3].item[1].linkId == "ActivityDefinition.implicitRules.value"
    assert inst.item[0].item[3].item[1].repeats is False
    assert inst.item[0].item[3].item[1].required is False
    assert inst.item[0].item[3].item[1].text == "A set of rules under which this content was created"
    assert inst.item[0].item[3].item[1].type == "string"
    ...
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[8].item[0].linkId == "ActivityDefinition.modifierExtension-flyover"
    assert inst.item[0].item[8].item[0].type == "display"
...
def impl_questionnaire_6(inst):
    ...
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[3].item[0].linkId == "GuidanceResponse.implicitRules-flyover"
    assert inst.item[0].item[3].item[0].type == "display"
    ...
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[8].item[0].linkId == "GuidanceResponse.modifierExtension-flyover"
    assert inst.item[0].item[8].item[0].type == "display"
    ...
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[9].item[0].linkId == "GuidanceResponse.requestIdentifier-flyover"
    assert inst.item[0].item[9].item[0].type == "display"
    assert inst.item[0].item[9].item[1].linkId == "GuidanceResponse.requestIdentifier.label"
    assert inst.item[0].item[9].item[1].repeats is False
    assert inst.item[0].item[9].item[1].required is False
    assert inst.item[0].item[9].item[1].text == "label:"
    assert inst.item[0].item[9].item[1].type == "string"
    assert inst.item[0].item[9].item[2].linkId == "GuidanceResponse.requestIdentifier.system"
    ...
    assert inst.item[0].item[9].item[3].linkId == "GuidanceResponse.requestIdentifier.value"
...
def test_questionnaire_6(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "cdshooksguidanceresponse-questionnaire.json"
    )
    inst = questionnaire.Questionnaire.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_questionnaire_7(inst):
    ...
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[4].item[0].linkId == "SearchParameter.implicitRules-flyover"
    assert inst.item[0].item[4].item[0].type == "display"
    ...
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[9].item[0].linkId == "SearchParameter.modifierExtension-flyover"
    assert inst.item[0].item[9].item[0].type == "display"
...
def test_questionnaire_7(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "searchparameter-questionnaire.json"
    )
    inst = questionnaire.Questionnaire.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_questionnaire_8(inst):
    ...
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[3].item[0].linkId == "ExplanationOfBenefit.implicitRules-flyover"
    assert inst.item[0].item[3].item[0].type == "display"
    assert inst.item[0].item[3].item[1].linkId == "ExplanationOfBenefit.implicitRules.value"
    assert inst.item[0].item[3].item[1].repeats is False
    assert inst.item[0].item[3].item[1].required is False
    assert inst.item[0].item[3].item[1].text == "A set of rules under which this content was created"
    assert inst.item[0].item[3].item[1].type == "string"
    ...
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[4].item[0].linkId == "ExplanationOfBenefit.language-flyover"
    assert inst.item[0].item[4].item[0].type == "display"
    ...
    assert inst.item[0].item[6].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[6].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[6].item[0].linkId == "ExplanationOfBenefit.contained-flyover"
    assert inst.item[0].item[6].item[0].type == "display"
    ...
    assert inst.item[0].item[7].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[7].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[7].item[0].linkId == "ExplanationOfBenefit.extension-flyover"
    assert inst.item[0].item[7].item[0].type == "display"
    ...
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[8].item[0].linkId == "ExplanationOfBenefit.modifierExtension-flyover"
    assert inst.item[0].item[8].item[0].type == "display"
    ...
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[9].item[0].linkId == "ExplanationOfBenefit.identifier-flyover"
    assert inst.item[0].item[9].item[0].text == "A unique identifier assigned to this explanation of benefit."
    assert inst.item[0].item[9].item[0].type == "display"
    assert inst.item[0].item[9].item[1].linkId == "ExplanationOfBenefit.identifier.label"
    assert inst.item[0].item[9].item[1].repeats is False
    assert inst.item[0].item[9].item[1].required is False
    assert inst.item[0].item[9].item[1].text == "label:"
    assert inst.item[0].item[9].item[1].type == "string"
    assert inst.item[0].item[9].item[2].linkId == "ExplanationOfBenefit.identifier.system"
    assert inst.item[0].item[9].item[2].repeats is False
    assert inst.item[0].item[9].item[2].required is False
    assert inst.item[0].item[9].item[2].text == "system:"
    assert inst.item[0].item[9].item[2].type == "string"
    assert inst.item[0].item[9].item[3].linkId == "ExplanationOfBenefit.identifier.value"
    assert inst.item[0].item[9].item[3].repeats is False
    assert inst.item[0].item[9].item[3].required is False
    assert inst.item[0].item[9].item[3].text == "value:"
    assert inst.item[0].item[9].item[3].type == "string"
...
def impl_questionnaire_9(inst):
    ...
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[3].item[0].linkId == "ImmunizationEvaluation.implicitRules-flyover"
    assert inst.item[0].item[3].item[0].type == "display"
    assert inst.item[0].item[3].item[1].linkId == "ImmunizationEvaluation.implicitRules.value"
    assert inst.item[0].item[3].item[1].repeats is False
    assert inst.item[0].item[3].item[1].required is False
    assert inst.item[0].item[3].item[1].text == "A set of rules under which this content was created"
    assert inst.item[0].item[3].item[1].type == "string"
    ...
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[4].item[0].linkId == "ImmunizationEvaluation.language-flyover"
    assert inst.item[0].item[4].item[0].type == "display"
    assert inst.item[0].item[4].item[1].linkId == "ImmunizationEvaluation.language.value"
    assert inst.item[0].item[4].item[1].repeats is False
    assert inst.item[0].item[4].item[1].required is False
    assert inst.item[0].item[4].item[1].text == "language"
    assert inst.item[0].item[4].item[1].type == "choice"
    ...
    assert inst.item[0].item[6].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[6].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[6].item[0].linkId == "ImmunizationEvaluation.contained-flyover"
    assert inst.item[0].item[6].item[0].type == "display"
    ...
    assert inst.item[0].item[7].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[7].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[7].item[0].linkId == "ImmunizationEvaluation.extension-flyover"
    assert inst.item[0].item[7].item[0].type == "display"
    ...
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[8].item[0].linkId == "ImmunizationEvaluation.modifierExtension-flyover"
    assert inst.item[0].item[8].item[0].type == "display"
    ...
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[9].item[0].linkId == "ImmunizationEvaluation.identifier-flyover"
    assert inst.item[0].item[9].item[0].text == (
    "A unique identifier assigned to this immunization evaluation"
    " record."
    )
    assert inst.item[0].item[9].item[0].type == "display"
    assert inst.item[0].item[9].item[1].linkId == "ImmunizationEvaluation.identifier.label"
    assert inst.item[0].item[9].item[1].repeats is False
    assert inst.item[0].item[9].item[1].required is False
    assert inst.item[0].item[9].item[1].text == "label:"
    assert inst.item[0].item[9].item[1].type == "string"
    assert inst.item[0].item[9].item[2].linkId == "ImmunizationEvaluation.identifier.system"
    assert inst.item[0].item[9].item[2].repeats is False
    assert inst.item[0].item[9].item[2].required is False
    assert inst.item[0].item[9].item[2].text == "system:"
    assert inst.item[0].item[9].item[2].type == "string"
    assert inst.item[0].item[9].item[3].linkId == "ImmunizationEvaluation.identifier.value"
    assert inst.item[0].item[9].item[3].repeats is False
    assert inst.item[0].item[9].item[3].required is False
    assert inst.item[0].item[9].item[3].text == "value:"
    assert inst.item[0].item[9].item[3].type == "string"
    ...
    "Health Level Seven International (Public Health and "
    "Emergency Response)"
    )
    assert inst.status == "draft"
    assert inst.version == "4.3.0"
...
def impl_questionnaire_10(inst):
    ...
    assert inst.item[0].item[1].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[1].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[1].item[0].linkId == "CoverageEligibilityResponse.id-flyover"
    assert inst.item[0].item[1].item[0].type == "display"
    ...
    assert inst.item[0].item[2].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[2].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[2].item[0].linkId == "CoverageEligibilityResponse.meta-flyover"
    assert inst.item[0].item[2].item[0].text == (
    "The metadata about the resource. This is content that is "
    "maintained by the infrastructure. Changes to the content "
    "might not always be associated with version changes to the "
    ...
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[3].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[3].item[0].linkId == "CoverageEligibilityResponse.implicitRules-flyover"
    assert inst.item[0].item[3].item[0].type == "display"
    assert inst.item[0].item[3].item[1].linkId == "CoverageEligibilityResponse.implicitRules.value"
    assert inst.item[0].item[3].item[1].repeats is False
    assert inst.item[0].item[3].item[1].required is False
    assert inst.item[0].item[3].item[1].text == "A set of rules under which this content was created"
    assert inst.item[0].item[3].item[1].type == "string"
    ...
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[4].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[4].item[0].linkId == "CoverageEligibilityResponse.language-flyover"
    assert inst.item[0].item[4].item[0].type == "display"
    assert inst.item[0].item[4].item[1].linkId == "CoverageEligibilityResponse.language.value"
    assert inst.item[0].item[4].item[1].repeats is False
    assert inst.item[0].item[4].item[1].required is False
    assert inst.item[0].item[4].item[1].text == "language"
    assert inst.item[0].item[4].item[1].type == "choice"
    ...
    assert inst.item[0].item[5].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[5].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[5].item[0].linkId == "CoverageEligibilityResponse.text-flyover"
    assert inst.item[0].item[5].item[0].type == "display"
    ...
    assert inst.item[0].item[6].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[6].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[6].item[0].linkId == "CoverageEligibilityResponse.contained-flyover"
    assert inst.item[0].item[6].item[0].type == "display"
    ...
    assert inst.item[0].item[7].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[7].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[7].item[0].linkId == "CoverageEligibilityResponse.extension-flyover"
    assert inst.item[0].item[7].item[0].type == "display"
    ...
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[8].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[8].item[0].linkId == "CoverageEligibilityResponse.modifierExtension-flyover"
    assert inst.item[0].item[8].item[0].type == "display"
    assert inst.item[0].item[8].linkId == "CoverageEligibilityResponse.modifierExtension"
    assert inst.item[0].item[8].repeats is True
    assert inst.item[0].item[8].required is False
    assert inst.item[0].item[8].text == "Extensions that cannot be ignored"
    assert inst.item[0].item[8].type == "group"
    ...
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].display == "Fly-over"
    assert inst.item[0].item[9].item[0].extension[0].valueCodeableConcept.coding[0].system == "http://hl7.org/fhir/questionnaire-item-control"
    assert inst.item[0].item[9].item[0].linkId == "CoverageEligibilityResponse.identifier-flyover"
    assert inst.item[0].item[9].item[0].text == (
    "A unique identifier assigned to this coverage eligiblity "
    "request."
    )
    assert inst.item[0].item[9].item[0].type == "display"
    assert inst.item[0].item[9].item[1].linkId == "CoverageEligibilityResponse.identifier.label"
    assert inst.item[0].item[9].item[1].repeats is False
    assert inst.item[0].item[9].item[1].required is False
    assert inst.item[0].item[9].item[1].text == "label:"
    assert inst.item[0].item[9].item[1].type == "string"
    assert inst.item[0].item[9].item[2].linkId == "CoverageEligibilityResponse.identifier.system"
    assert inst.item[0].item[9].item[2].repeats is False
    assert inst.item[0].item[9].item[2].required is False
    assert inst.item[0].item[9].item[2].text == "system:"
    assert inst.item[0].item[9].item[2].type == "string"
    assert inst.item[0].item[9].item[3].linkId == "CoverageEligibilityResponse.identifier.value"
    assert inst.item[0].item[9].item[3].repeats is False
    assert inst.item[0].item[9].item[3].required is False
    assert inst.item[0].item[9].item[3].text == "value:"
    assert inst.item[0].item[9].item[3].type == "string"
    ...
    assert inst.item[0].item[9].repeats is True
    assert inst.item[0].item[9].required is False
    assert inst.item[0].item[9].text == "Business Identifier for coverage eligiblity request"
    assert inst.item[0].item[9].type == "group"
...
def test_questionnaire_10(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "coverageeligibilityresponse-questionnaire.json"
    )
    inst = questionnaire.Questionnaire.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
