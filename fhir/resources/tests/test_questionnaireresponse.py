...
def impl_questionnaireresponse_1(inst):
    ...
    assert inst.id == "3141"
    assert inst.identifier.system == "http://example.org/fhir/NamingSystem/questionnaire-ids"
    assert inst.identifier.value == "Q12349876"
    assert inst.item[0].item[0].answer[0].item[0].item[0].answer[0].valueCoding.code == "1"
    assert inst.item[0].item[0].answer[0].item[0].item[0].answer[0].valueCoding.system == "http://cancer.questionnaire.org/system/code/yesno"
    assert inst.item[0].item[0].answer[0].item[0].item[0].linkId == "1.1.1.1"
    assert inst.item[0].item[0].answer[0].item[0].item[1].answer[0].valueCoding.code == "1"
    assert inst.item[0].item[0].answer[0].item[0].item[1].answer[0].valueCoding.system == "http://cancer.questionnaire.org/system/code/yesno"
    assert inst.item[0].item[0].answer[0].item[0].item[1].linkId == "1.1.1.2"
    assert inst.item[0].item[0].answer[0].item[0].item[2].answer[0].valueCoding.code == "0"
    assert inst.item[0].item[0].answer[0].item[0].item[2].answer[0].valueCoding.system == "http://cancer.questionnaire.org/system/code/yesno"
    ...
    assert inst.item[0].item[0].answer[0].valueCoding.system == "http://cancer.questionnaire.org/system/code/yesno"
...
def test_questionnaireresponse_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "questionnaireresponse-example.json"
    )
...
def impl_questionnaireresponse_2(inst):
    ...
    assert inst.item[0].item[0].answer[0].valueDate == fhirtypes.Date.validate("2008-01-17")
    ...
    assert inst.item[1].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54125-0"
    ...
    assert inst.item[1].item[0].item[1].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[1].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54131-8"
    assert inst.item[1].item[0].item[1].linkId == "1.1.2"
    assert inst.item[1].item[0].item[1].text == "Gender"
    assert inst.item[1].item[0].item[2].answer[0].valueDate == fhirtypes.Date.validate("1966-04-04")
    assert inst.item[1].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/21112-8"
    ...
    assert inst.item[1].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[1].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54132-6"
    ...
    assert inst.item[1].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[1].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54128-4"
    ...
    assert inst.item[1].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[1].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54135-9"
    assert inst.item[1].item[0].item[5].linkId == "1.1.6"
    assert inst.item[1].item[0].item[5].text == (
    "Are your parents related to each other in any way other than"
    " marriage?"
    )
    assert inst.item[1].item[0].item[6].answer[0].item[0].item[0].answer[0].valueCoding.code == "[in_i]"
    assert inst.item[1].item[0].item[6].answer[0].item[0].item[0].answer[0].valueCoding.display == "inches"
    assert inst.item[1].item[0].item[6].answer[0].item[0].item[0].answer[0].valueCoding.system == "http://unitsofmeasure.org"
    ...
    assert inst.item[1].item[0].item[6].definition == "http://loinc.org/fhir/DataElement/8302-2"
    assert inst.item[1].item[0].item[6].linkId == "1.1.7"
    assert inst.item[1].item[0].item[6].text == "Height"
    assert inst.item[1].item[0].item[7].answer[0].item[0].item[0].answer[0].valueCoding.code == "[lb_av]"
    assert inst.item[1].item[0].item[7].answer[0].item[0].item[0].answer[0].valueCoding.display == "pounds"
    assert inst.item[1].item[0].item[7].answer[0].item[0].item[0].answer[0].valueCoding.system == "http://unitsofmeasure.org"
    ...
    assert inst.item[1].item[0].item[7].definition == "http://loinc.org/fhir/DataElement/29463-7"
    ...
    assert inst.item[1].item[0].item[8].definition == "http://loinc.org/fhir/DataElement/39156-5"
    ...
    assert inst.item[1].item[0].item[9].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[1].item[0].item[9].definition == "http://loinc.org/fhir/DataElement/54134-2"
    ...
    assert inst.item[2].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[0].item[2].text == "Gender"
    assert float(inst.item[2].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal) == float(17)
    assert inst.item[2].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54141-7"
    assert inst.item[2].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.2.2"
    ...
    assert inst.item[2].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[1].item[0].item[0].answer[0].valueCoding.code == "LA10415-0"
    assert inst.item[2].item[1].item[0].item[0].answer[0].valueCoding.display == "Brother"
    assert inst.item[2].item[1].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[1].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[1].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[1].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[1].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[1].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[1].item[0].item[2].text == "Gender"
    assert float(inst.item[2].item[1].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal) == float(32)
    assert inst.item[2].item[1].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54141-7"
    assert inst.item[2].item[1].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.2.2"
    ...
    assert inst.item[2].item[1].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[1].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[1].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[1].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[1].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[1].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[1].item[1].item[0].answer[0].valueCoding.code == "LA10550-4"
    assert inst.item[2].item[1].item[1].item[0].answer[0].valueCoding.display == "-- Other Cancer"
    assert inst.item[2].item[1].item[1].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[1].item[1].item[0].linkId == "2.1.2.1"
    assert inst.item[2].item[1].item[1].item[0].text == "Disease or Condition"
    assert inst.item[2].item[1].item[1].item[1].answer[0].valueCoding.code == "LA10397-0"
    assert inst.item[2].item[1].item[1].item[1].answer[0].valueCoding.display == "30-39"
    assert inst.item[2].item[1].item[1].item[1].answer[0].valueCoding.system == "http://loinc.org"
    ...
    assert inst.item[2].item[1].item[1].text == "This family member's history of disease"
    assert inst.item[2].item[1].linkId == "2.1"
    assert inst.item[2].item[2].item[0].item[0].answer[0].valueCoding.code == "LA10418-4"
    assert inst.item[2].item[2].item[0].item[0].answer[0].valueCoding.display == "Sister"
    assert inst.item[2].item[2].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[2].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[2].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[2].item[0].item[2].answer[0].valueCoding.display == "Female"
    assert inst.item[2].item[2].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[2].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[2].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[2].item[0].item[2].text == "Gender"
    assert float(inst.item[2].item[2].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal) == float(36)
    assert inst.item[2].item[2].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54141-7"
    assert inst.item[2].item[2].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.2.2"
    ...
    assert inst.item[2].item[2].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[2].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[2].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[2].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[2].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[2].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[2].item[1].item[0].answer[0].valueCoding.code == "LA10536-3"
    assert inst.item[2].item[2].item[1].item[0].answer[0].valueCoding.display == "-- Breast Cancer"
    assert inst.item[2].item[2].item[1].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[2].item[1].item[0].linkId == "2.1.2.1"
    assert inst.item[2].item[2].item[1].item[0].text == "Disease or Condition"
    assert inst.item[2].item[2].item[1].item[1].answer[0].valueCoding.code == "LA10397-0"
    assert inst.item[2].item[2].item[1].item[1].answer[0].valueCoding.display == "30-39"
    assert inst.item[2].item[2].item[1].item[1].answer[0].valueCoding.system == "http://loinc.org"
    ...
    assert inst.item[2].item[2].item[1].text == "This family member's history of disease"
    assert inst.item[2].item[2].linkId == "2.1"
    assert inst.item[2].item[3].item[0].item[0].answer[0].valueCoding.code == "LA10419-2"
    assert inst.item[2].item[3].item[0].item[0].answer[0].valueCoding.display == "Nephew"
    assert inst.item[2].item[3].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[3].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[3].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[3].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[3].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[3].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[3].item[0].item[2].text == "Gender"
    assert float(inst.item[2].item[3].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal) == float(16)
    assert inst.item[2].item[3].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54141-7"
    assert inst.item[2].item[3].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.2.2"
    ...
    assert inst.item[2].item[3].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[3].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[3].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[3].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[3].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[3].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[4].item[0].item[0].answer[0].valueCoding.code == "LA10420-0"
    assert inst.item[2].item[4].item[0].item[0].answer[0].valueCoding.display == "Niece"
    assert inst.item[2].item[4].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[4].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[4].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[4].item[0].item[2].answer[0].valueCoding.display == "Female"
    assert inst.item[2].item[4].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[4].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[4].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[4].item[0].item[2].text == "Gender"
    assert float(inst.item[2].item[4].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal) == float(15)
    assert inst.item[2].item[4].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54141-7"
    assert inst.item[2].item[4].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.2.2"
    ...
    assert inst.item[2].item[4].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[4].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[4].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[4].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[4].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[4].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[5].item[0].item[0].answer[0].valueCoding.code == "LA10416-8"
    assert inst.item[2].item[5].item[0].item[0].answer[0].valueCoding.display == "Father"
    assert inst.item[2].item[5].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[5].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[5].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[5].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[5].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[5].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[5].item[0].item[2].text == "Gender"
    assert float(inst.item[2].item[5].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal) == float(52)
    assert inst.item[2].item[5].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54141-7"
    assert inst.item[2].item[5].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.2.2"
    ...
    assert inst.item[2].item[5].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[5].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[5].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[5].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[5].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[5].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[6].item[0].item[0].answer[0].valueCoding.code == "LA10425-9"
    assert inst.item[2].item[6].item[0].item[0].answer[0].valueCoding.display == "Paternal Uncle"
    assert inst.item[2].item[6].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[6].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[6].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[6].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[6].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[6].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[6].item[0].item[2].text == "Gender"
    assert float(inst.item[2].item[6].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal) == float(56)
    assert inst.item[2].item[6].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54141-7"
    assert inst.item[2].item[6].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.2.2"
    ...
    assert inst.item[2].item[6].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[6].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[6].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[6].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[6].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[6].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[7].item[0].item[0].answer[0].valueCoding.code == "LA10421-8"
    assert inst.item[2].item[7].item[0].item[0].answer[0].valueCoding.display == "Paternal Aunt"
    assert inst.item[2].item[7].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[7].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[7].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[7].item[0].item[2].answer[0].valueCoding.display == "Female"
    assert inst.item[2].item[7].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[7].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[7].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[7].item[0].item[2].text == "Gender"
    assert float(inst.item[2].item[7].item[0].item[3].answer[0].item[0].item[0].answer[0].valueDecimal) == float(57)
    assert inst.item[2].item[7].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54141-7"
    assert inst.item[2].item[7].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.2.2"
    ...
    assert inst.item[2].item[7].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[7].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[7].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[7].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[7].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[7].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[7].item[1].item[0].answer[0].valueCoding.code == "LA10543-9"
    assert inst.item[2].item[7].item[1].item[0].answer[0].valueCoding.display == "-- Skin Cancer"
    assert inst.item[2].item[7].item[1].item[0].answer[0].valueCoding.system == "http://loinc.org"
    ...
    assert inst.item[2].item[7].item[1].text == "This family member's history of disease"
    assert inst.item[2].item[7].linkId == "2.1"
    assert inst.item[2].item[8].item[0].item[0].answer[0].valueCoding.code == "LA10423-4"
    assert inst.item[2].item[8].item[0].item[0].answer[0].valueCoding.display == "Paternal Grandfather"
    assert inst.item[2].item[8].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[8].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[8].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[8].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[8].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[8].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[8].item[0].item[2].text == "Gender"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[0].answer[0].valueCoding.code == "LA10537-1"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[0].answer[0].valueCoding.display == "-- Colon Cancer"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54112-8"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.1.1"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[0].text == "Cause of Death"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[1].answer[0].valueCoding.code == "LA10400-2"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[1].answer[0].valueCoding.display == "OVER 60"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[1].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54113-6"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[1].linkId == "2.1.1.4.1.2"
    assert inst.item[2].item[8].item[0].item[3].answer[0].item[0].item[1].text == "Age at Death"
    ...
    assert inst.item[2].item[8].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[8].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[8].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[8].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[8].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[8].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
    ...
    assert inst.item[2].item[8].item[1].item[0].answer[0].valueCoding.code == "LA10537-1"
    assert inst.item[2].item[8].item[1].item[0].answer[0].valueCoding.display == "-- Colon Cancer"
    assert inst.item[2].item[8].item[1].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[8].item[1].item[0].linkId == "2.1.2.1"
    assert inst.item[2].item[8].item[1].item[0].text == "Disease or Condition"
    assert inst.item[2].item[8].item[1].item[1].answer[0].valueCoding.code == "LA10400-2"
    assert inst.item[2].item[8].item[1].item[1].answer[0].valueCoding.display == "OVER 60"
    assert inst.item[2].item[8].item[1].item[1].answer[0].valueCoding.system == "http://loinc.org"
    ...
    assert inst.item[2].item[8].item[1].text == "This family member's history of disease"
    assert inst.item[2].item[8].linkId == "2.1"
    assert inst.item[2].item[9].item[0].item[0].answer[0].valueCoding.code == "LA10424-2"
    assert inst.item[2].item[9].item[0].item[0].answer[0].valueCoding.display == "Paternal Grandmother"
    assert inst.item[2].item[9].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[9].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54136-7"
    ...
    assert inst.item[2].item[9].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54138-3"
    ...
    assert inst.item[2].item[9].item[0].item[2].answer[0].valueCoding.display == "Female"
    assert inst.item[2].item[9].item[0].item[2].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[9].item[0].item[2].definition == "http://loinc.org/fhir/DataElement/54123-5"
    assert inst.item[2].item[9].item[0].item[2].linkId == "2.1.1.3"
    assert inst.item[2].item[9].item[0].item[2].text == "Gender"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].answer[0].item[0].answer[0].valueString == "Lou Gehrigs"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].answer[0].item[0].linkId == "2.1.1.4.1.1.1"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].answer[0].item[0].text == "Please specify"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].answer[0].valueCoding.code == "LA10589-2"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].answer[0].valueCoding.display == "-- Other/Unexpected"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].definition == "http://loinc.org/fhir/DataElement/54112-8"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].linkId == "2.1.1.4.1.1"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[0].text == "Cause of Death"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[1].answer[0].valueCoding.code == "LA10400-2"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[1].answer[0].valueCoding.display == "OVER 60"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[1].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[1].definition == "http://loinc.org/fhir/DataElement/54113-6"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[1].linkId == "2.1.1.4.1.2"
    assert inst.item[2].item[9].item[0].item[3].answer[0].item[0].item[1].text == "Age at Death"
    ...
    assert inst.item[2].item[9].item[0].item[3].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[9].item[0].item[3].definition == "http://loinc.org/fhir/DataElement/54139-1"
    ...
    assert inst.item[2].item[9].item[0].item[4].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[9].item[0].item[4].definition == "http://loinc.org/fhir/DataElement/54121-9"
    ...
    assert inst.item[2].item[9].item[0].item[5].answer[0].valueCoding.system == "http://loinc.org"
    assert inst.item[2].item[9].item[0].item[5].definition == "http://loinc.org/fhir/DataElement/54122-7"
...
def impl_questionnaireresponse_3(inst):
    ...
    assert inst.item[1].item[1].answer[0].valueDate == fhirtypes.Date.validate("1960-03-13")
...
def test_questionnaireresponse_3(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "questionnaireresponse-example-f201-lifelines.json"
    )
    inst = questionnaireresponse.QuestionnaireResponse.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_questionnaireresponse_4(inst):
    ...
    assert inst.item[0].item[1].item[2].answer[0].item[0].item[0].answer[0].valueDate == fhirtypes.Date.validate("1972-11-30")
    assert inst.item[0].item[1].item[2].answer[0].item[0].item[0].linkId == "vitaminKDose1"
    assert inst.item[0].item[1].item[2].answer[0].item[0].item[0].text == "1st dose"
    assert inst.item[0].item[1].item[2].answer[0].item[0].item[1].answer[0].valueDate == fhirtypes.Date.validate("1972-12-11")
    assert inst.item[0].item[1].item[2].answer[0].item[0].item[1].linkId == "vitaminKDose2"
    ...
    assert inst.item[0].item[1].item[3].answer[0].item[0].answer[0].valueDate == fhirtypes.Date.validate("1972-12-04")
    ...
    assert inst.item[0].item[1].item[4].answer[0].valueString == "Already able to speak Chinese"
...
def test_questionnaireresponse_4(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "questionnaireresponse-example-bluebook.json"
    )
    inst = questionnaireresponse.QuestionnaireResponse.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
...
def impl_questionnaireresponse_5(inst):
    ...
    assert inst.item[0].answer[0].valueCoding.extension[0].url == "http://hl7.org/fhir/StructureDefinition/ordinalValue"
    assert float(inst.item[0].answer[0].valueCoding.extension[0].valueDecimal) == float(4)
    ...
    assert inst.item[1].answer[0].valueCoding.extension[0].url == "http://hl7.org/fhir/StructureDefinition/ordinalValue"
    assert float(inst.item[1].answer[0].valueCoding.extension[0].valueDecimal) == float(5)
    ...
    assert inst.item[2].answer[0].valueCoding.extension[0].url == "http://hl7.org/fhir/StructureDefinition/ordinalValue"
    assert float(inst.item[2].answer[0].valueCoding.extension[0].valueDecimal) == float(4)
