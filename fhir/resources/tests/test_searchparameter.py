...
class SearchParameterTests(unittest.TestCase):
    ...
    def implSearchParameter1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Optional Extensions Element"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("valueset-extensions-ValueSet-workflow"))
        ...
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/valueset-extensions-ValueSet-workflow"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
        self.assertEqual(force_bytes(inst.xpath), force_bytes("f:ValueSet/f:extension[@url='http://hl7.org/fhir/StructureDefinition/valueset-workflowStatus'] | /f:#workflowStatus"))
    ...
    def implSearchParameter2(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Optional Extensions Element"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("codesystem-extensions-CodeSystem-author"))
        self.assertEqual(force_bytes(inst.name), force_bytes("author"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("string"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/codesystem-extensions-CodeSystem-author"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
        self.assertEqual(force_bytes(inst.xpath), force_bytes("f:CodeSystem/f:extension[@url='http://hl7.org/fhir/StructureDefinition/codesystem-author'] | /f:#author"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))
    ...
    def testSearchParameter4(self):
        inst = self.instantiate_from("questionnaireresponse-extensions-QuestionnaireResponse-item-subject.json")
        self.assertIsNotNone(inst, "Must have instantiated a SearchParameter instance")
    ...
    def implSearchParameter4(self, inst):
        self.assertEqual(force_bytes(inst.base[0]), force_bytes("QuestionnaireResponse"))
        self.assertEqual(force_bytes(inst.code), force_bytes("item-subject"))
        self.assertEqual(force_bytes(inst.description), force_bytes("Allows searching for QuestionnaireResponses by item value where the item has isSubject=true"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.expression), force_bytes("QuestionnaireResponse.item.where(hasExtension('http://hl7.org/fhir/StructureDefinition/questionnaireresponse-isSubject')).answer.value.ofType(Reference)"))
        self.assertEqual(force_bytes(inst.id), force_bytes("questionnaireresponse-extensions-QuestionnaireResponse-item-subject"))
        self.assertEqual(force_bytes(inst.name), force_bytes("item-subject"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("reference"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/questionnaireresponse-extensions-QuestionnaireResponse-item-subject"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))
    ...
    def implSearchParameter5(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("This is the formal declaration for the _filter parameter, documented at [http://hl7.org/fhir/search_filter.html](http://hl7.org/fhir/search_filter.html)"))
        ...
        self.assertEqual(force_bytes(inst.publisher), force_bytes("Health Level Seven International (FHIR Infrastructure)"))
        self.assertEqual(force_bytes(inst.purpose), force_bytes("Support combination searches when the simple name=value basis of search cannot express what is required"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
        self.assertEqual(force_bytes(inst.type), force_bytes("special"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/filter"))
    ...
    def testSearchParameter7(self):
        inst = self.instantiate_from("diagnosticreport-genetic-DiagnosticReport-assessed-condition.json")
        self.assertIsNotNone(inst, "Must have instantiated a SearchParameter instance")
    ...
    def implSearchParameter7(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Condition assessed by genetic test"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.expression), force_bytes("DiagnosticReport.extension('http://hl7.org/fhir/StructureDefinition/DiagnosticReport-geneticsAssessedCondition')"))
        self.assertEqual(force_bytes(inst.id), force_bytes("diagnosticreport-genetic-DiagnosticReport-assessed-condition"))
        self.assertEqual(force_bytes(inst.name), force_bytes("assessed-condition"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("reference"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/diagnosticreport-genetic-DiagnosticReport-assessed-condition"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))
    ...
    def implSearchParameter8(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("The donation identification number (DIN)"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.expression), force_bytes("Device.extension('http://hl7.org/fhir/SearchParameter/device-extensions-Device-din')"))
        self.assertEqual(force_bytes(inst.id), force_bytes("device-extensions-Device-din"))
        self.assertEqual(force_bytes(inst.name), force_bytes("din"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("token"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/device-extensions-Device-din"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))

    def testSearchParameter9(self):
        inst = self.instantiate_from("observation-genetic-Observation-gene-identifier.json")
        self.assertIsNotNone(inst, "Must have instantiated a SearchParameter instance")
    ...
    def implSearchParameter9(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("HGNC gene symbol and identifier"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.expression), force_bytes("Observation.extension('http://hl7.org/fhir/StructureDefinition/observation-geneticsGene')"))
        self.assertEqual(force_bytes(inst.id), force_bytes("observation-genetic-Observation-gene-identifier"))
        self.assertEqual(force_bytes(inst.name), force_bytes("gene-identifier"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("token"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/observation-genetic-Observation-gene-identifier"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))

    def testSearchParameter10(self):
        try:
            inst = self.instantiate_from("codesystem-extensions-CodeSystem-workflow.json")
        except ValueError as exc:
            sys.stderr.write(str(exc) + "\n")
            return 1
        self.assertIsNotNone(inst, "Must have instantiated a SearchParameter instance")
    ...
    def implSearchParameter10(self, inst):
        ...
        self.assertEqual(force_bytes(inst.description), force_bytes("Optional Extensions Element"))
        self.assertTrue(inst.experimental)
        self.assertEqual(force_bytes(inst.id), force_bytes("codesystem-extensions-CodeSystem-workflow"))
        self.assertEqual(force_bytes(inst.name), force_bytes("workflow"))
        self.assertEqual(force_bytes(inst.status), force_bytes("draft"))
        self.assertEqual(force_bytes(inst.type), force_bytes("token"))
        self.assertEqual(force_bytes(inst.url), force_bytes("http://hl7.org/fhir/SearchParameter/codesystem-extensions-CodeSystem-workflow"))
        self.assertEqual(force_bytes(inst.version), force_bytes("4.0.1"))
        self.assertEqual(force_bytes(inst.xpath), force_bytes("f:CodeSystem/f:extension[@url='http://hl7.org/fhir/StructureDefinition/codesystem-workflowStatus'] | /f:#workflowStatus"))
        self.assertEqual(force_bytes(inst.xpathUsage), force_bytes("normal"))
