...
class ServiceRequestTests(unittest.TestCase):
    ...
    def implServiceRequest5(self, inst):
        ...
        self.assertEqual(force_bytes(inst.patientInstruction), force_bytes("Start with 30kg 10-15 repetitions for three sets and increase in increments of 5kg when you feel ready"))
        self.assertEqual(force_bytes(inst.status), force_bytes("active"))
        self.assertEqual(force_bytes(inst.text.status), force_bytes("generated"))
