...
def impl_specimendefinition_1(inst):
    ...
    assert inst.typeTested[0].container.cap.coding[0].system == "urn:iso:std:iso:6710:2017"
    ...
    assert inst.typeTested[0].container.material.coding[0].system == "http://snomed.info/sct"
    ...
    "Evacuated blood collection tube, thrombin/clot activator/gel"
    " separator"
    )
    ...
    assert inst.typeTested[0].handling[0].temperatureQualifier.text == "Ambient temperature"
    ...
    assert inst.typeTested[0].handling[1].maxDuration.system == "http://unitsofmeasure.org"
    ...
    assert inst.typeTested[0].handling[1].temperatureQualifier.text == "Refrigerated temperature"
    assert inst.typeTested[0].handling[1].temperatureRange.high.code == "Cel"
    assert inst.typeTested[0].handling[1].temperatureRange.high.system == "http://unitsofmeasure.org"
    ...
    assert inst.typeTested[1].container.cap.coding[0].system == "urn:iso:std:iso:6710:2017"
    ...
    assert inst.typeTested[1].container.material.coding[0].system == "http://snomed.info/sct"
    assert inst.typeTested[1].container.minimumVolumeQuantity.code == "mL"
    assert inst.typeTested[1].container.minimumVolumeQuantity.system == "http://unitsofmeasure.org"
    ...
    "Evacuated blood collection tube with heparin lithium and gel"
    " separator"
    )
    assert inst.typeTested[1].container.type.coding[0].system == "http://snomed.info/sct"
    assert inst.typeTested[1].handling[0].maxDuration.code == "min"
    assert inst.typeTested[1].handling[0].maxDuration.system == "http://unitsofmeasure.org"
    ...
    assert inst.typeTested[1].handling[0].temperatureQualifier.text == "Ambient temperature"
    assert inst.typeTested[1].handling[0].temperatureRange.high.code == "Cel"
    assert inst.typeTested[1].handling[0].temperatureRange.high.system == "http://unitsofmeasure.org"
    assert inst.typeTested[1].handling[0].temperatureRange.high.unit == "°C"
    assert float(inst.typeTested[1].handling[0].temperatureRange.high.value) == float(25)
    assert inst.typeTested[1].handling[0].temperatureRange.low.code == "Cel"
    assert inst.typeTested[1].handling[0].temperatureRange.low.system == "http://unitsofmeasure.org"
    ...
    assert inst.typeTested[1].handling[1].maxDuration.system == "http://unitsofmeasure.org"
    ...
    assert inst.typeTested[1].handling[1].temperatureQualifier.text == "Refrigerated temperature"
    assert inst.typeTested[1].handling[1].temperatureRange.high.code == "Cel"
    assert inst.typeTested[1].handling[1].temperatureRange.high.system == "http://unitsofmeasure.org"
    ...
    assert inst.typeTested[1].handling[1].temperatureRange.low.system == "http://unitsofmeasure.org"
    ...
    assert inst.typeTested[1].rejectionCriterion[0].coding[0].display == "insufficient specimen volume"
    assert inst.typeTested[1].rejectionCriterion[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/rejection-criteria"
    assert inst.typeTested[1].rejectionCriterion[1].coding[0].code == "hemolized"
    assert inst.typeTested[1].rejectionCriterion[1].coding[0].display == "hemolized specimen"
    assert inst.typeTested[1].rejectionCriterion[1].coding[0].system == "http://terminology.hl7.org/CodeSystem/rejection-criteria"
...
def test_specimendefinition_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "specimendefinition-example-serum-plasma.json"
    )
