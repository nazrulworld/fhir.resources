...
import json
import six
from fhir.resources import substancespecification
...
class SubstanceSpecificationTests(unittest.TestCase):
    ...
    def implSubstanceSpecification1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.text.div), force_bytes("<div xmlns=\"http://www.w3.org/1999/xhtml\"><p><b>Generated Narrative with Details</b></p><p><b>id</b>: example</p></div>"))
