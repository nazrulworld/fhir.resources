...
def impl_supplydelivery_1(inst):
    ...
    assert inst.suppliedItem.itemCodeableConcept.coding[0].display == "Blood collect tubes blue cap"
    ...
    assert inst.type.coding[0].system == "http://terminology.hl7.org/CodeSystem/supply-item-type"
...
def test_supplydelivery_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "supplydelivery-example.json"
    )
