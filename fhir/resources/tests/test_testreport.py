...
def impl_testreport_1(inst):
    ...
    assert inst.setup.action[0].operation.detail == "http://projectcrucible.org/permalink/1"
    assert inst.setup.action[0].operation.message == "DELETE Patient"
    assert inst.setup.action[0].operation.result == "pass"
    assert inst.setup.action[1].assert_fhir.detail == "http://projectcrucible.org/permalink/1"
    assert inst.setup.action[1].assert_fhir.message == "HTTP 204"
    assert inst.setup.action[1].assert_fhir.result == "pass"
    assert inst.setup.action[2].operation.detail == "http://projectcrucible.org/permalink/1"
    assert inst.setup.action[2].operation.message == "POST Patient/fixture-patient-create"
    assert inst.setup.action[2].operation.result == "pass"
    assert inst.setup.action[3].assert_fhir.detail == "http://projectcrucible.org/permalink/1"
    assert inst.setup.action[3].assert_fhir.message == "HTTP 201"
    assert inst.setup.action[3].assert_fhir.result == "pass"
    assert inst.status == "completed"
    assert inst.teardown.action[0].operation.detail == "http://projectcrucible.org/permalink/3"
    assert inst.teardown.action[0].operation.message == "DELETE Patient/fixture-patient-create."
    assert inst.teardown.action[0].operation.result == "pass"
    assert inst.testScript.reference == "TestScript/testscript-example"
    assert inst.test[0].action[0].operation.detail == "http://projectcrucible.org/permalink/2"
    assert inst.test[0].action[0].operation.message == "GET Patient/fixture-patient-create"
    assert inst.test[0].action[0].operation.result == "pass"
    assert inst.test[0].action[1].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
    assert inst.test[0].action[1].assert_fhir.message == "HTTP 200"
    assert inst.test[0].action[1].assert_fhir.result == "pass"
    assert inst.test[0].action[2].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
    assert inst.test[0].action[2].assert_fhir.message == "Last-Modified Present"
    assert inst.test[0].action[2].assert_fhir.result == "pass"
    assert inst.test[0].action[3].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
    assert inst.test[0].action[3].assert_fhir.message == "Response is Patient"
    assert inst.test[0].action[3].assert_fhir.result == "pass"
    assert inst.test[0].action[4].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
    assert inst.test[0].action[4].assert_fhir.message == "Response validates"
    assert inst.test[0].action[4].assert_fhir.result == "pass"
    assert inst.test[0].action[5].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
    assert inst.test[0].action[5].assert_fhir.message == "Patient.name.family 'Chalmers'"
    assert inst.test[0].action[5].assert_fhir.result == "pass"
    assert inst.test[0].action[6].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
    ...
    assert inst.test[0].action[7].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
    assert inst.test[0].action[7].assert_fhir.message == "Patient.name.family 'Chalmers'"
    assert inst.test[0].action[7].assert_fhir.result == "pass"
    assert inst.test[0].action[8].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
    assert inst.test[0].action[8].assert_fhir.message == "Patient.name.family 'Chalmers'"
    assert inst.test[0].action[8].assert_fhir.result == "pass"
    assert inst.test[0].action[9].assert_fhir.detail == "http://projectcrucible.org/permalink/2"
...
def test_testreport_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "testreport-example.json"
    )
