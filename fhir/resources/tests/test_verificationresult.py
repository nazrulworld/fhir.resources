...
class VerificationResultTests(unittest.TestCase):
    ...
    def implVerificationResult1(self, inst):
        ...
        self.assertEqual(force_bytes(inst.text.div), force_bytes("<div xmlns=\"http://www.w3.org/1999/xhtml\"><p><b>Generated Narrative with Details</b></p><p><b>id</b>: example</p><p><b>status</b>: attested</p></div>"))
