...
class TriggerDefinition(element.Element):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("condition", "condition", expression.Expression, "Expression", False, None, False),
            ("data", "data", datarequirement.DataRequirement, "DataRequirement", True, None, False),
            ...
            ("timingReference", "timingReference", fhirreference.FHIRReference, "Reference", False, "timing", False),
